...
export default function Home() {
  ...
  const primaryWeakArea = weakAreas[0] ?? null;

  const examPaths = useMemo(() => {
    return [...categories]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden border-b border-border/60">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-20 pt-14 sm:px-6 sm:pb-28 sm:pt-20 lg:px-8">
          ...
          <div className="mx-auto mt-10 max-w-5xl rounded-3xl border border-border/80 bg-card/80 p-4 shadow-sm backdrop-blur-sm sm:p-5">
            <div className="mb-4 flex items-center justify-between gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-primary">Start by exam</p>
                <h2 className="mt-1 text-lg font-black tracking-tight text-foreground">Choose a path, then go straight into practice</h2>
              </div>
              <Button variant="outline" className="rounded-xl" onClick={() => setLocation("/exams")}>
                View all exams
                <ChevronRight className="ml-1 h-4 w-4" />
              </Button>
            </div>
              ...
              {examPaths.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className="group overflow-hidden rounded-2xl border border-slate-100 bg-white p-4 text-left shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_22px_rgba(0,0,0,0.09)]"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-1 text-xs text-slate-500">{cat.testsCount} tests available</p>
                      </div>
                      <ChevronRight className="mt-0.5 h-4 w-4 shrink-0 text-slate-300 transition-transform group-hover:translate-x-0.5 group-hover:text-primary" />
                    </div>
                  </button>
                );
              })}
          ...
          <section className="mt-10">
            <CategoryTabsSection
              ...
              subtitle="Choose the Exam that matches your goal."
              ctaLabel="Browse all exams"
              defaultCtaPath="/exams"
            />
          </section>
          ...
          {primaryWeakArea && (
            <div className="mx-auto mt-6 max-w-5xl rounded-2xl border border-violet-200 bg-violet-50 px-4 py-3 shadow-sm">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-widest text-violet-600">Weak area nudge</p>
                  <p className="mt-1 text-sm font-medium text-violet-900">
                    Your local attempts suggest you should revisit <span className="font-bold">{primaryWeakArea.name}</span> next.
                  </p>
                </div>
                <Button variant="outline" className="rounded-xl border-violet-200 bg-white text-violet-700 hover:bg-violet-50" onClick={() => setLocation("/performance")}>
                  Review performance
                </Button>
              </div>
            </div>
      ...
      <section className="border-b border-border/60 bg-muted/30 py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="text-2xl font-black tracking-tight text-foreground sm:text-3xl">Why choose us</h2>
