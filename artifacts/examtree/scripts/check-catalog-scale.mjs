...
assert.match(marketplace, /test\.kind === "full-length"/, "full-length discovery must originate in real full-length catalog metadata");
assert.match(marketplace, /seriesMatchesFullLength/, "series shown as full-length must be tied to exams with live full-length mocks");
...
console.log("Catalog scale audit passed (79 assertions).");
