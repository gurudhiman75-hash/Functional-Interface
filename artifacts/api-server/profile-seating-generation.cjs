...
var require_pino = __commonJS({
  "../../node_modules/.pnpm/pino@9.14.0/node_modules/pino/pino.js"(exports2, module2) {
    ...
    module2.exports.stdSerializers = serializers2;
...
// src/lib/shared/randomness.ts
var generationContextStore = new import_node_async_hooks.AsyncLocalStorage();
...
function isExpensiveSeatingCase(arrangementType, orientationType, difficulty) {
  return difficulty === "Hard" && (arrangementType === "circular" || arrangementType === "double-row" || arrangementType === "parallel-row" || orientationType === "mixed" || orientationType === "alternate");
}
  ...
  const attemptCount = Math.min(
    ...
    Math.max(
      isExpensiveSeatingCase(
        ...
        input.orientationType,
        input.difficulty
      ) ? 6 : isAlternateLinearCase(
        input.arrangementType,
        input.orientationType
      ) ? 8 : 12,
      input.candidates.length * (isExpensiveSeatingCase(
        input.arrangementType,
        input.orientationType,
        input.difficulty
      ) ? 1 : isAlternateLinearCase(
        input.arrangementType,
        input.orientationType
      ) ? 1 : 2)
    )
