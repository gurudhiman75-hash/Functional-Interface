...
- 12 already-reviewed complete tense triplets
- 72 audited one-direction tense shifts
- 39 transitivity-conversion authorities
- 35 compound-verb authorities
- 35 aspect authorities
- **331 total atomic authorities**
- **12 operation families**
- **1,462 governed semantic combinations**

## Donor audit
Historical donor pools:
- 125 verb-sentence rows → exact dedupe + sentence-distractor audit → 138 final union with reviewed contexts
...
## Families
F01 verb phrase identification; F02 transitivity classification; F03 tense identification; F04 auxiliary identification; F05 direct-object identification; F06 complete-triplet tense transformation; F07 type + tense diagnosis; F08 paired tense-shift statement analysis; F09 aspect identification; F10 audited one-direction tense shift; F11 transitivity-conversion relation; F12 compound-verb operator identification.
