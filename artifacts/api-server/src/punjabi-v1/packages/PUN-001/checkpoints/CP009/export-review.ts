...
const plan:Record<PunjabiDifficulty,readonly [string,number][]>={
 Easy:[["F01",14],["F02",14],["F03",12]],
 Medium:[["F04",8],["F05",16],["F06",16]],
 Hard:[["F07",20],["F08",20]],
};
const strides:Record<string,number>={F01:5,F02:7,F03:5,F04:1,F05:5,F06:5,F07:37,F08:29};
const out:string[]=[
 "# PUN-001 CP009 Review — ਸਮਾਨਾਰਥਕ ਅਤੇ ਵਿਰੋਧੀ ਸ਼ਬਦ",
 "",
 "Status: HUMAN REVIEW PENDING",
 "",
 "The review is stratified across all eight audited families. Direct recognition stays Easy; context and lexical-set reasoning are Medium; Hard combines two independent lexical decisions.",
 ""
];
...
writeFileSync("PUN-001-CP009-REVIEW.md",out.join("\n"),"utf8");
console.log(`Wrote PUN-001-CP009-REVIEW.md with ${fingerprints.size} unique questions; all ${CP009_FAMILIES.length} families represented; ${f08Verdicts.size} F08 truth outcomes`);
