...
- F02 Forward proverb completion — Easy
- F03 Meaning → proverb — Easy
- F04 Reverse proverb completion — Medium
- F05 Authored situation → proverb — Medium
- F06 Correct proverb–meaning mapping — Medium
- F07 Ordered two-meaning → proverb mapping — Hard
