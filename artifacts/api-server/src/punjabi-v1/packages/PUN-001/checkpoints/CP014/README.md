...
No fixed numerical authority target is used.

## Families
- F01 Factual passage retrieval — Easy
- F02 Inferential comprehension — Medium
- F03 Title / summary selection — Medium
- F04 English → Punjabi administrative terminology — Easy
- F05 Punjabi → English administrative terminology — Medium
...
## Editorial controls
- passage learner text is Punjabi-only
- administrative English appears only where the bilingual task requires it
- Punjabi answer terms are concise single forms, not slash/parenthesis bundles
- duplicate administrative variants are collapsed by concept
- no trick/shortcut/option-analysis filler
