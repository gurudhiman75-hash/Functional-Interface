...
import { generateCP011ReviewBatch } from "./generator";

const batch = generateCP011ReviewBatch(120, 23000);
const outPath = resolve(process.cwd(), "dist/PUN-001-CP011-V2-REVIEW-120.md");
mkdirSync(dirname(outPath), { recursive: true });
const letters = ["A", "B", "C", "D"];
const lines: string[] = [];
lines.push("# PUN-001 CP011 V2 — Review File (120 Questions)");
lines.push("");
lines.push("**Topic:** ਮੁਹਾਵਰੇ — ਅਰਥ ਅਤੇ ਵਾਕ ਵਰਤੋਂ  ");
lines.push("**Engine revision:** 2.0.0  ");
lines.push("**Review seed:** 23000  ");
