...
const loanwordOverrides: Readonly<Record<string, readonly [string, string, string]>> = {
  ...
  "ED-W2-153": ["ਖ਼ੱਤ", "ਖ਼ੱਤਿ", "ਖ਼ਤ਼"],
  "ED-W2-154": ["ਖ਼ੱਤਰਾ", "ਖ਼ਤੜਾ", "ਖ਼ਤਰਾਾ"],
  "ED-W2-155": ["ਖ਼ਾਸ਼", "ਖ਼ਾਸਿ", "ਖ਼ਾਸ਼"],
  "ED-W2-156": ["ਖ਼ਿਯਾਲ", "ਖ਼ਿਆਲ਼", "ਖ਼ਿਆਲਿ"],
  "ED-W2-157": ["ਖ਼ੂਸ਼", "ਖ਼ੁਸ", "ਖ਼ੁਸ਼਼"],
