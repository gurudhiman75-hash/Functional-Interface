...
const CATEGORY_TERMS: Array<{
  ...
  { category: "appointments", weight: 12, terms: ["appointed", "appointment", "chairperson", "chairman", "chief executive", "governor", "director general", "president elected"] },
  { category: "reports_indices", weight: 12, terms: ["report", "index", "ranking", "survey", "released data", "annual report"] },
  { category: "science_technology", weight: 11, terms: ["technology", "artificial intelligence", "semiconductor", "quantum", "biotechnology", "researchers", "scientists"] },
  { category: "space", weight: 14, terms: ["isro", "satellite", "spacecraft", "launch vehicle", "mission", "orbit", "nasa"] },
  { category: "defence", weight: 12, terms: ["defence", "army", "navy", "air force", "missile", "military exercise", "drdo"] },
  { category: "international", weight: 9, terms: ["united nations", "world bank", "imf", "who", "summit", "bilateral", "treaty", "international"] },
