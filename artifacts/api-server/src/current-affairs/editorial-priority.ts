...
const HIGH_PATTERNS: Array<[RegExp, string]> = [
  ...
  [/\b(?:appointed|appointment|elected|assumes charge|takes charge)\b/i, "important appointment"],
  ...
  [/\b(?:bilateral|summit|state visit|trade talks?|free trade|fta)\b/i, "major international or trade development"],
];
