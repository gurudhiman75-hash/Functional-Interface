export const GEOMETRY_THEOREM_IDS = Object.freeze([
  ...
  "MIDPOINT_THEOREM",
  "MIDPOINT_CONVERSE",
  "PERPENDICULAR_BISECTOR_EQUIDISTANT",
  "PERPENDICULAR_BISECTOR_CONVERSE",
...
function humanize(id: string): string {
  const names: Partial<Record<TheoremId, string>> = {
    ...
    SIMILAR_TRIANGLES_AREA_SCALE: "in similar triangles, the ratio of the areas equals the square of the ratio of any corresponding side pair",
    ...
    PERPENDICULAR_BISECTOR_EQUIDISTANT: "every point on a segment's perpendicular bisector is equidistant from the segment endpoints",
    PERPENDICULAR_BISECTOR_CONVERSE: "a point equidistant from a segment's endpoints lies on its perpendicular bisector",
    TRIANGLE_CENTRE_PERP_BISECTORS_CIRCUMCENTRE: "the perpendicular bisectors of a triangle meet at its circumcentre",
    TRIANGLE_CENTRE_ANGLE_BISECTORS_INCENTRE: "the internal angle bisectors of a triangle meet at its incentre",
    TRIANGLE_CENTRE_ALTITUDES_ORTHOCENTRE: "the three altitudes of a triangle meet at its orthocentre",
    TRIANGLE_CENTRE_INCENTRE_OPPOSITE_ANGLE: "the angle at the incentre opposite a vertex equals 90° plus half that vertex angle",
    TRIANGLE_CENTRE_RIGHT_TRIANGLE_ORTHOCENTRE_VERTEX: "the orthocentre of a right triangle is its right-angled vertex",
