...
export const DI003_PERMANENT_RELEASE_ID = "DI-003-PERMANENT-ENGLISH-REVIEW-P1" as const;
...
export const DI003_PERMANENT_QLS: readonly Di003PermanentQlDescriptor[] = Object.freeze([
  ...
  { qlId: "DI-QL-044", taskKind: "SERIES_AVERAGE", label: "Average across all grouped-bar categories", semanticContract: "Add all five values of one series and divide by five.", difficulty: "Medium", supportedProfiles: PROFILES, sourceStatus: "V2_CERTIFIED", editorialStatus: "ENGLISH_REVIEW_APPROVED", localizationStatus: "NOT_STARTED" },
  ...
  { qlId: "DI-QL-046", taskKind: "PERCENT_CHANGE_WITHIN_SERIES", label: "Percentage increase within one series", semanticContract: "Read two values from one series, find the increase from the lower value to the higher value, and express it as a percentage of the lower value.", difficulty: "Hard", supportedProfiles: PROFILES, sourceStatus: "V2_CERTIFIED", editorialStatus: "ENGLISH_REVIEW_APPROVED", localizationStatus: "NOT_STARTED" },
  { qlId: "DI-QL-047", taskKind: "CATEGORY_SHARE_OF_SERIES_TOTAL", label: "Category share of a series total", semanticContract: "Find one category value as a percentage of the five-category total for the same series.", difficulty: "Hard", supportedProfiles: PROFILES, sourceStatus: "V2_CERTIFIED", editorialStatus: "ENGLISH_REVIEW_APPROVED", localizationStatus: "NOT_STARTED" },
  { qlId: "DI-QL-048", taskKind: "TOTAL_SERIES_PERCENT_EXCESS", label: "Percentage excess of one series total over the other", semanticContract: "Aggregate both series across all categories and calculate by what percentage the larger certified series total exceeds the smaller one.", difficulty: "Hard", supportedProfiles: PROFILES, sourceStatus: "V2_CERTIFIED", editorialStatus: "ENGLISH_REVIEW_APPROVED", localizationStatus: "NOT_STARTED" },
] as const);
