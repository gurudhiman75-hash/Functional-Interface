...
export const DI002_V2_REVIEW_QLS: readonly Di002V2ReviewQlDescriptor[] = Object.freeze([
  { qlId: "DI-QL-097", taskKind: "DIRECT_SELECTED_VALUE", label: "Read a Selected value", semanticContract: "Read the Selected value for a named row directly from the advanced table.", difficulty: "Easy", supportedProfiles: PROFILES, sourceStatus: "V2_REVIEW_CANDIDATE", editorialStatus: "ENGLISH_REVIEW_PENDING", localizationStatus: "NOT_STARTED" },
  { qlId: "DI-QL-098", taskKind: "DIRECT_SELECTION_RATE", label: "Read a selection rate", semanticContract: "Read the Selection % for a named row directly from the advanced table.", difficulty: "Easy", supportedProfiles: PROFILES, sourceStatus: "V2_REVIEW_CANDIDATE", editorialStatus: "ENGLISH_REVIEW_PENDING", localizationStatus: "NOT_STARTED" },
  ...
  { qlId: "DI-QL-101", taskKind: "SELECTED_DIFFERENCE", label: "Difference between Selected values", semanticContract: "Find the absolute difference between Selected values for two named rows.", difficulty: "Medium", supportedProfiles: PROFILES, sourceStatus: "V2_REVIEW_CANDIDATE", editorialStatus: "ENGLISH_REVIEW_PENDING", localizationStatus: "NOT_STARTED" },
  { qlId: "DI-QL-102", taskKind: "COMBINED_SELECTED", label: "Combined Selected total", semanticContract: "Add the Selected values for two named rows.", difficulty: "Medium", supportedProfiles: PROFILES, sourceStatus: "V2_REVIEW_CANDIDATE", editorialStatus: "ENGLISH_REVIEW_PENDING", localizationStatus: "NOT_STARTED" },
  { qlId: "DI-QL-103", taskKind: "SELECTION_RATE_POINT_GAP", label: "Selection-rate percentage-point gap", semanticContract: "Subtract two Selection % values and report the absolute difference in percentage points.", difficulty: "Medium", supportedProfiles: PROFILES, sourceStatus: "V2_REVIEW_CANDIDATE", editorialStatus: "ENGLISH_REVIEW_PENDING", localizationStatus: "NOT_STARTED" },
  { qlId: "DI-QL-104", taskKind: "SELECTED_SHARE_OF_TOTAL", label: "Row share of total Selected", semanticContract: "Express one row's Selected value as a percentage of the all-row Selected total, rounded to the nearest whole percent.", difficulty: "Medium", supportedProfiles: PROFILES, sourceStatus: "V2_REVIEW_CANDIDATE", editorialStatus: "ENGLISH_REVIEW_PENDING", localizationStatus: "NOT_STARTED" },
