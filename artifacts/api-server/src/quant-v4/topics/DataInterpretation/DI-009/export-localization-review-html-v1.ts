...
<section class="hero"><h1>DI-009 Histogram — Hindi/Punjabi Localization Review V1</h1><p>Review candidate only. All histogram values and answers remain tied to the approved English authority. Hindi/Punjabi are not yet active in Question Studio.</p><p><strong>13 QLs × 2 locales = 26 review questions.</strong></p></section>
${sections}
</main></body></html>`;
