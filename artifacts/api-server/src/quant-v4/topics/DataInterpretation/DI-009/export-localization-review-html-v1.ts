...
<section class="hero"><h1>DI-009 Histogram — Hindi/Punjabi Localization Review V1</h1><p>Frozen multilingual controlled-review authority. Learner-facing values contain no decimals. Percentage, grouped mean and grouped mode explicitly use nearest-whole answers. Hindi/Punjabi are active only in controlled Question Studio review.</p><p><strong>13 QLs × 2 locales = 26 review questions.</strong></p></section>
${sections}
</main></body></html>`;
