...
export const DI009_PERMANENT_QLS: readonly Di009PermanentQlDescriptor[] = Object.freeze([
  ...
  { qlId: "DI-QL-007", taskKind: "CLASS_SHARE_OF_TOTAL", label: "Class frequency as a percentage of total", semanticContract: "Compare one class frequency with the histogram total and express it as a percentage.", difficulty: "Medium", supportedProfiles: PROFILES, sourceStatus: "V6_CERTIFIED", editorialStatus: "ENGLISH_REVIEW_APPROVED", localizationStatus: "HI_PA_REVIEW_CANDIDATE" },
  ...
  { qlId: "DI-QL-012", taskKind: "APPROX_GROUPED_MEAN_FROM_HISTOGRAM", label: "Approximate grouped mean from histogram classes", semanticContract: "Use class marks and frequencies from the histogram to calculate the grouped-data mean.", difficulty: "Hard", supportedProfiles: PROFILES, sourceStatus: "V6_CERTIFIED", editorialStatus: "ENGLISH_REVIEW_APPROVED", localizationStatus: "HI_PA_REVIEW_CANDIDATE" },
  { qlId: "DI-QL-013", taskKind: "APPROX_GROUPED_MODE_FROM_HISTOGRAM", label: "Approximate grouped mode from a histogram", semanticContract: "Use the modal class and neighboring class frequencies in the grouped-data mode formula.", difficulty: "Hard", supportedProfiles: PROFILES, sourceStatus: "V6_CERTIFIED", editorialStatus: "ENGLISH_REVIEW_APPROVED", localizationStatus: "HI_PA_REVIEW_CANDIDATE" },
] as const);
