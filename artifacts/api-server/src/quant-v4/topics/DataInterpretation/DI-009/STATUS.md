...
- learner-facing numeric values are integer-only: decimal percentages, grouped means/modes, intermediate table values and histogram axis labels are excluded by deterministic state selection
