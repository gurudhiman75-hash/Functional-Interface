...
export const DI008_PERMANENT_QLS: readonly Di008PermanentQlDescriptor[] = Object.freeze([
  ...
  { qlId: "DI-QL-092", taskKind: "AVERAGE_PROFIT", label: "Average profit", semanticContract: "Calculate the requested profits and find their arithmetic average.", difficulty: "Medium", supportedProfiles: PROFILES, sourceStatus: "V2_CERTIFIED", editorialStatus: "ENGLISH_REVIEW_APPROVED", localizationStatus: "HI_PA_REVIEW_CANDIDATE" },
