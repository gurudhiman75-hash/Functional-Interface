...
const CONTEXTS: readonly Context[] = [
  {
    ...
    rowLabel: "Product",
    items: [
      "Notebooks", "Folders", "Marker sets", "Desk files", "Staplers", "Pens", "Pencils", "Erasers",
      "Highlighters", "Clipboards", "Envelopes", "Register books", "Sticky notes", "Correction pens",
      "Geometry boxes", "Glue sticks", "Punching machines", "Paper clips", "Binder clips",
      "Whiteboard markers", "Sketch pens", "Index cards", "Drawing sheets", "Writing pads",
    ],
    priceScale: 1,
  },
  {
    ...
    rowLabel: "Item",
    items: [
      "Tea packs", "Coffee jars", "Cereal boxes", "Biscuit packs", "Juice cartons", "Noodle packs",
      "Pasta packets", "Jam bottles", "Sauce bottles", "Snack packs", "Oat boxes", "Spice boxes",
      "Soup packets", "Milk powder tins", "Pickle jars", "Chocolate boxes", "Dry-fruit packs",
      "Honey bottles", "Wafer packs", "Breakfast mix packs", "Instant drink jars", "Cookie boxes",
      "Energy bar boxes", "Vermicelli packs",
    ],
    priceScale: 2,
  },
  {
    ...
    rowLabel: "Item",
    items: [
      "Footballs", "Badminton rackets", "Cricket gloves", "Skipping ropes", "Gym bottles", "Volleyballs",
      "Basketballs", "Tennis rackets", "Table-tennis bats", "Cricket bats", "Shin guards", "Sports cones",
      "Hand grips", "Yoga mats", "Resistance bands", "Dumbbells", "Knee caps", "Sports bags",
      "Swimming goggles", "Wrist bands", "Training bibs", "Shuttlecock tubes", "Exercise balls",
      "Boxing gloves",
    ],
    priceScale: 5,
  },
  {
    ...
    rowLabel: "Accessory",
    items: [
      "USB cables", "Power banks", "Keyboards", "Earphones", "Webcams", "Computer mice", "Memory cards",
      "USB hubs", "Chargers", "HDMI cables", "Bluetooth speakers", "Wireless mice", "Mouse pads",
      "Card readers", "Laptop stands", "Cooling pads", "Microphones", "Wi-Fi adapters", "Type-C adapters",
      "Portable drives", "Smart plugs", "Cable organisers", "Numeric keypads", "Headsets",
    ],
    priceScale: 10,
  },
  {
    ...
    rowLabel: "Item",
    items: [
      "Table lamps", "Electric kettles", "Steam irons", "Storage boxes", "Mixer jars", "Wall clocks",
      "Vacuum flasks", "Lunch boxes", "Extension boards", "Table fans", "Water jugs", "Serving trays",
      "Kitchen scales", "Door mats", "Laundry baskets", "Waste bins", "Bathroom shelves", "Tea kettles",
      "Food containers", "Cleaning brushes", "Clothes hangers", "Spice racks", "Bottle sets",
      "Hand blenders",
    ],
    priceScale: 5,
  },
  {
    ...
    rowLabel: "Item",
    items: [
      "Paper reams", "Desk organisers", "Ink cartridges", "Label rolls", "Document trays", "File covers",
      "Memo pads", "Calculator units", "Desk calendars", "Stamp pads", "Printer paper boxes",
      "Name-badge packs", "Laminating pouches", "Binding combs", "Receipt rolls", "Packing tape rolls",
      "Whiteboard erasers", "Pen stands", "Clip boxes", "Document envelopes", "Spiral binding coils",
      "Archive boxes", "Correction tape packs", "Carbon paper packs",
    ],
    priceScale: 4,
  },
];
