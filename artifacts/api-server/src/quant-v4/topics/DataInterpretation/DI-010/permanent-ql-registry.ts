...
export const DI010_PERMANENT_RELEASE_ID = "DI-010-PERMANENT-ENGLISH-REVIEW-P1" as const;
...
export const DI010_PERMANENT_QLS: readonly Di010PermanentQlDescriptor[] = Object.freeze([
  ...
  { qlId: "DI-QL-025", taskKind: "GROUPED_MEAN_FROM_POLYGON", label: "Approximate grouped mean from polygon", semanticContract: "Use class marks and frequencies represented by the polygon to calculate the grouped-data mean.", difficulty: "Hard", supportedProfiles: PROFILES, sourceStatus: "P2_CERTIFIED", editorialStatus: "ENGLISH_REVIEW_APPROVED", localizationStatus: "NOT_STARTED" },
