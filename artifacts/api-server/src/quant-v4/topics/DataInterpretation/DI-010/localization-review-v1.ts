...
function localizedStem(question: Di010Question, stimulus: Di010Stimulus, locale: Di010LocalizationLocale) {
  ...
  switch (question.kind) {
    ...
    case "HISTOGRAM_BAR_HEIGHT_FROM_POLYGON": {
      ...
      const value = interval(target);
      const h = [
        `इसी वितरण को हिस्टोग्राम में दिखाने पर वर्ग ${value} की आवृत्ति कितनी होगी?`,
        `यदि यही आँकड़े हिस्टोग्राम में दिखाए जाएँ, तो वर्ग ${value} की आवृत्ति क्या होगी?`,
        `हिस्टोग्राम में वर्ग ${value} के लिए दर्शाई जाने वाली आवृत्ति ज्ञात कीजिए।`,
      ];
      const p = [
        `ਇਸੇ ਵੰਡ ਨੂੰ ਹਿਸਟੋਗ੍ਰਾਮ ਵਿੱਚ ਦਿਖਾਉਣ ਤੇ ਵਰਗ ${value} ਦੀ ਬਾਰੰਬਾਰਤਾ ਕਿੰਨੀ ਹੋਵੇਗੀ?`,
        `ਜੇ ਇਹੀ ਅੰਕੜੇ ਹਿਸਟੋਗ੍ਰਾਮ ਵਿੱਚ ਦਿਖਾਏ ਜਾਣ, ਤਾਂ ਵਰਗ ${value} ਦੀ ਬਾਰੰਬਾਰਤਾ ਕੀ ਹੋਵੇਗੀ?`,
        `ਹਿਸਟੋਗ੍ਰਾਮ ਵਿੱਚ ਵਰਗ ${value} ਲਈ ਦਰਸਾਈ ਜਾਣ ਵਾਲੀ ਬਾਰੰਬਾਰਤਾ ਕੱਢੋ।`,
      ];
      return (hi ? h : p)[variant]!;
    }
...
function localizedExplanation(question: Di010Question, stimulus: Di010Stimulus, locale: Di010LocalizationLocale) {
  ...
  switch (question.kind) {
    ...
    case "HISTOGRAM_BAR_HEIGHT_FROM_POLYGON": {
      const target = classes[Number(evidence.targetIndex)]!;
      return pack(
        "समान वर्ग-चौड़ाई वाले हिस्टोग्राम में प्रत्येक वर्ग को उसकी आवृत्ति के अनुसार दिखाया जाता है।",
        "ਬਰਾਬਰ ਵਰਗ-ਚੌੜਾਈ ਵਾਲੇ ਹਿਸਟੋਗ੍ਰਾਮ ਵਿੱਚ ਹਰ ਵਰਗ ਨੂੰ ਉਸ ਦੀ ਬਾਰੰਬਾਰਤਾ ਅਨੁਸਾਰ ਦਿਖਾਇਆ ਜਾਂਦਾ ਹੈ।",
        [`वर्ग ${interval(target)} की आवृत्ति ${target.frequency} है।`, `अतः हिस्टोग्राम में इसी वर्ग के लिए ${target.frequency} दर्शाया जाएगा।`],
        [`ਵਰਗ ${interval(target)} ਦੀ ਬਾਰੰਬਾਰਤਾ ${target.frequency} ਹੈ।`, `ਇਸ ਲਈ ਹਿਸਟੋਗ੍ਰਾਮ ਵਿੱਚ ਇਸੇ ਵਰਗ ਲਈ ${target.frequency} ਦਰਸਾਇਆ ਜਾਵੇਗਾ।`],
      );
    }
    case "ZERO_CLOSING_ENDPOINTS": {
