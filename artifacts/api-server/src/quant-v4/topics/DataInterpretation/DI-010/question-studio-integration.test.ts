...
console.log(JSON.stringify({ status: "PASS_DI_010_QUESTION_STUDIO_CONTROLLED_REVIEW", releaseId: DI010_PERMANENT_RELEASE_ID, runtimeMode: DI010_QUESTION_STUDIO_RUNTIME_MODE, permanentQlCount: DI010_PERMANENT_QLS.length, questionStudioDiscoverable: true, questionBankWritable: false, testEligible: false, mockTestEligible: false, publiclyPublishable: false }));
