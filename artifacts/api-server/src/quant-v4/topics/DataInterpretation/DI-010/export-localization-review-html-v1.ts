...
<section class="hero"><h1>DI-010 Frequency Polygon — Hindi/Punjabi Localization Review V1</h1><p>Review candidate only. Learner-facing values contain no decimals. Percentage and grouped mean use explicit nearest-whole answers. Hindi/Punjabi are not yet active in Question Studio.</p><p><strong>13 QLs × 2 locales = 26 review questions.</strong></p></section>
${sections}
</main></body></html>`;
