...
export const DI006_PERMANENT_QLS: readonly Di006PermanentQlDescriptor[] = Object.freeze([
  ...
  { qlId: "DI-QL-064", taskKind: "COMBINED_TWO_VALUES", label: "Combine two caselet values", semanticContract: "Determine two requested shallow caselet values and add them.", difficulty: "Medium", supportedProfiles: PROFILES, sourceStatus: "V2_CERTIFIED", editorialStatus: "ENGLISH_REVIEW_APPROVED", localizationStatus: "HI_PA_FROZEN" },
