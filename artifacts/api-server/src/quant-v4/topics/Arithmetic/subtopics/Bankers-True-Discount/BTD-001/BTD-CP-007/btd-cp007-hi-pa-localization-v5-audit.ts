...
const AUDIT_VERSION = "BTD-001-CP007-HI-PA-LOCALIZATION-AUDIT-v5" as const;
...
function renderReview() {
  const lines: string[] = [
    "# BTD-001 CP007 Hindi/Punjabi Localization Review v5",
    "",
...
writeFileSync("btd-cp007-hi-pa-review-v5.md", review, "utf8");
writeFileSync("btd-cp007-hi-pa-diversity-v5.json", JSON.stringify({
  thresholds: {
...
console.log("PASS_BTD_001_CP007_HI_PA_LOCALIZATION_AUDIT_V5");
