...
export function localizePrt001Business(
  ...
  const translations: Record<string, readonly [string, string]> = {
    ...
    "digital retail venture": ["डिजिटल खुदरा उद्यम", "ਡਿਜਿਟਲ ਖੁਦਰਾ ਕਾਰੋਬਾਰ"],
    ...
    "consumer electronics dealership": ["उपभोक्ता इलेक्ट्रॉनिक्स डीलरशिप", "ਖਪਤਕਾਰ ਇਲੈਕਟ੍ਰਾਨਿਕਸ ਡੀਲਰਸ਼ਿਪ"],
