...
import questionLanguageE13Source from "../question-language.e13.en.json" assert { type: "json" };
import questionLanguageE13HiSource from "../question-language.e13.hi.json" assert { type: "json" };
import questionLanguageE13PaSource from "../question-language.e13.pa.json" assert { type: "json" };
...
import stemVariantsE13Source from "../stem-variants.e13.en.json" assert { type: "json" };
import stemVariantsE13HiSource from "../stem-variants.e13.hi.json" assert { type: "json" };
import stemVariantsE13PaSource from "../stem-variants.e13.pa.json" assert { type: "json" };
...
import taskRegistryE13Source from "../task-registry.e13.library.json" assert { type: "json" };
...
const questionLanguages = {
  en: mergeQuestionLanguages(questionLanguageSource as QuestionLanguageSource, questionLanguageE1Source as QuestionLanguageSource, questionLanguageE2Source as QuestionLanguageSource, questionLanguageE3ASource as QuestionLanguageSource, questionLanguageE3BSource as QuestionLanguageSource, questionLanguageE4Source as QuestionLanguageSource, questionLanguageE5Source as QuestionLanguageSource, questionLanguageE8Source as QuestionLanguageSource, questionLanguageE13Source as QuestionLanguageSource),
  hi: mergeQuestionLanguages(questionLanguageHiSource as QuestionLanguageSource, questionLanguageE1HiSource as QuestionLanguageSource, questionLanguageE2HiSource as QuestionLanguageSource, questionLanguageE3AHiSource as QuestionLanguageSource, questionLanguageE3BHiSource as QuestionLanguageSource, questionLanguageE4HiSource as QuestionLanguageSource, questionLanguageE5HiSource as QuestionLanguageSource, questionLanguageE8HiSource as QuestionLanguageSource, questionLanguageE13HiSource as QuestionLanguageSource, questionLanguageE11HiSource as QuestionLanguageSource),
  pa: mergeQuestionLanguages(questionLanguagePaSource as QuestionLanguageSource, questionLanguageE1PaSource as QuestionLanguageSource, questionLanguageE2PaSource as QuestionLanguageSource, questionLanguageE3APaSource as QuestionLanguageSource, questionLanguageE3BPaSource as QuestionLanguageSource, questionLanguageE4PaSource as QuestionLanguageSource, questionLanguageE5PaSource as QuestionLanguageSource, questionLanguageE8PaSource as QuestionLanguageSource, questionLanguageE13PaSource as QuestionLanguageSource, questionLanguageE11PaSource as QuestionLanguageSource),
};

const stemVariants = {
  en: mergeStemVariants(stemVariantsE6Source as StemVariantSource, stemVariantsE7Source as StemVariantSource, stemVariantsE8Source as StemVariantSource, stemVariantsE13Source as StemVariantSource),
  hi: mergeStemVariants(stemVariantsE6HiSource as StemVariantSource, stemVariantsE7HiSource as StemVariantSource, stemVariantsE8HiSource as StemVariantSource, stemVariantsE13HiSource as StemVariantSource),
  pa: mergeStemVariants(stemVariantsE6PaSource as StemVariantSource, stemVariantsE7PaSource as StemVariantSource, stemVariantsE8PaSource as StemVariantSource, stemVariantsE13PaSource as StemVariantSource),
};
...
const registries = [
  ...
  taskRegistryE13Source as TaskRegistrySource,
];
...
export function validatePrt001PilotLibraries(): string[] {
  ...
  const expectedE13VariantIds = Array.from({ length: 7 }, (_, index) => `PRT-QL-${String(index + 106).padStart(3, "0")}`).sort();
  const expectedE7VariantIds = registryIds.filter((id) => !expectedE6VariantIds.includes(id) && !expectedE8VariantIds.includes(id) && !expectedE13VariantIds.includes(id));
  for (const language of ["en", "hi", "pa"] as const) {
    ...
    const e13Source = language === "en" ? stemVariantsE13Source as StemVariantSource : language === "hi" ? stemVariantsE13HiSource as StemVariantSource : stemVariantsE13PaSource as StemVariantSource;
    ...
    if (!sameStrings(Object.keys(e7Source.entries).sort(), expectedE7VariantIds)) failures.push(`${language} E7 stem variants must cover every pre-E8/E13 active QL outside E6`);
    ...
    if (!sameStrings(Object.keys(e13Source.entries).sort(), expectedE13VariantIds)) failures.push(`${language} E13 stem variants must cover exactly PRT-QL-106..112`);
