...
const SCENARIO_VARIABLE_OVERRIDES: Record<string, Partial<Pct002Variables>> = {
  ...
  "PCT-QL-061": { wholeLabel: "payroll" },
  "PCT-QL-062": { wholeLabel: "enrolment" },
  "PCT-QL-063": { wholeLabel: "stock" },
  "PCT-QL-064": { wholeLabel: "usage" },
  "PCT-QL-065": { wholeLabel: "rainfall collection" },
  "PCT-QL-066": { wholeLabel: "budget" },
  "PCT-QL-067": { wholeLabel: "target output" },
  "PCT-QL-068": { wholeLabel: "passenger count" },
  "PCT-QL-069": { wholeLabel: "vote count" },
  "PCT-QL-070": { wholeLabel: "bed strength" },
