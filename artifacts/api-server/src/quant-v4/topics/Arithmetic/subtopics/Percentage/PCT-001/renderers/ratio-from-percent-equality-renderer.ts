...
export interface RatioFromPercentEqualityEvidence extends ExplanationEvidence {
  variables: Record<string, number | string>;
  derivedValues: Record<string, number | string>;
  entities: Record<string, string>;
}

export class RatioFromPercentEqualityRenderer implements ExplanationRenderer {
  ...
  render(evidence: ExplanationEvidence): ExplanationStep[] {
    const e = evidence as RatioFromPercentEqualityEvidence;
