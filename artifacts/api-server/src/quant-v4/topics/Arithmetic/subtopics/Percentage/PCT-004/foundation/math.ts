import type { Pct004AnswerType } from "./types";
...
export function wrapAnswer(answerType: Pct004AnswerType, raw: string): string {
...
export function retainedFactor(rate: number) {
  return (100 - rate) / 100;
}
