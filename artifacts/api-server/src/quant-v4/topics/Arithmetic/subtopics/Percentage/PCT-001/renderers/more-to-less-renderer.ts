...
export interface MoreToLessEvidence extends ExplanationEvidence {
  variables: Record<string, number | string>;
  derivedValues: Record<string, number | string>;
  entities: Record<string, string>;
}

export class MoreToLessRenderer implements ExplanationRenderer {
  ...
  render(evidence: ExplanationEvidence): ExplanationStep[] {
    const e = evidence as MoreToLessEvidence;
