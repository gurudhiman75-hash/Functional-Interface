...
import { extractPlaceholders, getCommonQuestionLanguageIds, getQuestionEntry, getQuestionLanguageIds, getTaskRegistryEntry, validatePct003Libraries } from "./library";

function check(name: string, passed: boolean, message: string) {
  return { name, passed, message };
}

function placeholderSet(parameters: Pct003Parameters, language: Pct003Language) {
