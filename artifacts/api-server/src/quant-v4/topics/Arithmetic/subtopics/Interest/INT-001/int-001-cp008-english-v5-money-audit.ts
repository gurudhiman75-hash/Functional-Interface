...
assert(questions === 1800, `expected 1800 V5 money audit questions, got ${questions}`);
assert(roundedCorrectAnswers > 0, "V5 money audit did not exercise rounded correct answers");
...
console.log("PASS_INT_CP008_ENGLISH_V5_MONEY_AUDIT");
