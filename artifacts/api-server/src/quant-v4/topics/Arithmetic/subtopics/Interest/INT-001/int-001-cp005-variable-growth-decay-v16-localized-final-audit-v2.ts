...
const DEVANAGARI_LETTER_OR_SIGN = /[\u0900-\u0963\u0970-\u097F]/u; // Deliberately excludes shared danda U+0964/U+0965.
...
console.log(JSON.stringify({
  ...
  ql094Rejected: true,
  sharedIndicDandaAllowed: true,
}, null, 2));
console.log("PASS_INT_CP005_V16_HI_PA_FINAL_LOCALIZATION_V2");
