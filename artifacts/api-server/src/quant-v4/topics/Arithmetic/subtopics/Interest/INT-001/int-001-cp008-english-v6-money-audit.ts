...
const needsPaise = (value: Rational): boolean => (value.numerator * 100n) % value.denominator !== 0n;
...
assert(questions === 1800, `expected 1800 V6 money audit questions, got ${questions}`);
assert(roundedCorrectAnswers > 0, "V6 money audit did not exercise rounded correct answers");
...
console.log("PASS_INT_CP008_ENGLISH_V6_MONEY_AUDIT");
