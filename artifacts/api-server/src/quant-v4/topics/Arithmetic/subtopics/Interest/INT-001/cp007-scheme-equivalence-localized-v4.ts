...
function polishText(text: string, locale: IntCp007LocalizedLocale): string {
  if (locale === "hi-IN") {
    return text
      ...
      .replace(/दो राशियाँ योजना A/gu, "दो राशियाँ अलग-अलग योजना A")
      .replace(/दो राशियाँ (.+) में लगाए जाते हैं/gu, "दो राशियाँ $1 में लगाई जाती हैं")
      .replace(/में लगाए जाते हैं/gu, "में लगाई जाती हैं")
  ...
  return text
    ...
    .replace(/ਦੋ ਰਕਮਾਂ ਯੋਜਨਾ A/gu, "ਦੋ ਰਕਮਾਂ ਵੱਖ-ਵੱਖ ਯੋਜਨਾ A")
    .replace(/ਦੋ ਰਕਮਾਂ (.+) ਵਿੱਚ ਲਗਾਏ ਜਾਂਦੇ ਹਨ/gu, "ਦੋ ਰਕਮਾਂ $1 ਵਿੱਚ ਲਗਾਈਆਂ ਜਾਂਦੀਆਂ ਹਨ")
    .replace(/ਵਿੱਚ ਲਗਾਏ ਜਾਂਦੇ ਹਨ/gu, "ਵਿੱਚ ਲਗਾਈਆਂ ਜਾਂਦੀਆਂ ਹਨ")
