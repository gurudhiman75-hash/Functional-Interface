...
export function solvePnc001Routed(parameters: Pnc001Parameters): Pnc001SolverResult {
  if (String(parameters.solveMode) === "findDictionaryRankOfWord") return solvePnc001DictionaryRank(parameters);
...
export function verifyPnc001RoutedIndependently(parameters: Pnc001Parameters): Pnc001IndependentVerification {
  if (String(parameters.solveMode) === "findDictionaryRankOfWord") return verifyPnc001DictionaryRankIndependently(parameters);
