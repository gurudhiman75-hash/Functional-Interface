...
export const PNC_001_CP_IDS = ["PNC-CP-001", "PNC-CP-002", "PNC-CP-003", "PNC-CP-004"] as const;
...
export interface Pnc001QuestionLanguageEntry {
  qlId: string;
  cpId: Pnc001CanonicalProblemId;
  difficulty: Pnc001Difficulty;
  template: string;
}
...
export interface Pnc001RegistryGroup {
  qlIds: string[];
  cpId: Pnc001CanonicalProblemId;
  taskKind: Pnc001TaskKind;
  solveMode: Pnc001SolveMode;
  answerType: Pnc001AnswerType;
...
export interface Pnc001ParameterInput {
  canonicalProblemId?: Pnc001ActiveCanonicalProblemId;
  cpId?: Pnc001ActiveCanonicalProblemId;
  difficulty?: Pnc001Difficulty;
  difficultyBand?: Pnc001Difficulty;
  language?: Pnc001Language;
  questionLanguageId?: string;
  seed?: string;
}

export interface Pnc001Parameters {
  packageId: typeof PNC_001_PACKAGE_ID;
  canonicalProblemId: Pnc001ActiveCanonicalProblemId;
  questionLanguageId: string;
  questionId: string;
  seed: string;
...
export interface Pnc001SolverEvidence {
  stageCounts?: number[];
  caseCounts?: Array<{ label: string; count: number; factors: number[] }>;
  totalCount?: number;
  invalidCount?: number;
  knownChoices?: number;
  totalChoices?: number;
  ...
  multisetRemainingMultiplicities?: number[];
  multisetNumerator?: number;
  multisetDenominator?: number;
...
export interface Pnc001SolverResult {
  ...
  equation: string;
  mathJax: string;
  evidence: Pnc001SolverEvidence;
}

export interface Pnc001IndependentVerification {
  supported: boolean;
  answer: number;
  method: string;
}

export interface Pnc001ReasoningEvidence {
  conceptId: string;
...
export interface Pnc001Explanation {
  explanationId: string;
  lines: string[];
}

export interface Pnc001ValidationCheck {
  name: string;
  passed: boolean;
  message: string;
}

export interface Pnc001ValidationResult {
  valid: boolean;
  checks: Pnc001ValidationCheck[];
}

export interface Pnc001QuestionPackage {
  packageId: typeof PNC_001_PACKAGE_ID;
  archetypeId: typeof PNC_001_PACKAGE_ID;
  canonicalProblemId: Pnc001ActiveCanonicalProblemId;
  questionLanguageId: string;
  questionId: string;
  seed: string;
  ...
  independentVerification: Pnc001IndependentVerification;
  reasoningEvidence: Pnc001ReasoningEvidence;
  explanation: Pnc001Explanation;
  validation: Pnc001ValidationResult;
  maturity: Pnc001Maturity;
