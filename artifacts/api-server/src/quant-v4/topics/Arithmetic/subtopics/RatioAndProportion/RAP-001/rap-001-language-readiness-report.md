...
- Hindi and Punjabi runtime generation is intentionally restricted to 74 localized QLs through the shared language-coverage allowlist.
...
- Preserved all active placeholders for the 74 allowlisted localized QLs.
...
- Direct backend generation remains available for Hindi/Punjabi only for the allowlisted 74 QLs.
...
- Full Hindi/Punjabi RAP-001 coverage is not complete; 95 of 169 English QLs are still not localized or allowlisted.
