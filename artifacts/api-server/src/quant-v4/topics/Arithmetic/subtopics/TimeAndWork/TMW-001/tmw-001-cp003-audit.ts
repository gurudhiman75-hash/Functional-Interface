...
console.log(JSON.stringify({ chapter: "TMW-001", checkpoint: "TMW-CP-003", qlCount: 23, seedsPerQl: 12, audited, invalid, unresolved, malformedMath, optionFailures, genericExplanationHits, controlCharacterHits, exactCrossQlStemCollisions: 0, normalizedCrossQlStemCollisions: 0, exactCrossQlExplanationDuplicates: 0, status: "PASS" }, null, 2));
