...
console.log(JSON.stringify({ chapter: "TMW-001", checkpoint: "TMW-CP-010", checked, publicationLocked: true, manualFindingsGuarded: true, singularHourAgreementGuarded: true, verdict: "PASS" }, null, 2));
