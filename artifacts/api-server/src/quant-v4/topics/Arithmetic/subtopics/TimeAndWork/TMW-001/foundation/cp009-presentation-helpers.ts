import { compare, equals, formatRational, rational, subtract, toLatex } from "./rational";
import { required } from "./cp001-helpers";
import { tmwCp009NetRate } from "./cp009-engine";
import type { Rational } from "./types";
import type { TmwCp009CommonTrap, TmwCp009LearningShortcut, TmwCp009Option, TmwCp009Parameters, TmwCp009Pipe, TmwCp009RegistryEntry, TmwCp009Solution } from "./cp009-types";
...
export function hours(value:Rational):string{return `${num(value)} ${equals(value,ONE)?"hour":"hours"}`;}
