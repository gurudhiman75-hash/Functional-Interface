...
const modes: Array<Omit<TmwCp001RegistryEntry, "qlId">> = [
  ...
  { cpId: "TMW-CP-001", solveMode: "convertRateAcrossTimeUnits", answerType: "RATE", ruleId: "TMW_RATE_DIRECT", formulaStrategyId: "FORMULA_RATE_CONVERSION", explanationStrategyId: "EXP_RATE_CONVERSION", scenarioFamily: "production", difficulty: "Medium", publiclyPublishable: false },
