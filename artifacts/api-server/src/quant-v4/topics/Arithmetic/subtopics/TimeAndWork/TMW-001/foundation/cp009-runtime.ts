...
export function runTmwCp009Pipeline(input:{questionLanguageId:string;seed:string;language?:"en"|"hi"|"pa"}):TmwCp009GeneratedQuestion{
 ...
 const learner=[stem,opening,formula,...givens,...steps,shortcut.title,...shortcut.steps,commonTrap.optionLabel,commonTrap.optionText,commonTrap.explanation,conclusion].join(" ");
