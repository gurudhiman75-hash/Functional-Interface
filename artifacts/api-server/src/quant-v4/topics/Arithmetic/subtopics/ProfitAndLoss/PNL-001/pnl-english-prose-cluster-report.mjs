...
const report = `# PNL-001 English Prose Cluster Wave 01
...
- The visible target is now rendered from `{targetRatePercent}` and `{targetDirection}` instead of a hard-coded 10% profit.
