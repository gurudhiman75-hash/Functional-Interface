  ...
  switch (solveMode) {
    case "CP_SP_TO_AMOUNT":
      return make(
        ...
        [
          { title: "Identify the direction", body: "Compare the selling price with the cost price before doing any percentage work." },
          { title: "Find the amount", body: "Subtract the smaller price from the larger price.", equationLatex: "A=|S-C|" },
        ],
    ...
    case "CP_SP_TO_RATE":
      return make(
        ...
        [
          { title: "Find profit or loss amount", body: "Compare selling price and cost price, then take their absolute difference.", equationLatex: "A=|S-C|" },
          { title: "Convert the amount to a rate", body: "Divide the amount by cost price and multiply by 100.", equationLatex: "r=\frac{A}{C}\times100" },
        ],
    ...
    case "CP_RATE_TO_SP":
      return make(
        ...
        [
          { title: "Write the commercial multiplier", body: "Use 1+r/100 for profit or 1−r/100 for loss." },
          { title: "Apply it to cost price", body: "Multiply the cost price by the appropriate factor.", equationLatex: "S=C\left(1\pm\frac{r}{100}\right)" },
        ],
    ...
    case "SP_RATE_TO_CP":
      return make(
        ...
        [
          { title: "Form the multiplier", body: "Use 1+r/100 for profit or 1−r/100 for loss." },
          { title: "Reverse the sale", body: "Divide the selling price by that multiplier.", equationLatex: "C=\frac{S}{1\pm r/100}" },
        ],
    ...
    case "AMOUNT_RATE_TO_CP":
      return make(
        ...
        [
          { title: "Write the percentage relation", body: "Treat the stated amount as r/100 of cost price.", equationLatex: "A=C\frac{r}{100}" },
          { title: "Solve for cost price", body: "Multiply the amount by 100 and divide by the rate.", equationLatex: "C=\frac{100A}{r}" },
        ],
    ...
    case "AMOUNT_CP_TO_RATE":
      return make(
        ...
        [
          { title: "Choose the correct base", body: "Use cost price because the question asks for the ordinary profit-or-loss rate." },
          { title: "Calculate the percentage", body: "Divide the amount by cost price and convert the fraction to percent.", equationLatex: "r=\frac{A}{C}\times100" },
        ],
    ...
    case "CP_SP_RATIO_TO_RATE":
      return make(
        ...
        [
          { title: "Compare the ratio parts", body: "Subtract the cost part from the selling part to identify the signed change." },
          { title: "Measure the change on cost", body: "Divide the absolute difference by the cost part and multiply by 100.", equationLatex: "r=\frac{|s-c|}{c}\times100" },
        ],
    ...
    case "RATE_TO_CP_SP_RATIO":
      return make(
        ...
        [
          { title: "Assume a cost base", body: "Take cost price as 100 parts." },
          { title: "Form the selling-price part", body: "Use 100+r for profit or 100−r for loss, then simplify the ratio.", equationLatex: "C:S=100:(100\pm r)" },
        ],
    ...
    case "MARGIN_SP_TO_PROFIT_CP":
      return make(
        ...
        [
          { title: "Express cost as a share of selling price", body: "Take selling price as 100 parts; profit is m parts and cost is 100−m parts." },
          { title: "Convert profit to the cost base", body: "Compare the profit part with the cost part.", equationLatex: "r_C=\frac{m}{100-m}\times100" },
        ],
    ...
    case "PROFIT_CP_TO_MARGIN_SP":
      return make(
        ...
        [
          { title: "Build a convenient price model", body: "Let cost price be 100 parts and profit be r parts." },
          { title: "Change the percentage base", body: "Selling price is 100+r parts, so divide profit by that total.", equationLatex: "m_S=\frac{r}{100+r}\times100" },
        ],
    ...
    case "CP_RATE_TO_AMOUNT":
      return make(
        ...
        [
          { title: "Convert the rate to a fraction", body: "Write the percentage as r/100." },
          { title: "Apply it to cost", body: "Multiply the cost price by that fraction.", equationLatex: "A=C\frac{r}{100}" },
        ],
    ...
    case "CP_AMOUNT_TO_SP":
      return make(
        ...
        [
          { title: "Identify the direction", body: "Decide whether the amount represents profit or loss." },
          { title: "Adjust the cost price", body: "Use addition for profit and subtraction for loss.", equationLatex: "S=C\pm A" },
        ],
    ...
    case "SP_AMOUNT_TO_CP":
      return make(
        ...
        [
          { title: "Read the direction carefully", body: "Profit means selling price is above cost; loss means it is below cost." },
          { title: "Reverse the adjustment", body: "Use C=S−A for profit or C=S+A for loss.", equationLatex: "C=S\mp A" },
        ],
    ...
    case "RATE_TO_FRACTION":
      return make(
        ...
        [
          { title: "Create the part model", body: "Take cost price as 100 and write the profit or loss amount as r parts." },
          { title: "Form the requested selling-price fraction", body: "Divide the amount parts by the selling-price parts and simplify." },
        ],
    ...
    case "CP_TWO_RATES_TO_SP_DIFFERENCE":
      return make(
        ...
        [
          { title: "Write both selling prices", body: "Apply each stated profit or loss multiplier to the same cost price." },
          { title: "Subtract the results", body: "The absolute difference equals cost price multiplied by the difference of the signed rates.", equationLatex: "\Delta S=C\frac{|r_1-r_2|}{100}" },
        ],
    ...
    case "SP_DIFFERENCE_TWO_RATES_TO_CP":
      return make(
        ...
        [
          { title: "Find the effective rate gap", body: "Measure the distance between the two profit-or-loss conditions." },
          { title: "Recover cost price", body: "Scale the known price difference from the rate gap to 100 percent.", equationLatex: "C=\frac{100\Delta S}{|r_1-r_2|}" },
        ],
    ...
    case "TWO_SELLING_CONDITIONS_TO_SECOND_RATE":
      return make(
        ...
        [
          { title: "Recover cost from the first condition", body: "Reverse the first profit or loss multiplier from the first selling price." },
          { title: "Evaluate the second condition", body: "Compare the second selling price with the recovered cost and measure the difference on cost." },
        ],
    ...
    default:
      return make(
        ...
        [
          { title: "Organise the known values", body: "Separate cost price, selling price, amount, and rate before choosing a formula." },
          { title: "Apply the matching relation", body: "Use the relation that keeps cost price as the standard base unless another base is stated." },
        ],
