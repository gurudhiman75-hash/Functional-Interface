...
export function buildCp002Explanation(solveMode: string): FriendlyExplanation {
  if (solveMode === "MP_DISCOUNT_TO_SP") return make(
    ...
    [
      { title: "Find the retained percentage", body: "Subtract the discount percentage from 100 percent." },
      { title: "Apply it to marked price", body: "Multiply the marked price by the retained fraction.", equationLatex: "S=M\left(1-\frac{d}{100}\right)" },
    ],
  ...
  if (solveMode === "MP_SP_TO_DISCOUNT") return make(
    ...
    [
      { title: "Find the discount amount", body: "Subtract selling price from marked price.", equationLatex: "D=M-S" },
      { title: "Convert to a percentage", body: "Divide the discount amount by marked price and multiply by 100.", equationLatex: "d=\frac{D}{M}\times100" },
    ],
  ...
  if (solveMode === "SP_DISCOUNT_TO_MP") return make(
    ...
    [
      { title: "Write the retained factor", body: "Convert 100−d percent to a decimal or fraction." },
      { title: "Recover marked price", body: "Divide the selling price by the retained factor.", equationLatex: "M=\frac{S}{1-d/100}" },
    ],
  ...
  if (/SUCCESSIVE_DISCOUNTS_TO_SP|THREE_PLUS_SUCCESSIVE_DISCOUNTS_TO_SP/.test(solveMode)) return make(
    ...
    [
      { title: "Convert every discount to a retained factor", body: "A discount of d percent leaves the factor 1−d/100." },
      { title: "Multiply the factors", body: "Apply the factors in order to the marked price.", equationLatex: "S=M\prod_i\left(1-\frac{d_i}{100}\right)" },
      { title: "Read the final amount", body: "The product gives the actual amount paid after all reductions." },
    ],
  ...
  if (solveMode === "SUCCESSIVE_DISCOUNTS_TO_EQUIVALENT") return make(
    ...
    [
      { title: "Multiply retained factors", body: "Use (1−d1/100)(1−d2/100)." },
      { title: "Convert back to a discount", body: "Subtract the retained percentage from 100 percent.", equationLatex: "d_e=100\left[1-\left(1-\frac{d_1}{100}\right)\left(1-\frac{d_2}{100}\right)\right]" },
    ],
  ...
  if (/MP_DISCOUNT_TO_AMOUNT|MP_AMOUNT_TO_DISCOUNT|MP_AMOUNT_TO_SP/.test(solveMode)) return make(
    ...
    [
      { title: "Write the price relation", body: "Keep marked price, discount amount, and selling price in the same currency units.", equationLatex: "S=M-D" },
      { title: "Use the requested conversion", body: "For a rate, divide D by M; for an amount or selling price, rearrange the same relation." },
    ],
  ...
  if (solveMode === "KNOWN_AND_EQUIVALENT_TO_MISSING_DISCOUNT") return make(
    ...
    [
      { title: "Convert the equivalent discount", body: "Find the overall retained factor 1−de/100." },
      { title: "Remove the known discount factor", body: "Divide the overall retained factor by 1−d1/100." },
      { title: "Recover the missing discount", body: "Subtract the remaining factor from 1 and convert to percent." },
    ],
  ...
  if (/SINGLE_VS_SUCCESSIVE_TO_SP_DIFFERENCE|DISCOUNT_VS_CASHBACK_COMPARE|MIXED_OFFER_ELIGIBILITY_COMPARE/.test(solveMode)) return make(
    ...
    [
      { title: "Evaluate the first offer", body: "Calculate its effective price after applying all valid conditions." },
      { title: "Evaluate the second offer", body: "Use the same original marked or billed amount and respect eligibility rules." },
      { title: "Compare final prices", body: "The lower effective price is better; subtract the two prices for the saving difference." },
    ],
  ...
  if (/CP_MARKUP_DISCOUNT_TO_RESULT/.test(solveMode)) return make(
    ...
    [
      { title: "Build marked price", body: "Increase cost price by the markup factor.", equationLatex: "M=C\left(1+\frac{m}{100}\right)" },
      { title: "Apply the discount", body: "Reduce marked price by the retained discount factor.", equationLatex: "S=M\left(1-\frac{d}{100}\right)" },
      { title: "Compare with cost", body: "Find S−C for the amount, or divide the absolute difference by C for the percentage." },
    ],
  ...
  if (/MP_CP_TARGET_RATE_TO_DISCOUNT/.test(solveMode)) return make(
    ...
    [
      { title: "Find target selling price", body: "Apply the target commercial multiplier to cost price." },
      { title: "Find the reduction from marked price", body: "Subtract target selling price from marked price." },
      { title: "Convert reduction to discount percentage", body: "Divide the reduction by marked price and multiply by 100." },
    ],
  ...
  if (/CP_DISCOUNT_TARGET_RATE_TO_MARKUP/.test(solveMode)) return make(
    ...
    [
      { title: "Calculate target selling price", body: "Apply the desired profit or loss multiplier to cost." },
      { title: "Reverse the discount", body: "Divide target selling price by the retained discount factor." },
      { title: "Find markup rate", body: "Compare the recovered marked price with cost price on the cost base." },
    ],
  ...
  if (/BUY_X_GET_Y_TO_EQUIVALENT_DISCOUNT|BUY_X_GET_Y_TO_EFFECTIVE_UNIT_PRICE/.test(solveMode)) return make(
    ...
    [
      { title: "Count total units received", body: "Add paid units and free units." },
      { title: "Spread the payment", body: "Divide the cost of paid units by total units received.", equationLatex: "p_e=p\frac{x}{x+y}" },
      { title: "Convert to discount if needed", body: "Compare the effective unit price with the marked unit price." },
    ],
  ...
  if (/CASHBACK_TO_EFFECTIVE_PRICE|CASHBACK_PERCENT_TO_EFFECTIVE_PRICE/.test(solveMode)) return make(
    ...
    [
      { title: "Determine cashback", body: "Use the flat amount or calculate the stated percentage of the billed price." },
      { title: "Find effective price", body: "Subtract cashback from the billed amount.", equationLatex: "E=B-C_b" },
    ],
  ...
  if (/DISCOUNT_THEN_FLAT_COUPON_TO_EFFECTIVE_PRICE|DISCOUNT_THEN_PERCENT_COUPON_TO_EFFECTIVE_PRICE/.test(solveMode)) return make(
    ...
    [
      { title: "Apply the store discount", body: "Reduce marked price by the discount factor." },
      { title: "Apply the coupon", body: "Subtract a flat coupon or apply the coupon percentage to the discounted amount." },
      { title: "Read effective price", body: "The amount left after both valid reductions is the final cost." },
    ],
  ...
  if (/COUPON_MINIMUM_SPEND_TO_EFFECTIVE_PRICE/.test(solveMode)) return make(
    ...
    [
      { title: "Test eligibility", body: "Compare billed price with the minimum required spend." },
      { title: "Apply or reject the coupon", body: "Subtract the coupon only if the condition is met." },
      { title: "State both results", body: "Report eligibility and the corresponding effective price clearly." },
    ],
  ...
  if (/PERCENT_CASHBACK_ON_BILLED_AMOUNT|PERCENT_CASHBACK_ON_ORIGINAL_PRICE_AFTER_DISCOUNT/.test(solveMode)) return make(
    ...
    [
      { title: "Identify the cashback base", body: "Use billed price or original marked price exactly as stated." },
      { title: "Calculate uncapped cashback", body: "Multiply the correct base by the cashback percentage." },
      { title: "Apply the cap and find effective price", body: "Use the smaller cashback, then subtract it from the billed amount." },
    ],
  ...
  if (/DISCOUNT_FRACTION_TO_PERCENT|PAID_TO_MARKED_RATIO_TO_DISCOUNT/.test(solveMode)) return make(
    ...
    [
      { title: "Interpret the parts", body: "Decide whether the given fraction represents discount or price paid." },
      { title: "Find the discount fraction", body: "If price paid is given, subtract the retained fraction from 1." },
      { title: "Convert to percent", body: "Multiply the discount fraction by 100." },
    ],
    "The converted value is the discount percentage.",
    "Do not confuse the fraction paid with the fraction discounted.",
  );
  if (solveMode === "COUPON_ORDER_COMPARE") return make(
    ...
    [
      { title: "Discount then coupon", body: "Apply the percentage reduction to marked price, then subtract the flat coupon." },
      { title: "Coupon then discount", body: "Subtract the flat coupon first, then apply the percentage reduction to the remainder." },
      { title: "Compare the two totals", body: "The lower final amount is the better order; their difference is the extra saving." },
    ],
  ...
  return make(
    ...
    [
      { title: "Identify the offer sequence", body: "List every reduction, condition, and percentage base in the order stated." },
      { title: "Evaluate the final price", body: "Apply each valid step and keep billed price separate from effective cost." },
      { title: "Interpret the result", body: "Report the requested price, rate, eligibility, or comparison." },
    ],
