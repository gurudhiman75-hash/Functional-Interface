...
const EN_BANNED = /practice race|selection trial|race report|official timing|college race|sports trial|track event|club race|maintains\s+\d|steady speeds|determine the finish|recorded winning margin|course reconstruction/i;
const HI_BANNED = /चयन दौड़|समय शून्य|ट्रैक प्रतियोगिता|आधिकारिक|रेस रिपोर्ट|रिकॉर्डेड|अभ्यास दौड़/i;
const PA_BANNED = /ਚੋਣ ਦੌੜ|ਸਮਾਂ ਸਿਫ਼ਰ|ਅਧਿਕਾਰਿਕ|ਰੇਸ ਰਿਪੋਰਟ|ਅਭਿਆਸ ਦੌੜ/i;

for (const [language, review, banned] of [
  ["en", TSD_CP010_EXAM_REAL_ENGLISH_REVIEW, EN_BANNED],
  ["hi", TSD_CP010_EXAM_REAL_HINDI_REVIEW, HI_BANNED],
  ["pa", TSD_CP010_EXAM_REAL_PUNJABI_REVIEW, PA_BANNED],
] as const) {
