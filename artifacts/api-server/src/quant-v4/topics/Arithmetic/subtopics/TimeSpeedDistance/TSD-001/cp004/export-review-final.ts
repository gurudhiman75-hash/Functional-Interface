...
import { generateCp004FinalEnglishReviewCorpus } from "./runtime-final";
...
for (const q of english) questions.push(q, renderCp004PolishedNativeQuestion(q, "hi"), renderCp004PolishedNativeQuestion(q, "pa"));

const outputDir = resolve(process.argv[2] ?? "dist/quant-v4/tsd-001/cp004-final-review");
