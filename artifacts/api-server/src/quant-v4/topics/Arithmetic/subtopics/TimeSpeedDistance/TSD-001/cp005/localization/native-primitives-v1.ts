...
export const TSD_CP005_NATIVE_TERMS = Object.freeze({
  ...
  TIME: pair("समय", "ਸਮਾਂ"),
  MEETING: pair("मुलाकात", "ਮੁਲਾਕਾਤ"),
  ROUTE: pair("मार्ग", "ਰਸਤਾ"),
  REST: pair("ठहराव", "ਠਹਿਰਾਅ"),
  RETURN: pair("वापसी", "ਵਾਪਸੀ"),
  REMAINING: pair("शेष", "ਬਾਕੀ"),
  COMBINED_SPEED: pair("संयुक्त गति", "ਕੁੱਲ ਰਫ਼ਤਾਰ"),
...
const OBJECTS: Readonly<Record<string, TsdCp005NativePair>> = Object.freeze({
  INTERCITY_BUS: pair("बस", "ਬੱਸ"),
  EXPRESS_COACH: pair("कोच", "ਕੋਚ"),
  COACH: pair("कोच", "ਕੋਚ"),
  TAXI: pair("टैक्सी", "ਟੈਕਸੀ"),
  CAR: pair("कार", "ਕਾਰ"),
  DELIVERY_VAN: pair("डिलीवरी वैन", "ਡਿਲਿਵਰੀ ਵੈਨ"),
  COURIER_VAN: pair("कूरियर वैन", "ਕੂਰੀਅਰ ਵੈਨ"),
  PASSENGER_TRAIN: pair("यात्री रेलगाड़ी", "ਯਾਤਰੀ ਰੇਲਗੱਡੀ"),
  EXPRESS_TRAIN: pair("एक्सप्रेस रेलगाड़ी", "ਐਕਸਪ੍ਰੈੱਸ ਰੇਲਗੱਡੀ"),
  MINIBUS: pair("मिनीबस", "ਮਿਨੀਬੱਸ"),
  JEEP: pair("जीप", "ਜੀਪ"),
  CARGO_TRUCK: pair("ट्रक", "ਟਰੱਕ"),
  POSTAL_VAN: pair("डाक वैन", "ਡਾਕ ਵੈਨ"),
  COMPANY_CAR: pair("कंपनी कार", "ਕੰਪਨੀ ਕਾਰ"),
  TRANSPORT_VAN: pair("परिवहन वैन", "ਟਰਾਂਸਪੋਰਟ ਵੈਨ"),
  SHUTTLE_BUS: pair("शटल बस", "ਸ਼ਟਲ ਬੱਸ"),
  PATROL_CAR: pair("गश्ती कार", "ਗਸ਼ਤੀ ਕਾਰ"),
  SERVICE_VAN: pair("सेवा वैन", "ਸੇਵਾ ਵੈਨ"),
  INSPECTION_JEEP: pair("निरीक्षण जीप", "ਜਾਂਚ ਜੀਪ"),
  TEST_CAR: pair("परीक्षण कार", "ਟੈਸਟ ਕਾਰ"),
  MAINTENANCE_VAN: pair("रखरखाव वैन", "ਮੈਂਟੇਨੈਂਸ ਵੈਨ"),
  SHUTTLE_VAN: pair("शटल वैन", "ਸ਼ਟਲ ਵੈਨ"),
  UTILITY_VEHICLE: pair("यूटिलिटी वाहन", "ਯੂਟਿਲਿਟੀ ਵਾਹਨ"),
  MOTORCYCLE: pair("मोटरसाइकिल", "ਮੋਟਰਸਾਈਕਲ"),
  SERVICE_CAR: pair("सेवा कार", "ਸੇਵਾ ਕਾਰ"),
});

const ENDPOINTS: Readonly<Record<string, TsdCp005NativePair>> = Object.freeze({
  TERMINALS: pair("टर्मिनल", "ਟਰਮੀਨਲ"),
  TOWNS: pair("नगर", "ਕਸਬੇ"),
  CITIES: pair("शहर", "ਸ਼ਹਿਰ"),
  DEPOTS: pair("डिपो", "ਡਿਪੋ"),
  HUBS: pair("हब", "ਹੱਬ"),
  STATIONS: pair("रेलवे स्टेशन", "ਰੇਲਵੇ ਸਟੇਸ਼ਨ"),
  JUNCTIONS: pair("जंक्शन", "ਜੰਕਸ਼ਨ"),
  CHECKPOINTS: pair("चेकपोस्ट", "ਚੈਕਪੋਸਟ"),
  WAREHOUSES: pair("गोदाम", "ਗੋਦਾਮ"),
  SORTING_CENTRES: pair("छँटाई केंद्र", "ਛਾਂਟ ਕੇਂਦਰ"),
  OFFICES: pair("कार्यालय", "ਦਫ਼ਤਰ"),
  LOGISTICS_CENTRES: pair("लॉजिस्टिक्स केंद्र", "ਲਾਜਿਸਟਿਕਸ ਕੇਂਦਰ"),
  INSPECTION_POSTS: pair("निरीक्षण चौकी", "ਜਾਂਚ ਚੌਕੀ"),
  TRACK_MARKERS: pair("परीक्षण ट्रैक के चिह्न", "ਟੈਸਟ ਟਰੈਕ ਦੇ ਨਿਸ਼ਾਨ"),
  GATES: pair("गेट", "ਗੇਟ"),
  WORK_SITES: pair("कार्यस्थल", "ਕੰਮ ਵਾਲੀ ਥਾਂ"),
  POSTS: pair("चौकी", "ਚੌਕੀ"),
...
export function cp005NativeContextIntro(
  objectFamily: string,
