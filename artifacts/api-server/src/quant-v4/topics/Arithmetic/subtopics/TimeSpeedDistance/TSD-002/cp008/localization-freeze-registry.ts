...
export const TSD_CP008_LOCALIZATION_FREEZE_APPROVAL = Object.freeze({
  ...
  finalLocalizationLayer: "APPROVED_TEMPLATES_PLUS_CASE_CONDITIONAL_QL099_RUNTIME_GUARD" as const,
  finalNormalizationReason: "PRESERVE_ENGLISH_SAME_DIRECTION_FASTER_TRAIN_INVARIANT_WITHOUT_CLUTTERING_OPPOSITE_DIRECTION_CASES" as const,
