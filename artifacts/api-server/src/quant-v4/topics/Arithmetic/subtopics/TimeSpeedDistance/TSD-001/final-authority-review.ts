...
import { remodelCp001LearnerQuestion } from "./cp001/runtime";
...
import { remodelCp002LearnerQuestion } from "./cp002/public-runtime";
import { generateCp002ReviewRows as generateCoreCp002ReviewRows } from "./cp002/runtime";
...
function cp001Record(row: TsdCp001GeneratedQuestion): TsdFinalReviewRecord {
  const remediated = remodelCp001LearnerQuestion(row);
...
function cp002Record(row: TsdCp002GeneratedQuestion): TsdFinalReviewRecord {
  const remediated = remodelCp002LearnerQuestion(row);
