...
assert.equal(answers.get("SAP-CP007-PROT-PREMATURE-ROUNDING-DIAGNOSIS")?.size, 100);

console.log("SAP-CP-007 wave-two v2 authority passed: 400 unique student-facing cases across QL-125..128, all three precision-comparison relations, exact half-unit/relative-error proofs, 100 distinct premature-rounding answers, 100 A/B/C/D positions each, and inactive lifecycle.");
