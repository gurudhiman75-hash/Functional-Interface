...
import { generateSapCp008ReviewRecords } from "./full-review-v3";
...
const summary = {
  ...
  editorialSurface: "V4_STUDENT_FACING",
};

const markdown: string[] = [
  "# SAP-CP-008 — 300-Question English Human Review — Student-Facing Final Candidate",
  "",
  ...
  "",
  "> All questions are provisional and inactive. The approximation stage is explicit in every stem; explanations are written for students rather than exposing generator terminology.",
  "",
];
