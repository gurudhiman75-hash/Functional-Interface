...
import { generateSapCp010ReviewRecords } from "./full-review-v2";
...
const summary = {
  ...
  reviewVersion: "CP010-EXAM-STANDARD-V2",
...
const lines: string[] = [
  "# SAP-CP-010 — 300-Question English Human Review — Exam Standard V2",
  "",
  ...
  "",
  "> All questions are provisional and inactive. Stems use competitive-exam language. Explanations use short benchmark or bracketing reasoning. Unsupported interpolation and advanced numerical methods are deliberately excluded.",
  "",
];
...
const html = `<!doctype html><html><head><meta charset="utf-8"><title>SAP-CP-010 Exam Standard V2 Review</title><style>body{font-family:Arial,sans-serif;max-width:1050px;margin:24px auto;padding:0 20px;line-height:1.5;color:#222}pre{white-space:pre-wrap;font-family:Arial,sans-serif}h1{border-bottom:2px solid #333}</style></head><body><pre>${escaped}</pre></body></html>`;
