...
const HI_WORDS: Record<string, string> = {
  ...
  "obtained": "प्राप्त", "represented": "दर्शाया", "represented": "दर्शाया", "simplified": "सरल", "reduced": "सरल",
  ...
  "away": "दूर", "zero": "शून्य", "non": "गैर", "negative": "ऋणात्मक", "principal": "मुख्य", "consecutive": "क्रमागत",
  ...
  "diagnosis": "निदान", "safe": "सुरक्षित", "tightest": "सबसे कड़ा", "guaranteed": "निश्चित", "every": "हर",
  "left": "बायाँ", "right": "दायाँ", "increasing": "बढ़ते", "order": "क्रम", "inclusive": "समेत", "recurring": "आवर्ती",
  "represented": "दर्शाया", "significant": "सार्थक", "figures": "अंक", "hundreds": "सैकड़ा", "tens": "दहाई", "units": "इकाई",
  "thousands": "हजार", "hundred": "सौ", "ten": "दस", "thousand": "हजार", "hundredths": "सौवाँ", "midpoint": "मध्यबिंदु",
  "factor": "गुणनखंड", "reciprocal": "व्युत्क्रम", "structural": "संरचनात्मक", "shortcut": "शॉर्टकट", "block": "खंड",
  "premature": "समय से पहले", "changed": "बदल दिया", "equivalent": "समतुल्य", "because": "क्योंकि", "while": "जबकि",
