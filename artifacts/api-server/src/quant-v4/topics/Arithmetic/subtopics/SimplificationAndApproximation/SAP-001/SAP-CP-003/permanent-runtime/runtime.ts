...
export interface SapCp003PermanentPackage extends Omit<SapCp003Package, "lifecycle"> {
  ...
  readonly approvalStatus: "QUESTIONS_AND_ANSWERS_REOPENED_FOR_STRUCTURAL_REMEDIATION";
  readonly lifecycle: {
    readonly permanentQlId: SapCp003PermanentQlId;
    readonly identityStatus: "PERMANENT_ID_ALLOCATED";
    readonly contentStatus: "QUESTIONS_AND_ANSWERS_REOPENED_STRUCTURAL_REMEDIATION_V2";
...
export function generateSapCp003PermanentPackage(
  ...
  return Object.freeze({
    ...
    approvalStatus: "QUESTIONS_AND_ANSWERS_REOPENED_FOR_STRUCTURAL_REMEDIATION" as const,
    lifecycle: Object.freeze({
      permanentQlId,
      identityStatus: "PERMANENT_ID_ALLOCATED" as const,
      contentStatus: "QUESTIONS_AND_ANSWERS_REOPENED_STRUCTURAL_REMEDIATION_V2" as const,
...
export const SAP_CP003_PERMANENT_STATE = Object.freeze({
  ...
  questionAndAnswerReview: "REOPENED_STRUCTURAL_REMEDIATION_V2" as const,
