...
import { SAP_CP010_PROTOTYPE_IDS } from "./final-runtime";
...
console.log("SAP-CP-010 final 300-review passed: 17 identities, 75/75/75/75 answers, both option-led kinds, all comparison relations, no 3-position streak.");
