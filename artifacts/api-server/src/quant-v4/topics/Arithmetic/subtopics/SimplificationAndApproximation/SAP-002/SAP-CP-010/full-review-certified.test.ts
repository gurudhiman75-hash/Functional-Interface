...
import { SAP_CP010_PROTOTYPE_IDS } from "./certified-runtime";
...
console.log("SAP-CP-010 certified 300-review passed: 17 identities, 75/75/75/75 answers, both special-form option kinds, all comparison relations and no 3-position streak.");
