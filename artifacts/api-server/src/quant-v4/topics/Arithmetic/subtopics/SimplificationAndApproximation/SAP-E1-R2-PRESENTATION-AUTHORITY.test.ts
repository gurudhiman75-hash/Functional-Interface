...
for (const id of SAP_CP010_E1_R2_STRUCTURES) {
  ...
  for (let seed = 1; seed <= 100; seed += 1) {
    ...
    if (id.includes("APPROX-")) {
      ...
      const signature = [d.x,d.y,d.z,d.w,d.displayRoot,d.displayMultiplier,d.displayOffset,d.displayCube,d.displayBase,d.displayDivisor,d.displaySquare].filter(v => v !== undefined).join("|");
...
console.log(JSON.stringify({ authority: "SAP-E1-R2-BANK-PRESENTATION-V3", states: 1200, unguided, supplied, offsetSignatures: offsetSignatures.size }));
