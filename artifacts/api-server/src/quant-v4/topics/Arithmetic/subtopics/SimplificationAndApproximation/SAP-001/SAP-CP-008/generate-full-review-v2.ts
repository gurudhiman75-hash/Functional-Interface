...
import { generateSapCp008ReviewRecords } from "./full-review-v2";
...
const summary = {
  ...
  editorialSurface: "V3_REMEDIATED",
};

const markdown: string[] = [
  "# SAP-CP-008 — 300-Question English Human Review — Remediated",
  "",
  ...
  "",
  "> All questions are provisional and inactive. Each stem states the approximation stage explicitly; wording is varied without changing the mathematical policy.",
  "",
];
