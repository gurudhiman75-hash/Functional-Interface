...
const lines: string[] = [
  "# SAP-CP-009 — 300-Question English Human Review",
  "",
  ...
  "",
  "> All questions are provisional and inactive. Stems use exam-style approximation wording; explanations use short student-friendly working.",
  "",
];
...
const html = `<!doctype html><html><head><meta charset="utf-8"><title>SAP-CP-009 300 Review</title><style>body{font-family:Arial,sans-serif;max-width:1050px;margin:24px auto;padding:0 20px;line-height:1.5;color:#222}pre{white-space:pre-wrap;font-family:Arial,sans-serif}h1{border-bottom:2px solid #333}</style></head><body><pre>${escaped}</pre></body></html>`;
