...
const rows = NUM_CP001_WAVE04_PROTOTYPE_IDS.flatMap((prototypeId) =>
...
fs.writeFileSync(path.join(outDir, "num-001-cp001-wave04-review.json"), JSON.stringify(rows, null, 2));
...
fs.writeFileSync(path.join(outDir, "num-001-cp001-wave04-review.md"), md);
console.log(JSON.stringify({ status: "PASS_NUM_CP001_WAVE04_REVIEW_EXPORT", questions: rows.length }, null, 2));