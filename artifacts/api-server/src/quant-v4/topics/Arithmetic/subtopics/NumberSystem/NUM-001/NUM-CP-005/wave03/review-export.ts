...
const jsonPath = resolve(outputDirectory, "num-001-cp005-wave03-review.json");
const markdownPath = resolve(outputDirectory, "num-001-cp005-wave03-review.md");

writeFileSync(jsonPath, `${JSON.stringify({
  status: "NUM_CP005_WAVE03_REVIEW_READY",
...
const markdown = [
  "# NUM-CP-005 Wave 03 — Source and Representation Review",
  "",
  "**Status:** executable discovery only; permanent QLs remain zero.",
  "",
  `**Temporary prototypes:** ${NUM_CP005_WAVE03_PROTOTYPE_IDS.length}`,
  "",
...
console.log(JSON.stringify({
  status: "PASS_NUM_CP005_WAVE03_REVIEW_EXPORT",
  temporaryPrototypeCount: NUM_CP005_WAVE03_PROTOTYPE_IDS.length,
  reviewQuestionCount: records.length,
  permanentQlCount: 0,
  jsonPath,
