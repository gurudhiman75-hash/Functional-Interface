...
export const NUM_CP010_WAVE02_PROTOTYPE_IDS = [
  "NUM-CP010-PROT-009",
  "NUM-CP010-PROT-010",
  "NUM-CP010-PROT-011",
  "NUM-CP010-PROT-012",
...
export type NumCp010Wave02PrototypeId = typeof NUM_CP010_WAVE02_PROTOTYPE_IDS[number];

export interface NumCp010Wave02Package {
  readonly packageId: "NUM-002";
  readonly checkpointId: "NUM-CP-010";
  readonly temporaryPrototypeId: NumCp010Wave02PrototypeId;
