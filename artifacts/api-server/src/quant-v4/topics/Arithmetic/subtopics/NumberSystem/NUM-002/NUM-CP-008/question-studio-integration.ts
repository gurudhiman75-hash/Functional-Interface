...
export function listNumCp008QuestionStudioPackages() {
  return [Object.freeze({
    ...
    topic: "Arithmetic",
    subtopic: "Number System",
    name: "NUM-002 Number System — Advanced Remainder Problems & Modular Conditions",
    label: "Number System — Advanced Remainder Problems & Modular Conditions",
    ...
    canonicalProblems: Object.freeze([Object.freeze({
      ...
      label: "Advanced remainder problems and combined remainder conditions",
    })]),
