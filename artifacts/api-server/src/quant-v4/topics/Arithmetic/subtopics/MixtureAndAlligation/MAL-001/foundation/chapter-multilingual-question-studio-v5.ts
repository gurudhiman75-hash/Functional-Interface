...
export const MAL_001_MULTILINGUAL_QUESTION_STUDIO_V5 = Object.freeze({
  localizationId: "MAL-001-HI-PA-QUESTION-STUDIO-V5",
...
function renderCp001StructuredStem(
  ...
  if (!/^MAL-QL-00[1-9]$|^MAL-QL-01[01]$/u.test(qlId)) return null;
...
export function applyMal001QuestionStudioLocalizationV5<T extends Record<string, any>>(
  question: T,
  language: Mal001LocalizedLanguage,
): T {
  const localized = applyMal001QuestionStudioLocalizationV4(question, language) as T;
  ...
  return {
    ...
    traceability: {
      ...
      localizationId: MAL_001_MULTILINGUAL_QUESTION_STUDIO_V5.localizationId,
