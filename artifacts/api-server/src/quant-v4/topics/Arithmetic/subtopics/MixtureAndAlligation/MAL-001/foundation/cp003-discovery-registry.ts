  ...
  readonly MalCp003DiscoveryRegistryEntry[] = [
    {
      ...
      sourceClasses: ["LEGACY_V2_RECOVERY"],
    ...
    },
    {
      ...
      baseDifficulty: "Medium",
      discoveryStatus: "EXECUTABLE_DISCOVERY",
      sourceClasses: ["LEGACY_FAMILY_INVERSE_CLOSURE"],
      currentOwnerVerdict: "MAL-CP-003",
      permanentQlId: null,
      active: false,
      publiclyPublishable: false,
    ...
    },
    {
      ...
      baseDifficulty: "Hard",
      discoveryStatus: "EXECUTABLE_DISCOVERY",
      sourceClasses: ["LEGACY_V2_RECOVERY", "LEGACY_FAMILY_INVERSE_CLOSURE"],
      currentOwnerVerdict: "MAL-CP-003",
      permanentQlId: null,
      active: false,
      publiclyPublishable: false,
    ...
    },
    {
      ...
      baseDifficulty: "Hard",
      discoveryStatus: "EXECUTABLE_DISCOVERY",
      sourceClasses: ["LEGACY_V2_RECOVERY", "BOUNDARY_CONSTRUCTION"],
      currentOwnerVerdict: "MAL-CP-003",
      permanentQlId: null,
      active: false,
      publiclyPublishable: false,
