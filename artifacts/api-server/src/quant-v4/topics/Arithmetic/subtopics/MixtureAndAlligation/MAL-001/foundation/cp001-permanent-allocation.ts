...
type MalCp001PermanentAllocationDefinition = Omit<
...
function allocate(
  definition: MalCp001PermanentAllocationDefinition,
): MalCp001PermanentAllocationEntry {
  return { ...definition, ...LOCKED_IMPLEMENTATION_BOUNDARY };
}
...
const allocationByQlId = new Map<
