...
export const STAT001_PERMANENT_RELEASE_ID = "STAT-001-PERMANENT-ENGLISH-REVIEW-P2" as const;
...
export const STAT001_PERMANENT_QLS: readonly Stat001PermanentQlDescriptor[] = Object.freeze([
  ...
  },
  {
    ...
    semanticContract: "Combine two groups with known counts and means by using their weighted totals rather than an unweighted average of the means.",
  ...
  },
  {
    ...
    semanticContract: "Order a raw data set and identify the central observation or the average of the two central observations according to parity.",
