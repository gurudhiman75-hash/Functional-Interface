...
export function runProbabilityPackagePipeline(
  ...
  return {
    ...
    explanation: { explanationId: `${entry.qlId}-${entry.explanationStrategyId}-SIMPLE-V2`, lines: explanation, wordCount: explanationWordCount(explanation), visuals },
    validation,
    ...
    traceability: {
      ...
      studentRendererVersion: "PRB-STUDENT-RENDERER-V2",
      explanationVersion: "PRB-SIMPLE-EXPLANATION-V2",
