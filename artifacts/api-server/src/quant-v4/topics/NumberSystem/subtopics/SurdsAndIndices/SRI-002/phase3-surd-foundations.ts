...
import { generateSriCp007FractionalIndexCandidate } from "./cp007-fractional-index-discovery";
...
export function generateSriPhase3SurdFoundationCandidate(candidateId: string, seed: string): SriDiscoveryQuestion {
  if (candidateId === "C007-F") return generateSriCp007FractionalIndexCandidate(seed);
