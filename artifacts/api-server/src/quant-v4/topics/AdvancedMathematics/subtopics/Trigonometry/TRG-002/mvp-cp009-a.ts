...
function ql052(seed: string) {
  ...
  return buildTrg002MvpQuestion({ qlId: "TRG-002-QL-052", cpId: "TRG-CP-009", lockedFamily: "SAME_SIDE_TWO_OBSERVATIONS", solveMode: "findNearDistanceFromPointSeparation", seed, difficulty: "Hard", target: "LENGTH",
...
function ql055(seed: string) {
  ...
  return buildTrg002MvpQuestion({ qlId: "TRG-002-QL-055", cpId: "TRG-CP-009", lockedFamily: "SAME_SIDE_TWO_OBSERVATIONS", solveMode: "findFarDistanceFromPointSeparation", seed, difficulty: "Hard", target: "LENGTH",
...
function ql058(seed: string) {
  ...
  return buildTrg002MvpQuestion({ qlId: "TRG-002-QL-058", cpId: "TRG-CP-009", lockedFamily: "OBSERVER_MOVES_CLOSER", solveMode: "findHeightAfterMovingCloser", seed, difficulty: "Hard", target: "LENGTH",
