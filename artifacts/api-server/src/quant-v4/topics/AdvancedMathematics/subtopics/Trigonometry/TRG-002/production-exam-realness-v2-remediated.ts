...
function ql050(seed: string) {
  ...
  return buildTrg002MvpQuestion({
    ...
    explanation: mvpExplanation(
      ...
      [
        `Let the nearer distance be x. Then the farther distance is x+${formatExactPlain(g.movement)}.`,
        `x tan45°=(x+${formatExactPlain(g.movement)})tan30°; solve to get x=${formatExactPlain(g.near)} m.`,
        `At 45°, height=x, so the tower height is ${formatExactPlain(g.height)} m.`,
      ],
...
function ql051(seed: string) {
  ...
  return buildTrg002MvpQuestion({
    ...
    explanation: mvpExplanation(
      ...
      [
        `Let the nearer distance be x; the farther distance is x+${formatExactPlain(g.movement)}.`,
        `Equate x tan45° and (x+${formatExactPlain(g.movement)})tan30° to get x=${formatExactPlain(g.near)} m.`,
        `Therefore the farther distance is ${formatExactPlain(g.far)} m.`,
      ],
...
function ql053(seed: string) {
  ...
  return buildTrg002MvpQuestion({
    ...
    explanation: mvpExplanation(
      ...
      [
        `Let the nearer distance be x; the farther distance is x+${formatExactPlain(g.movement)}.`,
        `Solve x tan60°=(x+${formatExactPlain(g.movement)})tan45° to get x=${formatExactPlain(g.near)} m.`,
        `Hence height=x tan60°=${formatExactPlain(g.height)} m.`,
      ],
...
function ql054(seed: string) {
  ...
  return buildTrg002MvpQuestion({
    ...
    explanation: mvpExplanation(
      ...
      [
        `Let the nearer distance be x; the farther distance is x+${formatExactPlain(g.movement)}.`,
        `Use x tan60°=(x+${formatExactPlain(g.movement)})tan45° and solve for x.`,
        `The nearer distance is ${formatExactPlain(g.near)} m.`,
      ],
...
function ql060(seed: string) {
  ...
  return buildTrg002MvpQuestion({
    ...
    explanation: mvpExplanation(
      ...
      [
        `Let the final distance be x. Then the initial distance is x+${formatExactPlain(g.movement)}.`,
        `Use x tan60°=(x+${formatExactPlain(g.movement)})tan45° to obtain x=${formatExactPlain(g.near)} m.`,
        `Then height=x tan60°=${formatExactPlain(g.height)} m.`,
      ],
...
function ql062(seed: string) {
  ...
  return buildTrg002MvpQuestion({
    ...
    explanation: mvpExplanation(
      ...
      [
        `Let the initial distance be x. The final distance is x+${formatExactPlain(g.movement)}.`,
        `Use x tan45°=(x+${formatExactPlain(g.movement)})tan30° and solve to get x=${formatExactPlain(g.near)} m.`,
        `At 45°, height=x, so the tower height is ${formatExactPlain(g.height)} m.`,
      ],
...
function ql066(seed: string) {
  ...
  return buildTrg002MvpQuestion({
    ...
    explanation: mvpExplanation(
      ...
      [
        `Let the initial distance be d. The final distance is d−${formatExactPlain(g.movement)}.`,
        `Use d tan45°=(d−${formatExactPlain(g.movement)})tan60° and solve for d.`,
        `The initial distance is ${formatExactPlain(g.far)} m.`,
      ],
