...
export type Phase3CheckpointId = "GEO-CP-007" | "GEO-CP-008" | "GEO-CP-009";
export type Phase3Difficulty = "Easy" | "Medium";

export interface Phase3PrototypeQuestion {
  readonly packageId: "GEO-001";
  readonly cpId: Phase3CheckpointId;
  ...
  readonly difficulty: Phase3Difficulty;
...
export interface Phase3PrototypeDefinition {
  readonly temporaryPrototypeId: string;
  readonly cpId: Phase3CheckpointId;
  readonly solveMode: string;
  readonly generate: (seed: string) => Phase3PrototypeQuestion;
}
