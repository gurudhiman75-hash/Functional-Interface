...
export const GEO_MERGE_SPLIT_PROPOSAL_V1_PART_B = Object.freeze([
  ...
  defineGeometryMergeSplitFamilyV1({
    ...
    cpId: "GEO-CP-006",
    learnerDecision: "Identify a triangle centre from its defining concurrency construction",
    candidateIds: Object.freeze(["GEO-TMP-GAP-CP006-CIRCUMCENTRE-IDENTIFY-V1", "GEO-TMP-GAP-W3-CP006-INCENTRE-IDENTIFY-V1"]),
    mergeRationale: "Circumcentre and incentre are source-backed instances of the same centre-name recognition contract from defining concurrency. The right-triangle orthocentre location task is intentionally excluded because it asks where a known centre lies rather than which centre a construction defines.",
  }),
  defineGeometryMergeSplitFamilyV1({
    proposalKey: "CP006_RIGHT_TRIANGLE_ORTHOCENTRE_LOCATION",
    cpId: "GEO-CP-006",
    learnerDecision: "Locate the orthocentre of a right triangle",
    candidateIds: Object.freeze(["GEO-TMP-GAP-W3-CP006-RIGHT-TRIANGLE-ORTHOCENTRE-V1"]),
    mergeRationale: "Keep distinct: the stem already names the orthocentre and asks for its location in a right triangle; this is not centre identification from concurrency and has a distinct audited source-gap contract.",
  }),
  defineGeometryMergeSplitFamilyV1({
