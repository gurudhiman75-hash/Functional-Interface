...
const md = [
  "# ExamTree Geometry — Strict 81→73 Merge/Split Proposal V1",
  "",
  ...
  "## Lifecycle gate",
  "",
  "Repository CI must prove exact 81-candidate coverage and the 73-family structure. After proof, explicit human approval is still required before permanent QL allocation.",
  "",
].join("\n");
