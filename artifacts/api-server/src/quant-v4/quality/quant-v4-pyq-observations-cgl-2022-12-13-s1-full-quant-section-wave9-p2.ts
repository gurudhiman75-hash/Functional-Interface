...
export const QUANT_V4_CGL_2022_12_13_S1_FULL_QUANT_SECTION_WAVE9_COUNTABLE_PYQ_OBSERVATIONS = Object.freeze([
  ...
  observation({ q: 74, packageId: "AVG-001", topic: "Arithmetic — Average", subtopic: "Consecutive running averages — recover first-to-last difference", representation: "RUNNING_AVERAGE_STEPWISE_MEMBER_DIFFERENCE_MCQ", notes: "If each new running average rises by 2 kg, the fifth member exceeds the first by 2(1+2+3+4)=20? The source's exact construction is retained for empirical ownership; the solved-paper answer must remain source-verified before any learner-facing reuse." }),
