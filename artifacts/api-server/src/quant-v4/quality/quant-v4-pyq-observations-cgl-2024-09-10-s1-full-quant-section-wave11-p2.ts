...
export const QUANT_V4_CGL_2024_09_10_S1_FULL_QUANT_SECTION_WAVE11_COUNTABLE_PYQ_OBSERVATIONS = Object.freeze([
  ...
  observation({ q: 11, packageId: "TRG-002", topic: "Advanced Mathematics — Trigonometry", subtopic: "Heights and distances — pole against ground", representation: "RIGHT_TRIANGLE_STANDARD_ANGLE_BASE_MCQ", notes: "A 10 m pole makes 30° with the ground; horizontal distance is 10 cos30°=5√3 m. Taxonomy correction: Heights & Distances is owned by TRG-002, not TRG-001." }),
  ...
  observation({ q: 24, packageId: "TMW-001", topic: "Arithmetic — Time & Work", subtopic: "Pipes and cisterns — two pipes turned off after common start", representation: "THREE_PIPES_PARTIAL_RUNTIME_MCQ", notes: "With rates 1/40, 1/50 and 1/60, P works all 30 minutes and Q,R work for x minutes; solve the stated partial-runtime condition." }),
