...
assert.equal(profile.packageWeights[0]?.questionCount, 23);
assert.equal(profile.packageWeights[0]?.questionShare, 23 / 200);
assert.equal(profile.packageWeights[0]?.meanQuestionsPerSection, 23 / 8);
