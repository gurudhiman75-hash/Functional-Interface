...
assert.equal(profile.packageWeights[0]?.questionCount, 10);
assert.equal(profile.packageWeights[0]?.questionShare, 10 / 100);
assert.equal(profile.packageWeights[0]?.meanQuestionsPerSection, 10 / 4);
