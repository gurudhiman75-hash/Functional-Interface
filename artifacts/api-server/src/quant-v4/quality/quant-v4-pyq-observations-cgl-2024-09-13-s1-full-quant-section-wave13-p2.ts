...
export const QUANT_V4_CGL_2024_09_13_S1_FULL_QUANT_SECTION_WAVE13_COUNTABLE_PYQ_OBSERVATIONS = Object.freeze([
  ...
  observation({ q: 73, sourceQuestionId: "630680809862", packageId: "INT-001", topic: "Arithmetic — Interest", subtopic: "Simple interest — partial principal repayment with deferred first-year interest", representation: "SIMPLE_INTEREST_PARTIAL_PRINCIPAL_REPAYMENT_TWO_YEAR_SETTLEMENT_MCQ", notes: "At 10% p.a., first-year interest on ₹6,23,305 is ₹62,330.50. After repaying ₹16,390 of principal, ₹6,06,915 remains; second-year interest is ₹60,691.50. Paying the remaining principal plus both unpaid interest amounts gives ₹7,29,937. The result is independently calculated rather than inferred from a candidate-selected option." }),
  observation({ q: 74, sourceQuestionId: "630680397662", packageId: "MEN-001", topic: "Advanced Mathematics", subtopic: "MEN-CP-003 — Perimeter of a circle after removing a quarter-sector", representation: "THREE_QUARTER_CIRCLE_REMAINING_PERIMETER_MCQ", notes: "The remaining boundary is three-quarters of the original circumference plus the two exposed radii: (3/4)×2×(22/7)×21+42=141 cm. This uses the official keyed option rather than the candidate-selected option." }),
