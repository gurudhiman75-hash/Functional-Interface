...
assert.equal(QUANT_V4_REGISTERED_PYQ_OBSERVATIONS.length, 158, "The normalized registry should contain four complete dated SSC CGL Tier-I Quant sections plus prior evidence.");
...
const EXPECTED_COUNTS: Readonly<Record<QuantV4SpecializedSelectionPackageId, Readonly<Record<QuantV4CompetitiveExamProfileId, number>>>> = Object.freeze({
  ...
  "TMW-001": Object.freeze({ ...ZERO_COUNTS, SSC_CGL_TIER_I: 10, SSC_CGL_CHSL: 5 }),
});
