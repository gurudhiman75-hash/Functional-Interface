...
assert.equal(QUANT_V4_REGISTERED_PYQ_OBSERVATIONS.length, 183, "The normalized registry should contain five complete dated SSC CGL Tier-I Quant sections plus prior evidence.");
