...
export const QUANT_V4_ALGEBRA_WAVE2_COUNTABLE_PYQ_OBSERVATIONS = Object.freeze([
  {
    ...
    questionRef: "SSCPORTAL-SSC-CGL-2024-09-10-S2-Q53",
    packageId: "ALG-002",
    topic: "Advanced Mathematics",
    subtopic: "ALG-CP-007 / ALG-QL-041 — Unique 3×3 linear system",
    representation: "DIRECT_MCQ",
    language: "en",
    notes: "Direct SSC target-exam evidence for the permanent 3×3 linear-system contract. Provenance is retained from the final Algebra V2 source fixture ledger; questionRef is normalized to whole-section Q53 for exact-paper reuse.",
  },
  {
