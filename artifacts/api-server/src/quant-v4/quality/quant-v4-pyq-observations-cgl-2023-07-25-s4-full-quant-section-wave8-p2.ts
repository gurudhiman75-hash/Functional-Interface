...
export const QUANT_V4_CGL_2023_07_25_S4_FULL_QUANT_SECTION_WAVE8_COUNTABLE_PYQ_OBSERVATIONS = Object.freeze([
  ...
  observation({ q: 75, packageId: "SRI-002", topic: "Number System", subtopic: "Surds, radicals and rationalisation — binomial conjugate", representation: "RATIONALISE_BINOMIAL_SURD_FRACTION_MCQ", notes: "With x=2 and y=3, multiply (√2-√3)/(√2+√3) by the conjugate. This gives (5-2√6)/(2-3)=2√6-5." }),
