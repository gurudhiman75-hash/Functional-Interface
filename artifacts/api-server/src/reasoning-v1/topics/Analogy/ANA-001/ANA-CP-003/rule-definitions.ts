...
export const ANA_CP003_RULES: readonly NumericRuleDefinition[] = [
  ...
  { id: "DIGIT_SUM", label: "sum the digits", family: "DIGIT_BASED", priority: 2, minInput: 23, maxInput: 98, parameters: fixed(), apply: (n) => { const [a,b]=digits(n); return a+b; }, explain: (n,o) => { const [a,b]=digits(n); return `${a} + ${b} = ${o}`; } },
  { id: "DIGIT_PRODUCT", label: "multiply the digits", family: "DIGIT_BASED", priority: 3, minInput: 23, maxInput: 98, parameters: fixed(), apply: (n) => { const [a,b]=digits(n); return a*b; }, explain: (n,o) => { const [a,b]=digits(n); return `${a} × ${b} = ${o}`; } },
  { id: "DIGIT_ABS_DIFF", label: "take the absolute digit difference", family: "DIGIT_BASED", priority: 3, minInput: 23, maxInput: 98, parameters: fixed(), apply: (n) => { const [a,b]=digits(n); return Math.abs(a-b); }, explain: (n,o) => { const [a,b]=digits(n); return `|${a} - ${b}| = ${o}`; } },
  { id: "DIGIT_SUM_SQUARES", label: "add the squares of the digits", family: "DIGIT_BASED", priority: 5, minInput: 23, maxInput: 98, parameters: fixed(), apply: (n) => { const [a,b]=digits(n); return a*a+b*b; }, explain: (n,o) => { const [a,b]=digits(n); return `${a}² + ${b}² = ${o}`; } },
  { id: "DIGIT_PRODUCT_PLUS_SUM", label: "add digit product and digit sum", family: "DIGIT_BASED", priority: 6, minInput: 23, maxInput: 98, parameters: fixed(), apply: (n) => { const [a,b]=digits(n); return a*b+a+b; }, explain: (n,o) => { const [a,b]=digits(n); return `(${a} × ${b}) + ${a} + ${b} = ${o}`; } },
  ...
  { id: "DIGIT_POSITIONAL", label: "multiply the digits and add the tens digit", family: "DIGIT_BASED", priority: 7, minInput: 23, maxInput: 98, parameters: fixed(), apply: (n) => { const [a,b]=digits(n); return a*b+a; }, explain: (n,o) => { const [a,b]=digits(n); return `(${a} × ${b}) + ${a} = ${o}`; } },
];
