...
const RULE_IDS = [
  ...
  "SET_PRODUCT_MINUS_FIRST", "SET_PRODUCT_MINUS_SECOND", "SET_AVERAGE", "SET_SUM_MULTIPLIER",
  "SET_DIFF_MULTIPLIER", "SET_CONSECUTIVE_CONSTRUCTION", "SET_MATCHING_TRIPLES", "SET_CORRESPONDING_MISSING_MEMBER",
] as const;
