...
export const ANA_CP004_RULES: readonly NumberSetRuleDefinition[] = [
  ...
  { id: "SET_PRODUCT_ADJUST", label: "multiply the first two numbers and add the question's fixed constant", priority: 5, contexts: kValues(1,2,3,5,7), minInput: 2, maxInput: 15, apply: (a,b,c) => a*b+c.k!, explain: (a,b,r,c) => `(${a} × ${b}) + ${c.k} = ${r}` },
