...
CP-008 combines established inequality semantics into higher-order tasks without treating every multi-set question as Data Sufficiency.

Implemented prototype authorities:

- select the statement set with an exact strongest endpoint relation;
- identify the one candidate statement that makes a consistent chain contradictory;
...
Permanent QLs, localization, Question Studio visibility, and public release remain disabled.
