...
function polishHindi(value: string): string {
  return value
    ...
    .replaceAll("मॉडल उत्तर बिंदु तभी दिखाना चाहिए", "मॉडल उत्तर बिंदु तभी दिखाने चाहिए")
    .replaceAll("मॉडल उत्तर बिंदु को पुराना छोड़कर", "मॉडल उत्तर बिंदुओं को पुराना छोड़कर")
    .replaceAll("मूल्यांकन मानदंड को पुराना छोड़कर", "मूल्यांकन मानदंडों को पुराना छोड़कर")
    .replaceAll("मॉडल उत्तर बिंदुओं को पुराना छोड़कर प्रकाशित करना उपयोगकर्ताओं को गलत दिशा दे सकता है, इसलिए एक भर्ती बोर्ड को इसे वर्तमान रखना चाहिए", "मॉडल उत्तर बिंदुओं को पुराना छोड़कर प्रकाशित करना उपयोगकर्ताओं को गलत दिशा दे सकता है, इसलिए एक भर्ती बोर्ड को इन्हें वर्तमान रखना चाहिए")
    .replaceAll("मूल्यांकन मानदंडों को पुराना छोड़कर प्रकाशित करना उपयोगकर्ताओं को गलत दिशा दे सकता है, इसलिए एक विश्वविद्यालय को इसे वर्तमान रखना चाहिए", "मूल्यांकन मानदंडों को पुराना छोड़कर प्रकाशित करना उपयोगकर्ताओं को गलत दिशा दे सकता है, इसलिए एक विश्वविद्यालय को इन्हें वर्तमान रखना चाहिए")
    ...
    .replaceAll("प्राधिकरण शिकायत संपर्क को", "प्राधिकरण उस शिकायत संपर्क को")
...
function polishPunjabi(value: string): string {
  return value
    ...
    .replaceAll("ਰਿਮੋਟ ਕਰਮਚਾਰੀਆਂ ਕੀ-ਸਟ੍ਰੋਕ ਲੌਗਿੰਗ ਦੀ ਵਰਤੋਂ ਉੱਤੇ ਸਵਾਲ ਕਰਦੇ ਹਨ", "ਰਿਮੋਟ ਕਰਮਚਾਰੀ ਕੀ-ਸਟ੍ਰੋਕ ਲੌਗਿੰਗ ਦੀ ਵਰਤੋਂ ਉੱਤੇ ਸਵਾਲ ਕਰਦੇ ਹਨ")
    .replaceAll("ਅਥਾਰਟੀ ਸ਼ਿਕਾਇਤ ਨੂੰ ਇਸ ਨੂੰ", "ਅਥਾਰਟੀ ਨੂੰ ਇਸ ਨੂੰ")
    .replaceAll("ਅਥਾਰਟੀ ਸ਼ਿਕਾਇਤ ਇਸ ਦੀ", "ਅਥਾਰਟੀ ਇਸ ਦੀ")
    .replaceAll("ਮਾਡਲ ਉੱਤਰ ਬਿੰਦੂ ਵਿੱਚ ਬਦਲਾਅ ਸੰਭਵ ਹੋਣ ਤਾਂ ਇੱਕ ਭਰਤੀ ਬੋਰਡ ਕੋਲ ਇਸ ਨੂੰ ਸਮੇਂ ਸਿਰ ਅੱਪਡੇਟ ਕਰਨ ਦੀ ਪ੍ਰਣਾਲੀ ਹੋਣੀ ਚਾਹੀਦੀ ਹੈ", "ਮਾਡਲ ਉੱਤਰ ਬਿੰਦੂਆਂ ਵਿੱਚ ਬਦਲਾਅ ਸੰਭਵ ਹੋਣ ਤਾਂ ਇੱਕ ਭਰਤੀ ਬੋਰਡ ਕੋਲ ਇਨ੍ਹਾਂ ਨੂੰ ਸਮੇਂ ਸਿਰ ਅੱਪਡੇਟ ਕਰਨ ਦੀ ਪ੍ਰਣਾਲੀ ਹੋਣੀ ਚਾਹੀਦੀ ਹੈ")
    .replaceAll("ਮੁਲਾਂਕਣ ਮਾਪਦੰਡ ਨੂੰ ਪੁਰਾਣਾ ਛੱਡ ਕੇ ਦਿਖਾਉਣਾ ਵਰਤੋਂਕਾਰਾਂ ਨੂੰ ਗਲਤ ਰਾਹ ਪਾ ਸਕਦਾ ਹੈ, ਇਸ ਲਈ ਇੱਕ ਯੂਨੀਵਰਸਿਟੀ ਨੂੰ ਇਸ ਨੂੰ ਮੌਜੂਦਾ ਰੱਖਣਾ ਚਾਹੀਦਾ ਹੈ", "ਮੁਲਾਂਕਣ ਮਾਪਦੰਡਾਂ ਨੂੰ ਪੁਰਾਣਾ ਛੱਡ ਕੇ ਦਿਖਾਉਣਾ ਵਰਤੋਂਕਾਰਾਂ ਨੂੰ ਗਲਤ ਰਾਹ ਪਾ ਸਕਦਾ ਹੈ, ਇਸ ਲਈ ਇੱਕ ਯੂਨੀਵਰਸਿਟੀ ਨੂੰ ਇਨ੍ਹਾਂ ਨੂੰ ਮੌਜੂਦਾ ਰੱਖਣਾ ਚਾਹੀਦਾ ਹੈ")
    .replaceAll("ਵੈਬਕੈਮ ਸਰਗਰਮੀ ਦੀ ਨਿਗਰਾਨੀ ਕਿਹੜੀ ਜਾਣਕਾਰੀ ਲਵੇਗਾ", "ਵੈਬਕੈਮ ਸਰਗਰਮੀ ਦੀ ਨਿਗਰਾਨੀ ਕਿਹੜੀ ਜਾਣਕਾਰੀ ਇਕੱਠੀ ਕਰੇਗੀ")
    .replaceAll("ਕੀ-ਸਟ੍ਰੋਕ ਲੌਗਿੰਗ ਕਿਹੜੀ ਜਾਣਕਾਰੀ ਲਵੇਗਾ", "ਕੀ-ਸਟ੍ਰੋਕ ਲੌਗਿੰਗ ਕਿਹੜੀ ਜਾਣਕਾਰੀ ਇਕੱਠੀ ਕਰੇਗੀ")
    .replaceAll("ਵੈਬਕੈਮ ਸਰਗਰਮੀ ਦੀ ਨਿਗਰਾਨੀ ਕਿਵੇਂ ਕੰਮ ਕਰਦਾ ਹੈ", "ਵੈਬਕੈਮ ਸਰਗਰਮੀ ਦੀ ਨਿਗਰਾਨੀ ਕਿਵੇਂ ਕੰਮ ਕਰਦੀ ਹੈ")
    .replaceAll("ਠੇਕਾ ਕਰਮਚਾਰੀਆਂ ਦੀ ਖਾਸ ਗਲਤ ਵਿਹਾਰ ਜਾਂਚ", "ਠੇਕਾ ਕਰਮਚਾਰੀਆਂ ਨਾਲ ਜੁੜੀ ਖਾਸ ਗਲਤ-ਵਿਹਾਰ ਜਾਂਚ")
    .replaceAll("ਵਾਪਸ ਲਿਆ ਜਾ ਸਕਣ ਵਾਲਾ ਅਸਥਾਈ ਰੋਕ", "ਵਾਪਸ ਲਈ ਜਾ ਸਕਣ ਵਾਲੀ ਅਸਥਾਈ ਰੋਕ")
    .replaceAll("ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਮਿਲਣ 'ਤੇ", "ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਸਾਹਮਣੇ ਆਉਣ 'ਤੇ")
    .replaceAll("ਗਲਤ ਵਿਹਾਰ ਦੇ ਇੱਕ ਦੋਸ਼ ਕਾਰਨ", "ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਲੱਗਣ ਕਾਰਨ")
    .replaceAll("ਗਲਤ ਵਿਹਾਰ ਦੇ ਇੱਕ ਦੋਸ਼ ਤੋਂ ਬਾਅਦ", "ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਲੱਗਣ ਤੋਂ ਬਾਅਦ")
    ...
    .replaceAll("ਗਲਤ ਗਲਤ ਵਿਹਾਰ ਦੇ ਇੱਕ ਦੋਸ਼ ਦੇ ਆਧਾਰ", "ਗਲਤ ਵਿਹਾਰ ਦੇ ਇੱਕ ਗਲਤ ਦੋਸ਼ ਦੇ ਆਧਾਰ")
    ...
    .replaceAll("ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਕਾਰਨ", "ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਲੱਗਣ ਕਾਰਨ")
    .replaceAll("ਗਲਤ ਵਿਹਾਰ ਦੇ ਇੱਕ ਦੋਸ਼ ਤੋਂ ਬਾਅਦ", "ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਲੱਗਣ ਤੋਂ ਬਾਅਦ")
    .replaceAll("ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਮਿਲਣ 'ਤੇ", "ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਸਾਹਮਣੇ ਆਉਣ 'ਤੇ")
    .replaceAll("ਵਾਪਸ ਲਈ ਜਾ ਸਕਣ ਵਾਲੀ ਅਸਥਾਈ ਰੋਕ ਤੁਰੰਤ ਜੋਖਮ ਨੂੰ ਸੰਭਾਲ ਸਕਦਾ ਹੈ", "ਵਾਪਸ ਲਈ ਜਾ ਸਕਣ ਵਾਲੀ ਅਸਥਾਈ ਰੋਕ ਤੁਰੰਤ ਜੋਖਮ ਨੂੰ ਸੰਭਾਲ ਸਕਦੀ ਹੈ");
}
