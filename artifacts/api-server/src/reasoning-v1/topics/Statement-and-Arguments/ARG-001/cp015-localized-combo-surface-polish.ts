...
function polishPunjabi(value: string): string {
  return value
    ...
    .replaceAll("ਗਲਤ ਵਿਹਾਰ ਦੇ ਇੱਕ ਦੋਸ਼", "ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼")
    ...
    .replaceAll("ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਸ਼ਿਕਾਇਤ ਜਾਂ ਸੰਕੇਤ ਹੈ, ਦੋਸ਼ ਦਾ ਆਪਣੇ ਆਪ ਸਬੂਤ ਨਹੀਂ", "ਗਲਤ ਵਿਹਾਰ ਦਾ ਇੱਕ ਦੋਸ਼ ਆਪਣੇ ਆਪ ਦੋਸ਼ ਦਾ ਸਬੂਤ ਨਹੀਂ ਹੈ")
