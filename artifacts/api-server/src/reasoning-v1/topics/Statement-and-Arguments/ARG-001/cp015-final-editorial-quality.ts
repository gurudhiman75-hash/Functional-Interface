...
function specificHindiReason(argument: string): string {
  if (/निर्णय घोषित.*अभ्यर्थी सहायता और बैकअप व्यवस्था.*(?:उपलब्ध हो जाएँगी|उपलब्ध)/.test(argument)) return "केवल निर्णय घोषित करने से पर्याप्त अभ्यर्थी सहायता और बैकअप व्यवस्था दो सप्ताह में अपने-आप उपलब्ध नहीं हो जाती; इनके लिए अलग स्टाफिंग और संचालन योजना चाहिए।";
  if (/निर्णय घोषित.*सुरक्षित डिवाइस और केंद्र.*(?:उपलब्ध हो जाएँगे|उपलब्ध)/.test(argument)) return "केवल निर्णय घोषित करने से पर्याप्त सुरक्षित डिवाइस और परीक्षा-केंद्र क्षमता दो सप्ताह में अपने-आप तैयार नहीं हो जाती; इसके लिए अलग संसाधन और क्षमता-योजना चाहिए।";
  if (/निर्णय घोषित.*(?:स्थिर )?कनेक्टिविटी.*(?:उपलब्ध हो जाए|उपलब्ध हो जाएगी|उपलब्ध)/.test(argument)) return "केवल निर्णय घोषित करने से आवश्यक स्थिर कनेक्टिविटी अपने-आप उपलब्ध नहीं हो जाती; दो सप्ताह की तैयारी के लिए नेटवर्क क्षमता की अलग जाँच और योजना चाहिए।";
  ...
  if (/समय-स्लॉट.*(?:स्थायी रूप से अव्यावहारिक|स्थायी रूप से अनुपलब्ध|सफलतापूर्वक देना स्थायी)/.test(argument)) return "समय-स्लॉट से कुछ पहुँच या संचालन कठिनाइयाँ हो सकती हैं, लेकिन इससे सेवा स्थायी रूप से अव्यावहारिक या अनुपलब्ध हो जाएगी, यह निष्कर्ष उचित नहीं है।";
...
function specificPunjabiReason(argument: string): string {
  if (/ਫੈਸਲਾ ਘੋਸ਼ਿਤ.*ਸੁਰੱਖਿਅਤ ਡਿਵਾਈਸ ਅਤੇ ਕੇਂਦਰ.*(?:ਉਪਲਬਧ ਹੋ ਜਾਣਗੇ|ਉਪਲਬਧ)/.test(argument)) return "ਕੇਵਲ ਫੈਸਲਾ ਘੋਸ਼ਿਤ ਕਰਨ ਨਾਲ ਲੋੜੀਂਦੇ ਸੁਰੱਖਿਅਤ ਡਿਵਾਈਸ ਅਤੇ ਕੇਂਦਰ ਦੋ ਹਫ਼ਤਿਆਂ ਵਿੱਚ ਆਪਣੇ ਆਪ ਤਿਆਰ ਨਹੀਂ ਹੋ ਜਾਂਦੇ; ਉਪਕਰਣ ਅਤੇ ਕੇਂਦਰ-ਸਮਰੱਥਾ ਦੀ ਵੱਖਰੀ ਯੋਜਨਾ ਚਾਹੀਦੀ ਹੈ।";
  if (/ਫੈਸਲਾ ਘੋਸ਼ਿਤ.*ਕਨੈਕਟਿਵਿਟੀ.*ਉਪਲਬਧ/.test(argument)) return "ਕੇਵਲ ਫੈਸਲਾ ਘੋਸ਼ਿਤ ਕਰਨ ਨਾਲ ਲੋੜੀਂਦੀ ਸਥਿਰ ਕਨੈਕਟਿਵਿਟੀ ਆਪਣੇ ਆਪ ਉਪਲਬਧ ਨਹੀਂ ਹੋ ਜਾਂਦੀ; ਦੋ ਹਫ਼ਤਿਆਂ ਦੀ ਤਿਆਰੀ ਲਈ ਨੈੱਟਵਰਕ ਸਮਰੱਥਾ ਦੀ ਵੱਖਰੀ ਜਾਂਚ ਅਤੇ ਯੋਜਨਾ ਚਾਹੀਦੀ ਹੈ।";
