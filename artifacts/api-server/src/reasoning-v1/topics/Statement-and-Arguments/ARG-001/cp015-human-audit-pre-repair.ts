...
function repairHindi(value: string): string {
  return value
    ...
    .replace(/मार्गदर्शित कार्यशालाएँ की/g, "मार्गदर्शित कार्यशालाओं की")
    .replace(/सभी मार्गदर्शित कार्यशालाओं की जगह ([^।!?]+?) कर देना चाहिए/g, "सभी मार्गदर्शित कार्यशालाओं को $1 से बदल देना चाहिए")
...
function repairPunjabi(value: string): string {
  return value
    ...
    .replace(/ਭਵਿੱਖ ਵਿੱਚ ਜ਼ਿਆਦਾਤਰ ਕਿਸੇ ਦੀ ਭਵਿੱਖ ਦੀ ਨਿਯਮ ਪਾਲਣਾ ਕਾਫ਼ੀ ਹੱਦ ਤੱਕ ਯਕੀਨੀ ਹੋ ਜਾਵੇਗੀ/g, "ਭਵਿੱਖ ਦੀ ਨਿਯਮ ਪਾਲਣਾ ਲਗਭਗ ਯਕੀਨੀ ਹੋ ਜਾਵੇਗੀ")
    ...
    .replace(/ਕੀ-ਸਟ੍ਰੋਕ ਲੌਗਿੰਗ ਕਿਹੜਾ ਡਾਟਾ ਇਕੱਠਾ ਕਰਦਾ ਹੈ, ਕਿਉਂ ਕਰਦਾ ਹੈ/g, "ਕੀ-ਸਟ੍ਰੋਕ ਲੌਗਿੰਗ ਕਿਹੜਾ ਡਾਟਾ ਇਕੱਠਾ ਕਰਦੀ ਹੈ, ਕਿਉਂ ਕਰਦੀ ਹੈ")
