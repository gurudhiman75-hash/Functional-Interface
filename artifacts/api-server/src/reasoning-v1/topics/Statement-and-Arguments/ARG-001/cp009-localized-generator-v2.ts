...
import {
  ...
  getArgCp009LocalizedTemplateV2,
...
export function generateArgCp009LocalizedQuestionV2(input: {
  ...
  const template = getArgCp009LocalizedTemplateV2({
    locale: input.locale,
    qlId: input.qlId,
  ...
  return Object.freeze({
    ...
    version: "CP009-I18N-V2" as const,
    authority: ARG_CP009_LOCALIZATION_AUTHORITY_V2,
    sourceEnglishAuthority: base.authority,
    qlId: base.qlId,
    scenarioId: `${base.templateId}-CP009-V2-${input.locale}-${base.variantKey}`,
    templateId: base.templateId,
    ...
    metadata: Object.freeze({
      ...
      localizationStatus: "CP009_HI_PA_REMEDIATED_V2" as const,
