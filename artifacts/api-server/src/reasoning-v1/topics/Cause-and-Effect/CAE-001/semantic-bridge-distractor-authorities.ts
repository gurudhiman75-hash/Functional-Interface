...
const BY_VARIANT: Readonly<Record<string, readonly CaeSemanticCandidateAuthority[]>> = {
  ...
  pump: [bridge("pump-pressure-valve", "A pressure-control valve on a small side branch stuck partly closed.", "एक छोटी शाखा लाइन का दबाव नियंत्रक वाल्व आंशिक रूप से बंद रह गया।", "ਇੱਕ ਛੋਟੀ ਸਾਈਡ ਬਰਾਂਚ ਦਾ ਦਬਾਅ-ਨਿਯੰਤਰਕ ਵਾਲਵ ਅੱਧਾ ਬੰਦ ਰਹਿ ਗਿਆ।", "LOCAL", "LOW", "LOW", "A plausible branch-line cause that is too limited to explain the wider supply-line pressure fall.")],
  ...
  "exam-centre": [bridge("exam-centre-protest", "A large protest slowed traffic on the approach road.", "एक बड़े विरोध प्रदर्शन ने पहुंच सड़क पर यातायात धीमा किया।", "ਇੱਕ ਵੱਡੇ ਵਿਰੋਧ ਪ੍ਰਦਰਸ਼ਨ ਨੇ ਪਹੁੰਚ ਸੜਕ ਉੱਤੇ ਆਵਾਜਾਈ ਹੌਲੀ ਕੀਤੀ।", "LOCAL", "LOW", "LOW", "A plausible access problem that does not cover the actual road closure.")],
