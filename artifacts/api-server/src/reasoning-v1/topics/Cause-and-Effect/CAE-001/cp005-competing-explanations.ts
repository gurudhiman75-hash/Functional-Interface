...
export const CP005_COMPETING_SCENARIOS: readonly Scenario[] = Object.freeze([
  ...
  },
  {
    ...
    evidence: l("The speed restriction appeared only where track water level had risen after prolonged rain; signalling tests were normal.", "गति प्रतिबंध केवल वहीं लगा जहाँ लंबे समय की बारिश के बाद पटरी पर पानी बढ़ा था; सਿਗ्नल परीक्षण सामान्य थे।", "ਗਤੀ ਪਾਬੰਦੀ ਸਿਰਫ਼ ਉੱਥੇ ਲੱਗੀ ਜਿੱਥੇ ਲੰਬੇ ਮੀਂਹ ਤੋਂ ਬਾਅਦ ਪਟੜੀ ਉੱਤੇ ਪਾਣੀ ਵਧਿਆ ਸੀ; ਸਿਗਨਲ ਜਾਂਚ ਆਮ ਸੀ।"),
  ...
  },
  {
    ...
    evidence: l("Pressure fell at several monitoring points at the same time; valve settings were unchanged and the leak-monitoring system detected no abnormal outflow.", "कई निगरानी बिंदुओं पर एक ही समय दबाव गिरा; वाल्व सेटिंग में कोई बदलाव नहीं था और लीकेज निगरानी प्रणाली ने कोई असामान्य बहाव नहीं दर्ज किया।", "ਕਈ ਨਿਗਰਾਨੀ ਬਿੰਦੂਆਂ ਉੱਤੇ ਇੱਕੋ ਸਮੇਂ ਦਬਾਅ ਘਟਿਆ; ਵਾਲਵ ਸੈਟਿੰਗ ਨਹੀਂ ਬਦਲੀ ਅਤੇ ਲੀਕ ਨਿਗਰਾਨੀ ਪ੍ਰਣਾਲੀ ਨੇ ਕੋਈ ਅਸਧਾਰਣ ਬਹਾਅ ਦਰਜ ਨਹੀਂ ਕੀਤਾ।"),
    explanation: l("Failure of the main pump best explains the simultaneous zone-wide pressure fall after valve changes and a major leak are ruled out.", "वाल्व बदलाव और बड़ी लीकेज को बाहर करने के बाद पूरे क्षेत्र में एक साथ दबाव गिरने को मुख्य पंप की विफलता सबसे अच्छी तरह समझाती है।", "ਵਾਲਵ ਬਦਲਾਅ ਅਤੇ ਵੱਡੀ ਲੀਕ ਨੂੰ ਰੱਦ ਕਰਨ ਤੋਂ ਬਾਅਦ ਪੂਰੇ ਖੇਤਰ ਵਿੱਚ ਇੱਕੋ ਸਮੇਂ ਦਬਾਅ ਘਟਣ ਨੂੰ ਮੁੱਖ ਪੰਪ ਦੀ ਨਾਕਾਮੀ ਸਭ ਤੋਂ ਚੰਗੀ ਤਰ੍ਹਾਂ ਸਮਝਾਉਂਦੀ ਹੈ।"),
    candidates: [
  ...
  },
  {
    ...
    evidence: l("Road conditions and staffing were normal; barcode scans completed normally, but bay-release commands failed at several loading bays during the same hour.", "सड़क की स्थिति और कर्मचारियों की उपलब्धता सामान्य थी; बारकोड स्कैन सामान्य रूप से पूरे हुए, लेकिन उसी घंटे कई लोडिंग बे पर बे-रिलीज आदेश विफल हुए।", "ਸੜਕ ਹਾਲਾਤ ਅਤੇ ਕਰਮਚਾਰੀ ਉਪਲਬਧਤਾ ਆਮ ਸੀ; ਬਾਰਕੋਡ ਸਕੈਨ ਆਮ ਤਰ੍ਹਾਂ ਪੂਰੇ ਹੋਏ, ਪਰ ਉਸੇ ਘੰਟੇ ਕਈ ਲੋਡਿੰਗ ਬੇ ਉੱਤੇ ਬੇ-ਰਿਲੀਜ਼ ਹੁਕਮ ਨਾਕਾਮ ਰਹੇ।"),
    explanation: l("A warehouse-wide loading-control failure best fits simultaneous bay-release command failures while roads, staffing and scanning remained normal.", "सड़क, कर्मचारी और स्कैनिंग सामान्य रहने के बावजूद कई बे पर एक साथ बे-रिलीज आदेश विफल होना गोदाम-व्यापी लोडिंग-नियंत्रण प्रणाली की खराबी से सबसे अच्छी तरह मेल खाता है।", "ਸੜਕਾਂ, ਕਰਮਚਾਰੀ ਅਤੇ ਸਕੈਨਿੰਗ ਆਮ ਰਹਿਣ ਦੇ ਬਾਵਜੂਦ ਕਈ ਬੇ ਉੱਤੇ ਇੱਕੋ ਸਮੇਂ ਬੇ-ਰਿਲੀਜ਼ ਹੁਕਮ ਨਾਕਾਮ ਹੋਣਾ ਗੋਦਾਮ-ਪੱਧਰੀ ਲੋਡਿੰਗ-ਕੰਟਰੋਲ ਪ੍ਰਣਾਲੀ ਦੀ ਖਰਾਬੀ ਨਾਲ ਸਭ ਤੋਂ ਚੰਗੀ ਤਰ੍ਹਾਂ ਮੇਲ ਖਾਂਦਾ ਹੈ।"),
    candidates: [
