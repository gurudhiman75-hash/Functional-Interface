...
let localizedCaseletCount=0,localizedChildCount=0,canonicalNameLeakCount=0,residualLatinCount=0,mechanicalTranslationeseCount=0,ordinalGrammarViolationCount=0,singularGenderMarkerCount=0,genericWrongOptionFallbackCount=0;
