...
import { SEA001_MACHINE_REALNESS_THRESHOLDS } from "./machine-realness-thresholds.ts";
...
export const SEA001_REALNESS_GATE_POLICY = Object.freeze({
  ...
  machineArtifactPolicy: "PINNED_ENGINEERING_ANTI_ARTIFACT_THRESHOLDS" as const,
...
export interface Sea001FinalRealnessReadiness {
  ...
  readonly machineArtifactThresholdStatus: "PINNED_BLOCKED";
  readonly machineArtifactThresholdFreezeReady: false;
  readonly machineArtifactThresholdPinnedAt: typeof SEA001_MACHINE_REALNESS_THRESHOLDS.pinnedAt;
...
export function sea001FinalRealnessReadiness(): Sea001FinalRealnessReadiness {
  ...
  // The measured 2026-08-19 corpus crosses the pinned structural thresholds in exactly
  // these three frozen authorities. Fixing them requires deliberate generator/content
  // hardening and therefore must not be hidden inside the already-approved learner freeze.
  blockers.push("STRUCTURAL_REALNESS_SEA_PBA_001");
  blockers.push("STRUCTURAL_REALNESS_SEA_PBA_011");
  blockers.push("STRUCTURAL_REALNESS_SEA_PBA_014");
  ...
  return {
    ...
    machineArtifactThresholdStatus: "PINNED_BLOCKED",
    machineArtifactThresholdFreezeReady: false,
    machineArtifactThresholdPinnedAt: SEA001_MACHINE_REALNESS_THRESHOLDS.pinnedAt,
