...
export const SEA_EXAM_REALNESS_EVIDENCE: readonly SeaExamRealnessEvidence[] = [
  {
    ...
    examDate: "2026-01-19",
    shift: "Paper-I reasoning analysis",
    ...
    note: "Section analysis reports a six-person seating arrangement and 2-3 seating questions; topology is not specified strongly enough to assign a package. SSC's modified Tier-II schedule placed the reasoning section on 19 January 2026.",
  },
  {
    id: "SEA-REAL-SSC-002",
    lane: "SSC",
