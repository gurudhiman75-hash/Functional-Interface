...
assert.equal(readiness.machineArtifactThresholdStatus, "PINNED_BLOCKED");
assert.equal(readiness.machineArtifactThresholdFreezeReady, false);
assert.equal(readiness.machineArtifactThresholdPinnedAt, "2026-08-19");
...
assert(readiness.blockers.includes("STRUCTURAL_REALNESS_SEA_PBA_001"));
assert(readiness.blockers.includes("STRUCTURAL_REALNESS_SEA_PBA_011"));
assert(readiness.blockers.includes("STRUCTURAL_REALNESS_SEA_PBA_014"));
