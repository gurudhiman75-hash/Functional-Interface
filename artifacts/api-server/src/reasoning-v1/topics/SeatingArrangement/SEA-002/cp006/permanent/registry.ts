...
const AUTHORITY = Object.freeze({
  "SEA-PBA-021": Object.freeze({ solveContract: "fixed row membership with opposites", definingDiscriminators: Object.freeze(["all row memberships supplied", "opposite-seat link", "same-row positional relation"]) }),
  "SEA-PBA-022": Object.freeze({ solveContract: "row membership partly inferred", definingDiscriminators: Object.freeze(["partial row membership", "opposite-seat link", "diagonal relation", "same-row positional relation"]) }),
  "SEA-PBA-023": Object.freeze({ solveContract: "same-row positional chains linked through opposite seats", definingDiscriminators: Object.freeze(["same-row positional chain", "opposite-seat bridge", "row identity anchor"]) }),
  "SEA-PBA-024": Object.freeze({ solveContract: "opposite/not-opposite/diagonal/endpoint composition", definingDiscriminators: Object.freeze(["opposite relation", "not-opposite relation", "diagonal relation", "endpoint constraint"]) }),
...
export interface Sea002Cp006PermanentQlRegistryEntry {
  ...
  readonly englishStatus: "ENGLISH_MANUAL_FREEZE_APPROVED_CORRECTED";
...
export const SEA002_CP006_PERMANENT_QL_REGISTRY: readonly Sea002Cp006PermanentQlRegistryEntry[] = Object.freeze(
  (Object.keys(SEA002_CP006_BLUEPRINT_TO_PERMANENT_QL) as Sea002Cp006BlueprintId[]).map((blueprintAuthorityId) => Object.freeze({
    ...
    englishStatus: "ENGLISH_MANUAL_FREEZE_APPROVED_CORRECTED" as const,
