...
const expectedGlossaryConcepts=["POSITION","UPPER_ROW","LOWER_ROW","NORTH","SOUTH","LEFT","RIGHT","SAME_ROW","DIFFERENT_ROW","OPPOSITE","DIAGONAL","ADJACENT","NOT_ADJACENT","BETWEEN","END_POSITION","FROM_EITHER_END","PERSON_FACING","CASE_ACCEPT","CASE_REJECT"] as const;
...
assert.deepEqual(SEA002_CP006_LOCALIZATION_READINESS.activeEditorialBlockers,[SEA002_CP006_LOCALIZATION_HUMAN_REVIEW_BLOCKER]);
...
assert.equal(SEA002_CP006_LOCALIZATION_READINESS.englishFreezeActive,true);
assert.equal(SEA002_CP006_LOCALIZATION_READINESS.englishFreezeFingerprint,SEA002_CP006_APPROVED_REVIEW.approvedReviewFingerprint);
...
assert.equal(fingerprint,SEA002_CP006_APPROVED_REVIEW.approvedReviewFingerprint);
...
console.log("approved English fingerprint",fingerprint);
