...
export const SEA002_CP008_WAVE04_SOURCE_DECISIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    rationale: "The geometry is useful for stress testing, but the available role-derived 12-seat relay remains discovery-only and cannot justify permanent allocation.",
  }),
  Object.freeze({
    family: "ALT12_INDEPENDENT_MIXED_FACING",
    prototypeId: "SEA-CP008-PROT-010" as const,
    decision: "RETAIN_DISCOVERY_STRESS_ONLY" as const,
    rationale: "The mixed-facing 12-seat relay remains too weak for a production authority. It is excluded from the permanent solve set rather than inflating the QL registry from prep-only evidence.",
  }),
] as const);

export const SEA002_CP008_SOURCE_SATURATION_V3 = Object.freeze({
  checkpointId: "SEA-CP-008" as const,
  status: "PRODUCTION_SOURCE_SATURATION_CANDIDATE_WAVE04" as const,
