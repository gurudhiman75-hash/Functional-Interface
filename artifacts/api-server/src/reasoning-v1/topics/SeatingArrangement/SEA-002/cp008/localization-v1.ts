...
function hiIntro(topology: Sea002Cp008ReviewTopology, facingMode: string): string {
  ...
  if (topology === "ALT12_ROLE_DERIVED") {
    return facingMode === "CORNERS_OUT_SIDES_IN"
      ? "बारह व्यक्ति एक वर्गाकार मेज के चारों ओर हैं। प्रत्येक कोने पर एक व्यक्ति और प्रत्येक भुजा पर दो व्यक्ति हैं। कोनों पर मौजूद व्यक्तियों का मुख बाहर की ओर तथा भुजाओं पर मौजूद व्यक्तियों का मुख केंद्र की ओर है।"
      : "बारह व्यक्ति एक वर्गाकार मेज के चारों ओर हैं। प्रत्येक कोने पर एक व्यक्ति और प्रत्येक भुजा पर दो व्यक्ति हैं। कोनों पर मौजूद व्यक्तियों का मुख केंद्र की ओर तथा भुजाओं पर मौजूद व्यक्तियों का मुख बाहर की ओर है।";
  }
...
function paIntro(topology: Sea002Cp008ReviewTopology, facingMode: string): string {
  ...
  if (topology === "ALT12_ROLE_DERIVED") {
    return facingMode === "CORNERS_OUT_SIDES_IN"
      ? "ਬਾਰਾਂ ਵਿਅਕਤੀ ਵਰਗਾਕਾਰ ਮੇਜ਼ ਦੇ ਆਲੇ-ਦੁਆਲੇ ਹਨ। ਹਰ ਕੋਨੇ 'ਤੇ ਇੱਕ ਵਿਅਕਤੀ ਅਤੇ ਹਰ ਭੁਜਾ 'ਤੇ ਦੋ ਵਿਅਕਤੀ ਹਨ। ਕੋਨਿਆਂ ਵਾਲਿਆਂ ਦਾ ਮੂੰਹ ਬਾਹਰ ਵੱਲ ਅਤੇ ਭੁਜਾਵਾਂ ਵਾਲਿਆਂ ਦਾ ਮੂੰਹ ਕੇਂਦਰ ਵੱਲ ਹੈ।"
      : "ਬਾਰਾਂ ਵਿਅਕਤੀ ਵਰਗਾਕਾਰ ਮੇਜ਼ ਦੇ ਆਲੇ-ਦੁਆਲੇ ਹਨ। ਹਰ ਕੋਨੇ 'ਤੇ ਇੱਕ ਵਿਅਕਤੀ ਅਤੇ ਹਰ ਭੁਜਾ 'ਤੇ ਦੋ ਵਿਅਕਤੀ ਹਨ। ਕੋਨਿਆਂ ਵਾਲਿਆਂ ਦਾ ਮੂੰਹ ਕੇਂਦਰ ਵੱਲ ਅਤੇ ਭੁਜਾਵਾਂ ਵਾਲਿਆਂ ਦਾ ਮੂੰਹ ਬਾਹਰ ਵੱਲ ਹੈ।";
  }
  ...
  if (topology === "VARIABLE_SIDE6") return "ਛੇ ਵਿਅਕਤੀ ਵਰਗਾਕਾਰ ਮੇਜ਼ ਦੀਆਂ ਭੁਜਾਵਾਂ 'ਤੇ ਹਨ ਅਤੇ ਸਭ ਦਾ ਮੂੰਹ ਕੇਂਦਰ ਵੱਲ ਹੈ। ਕੋਈ ਵੀ ਕੋਨੇ 'ਤੇ ਨਹੀਂ ਹੈ। ਦੋ ਆਮਨੇ-ਸਾਮਨੇ ਭੁਜਾਵਾਂ 'ਤੇ ਇੱਕ-ਇੱਕ ਅਤੇ ਬਾਕੀ ਦੋ ਭੁਜਾਵਾਂ 'ਤੇ ਦੋ-ਦੋ ਵਿਅਕਤੀ ਹਨ।";
...
function localizedExplanation(candidate: Sea002Cp008ReviewCandidate, locale: Sea002Cp008Locale): string {
  ...
  const roleDerived = candidate.topology === "ALT8_ROLE_DERIVED" || candidate.topology === "ALT12_ROLE_DERIVED";
  if (locale === "hi") {
    ...
    const setup = candidate.topology === "ALT12_METRIC"
      ...
      : candidate.topology === "VARIABLE_SIDE6"
        ...
        : roleDerived
          ? "पहले कोने और भुजा वाले स्थान तय करें। इसके बाद दिए गए कोना-बनाम-भुजा नियम से प्रत्येक व्यक्ति की मुख-दिशा तय करके बाएँ-दाएँ संबंध लगाएँ।"
          : mixed
  ...
  const setup = candidate.topology === "ALT12_METRIC"
    ...
    : candidate.topology === "VARIABLE_SIDE6"
      ...
      : roleDerived
        ? "ਪਹਿਲਾਂ ਕੋਨੇ ਅਤੇ ਭੁਜਾ ਵਾਲੇ ਸਥਾਨ ਨਿਰਧਾਰਤ ਕਰੋ। ਫਿਰ ਦਿੱਤੇ ਕੋਨਾ-ਬਨਾਮ-ਭੁਜਾ ਨਿਯਮ ਤੋਂ ਹਰ ਵਿਅਕਤੀ ਦੀ ਮੂੰਹ-ਦਿਸ਼ਾ ਨਿਰਧਾਰਤ ਕਰਕੇ ਖੱਬੇ-ਸੱਜੇ ਸੰਬੰਧ ਲਗਾਓ।"
        : mixed
