...
export const SEA002_CP008_PREFREEZE_AUTHORITY_V2 = Object.freeze({
  ...
  english: Object.freeze({
    status: "V3_EXAM_REAL_CI_CERTIFIED_HUMAN_APPROVAL_PENDING" as const,
  ...
  localization: Object.freeze({
    status: "V3_SOURCE_GRAPH_LOCALIZATION_CI_CERTIFIED_HUMAN_APPROVAL_PENDING" as const,
...
export function assertSea002Cp008PrefreezeBoundaryV2(): void {
  ...
  if (authority.english.status !== "V3_EXAM_REAL_CI_CERTIFIED_HUMAN_APPROVAL_PENDING"
    || authority.localization.status !== "V3_SOURCE_GRAPH_LOCALIZATION_CI_CERTIFIED_HUMAN_APPROVAL_PENDING") {
    throw new Error("SEA-CP-008 V3 review authority must retain the CI-certified/human-approval-pending lifecycle state.");
  }
