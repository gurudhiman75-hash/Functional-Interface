...
import { localizeSea002Cp007Candidate } from "./candidate-localizer-v1.ts";
...
const rows: string[] = [
  "# SEA-002 / SEA-CP-007 — Hindi + Punjabi Localization Review Candidate V1",
  "",
  "Status: **HUMAN LANGUAGE REVIEW PENDING / STRUCTURAL PARITY LOCKED / NO PRODUCT ACTIVATION**",
  "",
...
const output = "artifacts/api-server/dist/reasoning-v1/sea-002-cp007-localization-review-v1.md";
mkdirSync(dirname(output), { recursive: true });
writeFileSync(output, reviewText, "utf8");

console.log("PASS_SEA002_CP007_LOCALIZATION_REVIEW_EXPORT_V1");
