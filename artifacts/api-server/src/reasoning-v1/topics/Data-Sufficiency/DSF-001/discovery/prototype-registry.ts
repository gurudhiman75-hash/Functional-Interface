...
export const DSF_DISCOVERY_PROTOTYPES: readonly DsDiscoveryPrototype[] = [
  {
    ...
    permanentQlId: null,
    notes: "Executable adapter reuses NUM-001 divisibility helpers and routes all sufficiency truth through the shared DSF target-projection evaluator.",
  },
  {
  ...
  },
  {
    ...
    status: "EXECUTABLE_PROTOTYPE",
    permanentQlId: null,
    notes: "Discovery prototype proves a function target can be unique while multiple complete variable assignments survive. Production source-runtime integration is pending Algebra availability on New-main.",
  },
  {
    prototypeId: "DSF-PROT-005",
    domainFamily: "REASONING",
    sourceChapter: "Ranking and Order",
    sourcePath: "reasoning-v1/topics/Ranking-and-Order/RNK-001/RNK-CP-007/cp007-partial-order-position-adapter-v1.ts",
    targetKinds: ["RANK", "COUNT", "RELATIVE_ORDER"],
    status: "EXECUTABLE_PROTOTYPE",
    permanentQlId: null,
    notes: "Executable adapter projects the asked rank over all valid orders and independently verifies rank sets with RNK-CP-007 exactRankSet.",
  },
  {
