...
export const BLR_CP003_MERGE_SPLIT_MATRIX_V1: readonly BlrCp003MergeSplitDecision[] = [
  {
    ...
    rationale: "A shared passage changes assembly, not the subject-to-reference relation solve.",
  },
  {
    ...
    existingAuthority: "RESOLVE_NAMED_PERSON_RELATION",
    answerType: "RELATION_LABEL",
    rationale: "Great-generation depth is an output/path property inside the named-person relation authority.",
  },
  {
    ...
    rationale: "The reference and relation are fixed and the answer is one named person.",
  },
  {
    ...
    existingAuthority: "IDENTIFY_PERSON_BY_RELATION",
    answerType: "PERSON_NAME",
    rationale: "Great-generation vocabulary does not alter the person-by-relation solve contract.",
  },
  {
    ...
    rationale: "Target truth TRUE is already an instance property of the frozen claim authority.",
  },
  {
    ...
    existingAuthority: "SELECT_RELATION_CLAIM",
    answerType: "RELATION_CLAIM",
    rationale: "The frozen query contract already supports targetTruth FALSE.",
  },
  {
    ...
    rationale: "Embedding the comparison in a passage does not change its generation-delta solve.",
  },
  {
    ...
    existingAuthority: "COMPARE_GENERATIONS",
    answerType: "GENERATION_LABEL",
    rationale: "A three-level distance widens the output range but not the solve authority.",
  },
  {
    ...
    rationale: "The grouped item invokes the frozen exact-lineage solver without a second algorithm.",
  },
  {
    ...
    rationale: "The answer is a gender label; frozen BLR-QL-003 instead identifies a person from a supplied gender.",
  },
  {
    ...
    rationale: "The option is an unordered couple; frozen BLR-QL-004 requires subject-reference order.",
  },
  {
    ...
    provisionalAuthority: "SELECT_UNORDERED_FAMILY_PAIR",
    answerType: "UNORDERED_PERSON_PAIR",
    rationale: "Sibling pair order is immaterial and uses the same pair-selection solver as the couple item.",
  },
  {
    ...
    provisionalAuthority: "SELECT_UNORDERED_FAMILY_PAIR",
    answerType: "UNORDERED_PERSON_PAIR",
    rationale: "The rendered option does not state which member is the parent, unlike an ordered relation pair.",
  },
  {
    ...
    rationale: "The answer must contain every matching member, materially differing from one-person identification.",
  },
  {
    ...
    rationale: "This is a unary fact/status solve with a status-label answer, not a binary kinship relation.",
  },
  {
    ...
    answerType: "PERSON_NAME",
    rationale: "The answer is a person selected by a unary status fact rather than a relation to a reference person.",
  },
  {
    ...
    answerType: "PERSON_NAME",
    rationale: "The answer is a person, but selection requires the exact maternal/paternal solver outside BLR-QL-002's broad relation input domain.",
  },
  {
    prototypeId: "BLR-CP003-PROT-MULTI-ITEM-GROUP",
    decision: "ASSEMBLY_ONLY",
    answerType: "NONE",
    rationale: "The shared passage packages independently solved items and has no student answer of its own.",
  },
] as const;
  ...
  return [
    ...new Set(
      BLR_CP003_MERGE_SPLIT_MATRIX_V1.flatMap((entry) =>
        entry.decision === "PROVISIONAL_NEW" ? [entry.provisionalAuthority] : [],
      ),
    ),
  ];
}
