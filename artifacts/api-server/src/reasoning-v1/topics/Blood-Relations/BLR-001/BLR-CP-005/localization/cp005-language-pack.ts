...
export function localizedCoreConcept(
  ...
  switch (authority) {
    case "RESOLVE_INVARIANT_RELATION": return [
      localeText(locale, "दिए गए संकेतों से बनने वाली हर संभव परिवार-स्थिति को देखें; नाम देखकर लिंग, पक्ष या रास्ता स्वयं न मानें।", "ਦਿੱਤੇ ਸੰਕੇਤਾਂ ਤੋਂ ਬਣਦੀ ਹਰ ਸੰਭਵ ਪਰਿਵਾਰਕ ਸਥਿਤੀ ਨੂੰ ਵੇਖੋ; ਨਾਮ ਦੇ ਆਧਾਰ ’ਤੇ ਲਿੰਗ, ਪਾਸਾ ਜਾਂ ਰਸਤਾ ਆਪਣੇ ਆਪ ਨਾ ਮੰਨੋ।"),
      localeText(locale, "सटीक संबंध तभी निश्चित है जब हर संभव स्थिति में वही संबंध रहे; अलग सटीक संबंधों का एक साझा व्यापक संबंध हो तो वही उत्तर लें।", "ਸਟੀਕ ਰਿਸ਼ਤਾ ਤਦੋਂ ਹੀ ਨਿਸ਼ਚਿਤ ਹੈ ਜਦੋਂ ਹਰ ਸੰਭਵ ਸਥਿਤੀ ਵਿੱਚ ਉਹੀ ਰਿਸ਼ਤਾ ਰਹੇ; ਵੱਖਰੇ ਸਟੀਕ ਰਿਸ਼ਤਿਆਂ ਦਾ ਇੱਕ ਸਾਂਝਾ ਵਿਆਪਕ ਰਿਸ਼ਤਾ ਹੋਵੇ ਤਾਂ ਉਹੀ ਉੱਤਰ ਲਵੋ।"),
    ];
    case "RESOLVE_RELATION_UNCERTAINTY": return [
      localeText(locale, "हर संभव परिवार-स्थिति में मिलने वाला सटीक संबंध अलग-अलग लिखें।", "ਹਰ ਸੰਭਵ ਪਰਿਵਾਰਕ ਸਥਿਤੀ ਵਿੱਚ ਮਿਲਦਾ ਸਟੀਕ ਰਿਸ਼ਤਾ ਵੱਖ-ਵੱਖ ਲਿਖੋ।"),
    ...
    case "SELECT_CLAIM_BY_MODEL_STATUS": return [
      localeText(locale, "निश्चित = हर संभव स्थिति में सही; संभव = कुछ स्थितियों में सही, लेकिन सभी में नहीं; असंभव = किसी भी स्थिति में सही नहीं।", "ਨਿਸ਼ਚਿਤ = ਹਰ ਸੰਭਵ ਸਥਿਤੀ ਵਿੱਚ ਸਹੀ; ਸੰਭਵ = ਕੁਝ ਸਥਿਤੀਆਂ ਵਿੱਚ ਸਹੀ, ਪਰ ਸਾਰੀਆਂ ਵਿੱਚ ਨਹੀਂ; ਅਸੰਭਵ = ਕਿਸੇ ਵੀ ਸਥਿਤੀ ਵਿੱਚ ਸਹੀ ਨਹੀਂ।"),
      localeText(locale, "हर विकल्प को सभी संभव स्थितियों में जाँचें, केवल पहली सुविधाजनक स्थिति पर नहीं।", "ਹਰ ਵਿਕਲਪ ਨੂੰ ਸਾਰੀਆਂ ਸੰਭਵ ਸਥਿਤੀਆਂ ਵਿੱਚ ਜਾਂਚੋ, ਕੇਵਲ ਪਹਿਲੀ ਸੁਖਾਵੀਂ ਸਥਿਤੀ ਉੱਤੇ ਨਹੀਂ।"),
    ];
    case "IDENTIFY_PERSON_BY_MODEL_STATUS": return [
      localeText(locale, "हर दिए गए उम्मीदवार को हर संभव परिवार-स्थिति में अलग से जाँचें।", "ਹਰ ਦਿੱਤੇ ਉਮੀਦਵਾਰ ਨੂੰ ਹਰ ਸੰਭਵ ਪਰਿਵਾਰਕ ਸਥਿਤੀ ਵਿੱਚ ਵੱਖਰੇ ਤੌਰ ’ਤੇ ਜਾਂਚੋ।"),
      localeText(locale, "हर स्थिति में मेल = निश्चित; कुछ स्थितियों में मेल = संभव; किसी में भी मेल नहीं = असंभव।", "ਹਰ ਸਥਿਤੀ ਵਿੱਚ ਮੇਲ = ਨਿਸ਼ਚਿਤ; ਕੁਝ ਸਥਿਤੀਆਂ ਵਿੱਚ ਮੇਲ = ਸੰਭਵ; ਕਿਸੇ ਵਿੱਚ ਵੀ ਮੇਲ ਨਹੀਂ = ਅਸੰਭਵ।"),
    ];
    ...
    case "DETERMINE_COUNT_BOUND": return [
      localeText(locale, "हर संभव स्थिति में उसी सदस्य/समूह की गणना करें।", "ਹਰ ਸੰਭਵ ਸਥਿਤੀ ਵਿੱਚ ਉਸੇ ਮੈਂਬਰ/ਸਮੂਹ ਦੀ ਗਿਣਤੀ ਕਰੋ।"),
    ...
    case "SELECT_COUNT_BY_MODEL_STATUS": return [
      localeText(locale, "जो संख्या कम-से-कम एक संभव स्थिति में आती है वह संभव है; जो किसी भी स्थिति में नहीं आती वह असंभव है।", "ਜੋ ਗਿਣਤੀ ਘੱਟੋ-ਘੱਟ ਇੱਕ ਸੰਭਵ ਸਥਿਤੀ ਵਿੱਚ ਆਉਂਦੀ ਹੈ ਉਹ ਸੰਭਵ ਹੈ; ਜੋ ਕਿਸੇ ਵੀ ਸਥਿਤੀ ਵਿੱਚ ਨਹੀਂ ਆਉਂਦੀ ਉਹ ਅਸੰਭਵ ਹੈ।"),
      localeText(locale, "हर स्थिति में गिनी जाने वाली श्रेणी एक ही रखें।", "ਹਰ ਸਥਿਤੀ ਵਿੱਚ ਗਿਣੀ ਜਾਣ ਵਾਲੀ ਸ਼੍ਰੇਣੀ ਇੱਕੋ ਰੱਖੋ।"),
    ];
    case "RESOLVE_COUNT_DETERMINACY": return [
      localeText(locale, "हर संभव स्थिति में मांगी गई संख्या अलग से निकालें।", "ਹਰ ਸੰਭਵ ਸਥਿਤੀ ਵਿੱਚ ਮੰਗੀ ਗਿਣਤੀ ਵੱਖਰੇ ਤੌਰ ’ਤੇ ਕੱਢੋ।"),
      localeText(locale, "सभी संभव स्थितियों में एक ही संख्या आए तभी सटीक संख्या निश्चित है; अलग संख्याएँ आएँ तो निर्धारित नहीं किया जा सकता।", "ਸਾਰੀਆਂ ਸੰਭਵ ਸਥਿਤੀਆਂ ਵਿੱਚ ਇੱਕੋ ਗਿਣਤੀ ਆਵੇ ਤਾਂ ਹੀ ਸਟੀਕ ਗਿਣਤੀ ਨਿਸ਼ਚਿਤ ਹੈ; ਵੱਖਰੀਆਂ ਗਿਣਤੀਆਂ ਆਉਣ ਤਾਂ ਨਿਰਧਾਰਤ ਨਹੀਂ ਕੀਤਾ ਜਾ ਸਕਦਾ।"),
    ];
  }
}

export function localizedShortcut(authority: BlrCp005Authority, locale: BlrCp005TranslatedLocale): string {
  if (authority.includes("COUNT")) return localeText(locale, "हर संभव स्थिति की संख्या एक पंक्ति में लिखें; फिर न्यूनतम, अधिकतम, संभवता या समानता सीधे पढ़ें।", "ਹਰ ਸੰਭਵ ਸਥਿਤੀ ਦੀ ਗਿਣਤੀ ਇੱਕ ਕਤਾਰ ਵਿੱਚ ਲਿਖੋ; ਫਿਰ ਘੱਟੋ-ਘੱਟ, ਵੱਧ ਤੋਂ ਵੱਧ, ਸੰਭਾਵਨਾ ਜਾਂ ਸਮਾਨਤਾ ਸਿੱਧੀ ਪੜ੍ਹੋ।");
  if (authority.includes("PERSON")) return localeText(locale, "हर उम्मीदवार के लिए एक कॉलम बनाएं और जिस स्थिति में वह भूमिका निभाता है वहाँ ✓ लगाएं।", "ਹਰ ਉਮੀਦਵਾਰ ਲਈ ਇੱਕ ਕਾਲਮ ਬਣਾਓ ਅਤੇ ਜਿਸ ਸਥਿਤੀ ਵਿੱਚ ਉਹ ਭੂਮਿਕਾ ਨਿਭਾਉਂਦਾ ਹੈ ਉੱਥੇ ✓ ਲਗਾਓ।");
  return localeText(locale, "तीन-स्थिति तालिका रखें: सभी स्थितियाँ = निश्चित, कुछ स्थितियाँ = संभव, कोई स्थिति नहीं = असंभव।", "ਤਿੰਨ-ਸਥਿਤੀ ਸਾਰਣੀ ਰੱਖੋ: ਸਾਰੀਆਂ ਸਥਿਤੀਆਂ = ਨਿਸ਼ਚਿਤ, ਕੁਝ ਸਥਿਤੀਆਂ = ਸੰਭਵ, ਕੋਈ ਸਥਿਤੀ ਨਹੀਂ = ਅਸੰਭਵ।");
}
