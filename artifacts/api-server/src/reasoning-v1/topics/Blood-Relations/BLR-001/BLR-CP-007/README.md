...
- Redundant learner-facing labels such as `marriage-based relation` and `blood-based route` are removed; useful spouse/parent/sibling ordering guidance is retained in plain language.
...
redundant relation qualifiers                 0
...
average displayed key size                 5.161
QL-034 maximum statements                      7
QL-034 average statements                  6.375
```
...
- `cp007-editorial-v4-wave3-final.ts` — approved final wording, key trimming and learner-facing polish;
- `cp007-editorial-v4-wave3-final.test.ts` — complete semantic/editorial and approved-wording contract;
