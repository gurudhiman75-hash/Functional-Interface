import { absoluteJourneyPa, absoluteLegJourneyPa, advancedJourneyPa, asR, canonicalTurnLinkPa, coordinateTextPa, directionPa, metresPa, namePa, placePa, relationSentencePa, walkVerbPa, type R } from "./punjabi-foundation";
...
export function renderPunjabiStem036To044(english: R): string | null {
  ...
  switch (qlId) {
    ...
    case "DIR-QL-038":
      return `${placePa(s.place)} ਵਿੱਚ ਚਾਲ ਇੱਕ ਨਿਸ਼ਾਨ ਲੱਗੇ ਬਿੰਦੂ ਤੋਂ ਸ਼ੁਰੂ ਹੁੰਦੀ ਹੈ। ${absoluteLegJourneyPa(s.legs ?? [], s.subject)} ਅੰਤਿਮ ਬਿੰਦੂ ਸ਼ੁਰੂਆਤੀ ਬਿੰਦੂ ਤੋਂ ${coordinateTextPa(s.target)} ਹੈ। ਜਿਸ ਚਾਲ ਦੀ ਦਿਸ਼ਾ ਨਹੀਂ ਦਿੱਤੀ ਗਈ, ਉਹ ਕਿਹੜੀ ਸੀ?`;
    case "DIR-QL-039": {
    ...
    case "DIR-QL-040":
      return `${placePa(s.place)} ਵਿੱਚ ${namePa(s.subject)} ਇੱਕ ਨਿਸ਼ਾਨ ਲੱਗੇ ਬਿੰਦੂ ਤੋਂ ਚੱਲਣਾ ਸ਼ੁਰੂ ਕਰਦਾ ਹੈ। ${advancedJourneyPa(s.operations ?? [], s.subject)} ਅੰਤਿਮ ਬਿੰਦੂ ਸ਼ੁਰੂਆਤੀ ਬਿੰਦੂ ਤੋਂ ${coordinateTextPa(s.target)} ਹੈ। ਦੱਸੋ, ਸ਼ੁਰੂ ਵਿੱਚ ਉਸ ਦਾ ਮੂੰਹ ਕਿਹੜੀ ਦਿਸ਼ਾ ਵੱਲ ਸੀ?`;
    case "DIR-QL-041": {
    ...
    case "DIR-QL-042":
      return `${placePa(s.place)} ਵਿੱਚ ${namePa(s.subject)} ਚੌਕੀ ${s.checkpoint} ਤੋਂ ਚੱਲਣਾ ਸ਼ੁਰੂ ਕਰਦਾ ਹੈ ਅਤੇ ਸ਼ੁਰੂ ਵਿੱਚ ਉਸ ਦਾ ਮੂੰਹ ${directionPa(s.initialFacing)} ਦਿਸ਼ਾ ਵੱਲ ਹੈ। ${advancedJourneyPa(s.operations ?? [], s.subject)} ਅੰਤਿਮ ਬਿੰਦੂ ਚੌਕੀ ਤੋਂ ਕਿਹੜੀ ਦਿਸ਼ਾ ਵੱਲ ਹੈ?`;
    case "DIR-QL-043":
      return `${placePa(s.place)} ਵਿੱਚ ${namePa(s.subject)} ਚੌਕੀ ${s.checkpoint} ਤੋਂ ਚੱਲਣਾ ਸ਼ੁਰੂ ਕਰਦਾ ਹੈ ਅਤੇ ਸ਼ੁਰੂ ਵਿੱਚ ਉਸ ਦਾ ਮੂੰਹ ${directionPa(s.initialFacing)} ਦਿਸ਼ਾ ਵੱਲ ਹੈ। ${advancedJourneyPa(s.operations ?? [], s.subject)} ਅੰਤਿਮ ਬਿੰਦੂ ਅਤੇ ਚੌਕੀ ਵਿਚਕਾਰ ਸਭ ਤੋਂ ਘੱਟ ਦੂਰੀ ਕਿੰਨੀ ਹੈ?`;
    case "DIR-QL-044":
