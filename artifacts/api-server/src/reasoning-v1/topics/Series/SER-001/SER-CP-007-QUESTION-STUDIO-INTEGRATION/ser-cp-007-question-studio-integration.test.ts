...
assert.equal(ACTIVATION.sourceReviewAuthorityId, SER_001_QUESTION_STUDIO_REVIEW_PACKAGE.integrationAuthority);
...
assert.equal(ACTIVATION.activationScope, "QUESTION_STUDIO_QUESTION_BANK_AND_INTERNAL_TEST_BUILDER");
...
assert.doesNotMatch(seriesRoute, /SER-CP-008|SER-CP-009|SER-QL-0(?:1[4-9]|2\d|3\d|4[0-2])/);
...
console.log(JSON.stringify({
  ...
  packageId: "SER-001",
  runtimeMode: "FROZEN_REVIEW_WITH_APPROVED_INTERNAL_ACTIVATION",
