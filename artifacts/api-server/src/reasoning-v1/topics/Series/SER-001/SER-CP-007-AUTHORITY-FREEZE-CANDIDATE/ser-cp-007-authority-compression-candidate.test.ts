...
assert.equal(candidateAuthorityIds.size, 14);
...
assert.equal(templateCounts.size, 14);
...
console.log(
  JSON.stringify(
    {
      status: "PASS_SER_CP007_AUTHORITY_COMPRESSION_CANDIDATE_17_TO_14",
      ...
      candidateSummary,
      permanentQls: 0,
      compressionDecision: "PROVISIONAL_PENDING_FULL_MANUAL_REVIEW",
