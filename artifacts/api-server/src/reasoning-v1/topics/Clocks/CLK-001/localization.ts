...
function makeLocalizedSurface(
  ...
  switch (task) {
    ...
    case 'GAP_BETWEEN_SPECIAL_EVENTS':
      return surface(
        '12:00 पर सुइयाँ एक-दूसरे पर हैं। अगली बार उनके विपरीत होने तक कितना समय लगेगा?',
        '12:00 ਉੱਤੇ ਸੂਈਆਂ ਇੱਕ-ਦੂਜੇ ਉੱਤੇ ਹਨ। ਅਗਲੀ ਵਾਰ ਉਹਨਾਂ ਦੇ ਵਿਰੁੱਧ ਹੋਣ ਤੱਕ ਕਿੰਨਾ ਸਮਾਂ ਲੱਗੇਗਾ?',
        'मिलने और विपरीत होने की घटनाएँ सापेक्ष कोण से निकलती हैं।',
        'ਮਿਲਣ ਅਤੇ ਵਿਰੁੱਧ ਹੋਣ ਦੀਆਂ ਘਟਨਾਵਾਂ ਸਾਪੇਖ ਕੋਣ ਤੋਂ ਨਿਕਲਦੀਆਂ ਹਨ।',
        ['12:00 से अगली 180° स्थिति तक का अंतर निकालें।', 'समय = ' + a + '।'],
        ['12:00 ਤੋਂ ਅਗਲੀ 180° ਸਥਿਤੀ ਤੱਕ ਦਾ ਅੰਤਰ ਕੱਢੋ।', 'ਸਮਾਂ = ' + a + '।'],
      );
