...
export function intendedRearrangementMatch(
  ...
  return match.checkpointId === "COD-CP-005"
    && match.ruleId === ruleId
    && sameRearrangementContext(match.context as CodCp005RuleContext, context);
}
