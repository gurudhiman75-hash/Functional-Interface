...
assert.ok((difficulties.get("EASY") ?? 0) / generated >= 0.12 && (difficulties.get("EASY") ?? 0) / generated <= 0.40);
assert.ok((difficulties.get("MEDIUM") ?? 0) / generated >= 0.45 && (difficulties.get("MEDIUM") ?? 0) / generated <= 0.80);
assert.ok((difficulties.get("HARD") ?? 0) / generated >= 0.05 && (difficulties.get("HARD") ?? 0) / generated <= 0.25);
