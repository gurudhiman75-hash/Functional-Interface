...
const PATTERNS: Readonly<Record<SentenceCodeTopologyKind, TopologyPattern>> = {
  ...
  FORKED_EVIDENCE_JOIN: {
    ...
    rowCount: 4,
    roles: [
      { role: "TARGET", mask: 0b0101 },
      { role: "SHARED_A", mask: 0b0111 },
      { role: "SHARED_B", mask: 0b1101 },
      { role: "ROW_1_ONLY", mask: 0b0001 },
      { role: "ROW_2_ONLY", mask: 0b0010 },
      { role: "ROW_3_ONLY", mask: 0b0100 },
      { role: "ROW_4_ONLY", mask: 0b1000 },
    ],
    targetRole: "TARGET",
    expectedSolutionCount: 1,
    expectedQueryDomainSize: 1,
