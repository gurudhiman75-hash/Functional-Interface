...
export const ENGLISH_SENTENCE_CODE_FRAMES: readonly EnglishSentenceCodeFrame[] = [
  ...
  {
    id: "FORKED-THREE-ITEM-LIST",
    topologyKind: "FORKED_EVIDENCE_JOIN",
    grammarFamily: "LIST",
    rowTemplates: {
      r1: "{MISSING_ROW_2}, {MISSING_ROW_3} {TARGET} {MISSING_ROW_4}",
      r2: "{MISSING_ROW_1}, {MISSING_ROW_3} {TARGET} {MISSING_ROW_4}",
      r3: "{MISSING_ROW_1}, {MISSING_ROW_2} {TARGET} {MISSING_ROW_4}",
      r4: "{MISSING_ROW_1}, {MISSING_ROW_2} {TARGET} {MISSING_ROW_3}",
    },
    status: "REVIEWED",
  },
  {
