...
export const ENGLISH_SENTENCE_CODE_LEXEMES: readonly EnglishSentenceCodeLexeme[] = [
  ...
  verb("play", "transitive_or_intransitive", "action"),
  noun("games", "plural", "activity", "object"),
  ...
  noun("skills", "plural", "ability", "object"),
  ...
  adverb("high", "manner"),
  verb("practise", "transitive_or_intransitive", "action"),
