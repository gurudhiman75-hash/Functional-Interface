...
export const STA_V41_CONTEXTS: readonly StaV41Context[] = Object.freeze([
  ctx("EXAM-ENTRY", "SSC", "Easy", "EXAM_ADMINISTRATION",
    ...
    lt("long entry queues", "लंबी प्रवेश कतारें", "ਲੰਬੀਆਂ ਦਾਖਲਾ ਕਤਾਰਾਂ"),
  ...
  ctx("BANK-ROUTINE", "BANKING", "Medium", "BANKING_SERVICE",
    ...
    lt("fewer repeat visits", "कम दोबारा विज़िट", "ਘੱਟ ਦੁਬਾਰਾ ਦੌਰੇ"),
  ...
  ctx("DISTRICT-CERTIFICATE", "PUNJAB_STATE", "Easy", "PUBLIC_CERTIFICATE",
    ...
    lt("fewer incomplete submissions", "कम अधूरे आवेदन", "ਘੱਟ ਅਧੂਰੀਆਂ ਅਰਜ਼ੀਆਂ"),
  ...
  ctx("HR-LEAVE", "CROSS_EXAM_DISCOVERY", "Medium", "WORKPLACE_HR",
    ...
    lt("quicker request processing", "तेज़ अनुरोध प्रक्रिया", "ਤੇਜ਼ ਬੇਨਤੀ ਕਾਰਵਾਈ"),
  ...
  ctx("HOSPITAL-APPOINTMENT", "CROSS_EXAM_DISCOVERY", "Hard", "HEALTH_APPOINTMENT",
    ...
    lt("fewer missed appointments", "कम छूटे अपॉइंटमेंट", "ਘੱਟ ਖੁੰਝੀਆਂ ਮੁਲਾਕਾਤਾਂ"),
  ...
  ctx("RAILWAY-ENQUIRY", "SSC", "Medium", "RAILWAY_SERVICE",
    ...
    lt("additional self-service kiosks", "अतिरिक्त स्व-सेवा कियोस्क", "ਵਾਧੂ ਸਵੈ-ਸੇਵਾ ਕਿਓਸਕ"),
  ...
  ctx("SCHOLARSHIP-FORM", "PUNJAB_STATE", "Hard", "EDUCATION_BENEFIT",
    ...
    lt("fewer document-related rejections", "कम दस्तावेज़-संबंधी अस्वीकृतियां", "ਘੱਟ ਦਸਤਾਵੇਜ਼-ਸਬੰਧੀ ਰੱਦਗੀਆਂ"),
  ...
  ctx("LOAN-VERIFICATION", "BANKING", "Hard", "LOAN_PROCESSING",
    ...
    lt("verification backlogs", "सत्यापन लंबित कार्य", "ਤਸਦੀਕ ਬਕਾਇਆ ਕੰਮ"),
  ...
  ctx("WATER-COMPLAINT", "PUNJAB_STATE", "Medium", "MUNICIPAL_SERVICE",
    ...
    lt("automatic complaint-ticket numbers", "स्वचालित शिकायत टिकट नंबर", "ਆਟੋਮੈਟਿਕ ਸ਼ਿਕਾਇਤ ਟਿਕਟ ਨੰਬਰ"),
  ...
  ctx("WAREHOUSE-DISPATCH", "CROSS_EXAM_DISCOVERY", "Hard", "LOGISTICS",
    ...
    lt("misrouted packages", "गलत मार्ग पर भेजे पैकेज", "ਗਲਤ ਰੂਟ ਭੇਜੇ ਪੈਕੇਜ"),
    lt("route-code validation", "रूट-कोड सत्यापन", "ਰੂਟ-ਕੋਡ ਤਸਦੀਕ"),
    lt("fewer routing errors", "कम रूटिंग त्रुटियां", "ਘੱਟ ਰੂਟਿੰਗ ਗਲਤੀਆਂ"),
  ...
  ctx("SCHOOL-ATTENDANCE", "SSC", "Easy", "SCHOOL_ADMINISTRATION",
    ...
    lt("late attendance compilation", "उपस्थिति संकलन में देरी", "ਹਾਜ਼ਰੀ ਇਕੱਠੀ ਕਰਨ ਵਿੱਚ ਦੇਰੀ"),
    lt("classroom attendance syncing", "कक्षा उपस्थिति सिंकिंग", "ਕਲਾਸ ਹਾਜ਼ਰੀ ਸਿੰਕਿੰਗ"),
    lt("quicker attendance compilation", "तेज़ उपस्थिति संकलन", "ਤੇਜ਼ ਹਾਜ਼ਰੀ ਇਕੱਠ"),
  ...
  ctx("FRAUD-ALERT", "BANKING", "Medium", "DIGITAL_PAYMENTS",
    ...
    lt("delayed fraud reports", "धोखाधड़ी रिपोर्ट में देरी", "ਧੋਖਾਧੜੀ ਰਿਪੋਰਟਾਂ ਵਿੱਚ ਦੇਰੀ"),
  ...
  ctx("LIBRARY-MEMBERSHIP", "CROSS_EXAM_DISCOVERY", "Easy", "LIBRARY_SERVICE",
    ...
    lt("the library web portal", "पुस्तकालय वेब पोर्टल", "ਲਾਇਬ੍ਰੇਰੀ ਵੈੱਬ ਪੋਰਟਲ"),
  ...
  ctx("RECRUITMENT-INTERVIEW", "SSC", "Hard", "RECRUITMENT",
    ...
    lt("unused interview slots", "खाली रह जाने वाले साक्षात्कार स्लॉट", "ਖਾਲੀ ਰਹਿ ਜਾਣ ਵਾਲੇ ਇੰਟਰਵਿਊ ਸਲਾਟ"),
  ...
  ctx("INSURANCE-CLAIM", "BANKING", "Easy", "INSURANCE_SERVICE",
    ...
    lt("document-category prompts", "दस्तावेज़ श्रेणी संकेत", "ਦਸਤਾਵੇਜ਼ ਸ਼੍ਰੇਣੀ ਸੰਕੇਤ"),
  ...
  ctx("BUS-PASS", "PUNJAB_STATE", "Medium", "PUBLIC_TRANSPORT",
    ...
    lt("renewal-office queues", "नवीनीकरण कार्यालय की कतारें", "ਨਵੀਨੀਕਰਨ ਦਫ਼ਤਰ ਕਤਾਰਾਂ"),
    lt("online document pre-check", "ऑनलाइन दस्तावेज़ पूर्व-जांच", "ਆਨਲਾਈਨ ਦਸਤਾਵੇਜ਼ ਪਹਿਲਾਂ-ਜਾਂਚ"),
    lt("shorter renewal visits", "कम समय वाले नवीनीकरण दौरे", "ਛੋਟੇ ਨਵੀਨੀਕਰਨ ਦੌਰੇ"),
  ...
  ctx("SUPPORT-TICKET", "CROSS_EXAM_DISCOVERY", "Medium", "CUSTOMER_SUPPORT",
    ...
    lt("support requests", "सहायता अनुरोध", "ਮਦਦ ਬੇਨਤੀਆਂ"),
    lt("the support ticket portal", "सहायता टिकट पोर्टल", "ਮਦਦ ਟਿਕਟ ਪੋਰਟਲ"),
    lt("duplicate support tickets", "दोहराए गए सहायता टिकट", "ਦੁਹਰਾਏ ਮਦਦ ਟਿਕਟ"),
