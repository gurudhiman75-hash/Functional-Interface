...
assert.equal(STA_001_CHAPTER_REOPEN_V4.contentAuthority.candidateAuthoritiesPerScenario, 7);
assert.equal(STA_001_CHAPTER_REOPEN_V4.contentAuthority.requiredDependencyAuthoritiesPerScenario, 3);
assert.equal(STA_001_CHAPTER_REOPEN_V4.contentAuthority.subtleDistractorAuthoritiesPerScenario, 4);
...
assert.equal(STA_001_CHAPTER_REOPEN_V4.contentAuthority.antiCardinalityGateRequired, true);
