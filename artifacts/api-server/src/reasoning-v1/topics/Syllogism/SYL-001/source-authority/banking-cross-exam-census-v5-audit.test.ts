...
assert.equal(SYL_BANKING_CROSS_EXAM_CENSUS_V5.independentlyCountCorroboratedCompleteOfficerLevelShiftCount, 1);

assert.equal(SYL_BANKING_CROSS_EXAM_RRB_PO_2024_08_04_S4_V5.reportedSyllogismCount, 4);
assert.equal(SYL_BANKING_CROSS_EXAM_RRB_PO_2024_08_04_S4_V5.countSources.length, 1);
assert.equal(SYL_BANKING_CROSS_EXAM_RRB_PO_2024_08_04_S4_V5.exactCountIndependentlyCorroborated, false);
...
assert.equal(SYL_BANKING_CROSS_EXAM_RRB_PO_2024_08_04_S4_V5.recoveryStatus, "ARCHIVE_COMPLETE_FOUR_OF_FOUR_SINGLE_COUNT_SOURCE");
