...
- official-paper reproductions of three-action combination questions;
- single-best-action boundary evidence recorded and excluded from core COA;
- dedicated exclusive-either authorities with `MUTUALLY_EXCLUSIVE_ALTERNATIVES` relation;
- dedicated three-action semantic authorities with independent I/II/III evaluation;
- five-code renderer that never maps ordinary independent authorities to `Either`;
- three-action combination renderer with authored option masks;
- additive preservation of all CP001–CP007 English authority;
...
- `THREE_ACTION_COMBINATION`: source-supported core variant;
- `SINGLE_BEST_ACTION`: excluded to Decision Making / situational judgment boundary.
