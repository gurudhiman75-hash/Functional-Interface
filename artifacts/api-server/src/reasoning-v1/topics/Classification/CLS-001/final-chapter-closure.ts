...
export const CLS001_FINAL_CHAPTER_CLOSURE = {
  ...
  checkpoints: [
    ...
    },
    {
      ...
      englishAuthority: "FROZEN_ENGLISH_RUNTIME_PROOF",
      nativeAuthority: "MULTILINGUAL_REVIEW_FROZEN",
      learnerSurfaceAuthority: "V3_REVIEW_FROZEN",
    },
    {
  ...
  lifecycle: {
    ...
    questionStudioIntegrationAuthorized: false,
  ...
  reopenOnlyFor: [
    ...
    "RENDERING_DEFECT",
    "EXPLICIT_PRODUCT_INTEGRATION_AUTHORIZATION",
  ],
} as const;
