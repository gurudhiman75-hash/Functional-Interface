...
export const RNK_CP005_PERMANENT_RUNTIME_VERSION = "RNK_CP005_PERMANENT_RUNTIME_V2" as const;
export const RNK_CP005_ENGLISH_DISCOVERY_FREEZE_VERSION = "RNK_CP005_ENGLISH_REASONING_REMODEL_FREEZE_V2" as const;
export const RNK_CP005_EXPECTED_PROJECTION_SHA256 = "8ab6d6ab6965aec6be32753bec5d7f083f2b1b03810609b1b2bb40ea02ae8822" as const;
...
export type RnkCp005PermanentQuestion = Omit<
  ...
  "permanentQlId" | "reviewMetadata"
> & {
  readonly permanentQlId: RnkCp005PermanentQlId;
  readonly reviewMetadata: RnkCp005ReasoningQuestion["reviewMetadata"] & {
...
function projectionRecord(question: RnkCp005PermanentQuestion): unknown {
  return {
    ...
    reasoningVersion: question.sharedPassage.reasoningVersion,
    evidenceMode: question.sharedPassage.evidenceMode,
    directRankExposure: question.sharedPassage.directRankExposure,
    ...
    reasoningClues: question.sharedPassage.reasoningClues,
    stem: question.stem,
