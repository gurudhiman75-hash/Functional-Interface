...
export const STC_001_MANIFEST = {
  ...
  qlIds: STC_QL_IDS,
  checkpoints: [
    { checkpointId: "STC-CP-001", qlIds: ["STC-QL-001", "STC-QL-002"], status: "IMPLEMENTED_REVIEW_CANDIDATE_V1" },
    { checkpointId: "STC-CP-002", qlIds: ["STC-QL-003", "STC-QL-004"], status: "RESERVED" },
