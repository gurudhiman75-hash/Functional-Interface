import { WOR_001_CHECKPOINTS, WOR_001_PROTOTYPES, worPrototypesForCheckpoint } from "./prototype-registry";
...
export const WOR_001_QUESTION_STUDIO_ADAPTER = {
  ...
  permanentQlCount: 0,
  checkpoints: WOR_001_CHECKPOINTS,
  ...
  listPrototypes(checkpointId?: WorCheckpointId) {
    return checkpointId ? worPrototypesForCheckpoint(checkpointId) : WOR_001_PROTOTYPES;
  },
