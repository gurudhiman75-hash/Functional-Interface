...
const caselets = generateLp011BatchStabilizedV1_3("lp-011-human-review-v1-3", 12);

console.log("# LP-011 — Box-and-Attribute Stack Puzzle — English Review V1.3\n");
console.log("Candidate QLs: `LP-QL-041..044`  ");
console.log("Status: **HUMAN REVIEW ONLY — NOT PERMANENTLY ALLOCATED**\n");
console.log("V1.3 keeps V1.2 solver semantics and difficulty topology, while normalizing learner-facing terminology and removing machine-like setup wording.\n");
