...
| LP-CP-009 | Month-based and year-based scheduling | `LP-QL-033..036` permanent; English V1 frozen from approved V2 review; runtime/localization/release remain locked |
