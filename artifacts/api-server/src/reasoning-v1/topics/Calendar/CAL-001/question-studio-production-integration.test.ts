...
assert.match(route, /CAL_001_PRODUCTION_RELEASE\.questionBankStatus/);
assert.match(route, /CAL_001_PRODUCTION_RELEASE\.testEligibility/);
assert.match(route, /CAL_001_PRODUCTION_RELEASE\.publiclyPublishable/);
assert.match(route, /CAL_001_PRODUCTION_RELEASE\.mockTestEligible/);
