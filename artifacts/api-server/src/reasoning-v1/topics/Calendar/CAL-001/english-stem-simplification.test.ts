...
const REQUIRED_PATTERNS: Partial<Record<CalendarPrototypeId, RegExp>> = {
  ...
  "CAL-PQL-025": /^How many odd days are there from year 1 to year \d+ in the Gregorian calendar\?$/,
  ...
  "CAL-PQL-032": /^Do \d{4} and \d{4} have the same calendar\? Choose the correct reason\.$/,
