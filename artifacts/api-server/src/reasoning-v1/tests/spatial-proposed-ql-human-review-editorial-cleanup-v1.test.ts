...
console.log(JSON.stringify({status:"PASS_SPA_FND_001_PROPOSED_QL_HUMAN_REVIEW_EDITORIAL_CLEANUP_V1",numericOptionLanguageRemoved:true,reviewerJargonRemoved:true,renderedOptionCaptionsLettered:true},null,2));
