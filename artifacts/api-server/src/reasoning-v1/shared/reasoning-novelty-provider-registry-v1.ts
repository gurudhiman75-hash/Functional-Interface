...
export const REASONING_V1_NOVELTY_PROVIDERS_V1: readonly ReasoningNoveltyProviderDescriptorV1[] = [
  ...
  {
    providerId: "LP-001-POST-SOLUTION-SWAP",
    chapterId: "LP-001",
    ...
    generatorModule: "../topics/Logic-Puzzles/LP-001/lp-001-controlled-novelty-discovery-v1",
    generatorExport: "generateLpControlledNovelPostSolutionSwapCandidateV1",
    supportedLanguages: ["en"],
    permanentQlAllocationRequired: false,
