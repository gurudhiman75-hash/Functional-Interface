...
body{font-family:Arial,sans-serif;margin:0;background:#f3f4f6;color:#181818}main{max-width:1180px;margin:auto;padding:24px}.summary{background:#fff;border:1px solid #ddd;border-radius:10px;padding:14px;margin-bottom:20px}.card{background:#fff;border:1px solid #d8d8d8;border-radius:10px;padding:16px;margin:0 0 18px}.meta{font-size:12px;color:#5a5a5a}.stem{font-size:15px}.strip{display:flex;flex-wrap:wrap;gap:12px;align-items:flex-start}.figure{width:128px;border:1px solid #ddd;border-radius:8px;padding:6px;text-align:center;background:#fff}.figure svg{display:block;width:100%;height:auto}.cap{font-size:11px;color:#666;margin-bottom:3px}.explanation{background:#fafafa;border-left:3px solid #bbb;padding:8px 12px;margin-top:10px}.explanation p{margin:6px 0}h2{font-size:18px}h3{font-size:14px;margin-bottom:7px}@media(max-width:520px){main{padding:10px}.card{padding:10px}.figure{width:104px}.stem{font-size:14px}.explanation{font-size:13px}}
