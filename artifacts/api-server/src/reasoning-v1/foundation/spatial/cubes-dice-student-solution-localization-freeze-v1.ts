...
function replacementsFor(language: CubesDiceStudentSolutionLanguageV1): readonly (readonly [string, string])[] {
  if (language === "hi") {
    return Object.freeze([
      ...
      ["आधार का हर गैर-खाली स्थान ऊपर से एक वर्ग देता है।", "जिस आधार-स्थान पर घनों का खड़ा ढेर मौजूद है, वह ऊपर से एक वर्ग देता है।"],
  ...
  if (language === "pa") {
    return Object.freeze([
      ...
      ["ਅਧਾਰ ਦੀ ਹਰ ਗੈਰ-ਖਾਲੀ ਥਾਂ ਉੱਪਰੋਂ ਇੱਕ ਵਰਗ ਦਿੰਦੀ ਹੈ।", "ਜਿਸ ਅਧਾਰ-ਥਾਂ ਉੱਤੇ ਘਣਾਂ ਦਾ ਖੜ੍ਹਾ ਢੇਰ ਮੌਜੂਦ ਹੈ, ਉਹ ਉੱਪਰੋਂ ਇੱਕ ਵਰਗ ਦਿੰਦਾ ਹੈ।"],
