...
const HI_STEMS = Object.freeze([
  ...
  "किस विकल्प में प्रश्न-आकृति बिना घुमाए उसके एक भाग के रूप में मौजूद है?",
  ...
  "किस विकल्प में दी गई आकृति ठीक एक भाग के रूप में छिपी है? आकृति को घुमाना नहीं है।",
...
const PA_STEMS = Object.freeze([
  ...
  "ਕਿਹੜੇ ਵਿਕਲਪ ਵਿੱਚ ਪ੍ਰਸ਼ਨ-ਆਕ੍ਰਿਤੀ ਬਿਨਾਂ ਘੁਮਾਏ ਉਸਦਾ ਹਿੱਸਾ ਬਣਦੀ ਹੈ?",
  ...
  "ਕਿਹੜੇ ਵਿਕਲਪ ਵਿੱਚ ਦਿੱਤੀ ਆਕ੍ਰਿਤੀ ਠੀਕ ਇੱਕ ਹਿੱਸੇ ਵਜੋਂ ਲੁਕੀ ਹੋਈ ਹੈ? ਆਕ੍ਰਿਤੀ ਨੂੰ ਘੁਮਾਉਣਾ ਨਹੀਂ ਹੈ।",
...
function hiExplanation(question: EmbeddedFigurePermanentEnglishQuestionV1) {
  ...
  return Object.freeze({
    ...
    application: `विकल्प ${question.answer} में सभी आवश्यक रेखाएँ और जोड़ एक ही समान अनुपात में सही बने हुए हैं। बाकी विकल्पों में ${traps.join(", ")}।`,
...
function paExplanation(question: EmbeddedFigurePermanentEnglishQuestionV1) {
  ...
  return Object.freeze({
    ...
    application: `ਵਿਕਲਪ ${question.answer} ਵਿੱਚ ਸਾਰੀਆਂ ਲੋੜੀਂਦੀਆਂ ਰੇਖਾਵਾਂ ਅਤੇ ਜੋੜ ਇੱਕੋ ਸਮਾਨ ਅਨੁਪਾਤ ਵਿੱਚ ਠੀਕ ਹਨ। ਬਾਕੀ ਵਿਕਲਪਾਂ ਵਿੱਚ ${traps.join(", ")}।`,
