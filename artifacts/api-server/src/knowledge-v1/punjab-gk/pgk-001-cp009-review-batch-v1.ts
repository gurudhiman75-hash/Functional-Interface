...
const rows: readonly Row[] = [
  ...
  ["Easy", "Which Punjab town is a major secondary-steel cluster?", ["Mandi Gobindgarh", "Abohar", "Pathankot", "Kapurthala"], "Mandi Gobindgarh", "Mandi Gobindgarh is one of Punjab's oldest secondary-steel clusters.", ["centre-mandi-gobindgarh-secondary-steel"], [S.punjabIndustryPolicy, S.mandiGobindgarhPlan]],
  ...
  ["Easy", "Mandi Gobindgarh is a major centre for which industry?", ["Secondary steel", "Sports goods", "Dairy processing", "Petroleum refining"], "Secondary steel", "Mandi Gobindgarh is one of Punjab's oldest secondary-steel clusters.", ["centre-mandi-gobindgarh-secondary-steel"], [S.punjabIndustryPolicy]],
