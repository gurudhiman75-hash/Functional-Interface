...
const rowsByQl: Record<keyof typeof PGK_001_CP003_QL_NAMES, readonly Row[]> = {
  ...
  "PGK-001-QL-016": [
    ...
    },
    {
      ...
      explanation: "Punjab's relief generally rises toward the northeast and falls toward the southwest. The state profile gives roughly 180 metres in the southwest and over 500 metres near the northeast border.",
      factIds: ["punjab-elevation-profile"],
      sourceIds: [PGK_001_CP003_SOURCE_IDS.knowPunjab],
    },
    {
  ...
  "PGK-001-QL-018": [
    ...
    },
    {
      ...
      explanation: "Kandi is linked with the Shivalik foothill belt. The other three options mix Punjab regions with landforms that do not describe them.",
      factIds: ["pau-kandi-shivalik"],
      sourceIds: [PGK_001_CP003_SOURCE_IDS.pauKandi],
    },
  ],
  "PGK-001-QL-019": [
    ...
    {
      difficulty: "Medium",
      stem: "Flooding can renew the Ghaggar floodplain soil mainly through the deposition of:",
      canonical: "Silt",
  ...
  "PGK-001-QL-020": [
    ...
    },
    {
      ...
      explanation: "Punjab rises toward the Shivalik side in the northeast and opens into broad alluvial plains. Elevation generally decreases toward the southwest.",
      factIds: ["punjab-elevation-profile", "pau-kandi-shivalik", "punjab-indo-gangetic-plain"],
      sourceIds: [PGK_001_CP003_SOURCE_IDS.knowPunjab, PGK_001_CP003_SOURCE_IDS.pauKandi, PGK_001_CP003_SOURCE_IDS.fatehgarhPlan],
    },
  ],
