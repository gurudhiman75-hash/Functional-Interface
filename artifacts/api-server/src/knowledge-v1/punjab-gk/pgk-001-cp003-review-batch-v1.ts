...
const rowsByQl: Record<keyof typeof PGK_001_CP003_QL_NAMES, readonly Row[]> = {
  ...
  "PGK-001-QL-016": [
    ...
    },
    {
      ...
      explanation: "Punjab's relief rises toward the northeast and falls toward the southwest. The state profile gives roughly 180 metres in the southwest and over 500 metres near the northeast border.",
      factIds: ["punjab-elevation-profile"],
      sourceIds: [PGK_001_CP003_SOURCE_IDS.knowPunjab],
    },
    {
  ...
  "PGK-001-QL-020": [
    ...
    },
    {
      ...
      explanation: "Punjab rises toward the Shivalik side in the northeast and opens into broad alluvial plains. Elevation decreases toward the southwest.",
      factIds: ["punjab-elevation-profile", "pau-kandi-shivalik", "punjab-indo-gangetic-plain"],
      sourceIds: [PGK_001_CP003_SOURCE_IDS.knowPunjab, PGK_001_CP003_SOURCE_IDS.pauKandi, PGK_001_CP003_SOURCE_IDS.fatehgarhPlan],
    },
  ],
