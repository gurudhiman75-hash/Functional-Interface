...
const overrides: Readonly<Record<string, Override>> = Object.freeze({
  ...
  "PGK-001-CP004-Q006": {
    ...
    explanation: "Vipasa was the ancient name of the Beas. It is also written as Vipasha.",
  ...
  "PGK-001-CP004-Q012": {
    ...
    explanation: "Chenab was known as Askini in ancient tradition. The name is also written as Asikni.",
  ...
  "PGK-001-CP004-Q040": {
    ...
    explanation: "Jhelum was known as Vitista, also written as Vitasta. Vipasa belongs to Beas, Askini to Chenab and Purushni to Ravi.",
