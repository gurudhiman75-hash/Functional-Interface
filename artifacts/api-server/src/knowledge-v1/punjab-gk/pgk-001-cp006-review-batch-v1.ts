...
const rowsByQl: Record<keyof typeof PGK_001_CP006_QL_NAMES, readonly Row[]> = {
  "PGK-001-QL-035": [
    ...
    {
      difficulty: "Easy",
      stem: "The main rainy season in Punjab extends roughly from:",
  ...
  "PGK-001-QL-036": [
    {
      difficulty: "Easy",
      stem: "Which part of Punjab receives heavier rainfall?",
      ...
      explanation: "Rainfall is heavier near the Himalayan and Shivalik foothills and tends to decrease away from them.",
      factIds: ["rainfall-gradient"], sourceIds: climateSource,
    },
    {
      difficulty: "Easy",
      stem: "Rainfall in Punjab tends to decrease toward the:",
      canonical: "Southwest",
    ...
    },
    {
      ...
      explanation: "The foothill side is wetter, while rainfall tends to decrease toward the southwest.",
      factIds: ["rainfall-gradient"], sourceIds: climateSource,
    },
    {
      difficulty: "Medium",
      stem: "Compared with the foothill side, south-western Punjab is:",
      canonical: "Drier and hotter",
      options: ["Drier and hotter", "Wetter and cooler", "Equally wet and cooler", "Snowier and wetter"],
      explanation: "The southwest lies farther from the foothills and receives less rainfall, with higher heat during summer.",
  ...
  "PGK-001-QL-037": [
    {
      difficulty: "Easy",
      stem: "What is the dominant soil type across Punjab's broad plains?",
    ...
    },
    {
      ...
      explanation: "Bet is a common Punjab term for low-lying river floodplain land associated with newer alluvium.",
      factIds: ["khadar-new-alluvium"], sourceIds: soilSource,
    },
    {
      difficulty: "Medium",
  ...
  "PGK-001-QL-038": [
    {
      difficulty: "Easy",
      stem: "Soils in parts of south-western Punjab can be:",
  ...
  "PGK-001-QL-039": [
    ...
    {
      difficulty: "Easy",
      stem: "Why is salt-affected soil harmful?",
  ...
  "PGK-001-QL-040": [
    ...
    {
      difficulty: "Medium",
      stem: "Contour bunding is useful for:",
