...
const rowsByQl: Record<keyof typeof PGK_001_CP006_QL_NAMES, readonly Row[]> = {
  ...
  "PGK-001-QL-037": [
    ...
    {
      difficulty: "Easy",
      stem: "What does the term Khadar refer to?",
    ...
    },
    {
      ...
      explanation: "Bet is a common Punjab term for low-lying river floodplain land formed from newer alluvium.",
      factIds: ["khadar-new-alluvium"], sourceIds: soilSource,
    },
    {
      difficulty: "Medium",
  ...
  "PGK-001-QL-038": [
    ...
    {
      difficulty: "Medium",
      stem: "Which soil condition is indicated by a pH above 7?",
