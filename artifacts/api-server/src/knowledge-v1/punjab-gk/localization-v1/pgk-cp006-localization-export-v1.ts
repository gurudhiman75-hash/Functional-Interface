...
const corpora = Object.fromEntries(locales.map((locale) => [locale, generatePgkCp006LocalizedReviewV1(locale)])) as
  Record<PgkLocaleV1, ReturnType<typeof generatePgkCp006LocalizedReviewV1>>;

const lines: string[] = [
  "# PGK-001 CP006 — Multilingual Review V1",
  "",
  "Status: REVIEW-READY / AWAITING HUMAN APPROVAL",
  "English authority: PGK-001 CP006 HUMAN APPROVED / FROZEN V2",
...
const outPath = path.join(outDir, "PGK-MULTILINGUAL-V1-CP006-REVIEW.md");
