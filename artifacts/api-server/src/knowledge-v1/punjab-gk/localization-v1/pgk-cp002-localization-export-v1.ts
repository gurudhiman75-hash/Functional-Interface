...
const corpora = Object.fromEntries(locales.map((locale) => [locale, generatePgkCp002LocalizedReviewV1(locale)])) as
  Record<PgkLocaleV1, ReturnType<typeof generatePgkCp002LocalizedReviewV1>>;

const lines: string[] = [
  "# PGK-001 CP002 — Multilingual Review V1",
  "",
  "Status: REVIEW-READY / AWAITING HUMAN APPROVAL",
  "English authority: PGK-001 CP002 HUMAN APPROVED / FROZEN V3",
...
const outPath = path.join(outDir, "PGK-MULTILINGUAL-V1-CP002-REVIEW.md");
