...
const corpora = Object.fromEntries(locales.map((locale) => [locale, generatePgkCp004LocalizedReviewV1(locale)])) as
  Record<PgkLocaleV1, ReturnType<typeof generatePgkCp004LocalizedReviewV1>>;

const lines: string[] = [
  "# PGK-001 CP004 — Multilingual Review V1",
  "",
  "Status: REVIEW-READY / AWAITING HUMAN APPROVAL",
  "English authority: PGK-001 CP004 HUMAN APPROVED / FROZEN V2",
...
const outPath = path.join(outDir, "PGK-MULTILINGUAL-V1-CP004-REVIEW.md");
