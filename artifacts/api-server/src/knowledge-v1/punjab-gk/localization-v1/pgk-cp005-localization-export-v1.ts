...
const corpora = Object.fromEntries(locales.map((locale) => [locale, generatePgkCp005LocalizedReviewV1(locale)])) as
  Record<PgkLocaleV1, ReturnType<typeof generatePgkCp005LocalizedReviewV1>>;

const lines: string[] = [
  "# PGK-001 CP005 — Multilingual Review V1",
  "",
  "Status: REVIEW-READY / AWAITING HUMAN APPROVAL",
  "English authority: PGK-001 CP005 HUMAN APPROVED / FROZEN V1",
...
const outPath = path.join(outDir, "PGK-MULTILINGUAL-V1-CP005-REVIEW.md");
