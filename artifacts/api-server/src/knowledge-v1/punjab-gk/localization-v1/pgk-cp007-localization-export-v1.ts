...
const corpora = Object.fromEntries(locales.map((locale) => [locale, generatePgkCp007LocalizedReviewV1(locale)])) as
  Record<PgkLocaleV1, ReturnType<typeof generatePgkCp007LocalizedReviewV1>>;

const lines: string[] = [
  "# PGK-001 CP007 — Multilingual Review V1",
  "",
  "Status: REVIEW-READY / AWAITING HUMAN APPROVAL",
  "English authority: PGK-001 CP007 HUMAN APPROVED / FROZEN V2",
...
const outPath = path.join(outDir, "PGK-MULTILINGUAL-V1-CP007-REVIEW.md");
