...
const rows: readonly Row[] = [
  ...
  ["Medium", "Banda Singh Bahadur's land policy recognised proprietary rights mainly for:", ["Tillers of the land", "Only Mughal mansabdars", "European trading companies", "Urban guilds"], "Tillers of the land", "His agrarian measures are described as recognising ownership rights of cultivators who tilled the land.", ["banda-zamindari-tiller-rights"], [S.pibBanda, S.censusSangrur]],
