...
Audit branch: `feature/pgk-001-exhaustive-audit-v4`
...
Generic literary placeholders were replaced with concrete institutional authorities:

- Baba Farid literary-history provenance → Punjabi University / Punjabipedia;
- Waris Shah and `Heer` provenance → Punjabi University / Punjabipedia;
- Bhai Vir Singh, `Sundari` and `Rana Surat Singh` provenance → Punjabi University / Punjabipedia;
- Amrita Pritam's `Ajj Aakhaan Waris Shah Nu` provenance → Sahitya Akademi fellowship material.
