...
const rows: readonly Row[] = [
  ...
  ["Medium", "Hyphasis is identified with which modern river?", ["Beas", "Jhelum", "Chenab", "Indus"], "Beas", "The ancient Hyphasis is identified with the Beas River.", ["hyphasis-beas-limit"], [S.britannicaAlexander]],
  ...
  ["Easy", "Chanakya is also known as:", ["Kautilya", "Megasthenes", "Panini", "Asvaghosha"], "Kautilya", "Chanakya is also known as Kautilya and is credited with the Arthashastra.", ["chanakya-kautilya-taxila", "arthashastra-kautilya"], [S.psebClass6]],
