...
const rows: readonly Row[] = [
  ...
  ["Medium", "Hyphasis is identified with which modern river in standard historical geography?", ["Beas", "Jhelum", "Chenab", "Indus"], "Beas", "The ancient Hyphasis is identified with the Beas River in standard historical geography.", ["hyphasis-beas-limit"], [S.britannicaAlexander]],
