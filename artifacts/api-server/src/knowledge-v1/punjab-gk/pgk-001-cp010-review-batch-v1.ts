...
const rows: readonly Row[] = [
  ...
  ["Medium", "Hyphasis is generally identified with which modern river?", ["Beas", "Jhelum", "Chenab", "Indus"], "Beas", "The ancient Hyphasis is generally identified with the Beas River.", ["hyphasis-beas-limit"], [S.britannicaAlexander]],
  ...
  ["Easy", "Chanakya is also known as:", ["Kautilya", "Megasthenes", "Panini", "Asvaghosha"], "Kautilya", "Chanakya is also known as Kautilya and is traditionally credited with the Arthashastra.", ["chanakya-kautilya-taxila", "arthashastra-kautilya"], [S.psebClass6]],
  ...
  ["Medium", "The famous Kushan-period sculptures from Sanghol belong mainly to which school of art?", ["Mathura school", "Pala school", "Chola school", "Mughal school"], "Mathura school", "The carved sculptures from Sanghol show the style of the Mathura school of art.", ["sanghol-mathura-school"], [S.nmaSanghol]],
  ...
  ["Medium", "Sanghol's major Buddhist and artistic phase belongs mainly to which dynasty?", ["Kushan", "Lodi", "Tughlaq", "Sikh Misls"], "Kushan", "Sanghol was a prominent centre of Buddhist architecture and art during the Kushan period.", ["sanghol-kushan-buddhist", "kushan-kanishka"], [S.nmaSanghol]],
  ...
  ["Hard", "Which sequence correctly connects site and historical phase?", ["Rupnagar — Harappan; Sanghol — Kushan Buddhist phase", "Rupnagar — Mughal; Sanghol — Lodi", "Rupnagar — Sikh Misl; Sanghol — Delhi Sultanate", "Rupnagar — British; Sanghol — Mauryan capital"], "Rupnagar — Harappan; Sanghol — Kushan Buddhist phase", "Rupnagar preserves Harappan remains, while Sanghol is especially important for its Kushan-period Buddhist and artistic remains.", ["harappan-rupnagar", "sanghol-kushan-buddhist"], [S.asiPunjabSites, S.nmaSanghol]],
] as const;
