...
const rowsByQl: Record<keyof typeof PGK_001_CP001_QL_NAMES, readonly Row[]> = {
  "PGK-001-QL-001": [
    ...
    R("Easy", "Which river is NOT one of the five rivers traditionally linked with the name Punjab?", "Ganga", ["Ganga", "Ravi", "Chenab", "Jhelum"], ["historical-five-rivers"], "The traditional five are Sutlej, Beas, Ravi, Chenab and Jhelum. Ganga is not part of this five-river set."),
  ...
  "PGK-001-QL-002": [
    R("Easy", "What is the geographical area of Punjab?", "50,362 sq km", ["50,362 sq km", "44,212 sq km", "55,673 sq km", "60,362 sq km"], ["area"], "The Government of Punjab gives the state's geographical area as 50,362 square kilometres."),
    ...
    R("Medium", "Which pair forms Punjab's southern boundary?", "Haryana and Rajasthan", ["Haryana and Rajasthan", "Himachal Pradesh and Haryana", "Jammu and Kashmir and Himachal Pradesh", "Rajasthan and Gujarat"], ["south-border"], "The Punjab government profile lists Haryana and Rajasthan on the south of the state."),
    R("Medium", "Punjab lies approximately between which latitudes?", "29.30°N and 32.32°N", ["29.30°N and 32.32°N", "20.30°N and 23.32°N", "33.55°N and 36.50°N", "24.00°N and 27.00°N"], ["latitude-span"], "The official Punjab profile places the state roughly between 29.30°N and 32.32°N latitude."),
    R("Medium", "Punjab lies approximately between which longitudes?", "73.55°E and 76.50°E", ["73.55°E and 76.50°E", "68.00°E and 71.00°E", "77.55°E and 80.50°E", "82.00°E and 85.00°E"], ["longitude-span"], "The official Punjab profile gives an approximate longitude span of 73.55°E to 76.50°E."),
  ],
  "PGK-001-QL-003": [
    R("Easy", "Which three broad regions are listed for Punjab on the state government profile?", "Majha, Doaba and Malwa", ["Majha, Doaba and Malwa", "Majha, Mewar and Marwar", "Doaba, Bundelkhand and Malwa", "Malwa, Baghelkhand and Doaba"], ["traditional-regions"], "The Government of Punjab profile groups the state into Majha, Doaba and Malwa for its broad regional description."),
    ...
    R("Easy", "Punjabi in Punjab is written in which script?", "Gurmukhi", ["Gurmukhi", "Devanagari", "Perso-Arabic", "Roman"], ["gurmukhi-script"], "The Punjab government profile states that Punjabi is written in the Gurmukhi script."),
    ...
    R("Medium", "Which set is correctly matched?", "Punjab — Punjabi — Gurmukhi", ["Punjab — Punjabi — Gurmukhi", "Punjab — Hindi — Gurmukhi", "Punjab — Punjabi — Devanagari", "Punjab — Urdu — Roman"], ["official-language", "gurmukhi-script"], "Punjabi is Punjab's official language, and the Punjab government profile gives Gurmukhi as its script."),
  ],
  "PGK-001-QL-004": [
    R("Medium", "The reorganisation linked with the present Punjab-Haryana arrangement took effect on which date?", "1 November 1966", ["1 November 1966", "15 August 1947", "26 January 1950", "1 November 1956"], ["reorganisation-1966"], "The reorganisation took effect on 1 November 1966. Chandigarh then became a Union Territory and the capital of both Punjab and Haryana."),
    R("Medium", "Which change is linked with the 1 November 1966 reorganisation?", "Chandigarh became a Union Territory serving as capital of Punjab and Haryana.", ["Chandigarh became a Union Territory serving as capital of Punjab and Haryana.", "All five historical Punjab rivers came within Indian Punjab.", "Punjab's capital shifted to Amritsar.", "Punjabi ceased to be used in Punjab."], ["reorganisation-1966", "chandigarh-joint-capital"], "The 1966 reorganisation is central to the present Punjab-Haryana-Chandigarh arrangement. Chandigarh became a Union Territory and the capital of both states."),
    R("Medium", "According to Punjab at a Glance 2022, how many districts were recorded in Punjab?", "23", ["23", "20", "22", "25"], ["district-count-2022"], "Punjab at a Glance 2022 records 23 districts. The year matters because administrative counts can change."),
    R("Medium", "Why should the figure '23 districts' carry a reference year in the Punjab GK engine?", "District counts are administrative data that can change over time.", ["District counts are administrative data that can change over time.", "Punjab's geographical area changes every census.", "The five-river identity changes every year.", "Gurmukhi changes with each district notification."], ["district-count-2022"], "District creation or reorganisation can change the count. The engine therefore stores 23 as a 2022 official snapshot rather than an eternal fact."),
    R("Hard", "Which pair correctly combines an immutable historical date with a versioned administrative fact?", "1 November 1966 — reorganisation; 23 districts — 2022 snapshot", ["1 November 1966 — reorganisation; 23 districts — 2022 snapshot", "1 November 1956 — reorganisation; 23 districts — timeless count", "15 August 1947 — Chandigarh made joint capital; 20 districts — 2022 snapshot", "26 January 1950 — Punjab-Haryana reorganisation; 25 districts — 2022 snapshot"], ["reorganisation-1966", "district-count-2022"], "The 1966 reorganisation date is historical and fixed. The district count is administrative data and is tied here to the 2022 official statistical reference."),
    R("Hard", "Which statement uses the safer form for an administrative GK fact?", "Punjab at a Glance 2022 records 23 districts.", ["Punjab at a Glance 2022 records 23 districts.", "Punjab will always have exactly 23 districts.", "Punjab has had 23 districts since 1966.", "The number of Punjab districts cannot change."], ["district-count-2022"], "Administrative boundaries are mutable. Attaching the official reference year prevents a current snapshot from being mistaken for an immutable historical fact."),
  ],
  "PGK-001-QL-005": [
    ...
    R("Medium", "Which bird is the state bird of Punjab?", "Northern Goshawk", ["Northern Goshawk", "Sarus Crane", "Great Hornbill", "Indian Roller"], ["state-bird-northern-goshawk"], "The Northern Goshawk is Punjab's state bird. The Punjab ENVIS reference cites the state notification issued in September 2015."),
  ...
  "PGK-001-QL-006": [
    ...
    R("Hard", "Consider the statements: I. Pakistan lies west of Punjab. II. Himachal Pradesh lies northeast of Punjab. III. Haryana and Rajasthan lie south of Punjab. Which are correct?", "All three", ["I and II only", "II and III only", "I and III only", "All three"], ["west-border", "northeast-border", "south-border"], "All three boundary statements match the Punjab government profile: Pakistan to the west, Himachal Pradesh to the northeast, and Haryana plus Rajasthan to the south."),
    R("Hard", "A state has Punjabi as its official language, uses Gurmukhi for Punjabi, and shares Chandigarh as capital with Haryana. Which state is it?", "Punjab", ["Punjab", "Himachal Pradesh", "Rajasthan", "Uttarakhand"], ["official-language", "gurmukhi-script", "chandigarh-joint-capital"], "These clues point to Punjab: Punjabi is its official language, Gurmukhi is the script stated in the government profile, and Chandigarh is its shared capital with Haryana."),
