...
const rowsByQl: Record<keyof typeof PGK_001_CP001_QL_NAMES, readonly Row[]> = {
  "PGK-001-QL-001": [
    R("Easy", "What does the name 'Punjab' literally refer to?", "Land of five rivers", ["Land of five rivers", "Land of five mountains", "Land of five forts", "Land of five lakes"], ["name-etymology"], "The name derives from Punj, meaning five, and Aab, meaning water. It therefore carries the sense 'land of five rivers'."),
    R("Easy", "Which river is NOT one of Punjab's traditional five rivers?", "Ganga", ["Ganga", "Ravi", "Chenab", "Jhelum"], ["historical-five-rivers"], "The traditional five are Sutlej, Beas, Ravi, Chenab and Jhelum. Ganga is not part of this five-river set."),
  ...
  "PGK-001-QL-002": [
    R("Easy", "What is the geographical area of Punjab?", "50,362 sq km", ["50,362 sq km", "44,212 sq km", "55,673 sq km", "60,362 sq km"], ["area"], "Punjab's geographical area is 50,362 square kilometres."),
  ...
  "PGK-001-QL-003": [
    R("Easy", "Which three broad regions are listed for Punjab on the state government profile?", "Majha, Doaba and Malwa", ["Majha, Doaba and Malwa", "Majha, Mewar and Marwar", "Doaba, Bundelkhand and Malwa", "Malwa, Baghelkhand and Doaba"], ["traditional-regions"], "Punjab is broadly divided into Majha, Doaba and Malwa."),
