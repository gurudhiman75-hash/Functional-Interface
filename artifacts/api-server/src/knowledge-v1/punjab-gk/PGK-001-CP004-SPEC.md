...
Use river names against river names, region names against region names and river-pair alternatives against other plausible river pairs. Do not use obviously unrelated mountains, cities or states as filler distractors.

## Explanation rule

Explanations should normally be 1–2 short sentences. They should clarify a river relation, present-vs-historical distinction, confluence or doab boundary without analysing all options.
...
CP004 is review-only. It must not be registered for runtime Question Studio generation, Question Bank writes, tests, mocks or public publication before explicit human approval.
