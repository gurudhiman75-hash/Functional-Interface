...
export const PGK_001_CP002_EXPLANATIONS_V3 = Object.freeze([
  ...
  "Ropar is the commonly used name for Rupnagar. The name is used for both the district and the division.",
  ...
  "Sahibzada Ajit Singh Nagar district is headquartered at Mohali. This is why the district is also commonly called Mohali district.",
  ...
  "Mohali is the headquarters of Sahibzada Ajit Singh Nagar district, commonly shortened to SAS Nagar.",
  "Ropar is the older and commonly used name of Rupnagar.",
