...
const rows: readonly Row[] = [
  ["Easy", "Wheat is a major crop of which season in Punjab?", ["Rabi", "Kharif", "Zaid", "Perennial"], "Rabi", "Wheat is Punjab's major Rabi cereal crop and is grown during the cool season.", ["wheat-rabi"], [S.pauRabi]],
  ["Easy", "Rice is a major crop of which season in Punjab?", ["Kharif", "Rabi", "Zaid", "Winter only"], "Kharif", "Rice or paddy is a major Kharif crop of Punjab.", ["rice-kharif"], [S.pauKharif]],
  ["Easy", "Cotton in Punjab is primarily a:", ["Kharif crop", "Rabi crop", "Zaid crop only", "Winter cereal"], "Kharif crop", "Cotton is a Kharif crop concentrated especially in south-western Punjab.", ["cotton-kharif"], [S.pauKharif, S.pauCotton]],
  ["Easy", "Rapeseed and mustard are important Punjab crops of which season?", ["Rabi crops", "Kharif crops", "Zaid crops only", "Perennial crops"], "Rabi crops", "Rapeseed and mustard are important Rabi oilseed crops of Punjab.", ["mustard-rabi"], [S.pauRabi]],
  ["Easy", "Maize is a major crop of which season in Punjab?", ["Kharif crop", "Rabi crop", "Winter oilseed", "Perennial crop"], "Kharif crop", "Maize is an important Kharif crop and is also promoted in Kandi areas.", ["maize-kharif", "maize-kandi"], [S.pauKharif, S.pauMaizeKandi]],
  ["Medium", "Which crop-season pair is incorrectly matched?", ["Cotton — Rabi", "Wheat — Rabi", "Rice — Kharif", "Maize — Kharif"], "Cotton — Rabi", "Cotton is a Kharif crop. Wheat is Rabi, while rice and maize are major Kharif crops.", ["cotton-kharif", "wheat-rabi", "rice-kharif", "maize-kharif"], [S.pauRabi, S.pauKharif]],
  ...
  ["Easy", "Gram or chickpea is an important crop of which season in Punjab?", ["Rabi season", "Kharif season", "Monsoon-only flood season", "Perennial cycle"], "Rabi season", "Gram or chickpea is an important Rabi pulse crop.", ["gram-rabi"], [S.pauRabi]],
  ...
  ["Medium", "Which crop-season pair is correctly matched?", ["Maize — Kharif", "Gram — Kharif", "Mustard — Kharif", "Rice — Rabi"], "Maize — Kharif", "Maize and rice are major Kharif crops, while gram and mustard are Rabi crops.", ["maize-kharif", "gram-rabi", "mustard-rabi", "rice-kharif"], [S.pauRabi, S.pauKharif]],
  ...
  ["Medium", "Which characteristic distinguishes PAU Kinnow 1?", ["Low seed content", "Blue fruit colour", "Very high seed number", "Salt-water cultivation only"], "Low seed content", "PAU Kinnow 1 is a low-seeded kinnow variety developed for improved fruit quality.", ["pau-kinnow1"], [S.pauInstitution]],
  ...
  ["Medium", "Crop diversification in Punjab aims to reduce excessive dependence on:", ["The rice-wheat cycle", "Fruit orchards", "Pulse crops", "Oilseed crops"], "The rice-wheat cycle", "Diversification aims to reduce overdependence on rice-wheat and broaden the crop base.", ["diversification-water", "rice-wheat-rotation"], [S.punjabAgPolicy]],
