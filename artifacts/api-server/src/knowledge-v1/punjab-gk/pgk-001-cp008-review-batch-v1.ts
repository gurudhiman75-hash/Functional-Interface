...
const rows: readonly Row[] = [
  ["Easy", "Wheat belongs to which crop season in Punjab?", ["Rabi", "Kharif", "Zaid", "Perennial"], "Rabi", "Wheat is Punjab's major Rabi cereal crop and is grown during the cool season.", ["wheat-rabi"], [S.pauRabi]],
  ["Easy", "Rice belongs to which crop season in Punjab?", ["Kharif", "Rabi", "Zaid", "Winter only"], "Kharif", "Rice or paddy is a major Kharif crop of Punjab.", ["rice-kharif"], [S.pauKharif]],
  ["Easy", "Cotton in Punjab is primarily a:", ["Kharif crop", "Rabi crop", "Zaid crop only", "Winter cereal"], "Kharif crop", "Cotton is a Kharif crop concentrated in south-western Punjab.", ["cotton-kharif"], [S.pauKharif, S.pauCotton]],
  ["Easy", "Rapeseed and mustard belong to which crop season in Punjab?", ["Rabi crops", "Kharif crops", "Zaid crops only", "Perennial crops"], "Rabi crops", "Rapeseed and mustard are important Rabi oilseed crops of Punjab.", ["mustard-rabi"], [S.pauRabi]],
  ["Easy", "Maize belongs to which crop season in Punjab?", ["Kharif crop", "Rabi crop", "Winter oilseed", "Perennial crop"], "Kharif crop", "Maize is an important Kharif crop and is also promoted in Kandi areas.", ["maize-kharif", "maize-kandi"], [S.pauKharif, S.pauMaizeKandi]],
  ...
  ["Easy", "Which part of Punjab contains the state's principal cotton belt?", ["South-western Punjab", "Shivalik foothills only", "Majha river belt only", "Rupnagar hills only"], "South-western Punjab", "Punjab's main cotton belt lies in the south-western part of the state.", ["cotton-southwest"], [S.pauCotton]],
  ...
  ["Easy", "Gram or chickpea belongs to which crop season in Punjab?", ["Rabi season", "Kharif season", "Monsoon-only flood season", "Perennial cycle"], "Rabi season", "Gram or chickpea is an important Rabi pulse crop.", ["gram-rabi"], [S.pauRabi]],
  ...
  ["Medium", "PAU Kinnow 1 was developed for which characteristic?", ["Low seed content", "Blue fruit colour", "Very high seed number", "Salt-water cultivation only"], "Low seed content", "PAU Kinnow 1 is a low-seeded kinnow variety developed for improved fruit quality.", ["pau-kinnow1"], [S.pauInstitution]],
  ...
  ["Medium", "Punjab's crop-diversification policy seeks to reduce excessive dependence on:", ["The rice-wheat cycle", "Fruit orchards", "Pulse crops", "Oilseed crops"], "The rice-wheat cycle", "Diversification aims to reduce overdependence on rice-wheat and broaden the crop base.", ["diversification-water", "rice-wheat-rotation"], [S.punjabAgPolicy]],
