...
const rows: readonly Row[] = [
  ...
  ["Medium", "Which crop is a traditional diversification option in south-western Punjab?", ["Cotton", "Tea", "Jute", "Coffee"], "Cotton", "Cotton is a major Kharif crop of Punjab's south-western belt and provides an alternative to paddy.", ["cotton-southwest", "cotton-kharif"], [S.pauCotton]],
  ["Medium", "Which fruit is important for horticultural diversification in the Abohar-Fazilka belt?", ["Kinnow", "Apple", "Walnut", "Cherry"], "Kinnow", "Kinnow is a leading horticultural crop of the Abohar-Fazilka belt.", ["abohar-kinnow", "arid-irrigated-kinnow"], [S.pauFruits]],
