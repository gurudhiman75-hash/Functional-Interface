...
const rows: readonly Row[] = [
  ["Easy", "Wheat is mainly grown in Punjab during which crop season?", ["Rabi", "Kharif", "Zaid", "Perennial"], "Rabi", "Wheat is Punjab's major Rabi cereal crop and is grown during the cool season.", ["wheat-rabi"], [S.pauRabi]],
  ["Easy", "Rice is mainly grown in Punjab during which crop season?", ["Kharif", "Rabi", "Zaid", "Winter only"], "Kharif", "Rice or paddy is a major Kharif crop of Punjab.", ["rice-kharif"], [S.pauKharif]],
  ["Easy", "Cotton in Punjab is primarily a:", ["Kharif crop", "Rabi crop", "Zaid crop only", "Winter cereal"], "Kharif crop", "Cotton is grown mainly in the Kharif season, especially in south-western Punjab.", ["cotton-kharif"], [S.pauKharif, S.pauCotton]],
  ["Easy", "Rapeseed and mustard are mainly grown in Punjab as:", ["Rabi crops", "Kharif crops", "Zaid crops only", "Perennial crops"], "Rabi crops", "Rapeseed and mustard are important Rabi oilseed crops of Punjab.", ["mustard-rabi"], [S.pauRabi]],
  ["Easy", "Maize in Punjab is mainly grown as a:", ["Kharif crop", "Rabi crop", "Winter oilseed", "Perennial crop"], "Kharif crop", "Maize is an important Kharif crop and is also promoted in Kandi areas.", ["maize-kharif", "maize-kandi"], [S.pauKharif, S.pauMaizeKandi]],
  ["Medium", "Which crop-season pair is incorrectly matched?", ["Cotton — Rabi", "Wheat — Rabi", "Rice — Kharif", "Maize — Kharif"], "Cotton — Rabi", "Cotton is a Kharif crop. Wheat is Rabi, while rice and maize are mainly Kharif crops.", ["cotton-kharif", "wheat-rabi", "rice-kharif", "maize-kharif"], [S.pauRabi, S.pauKharif]],
  ...
  ["Hard", "Consider the following statements:\nI. Rice is mainly a Kharif crop in Punjab.\nII. Wheat is mainly a Rabi crop.\nIII. Rice-wheat is a dominant crop rotation.\nWhich of the statements given above are correct?", ["I only", "I and II only", "II and III only", "I, II and III"], "I, II and III", "All three statements correctly describe the basic rice-wheat system of Punjab.", ["rice-kharif", "wheat-rabi", "rice-wheat-rotation"], [S.pauRabi, S.pauKharif, S.punjabAgPolicy]],

  ["Easy", "Cotton cultivation in Punjab is concentrated mainly in which part of the state?", ["South-western Punjab", "Shivalik foothills only", "Majha river belt only", "Rupnagar hills only"], "South-western Punjab", "Punjab's main cotton belt lies in the south-western part of the state.", ["cotton-southwest"], [S.pauCotton]],
  ...
  ["Easy", "Sugarcane in Punjab is primarily classified as a:", ["Commercial crop", "Winter pulse", "Oilseed only", "Fibre tree crop"], "Commercial crop", "Sugarcane is an important commercial crop used mainly for sugar and jaggery production.", ["sugarcane-commercial"], [S.pauSouthwest]],
  ["Easy", "Gram or chickpea is mainly grown in Punjab during the:", ["Rabi season", "Kharif season", "Monsoon-only flood season", "Perennial cycle"], "Rabi season", "Gram or chickpea is an important Rabi pulse crop.", ["gram-rabi"], [S.pauRabi]],
  ...
  ["Medium", "Which crop-season pair is correctly matched?", ["Maize — Kharif", "Gram — Kharif", "Mustard — Kharif", "Rice — Rabi"], "Maize — Kharif", "Maize is mainly Kharif, while gram and mustard are Rabi crops and rice is mainly Kharif.", ["maize-kharif", "gram-rabi", "mustard-rabi", "rice-kharif"], [S.pauRabi, S.pauKharif]],
  ...
  ["Medium", "PAU Kinnow 1 was developed mainly for which characteristic?", ["Low seed content", "Blue fruit colour", "Very high seed number", "Salt-water cultivation only"], "Low seed content", "PAU Kinnow 1 is a low-seeded kinnow variety developed for improved fruit quality.", ["pau-kinnow1"], [S.pauInstitution]],
  ...
  ["Medium", "Crop diversification in Punjab is mainly encouraged to reduce excessive dependence on:", ["The rice-wheat cycle", "Fruit orchards", "Pulse crops", "Oilseed crops"], "The rice-wheat cycle", "Diversification aims to reduce overdependence on rice-wheat and broaden the crop base.", ["diversification-water", "rice-wheat-rotation"], [S.punjabAgPolicy]],
