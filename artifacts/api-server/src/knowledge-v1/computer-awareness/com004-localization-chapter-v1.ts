...
const packets = [COM004_LOCALIZATION_WAVE2_QL006_V1, COM004_LOCALIZATION_WAVE2_QL005_V1, COM004_LOCALIZATION_WAVE1_QL001_V1, COM004_LOCALIZATION_WAVE1_QL002_V1, COM004_LOCALIZATION_WAVE1_QL003_V1, COM004_LOCALIZATION_WAVE1_QL004_V1];
...
export function auditCom004LocalizationChapterV1(corpus: {hi: readonly Com004LocalizedQuestionV1[]; pa: readonly Com004LocalizedQuestionV1[]} = COM004_LOCALIZATION_CHAPTER_V1) {
  ...
  for (const language of ['hi','pa'] as const) {
    ...
    for (const item of items) {
      ...
      if (item.runtimeRegistered || item.productionReleased || item.localizationFrozen) issues.push(`PREMATURE_RELEASE:${key}`);
    }
