...
assert.deepEqual(validateComputerAwarenessEditorialText({ stem: "Which person is associated with ENIAC?", explanation: "The person helped build the computer." }).issues, ["ASSOCIATED_WITH_OVERUSED"]);
