...
assert.deepEqual(validateComputerAwarenessEditorialText({ stem: "Which person is associated with ENIAC?", explanation: "The person helped build the computer." }).issues, ["ASSOCIATION_WORD_OVERUSED"]);
