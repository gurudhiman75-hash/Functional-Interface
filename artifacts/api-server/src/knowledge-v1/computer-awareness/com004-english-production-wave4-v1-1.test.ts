...
if (COM004_ENGLISH_PRODUCTION_WAVE4_AUTHORITY_V1.editorialOverlay.version !== "V1.1") issues.push("EDITORIAL_OVERLAY_VERSION_DRIFT");
...
if (issues.length) throw new Error(`COM-004 English Production Wave 4 V1.1 audit failed:\n${issues.join("\n")}`);
console.log(JSON.stringify({ checkpoint:"COM004_ENGLISH_PRODUCTION_WAVE4_V1_1_REVIEW_CANDIDATE", valid:true, qlCount:expectedQls.length, questionCount:COM004_ENGLISH_PRODUCTION_WAVE4_V1.length, questionsPerQl:12, uniqueStemCount:allStems.size, editorialOverlay:"V1.1", runtimeAuthorized:false, localizationAuthorized:false, questionBankWritesAuthorized:false, nextGate:COM004_ENGLISH_PRODUCTION_WAVE4_AUTHORITY_V1.nextGate }, null, 2));
