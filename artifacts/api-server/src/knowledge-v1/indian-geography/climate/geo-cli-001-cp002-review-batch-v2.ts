import {
  GEO_CLI_001_CP002_REVIEW_BATCH_V1,
  type GeoCli001Cp002Difficulty,
  type GeoCli001Cp002Question,
} from "./geo-cli-001-cp002-review-batch-v1";

const LEARNER_EXPLANATION_PATCH =
...
export function auditGeoCli001Cp002ReviewBatchV2() {
  const issues: string[] = [];
  ...
  for (const question of GEO_CLI_001_CP002_REVIEW_BATCH_V2) {
  ...
  if (GEO_CLI_001_CP002_REVIEW_BATCH_V2.length !== 54) issues.push(`COUNT:${GEO_CLI_001_CP002_REVIEW_BATCH_V2.length}`);
  ...
  return {
    ...
    issues,
    questionCount: GEO_CLI_001_CP002_REVIEW_BATCH_V2.length,
