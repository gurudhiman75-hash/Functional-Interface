...
const STEM_PATCHES: Readonly<Record<string, string>> = Object.freeze({
  ...
  "GEO-CLI-001-CP001-Q009": "How does latitude mainly influence temperature across India?",
  ...
  "GEO-CLI-001-CP001-Q014": "Why are hill regions generally cooler than nearby plains?",
  "GEO-CLI-001-CP001-Q015": "Which climate control mainly explains lower temperatures at high elevations?",
  ...
  "GEO-CLI-001-CP001-Q018": "Why is a hill station generally cooler than a nearby lowland?",
  "GEO-CLI-001-CP001-Q019": "Which location is expected to have the smaller annual temperature range?",
  "GEO-CLI-001-CP001-Q020": "Why do inland areas often have greater temperature extremes than coastal areas?",
  "GEO-CLI-001-CP001-Q021": "Which climate control mainly moderates temperatures near a coast?",
  ...
  "GEO-CLI-001-CP001-Q026": "How do the Himalayas moderate winter conditions in northern India?",
  "GEO-CLI-001-CP001-Q027": "Which statement best describes the climatic role of the Himalayas?",
  "GEO-CLI-001-CP001-Q028": "What happens to moisture-bearing winds when they meet the Himalayan barrier?",
  ...
  "GEO-CLI-001-CP001-Q031": "Which climate control involves the movement of warm or cold seawater?",
  ...
  "GEO-CLI-001-CP001-Q039": "Strong summer heating of land generally creates which surface-pressure condition?",
  "GEO-CLI-001-CP001-Q040": "Strong winter cooling of land generally creates which surface-pressure condition?",
  "GEO-CLI-001-CP001-Q041": "Which climate control connects seasonal heating with changes in wind flow?",
  ...
  "GEO-CLI-001-CP001-Q043": "What is rainfall called when moist air is forced to rise over a mountain barrier?",
  "GEO-CLI-001-CP001-Q044": "Orographic rainfall is generally greater on which side of a mountain barrier?",
  "GEO-CLI-001-CP001-Q045": "What is the dry zone on the leeward side of a mountain range called?",
  "GEO-CLI-001-CP001-Q046": "Why can the orientation of a mountain range affect rainfall?",
  "GEO-CLI-001-CP001-Q047": "Which climate control mainly explains sharp rainfall differences across a mountain range?",
