import {
  GEO_CLI_001_CP006_REVIEW_BATCH_V1,
  type GeoCli001Cp006Difficulty,
  type GeoCli001Cp006Question,
} from "./geo-cli-001-cp006-review-batch-v1";

const STEM_PATCHES: Readonly<Record<string, string>> = Object.freeze({
  "GEO-CLI-001-CP006-Q050": "Consider these statements:\nI. Retreating monsoon mainly occurs in October-November.\nII. October heat is hot and humid.\nIII. Many rain-bearing depressions form near the Andaman Sea.\nWhich statements are correct?",
});

export const GEO_CLI_001_CP006_REVIEW_BATCH_V2: readonly GeoCli001Cp006Question[] = Object.freeze(
  GEO_CLI_001_CP006_REVIEW_BATCH_V1.map((question) => Object.freeze({
    ...question,
...
export function auditGeoCli001Cp006ReviewBatchV2() {
  const issues: string[] = [];
  ...
  if (Object.keys(STEM_PATCHES).length !== 1) issues.push(`STEM_PATCH_COUNT:${Object.keys(STEM_PATCHES).length}`);

  for (const question of GEO_CLI_001_CP006_REVIEW_BATCH_V2) {
  ...
  if (GEO_CLI_001_CP006_REVIEW_BATCH_V2.length !== 54) issues.push(`COUNT:${GEO_CLI_001_CP006_REVIEW_BATCH_V2.length}`);
  ...
  return Object.freeze({
    ...
    questionCount: GEO_CLI_001_CP006_REVIEW_BATCH_V2.length,
