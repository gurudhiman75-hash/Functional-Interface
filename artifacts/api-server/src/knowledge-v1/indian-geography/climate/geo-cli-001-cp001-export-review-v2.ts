...
import {
  ...
  auditGeoCli001Cp001ReviewBatchV2,
} from "./geo-cli-001-cp001-review-batch-v2";

const audit = auditGeoCli001Cp001ReviewBatchV2();
if (!audit.valid) throw new Error(audit.issues.join("\n"));

const outputDir = join(process.cwd(), "dist", "geography-review", "GEO-CLI-001-CP001-V2");
...
GEO_CLI_001_CP001_REVIEW_BATCH_V2.forEach((question, index) => {
...
writeFileSync(join(outputDir, "GEO-CLI-001-CP001-REVIEW-BATCH-V2.md"), `${lines.join("\n")}\n`, "utf8");
writeFileSync(join(outputDir, "GEO-CLI-001-CP001-REVIEW-BATCH-V2.json"), `${JSON.stringify({ audit, questions: GEO_CLI_001_CP001_REVIEW_BATCH_V2 }, null, 2)}\n`, "utf8");
