...
import {
  ...
  auditGeoCli001Cp001ReviewBatchV1,
} from "./geo-cli-001-cp001-review-batch-v1";

const audit = auditGeoCli001Cp001ReviewBatchV1();
if (!audit.valid) throw new Error(audit.issues.join("\n"));

const outputDir = join(process.cwd(), "dist", "geography-review", "GEO-CLI-001-CP001-V1");
...
GEO_CLI_001_CP001_REVIEW_BATCH_V1.forEach((question, index) => {
...
writeFileSync(join(outputDir, "GEO-CLI-001-CP001-REVIEW-BATCH-V1.md"), `${lines.join("\n")}\n`, "utf8");
writeFileSync(join(outputDir, "GEO-CLI-001-CP001-REVIEW-BATCH-V1.json"), `${JSON.stringify({ audit, questions: GEO_CLI_001_CP001_REVIEW_BATCH_V1 }, null, 2)}\n`, "utf8");
