...
Status: ACTIVE IMPLEMENTATION — CP009–CP010 REVIEW
Engine: `knowledge-v1`
...
CP001–CP008 are approved and merged, covering QL001–QL072 with 432 approved owning questions. CP009 — Soil–Crop Relations (QL073–QL081) and CP010 — Soil Properties & Comparative Identification (QL082–QL090) are implemented as 54-question review candidates and remain unmerged until explicit human approval. The next permanent checkpoint after approval will be CP011 — Soil Erosion & Conservation (QL091–QL099). Runtime publication and Question Bank/test/mock activation remain separately governed.
