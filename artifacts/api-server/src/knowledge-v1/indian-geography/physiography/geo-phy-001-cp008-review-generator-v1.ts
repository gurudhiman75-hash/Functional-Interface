...
const rowsByQl: Record<number, readonly Row[]> = {
  ...
  72: [
    ["Consider the following statements: I. Western Ghats are higher than Eastern Ghats. II. Western Ghats are more continuous. III. Eastern Ghats are cut by rivers. Which statements are correct?", "All three", ["I and II only", "II and III only", "I and III only", "All three"], ["western-higher", "western-continuous", "eastern-discontinuous"]],
    ["Consider the following statements: I. Narmada lies between Vindhya and Satpura. II. Vindhya lies south of Narmada. III. Satpura lies south of Narmada. Which statements are correct?", "I and III only", ["I and II only", "II and III only", "I and III only", "All three"], ["narmada-between"]],
    ...
    ["Consider the following statements: I. Anamudi is linked with the Western Ghats. II. Doddabetta is linked with the Nilgiri Hills. III. Mahendragiri is linked with the Eastern Ghats. Which statements are correct?", "All three", ["I and II only", "II and III only", "I and III only", "All three"], ["anamudi", "doddabetta", "mahendragiri"]],
