...
const outDir = path.resolve(process.cwd(), "dist/geography-review/GEO-AGR-001-CP001-V1");
...
const name = "GEO-AGR-001-CP001-REVIEW-BATCH-V1";
fs.writeFileSync(path.join(outDir, name + ".md"), lines.join("\n"));
fs.writeFileSync(path.join(outDir, name + ".json"), JSON.stringify({ audit, questions: GEO_AGR_001_CP001_REVIEW_BATCH_V1 }, null, 2));
