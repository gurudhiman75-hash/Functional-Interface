...
import {
  GEO_AGR_001_CP004_IRRIGATION_INPUTS_SEGMENT_V1,
  auditGeoAgr001Cp004IrrigationInputsSegmentV1,
} from "./geo-agr-001-cp004-segment-a-irrigation-inputs-v1";
import {
  GEO_AGR_001_CP004_GREEN_REVOLUTION_SEGMENT_V1,
  auditGeoAgr001Cp004GreenRevolutionSegmentV1,
} from "./geo-agr-001-cp004-segment-b-green-revolution-v1";
...
export const GEO_AGR_001_CP004_REVIEW_BATCH_V1: readonly GeoAgr001Question[] = Object.freeze(
  SOURCE.map((source, index) => Object.freeze({
    ...source,
    questionId: `GEO-AGR-001-CP004-Q${String(index + 1).padStart(3, "0")}`,
...
export function auditGeoAgr001Cp004ReviewBatchV1() {
  const issues: string[] = [];
  const segmentAudits = [
    auditGeoAgr001Cp004IrrigationInputsSegmentV1(),
    auditGeoAgr001Cp004GreenRevolutionSegmentV1(),
  ...
  for (const q of GEO_AGR_001_CP004_REVIEW_BATCH_V1) {
  ...
  if (GEO_AGR_001_CP004_REVIEW_BATCH_V1.length !== 108) issues.push("COUNT:" + GEO_AGR_001_CP004_REVIEW_BATCH_V1.length);
  for (let n = 73; n <= 90; n += 1) {
  ...
  return Object.freeze({
    ...
    questionCount: GEO_AGR_001_CP004_REVIEW_BATCH_V1.length,
