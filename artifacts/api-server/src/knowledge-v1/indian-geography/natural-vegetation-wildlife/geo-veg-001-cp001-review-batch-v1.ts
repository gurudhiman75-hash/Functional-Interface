...
const RAW: readonly RawQuestion[] = Object.freeze([
  ...
  },
  {
    ...
    "difficulty": "Easy",
    "stem": "Which physical control includes slope and elevation and can influence both vegetation and land use?",
    "answer": "Relief",
    "distractors": [
      "Soil",
      "Precipitation",
  ...
  },
  {
    ...
    "difficulty": "Easy",
    "stem": "Which climatic factor generally decreases as altitude increases and strongly affects vegetation type and growth?",
    "answer": "Temperature",
    "distractors": [
      "Precipitation",
      "Photoperiod",
  ...
  },
  {
    ...
    "qlName": "Temperature and photoperiod controls",
    "difficulty": "Medium",
    "stem": "Which set best explains variation in the duration of sunlight from place to place and season to season?",
    "answer": "Latitude, altitude and season",
    "distractors": [
      "Latitude, rainfall and soil type",
      "Altitude, precipitation and soil moisture",
      "Temperature, relief and soil type"
    ],
  ...
  },
  {
    ...
    "distractors": [
      ...
      "Temperature, photoperiod and relief",
      "Precipitation, photoperiod and soil"
    ],
...
const TRIVIAL_DISTRACTOR = /currency|population census|political boundary|time zone|magnetic declination|crop price|dam height|road density|literacy|mineral price/i;
