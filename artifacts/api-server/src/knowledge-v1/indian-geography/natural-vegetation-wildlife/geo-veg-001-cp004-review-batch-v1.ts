...
const RAW:readonly RawQuestion[]=Object.freeze([
  ...
  },
  {
    ...
    "qlName": "Thorn forest climate",
    "difficulty": "Hard",
    "stem": "Two equally warm regions differ in rainfall: one gets 85 cm and the other 45 cm. Which vegetation contrast is most plausible?",
  ...
  },
  {
    ...
    "explanation": "Succulent stems act as water reservoirs. Stored water helps the plant survive between infrequent rain events and reduces dependence on frequent rainfall.",
    "sourceFactIds": [
      "THORN-WATER-STORAGE"
    ]
  },
  ...
  },
  {
    ...
    "explanation": "Low moisture prevents a dense closed forest from developing. Trees and shrubs are therefore widely spaced, leaving open ground between them.",
    "sourceFactIds": [
