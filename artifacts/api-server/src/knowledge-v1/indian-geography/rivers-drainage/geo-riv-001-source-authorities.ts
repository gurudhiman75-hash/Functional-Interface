...
export const GEO_RIV_001_SOURCE_AUTHORITIES: GeoRiv001SourceAuthority[] = [
  {
    ...
    supports: [
      ...
      "indus-system-school-standard-framing",
    ],
  ...
  },
  {
    ...
    supports: [
      ...
      "chenab-tributaries",
      "ravi-source-region",
      "ravi-characteristics",
      "ravi-tributaries",
      "satluj-source-region",
      "satluj-shipkila",
      "satluj-spiti",
    ],
    verifiedOn: "2026-09-09",
    notes: [
      ...
      "Preserve source-specific wording where official descriptions differ from simplified textbook conventions, especially the Indus source description.",
    ],
  },
  {
    sourceId: "BBMB-BEAS-PONG-PSP-HYDROLOGY",
    title: "Bhakra Beas Management Board — Pong Pumped Storage Project Feasibility Study, Chapter 3 Hydrology",
    url: "https://bbmb.gov.in/writereaddata/Portal/News/247_1_EOI_PSP.pdf",
    sourceType: "official",
    supports: [
      "beas-source",
      "beas-rohtang",
      "beas-sutlej-relation",
      "beas-basin-tributaries",
    ],
    verifiedOn: "2026-09-09",
    notes: [
      "The hydrology chapter describes the Beas as originating from Beas Kund in the Pir Panjal ranges near Rohtang Pass and as a principal tributary of the Satluj.",
      "Use durable source/place/parent-river relations; avoid project-status facts in Static GK authoring.",
    ],
  },
  {
    sourceId: "CWC-RAVI-BEAS-WATERS-TRIBUNAL-1987",
    title: "Government of India — Ravi & Beas Waters Tribunal Report, 1987 (CWC copy)",
    url: "https://cwc.gov.in/sites/default/files/Ravi-%20Beas%20Waters%20Tribunal%20Report%201987.pdf",
    sourceType: "official",
    supports: [
      "indus-river-system-membership",
      "ravi-joins-chenab",
      "beas-joins-sutlej",
      "satluj-indus-system-course",
    ],
    verifiedOn: "2026-09-09",
    notes: [
      "Use Chapter III river-system geography only as corroborating static authority.",
      "Do not use this source to create current treaty-policy questions without a separate current-policy verification gate.",
    ],
  },
  {
