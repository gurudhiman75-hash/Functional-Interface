...
- source region/range
- source state/district where present
- Peninsular source place/hill/range
...
- Medium: reverse recall, source geography, matched pairs, two-fact statement composition
- Hard: source-to-mouth chains and multi-statement reasoning

## Explanation policy
Explanations state the relevant fact(s) directly. No meta language, option analysis, shortcuts, traps, or tautological filler.
