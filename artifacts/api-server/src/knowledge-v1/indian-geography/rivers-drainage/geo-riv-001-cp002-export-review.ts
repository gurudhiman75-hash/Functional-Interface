  ...
  JSON.stringify(
    {
      ...
      authority: "V1",
      status: "REVIEW_ONLY",
      visualPolicy: "OPTIONAL_EDITORIAL_ATTACHMENT",
      audit,
...
const lines: string[] = [
  ...
  "**Visuals:** Optional editorial maps/photos may be attached manually during review when useful.",
  "",
  "---",
  "",
];
...
for (const [index, q] of GEO_RIV_001_CP002_REVIEW_BATCH_V1.entries()) {
  ...
  cards.push(`<article class="question-card">
    ...
    <details><summary>Provenance</summary><p><strong>Source IDs:</strong> ${escapeHtml(q.sourceIds.join(", "))}</p><p><strong>Fact IDs:</strong> ${escapeHtml(q.sourceFactIds.join(", "))}</p></details>
  </article>`);
}
...
<body><main>
<header><h1>GEO-RIV-001-CP002 Review Batch V1</h1><div class="summary">Indus River System · Review-only · ${audit.questionCount} questions.<br/>Maps/photos are optional editorial attachments and are not generated automatically.</div></header>
${cards.join("\n")}
</main></body></html>`;
