...
Status: APPROVED / POST-CP007 REVALIDATION
Chapter: `GEO-RIV-001`
...
## Approval and base boundary

CP007 has received explicit human approval and is merged into `New-main`. CP015 V2 is therefore restacked directly on the post-CP007 `New-main` base and must pass the full CP015 qualification gate again on that base before merge.

No CP007 implementation files are carried by the clean CP015 branch.
...
CP015 is approved content pending successful post-CP007 base revalidation and merge. It does not register a new runtime package, does not write Question Bank rows, and is not test/mock/public eligible merely by this checkpoint merge.
