...
if (!audit.valid) {
  throw new Error(
    `GEO-RIV-001 CP004 cannot freeze an invalid V2 batch: ${audit.issues.join(", ")}`,
  );
}

export const GEO_RIV_001_CP004_FREEZE_AUTHORITY_V1 = Object.freeze({
  authorityId: "GEO-RIV-001-CP004-ENGLISH-FREEZE-V1" as const,
  chapterId: "GEO-RIV-001" as const,
  cpId: "GEO-RIV-001-CP004" as const,
  title: "Brahmaputra River System" as const,
  ...
  corpus: Object.freeze({
    ...
    qlCount: new Set(GEO_RIV_001_CP004_REVIEW_BATCH_V2.map((q) => q.qlId)).size,
  ...
  replacementRule:
    "Any change to the approved CP004 stems, options, answers, explanations, difficulty labels, source/fact provenance, QL allocation, or editorial wording requires a new governed freeze version." as const,
});

export const GEO_RIV_001_CP004_FROZEN_QUESTIONS_V1 = Object.freeze(
  GEO_RIV_001_CP004_REVIEW_BATCH_V2.map((question) =>
    Object.freeze({
      ...question,
      options: Object.freeze([...question.options]),
      sourceIds: Object.freeze([...question.sourceIds]),
      sourceFactIds: Object.freeze([...question.sourceFactIds]),
      freezeAuthorityId: GEO_RIV_001_CP004_FREEZE_AUTHORITY_V1.authorityId,
...
export type GeoRiv001Cp004FrozenQuestionV1 =
  (typeof GEO_RIV_001_CP004_FROZEN_QUESTIONS_V1)[number];
