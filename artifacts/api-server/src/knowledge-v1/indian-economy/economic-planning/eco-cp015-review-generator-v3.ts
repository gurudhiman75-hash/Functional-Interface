...
const STEM_REVISIONS_V3: Readonly<Record<string,string>> = Object.freeze({
  ...
  "What was the main focus of the Second Five-Year Plan?": "What was the focus of the Second Five-Year Plan?",
  ...
  "Which change best reflects the shift from the Planning Commission to NITI Aayog?": "Which change reflects the shift from the Planning Commission to NITI Aayog?",
});
