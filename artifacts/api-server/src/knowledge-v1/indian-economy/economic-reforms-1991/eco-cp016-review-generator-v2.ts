...
const STEM_REVISIONS_V2: Readonly<Record<string,string>> = Object.freeze({
  ...
  "Which statement best reflects the post-1991 financial reform direction?": "Which statement describes the post-1991 financial reform direction?",
  ...
  "Which statement best summarises the direction of the 1991 reforms?": "Which statement summarises the direction of the 1991 reforms?",
});
