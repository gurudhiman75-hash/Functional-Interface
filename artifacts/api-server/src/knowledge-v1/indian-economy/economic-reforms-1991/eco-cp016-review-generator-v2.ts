...
const STEM_REVISIONS_V2: Readonly<Record<string,string>> = Object.freeze({
  "Which sequence best describes the 1991 reform context?": "Which sequence correctly shows the 1991 reform context?",
  ...
  "Which statement best reflects the post-1991 financial reform direction?": "Which statement correctly describes the post-1991 financial reform direction?",
  "Which measure is mainly a stabilisation measure rather than a structural reform?": "Which of the following is a stabilisation measure rather than a structural reform?",
  "What did current-account convertibility mainly allow?": "What did current-account convertibility allow?",
  "Which reform pair deals mainly with different areas of the economy?": "Which reform pair deals with two different areas of the economy?",
  "Which statement best summarises the direction of the 1991 reforms?": "Which statement describes the overall direction of the 1991 reforms?",
});
