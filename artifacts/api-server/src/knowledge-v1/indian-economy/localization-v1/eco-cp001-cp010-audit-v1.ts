...
import {
  ...
  generateEcoCp001Cp010LocalizedReviewV1,
...
for (const locale of locales) {
  fail(generateEcoCp001Cp010LocalizedReviewV1(locale).length === 436, `${locale}: CP001-CP010 expected 436`);
}

fail(
  locales.flatMap((locale) => generateEcoCp001Cp010LocalizedReviewV1(locale)).length === 1308,
  "CP001-CP010 expected 1308 EN-HI-PA surfaces",
);

console.log("Economy CP001-CP010 multilingual audit passed: 436 questions per locale / 1308 surfaces.");
