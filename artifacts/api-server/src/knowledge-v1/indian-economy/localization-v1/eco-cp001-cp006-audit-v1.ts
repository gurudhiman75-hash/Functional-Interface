...
import {
  ...
  generateEcoCp001Cp006LocalizedReviewV1,
...
for (const locale of locales) {
  fail(generateEcoCp001Cp006LocalizedReviewV1(locale).length === 260, `${locale}: CP001-CP006 expected 260`);
}

fail(
  locales.flatMap((locale) => generateEcoCp001Cp006LocalizedReviewV1(locale)).length === 780,
  "CP001-CP006 expected 780 EN-HI-PA surfaces",
);

console.log("Economy CP001-CP006 multilingual audit passed: 260 questions per locale / 780 surfaces.");
