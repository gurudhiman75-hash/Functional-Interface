# Economy Multilingual V1 — CP001–CP014
...
- CP001–CP014 cumulative: 612 questions per locale / 1,836 EN-HI-PA surfaces
- Current CP013–CP014 checkpoint: 88 questions per locale / 264 EN-HI-PA surfaces
...
- CP013 and CP014 use V2 stem-polish authorities; stem-only revisions preserve options, answers, explanations, QL, difficulty and source provenance
...
- `ABBREVIATION` entries retain standard forms such as GDP, CPI, WPI, GVA, LFPR, MGNREGA, RBI, FEMA, PSS, SEBI, NABARD, MPC, SDF, MSF, CRR, OMO, RRB, PACS, NPA, PSL, MSME, DICGC, DFI, IFCI, SIDBI, NHB, NaBFID, NBFC, HFC, FRBM, GST, CGST, SGST, IGST, UTGST, CBDT and CAG
