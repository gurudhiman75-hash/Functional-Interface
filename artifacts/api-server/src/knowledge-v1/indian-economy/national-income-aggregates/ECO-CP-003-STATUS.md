...
- strengthened GDP-to-GNP adjustment distractors around NFIA;
- improved nominal-versus-real explanations while keeping them short;
- kept per-capita income and value-added numericals as direct calculation questions;
- kept the factor-cost / market-price formula explicitly labelled as the traditional exam relationship;
- improved market-price and net-indirect-tax distractors;
- added V2 QA for complete question stems, source resolution, answer alignment, duplicate prevention and Static-GK boundaries;
- retained 44-question / 12-QL coverage and Easy/Medium/Hard variation.
