...
- Stem baseline: short, simple SSC/Banking-style wording.
- Explanation baseline: simple and slightly explanatory; each answer makes the cross-topic connection explicit.
