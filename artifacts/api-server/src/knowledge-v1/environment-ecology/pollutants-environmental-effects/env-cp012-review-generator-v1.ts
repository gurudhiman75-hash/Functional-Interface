...
const S: readonly Seed[] = Object.freeze([
  ...
  { qlId:"ENV-012-QL-003", qlName:"Acid rain", difficulty:"Easy", stem:"Which pollutant is NOT a main acid-rain precursor?", correct:"Carbon monoxide", distractors:["Sulfur dioxide","Nitrogen oxides","Sulfur dioxide from fuel burning"], explanation:"Acid rain is mainly linked with SO2 and NOx, not CO.", sourceFactIds:["env-cp012-acid-rain-precursors","env-cp012-co-oxygen"] },
