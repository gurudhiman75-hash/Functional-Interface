...
function stripAllowedRoman(text:string){
 return text
  ...
  .replace(/\b(?:IUCN|CPCB|SPCB|PCC|NBA|SBB|BMC|PBR|NTCA|CZA|WCCB|FSI|BSI|ZSI|WII|EIA|NGT|CITES|CMS|CBD|UNFCCC|NDCs?|POPs?|HFCs?|CFCs?|NAPCC|STPF|GPS|GIS|GK|COP|COP21|M)\b/gu,"")
