...
function stem(q: (typeof ENGLISH)[number], locale: NativeLocale): string {
  ...
  if (ql === 17) {
    ...
    return locale === "hi" ? "अनुच्छेद 6 के पंजीकरण मार्ग में आवेदन से ठीक पहले कम से कम कितने समय भारत में रहना आवश्यक था?" : "ਅਨੁਛੇਦ 6 ਹੇਠ ਨਾਗਰਿਕ ਵਜੋਂ ਦਰਜ ਹੋਣ ਲਈ, ਅਰਜ਼ੀ ਦੇਣ ਤੋਂ ਠੀਕ ਪਹਿਲਾਂ ਘੱਟੋ-ਘੱਟ ਕਿੰਨਾ ਸਮਾਂ ਭਾਰਤ ਵਿੱਚ ਰਹਿਣਾ ਲਾਜ਼ਮੀ ਸੀ?";
  }
  if (ql === 18) {
    ...
    if (q.canonicalAnswer === "Article 7") return locale === "hi" ? "1 मार्च 1947 के बाद भारत से पाकिस्तान गए और बाद में स्थायी वापसी के परमिट पर लौटे व्यक्ति वाला अपवाद किस अनुच्छेद में है?" : "1 ਮਾਰਚ 1947 ਤੋਂ ਬਾਅਦ ਭਾਰਤ ਤੋਂ ਪਾਕਿਸਤਾਨ ਗਏ ਅਤੇ ਫਿਰ ਪੱਕੀ ਵਾਪਸੀ ਦੇ ਪਰਮਿਟ ਨਾਲ ਮੁੜੇ ਵਿਅਕਤੀ ਲਈ ਇਹ ਅਪਵਾਦ ਕਿਹੜੇ ਅਨੁਛੇਦ ਵਿੱਚ ਦਿੱਤਾ ਗਿਆ ਹੈ?";
    return locale === "hi" ? "विदेश में रहने वाले भारतीय मूल के कुछ व्यक्तियों के लिए भारतीय राजनयिक या वाणिज्य-दूत प्रतिनिधि के माध्यम से पंजीकरण किस अनुच्छेद में है?" : "ਵਿਦੇਸ਼ ਵਿੱਚ ਰਹਿੰਦੇ ਭਾਰਤੀ ਮੂਲ ਦੇ ਕੁਝ ਵਿਅਕਤੀਆਂ ਨੂੰ ਭਾਰਤੀ ਰਾਜਨਾਇਕ ਜਾਂ ਕੌਂਸੁਲਰ ਅਧਿਕਾਰੀ ਕੋਲ ਨਾਗਰਿਕ ਵਜੋਂ ਦਰਜ ਕਰਨ ਦਾ ਪ੍ਰਬੰਧ ਕਿਹੜੇ ਅਨੁਛੇਦ ਵਿੱਚ ਹੈ?";
  }
...
function explanation(q: (typeof ENGLISH)[number], locale: NativeLocale): string {
  ...
  if (ql === 17) {
    if (q.canonicalAnswer === "19 July 1948") {
      return locale === "hi"
        ? "अनुच्छेद 6 में 19 जुलाई 1948 एक महत्वपूर्ण तारीख है; इससे पहले और इस तारीख को या इसके बाद आए कुछ प्रवासियों के लिए अलग शर्तें थीं।"
        : "ਅਨੁਛੇਦ 6 ਵਿੱਚ 19 ਜੁਲਾਈ 1948 ਮਹੱਤਵਪੂਰਨ ਤਾਰੀਖ ਹੈ; ਇਸ ਤੋਂ ਪਹਿਲਾਂ ਅਤੇ ਇਸ ਤਾਰੀਖ ਨੂੰ ਜਾਂ ਇਸ ਤੋਂ ਬਾਅਦ ਆਏ ਕੁਝ ਪਰਵਾਸੀਆਂ ਲਈ ਵੱਖਰੀਆਂ ਸ਼ਰਤਾਂ ਸਨ।";
    }
    if (q.canonicalAnswer === "Registration as a citizen") {
      return locale === "hi"
        ? "19 जुलाई 1948 को या उसके बाद आए कुछ प्रवासियों के लिए नागरिक के रूप में पंजीकरण आवश्यक था।"
        : "19 ਜੁਲਾਈ 1948 ਨੂੰ ਜਾਂ ਇਸ ਤੋਂ ਬਾਅਦ ਆਏ ਕੁਝ ਪਰਵਾਸੀਆਂ ਲਈ ਨਾਗਰਿਕ ਵਜੋਂ ਦਰਜ ਹੋਣਾ ਲਾਜ਼ਮੀ ਸੀ।";
    }
    return locale === "hi"
      ? "अनुच्छेद 6 के पंजीकरण मार्ग में आवेदन से ठीक पहले कम से कम छह महीने भारत में रहना आवश्यक था।"
      : "ਅਨੁਛੇਦ 6 ਹੇਠ ਨਾਗਰਿਕ ਵਜੋਂ ਦਰਜ ਹੋਣ ਲਈ ਅਰਜ਼ੀ ਤੋਂ ਠੀਕ ਪਹਿਲਾਂ ਘੱਟੋ-ਘੱਟ ਛੇ ਮਹੀਨੇ ਭਾਰਤ ਵਿੱਚ ਰਹਿਣਾ ਲਾਜ਼ਮੀ ਸੀ।";
  }
  if (ql === 18) {
    if (q.canonicalAnswer === "Article 7") {
      return locale === "hi"
        ? "1 मार्च 1947 के बाद भारत से पाकिस्तान गए, लेकिन स्थायी वापसी के परमिट पर भारत लौटे व्यक्ति का अपवाद अनुच्छेद 7 में है।"
        : "1 ਮਾਰਚ 1947 ਤੋਂ ਬਾਅਦ ਭਾਰਤ ਤੋਂ ਪਾਕਿਸਤਾਨ ਗਏ, ਪਰ ਪੱਕੀ ਵਾਪਸੀ ਦੇ ਪਰਮਿਟ ਨਾਲ ਭਾਰਤ ਮੁੜੇ ਵਿਅਕਤੀ ਲਈ ਅਪਵਾਦ ਅਨੁਛੇਦ 7 ਵਿੱਚ ਹੈ।";
    }
    if (q.canonicalAnswer === "Article 8") {
      return locale === "hi"
        ? "अनुच्छेद 8 विदेश में रहने वाले कुछ भारतीय मूल के व्यक्तियों को भारतीय राजनयिक या वाणिज्य-दूत अधिकारी के माध्यम से पंजीकरण का मार्ग देता है।"
        : "ਅਨੁਛੇਦ 8 ਵਿਦੇਸ਼ ਵਿੱਚ ਰਹਿੰਦੇ ਕੁਝ ਭਾਰਤੀ ਮੂਲ ਦੇ ਵਿਅਕਤੀਆਂ ਨੂੰ ਭਾਰਤੀ ਰਾਜਨਾਇਕ ਜਾਂ ਕੌਂਸੁਲਰ ਅਧਿਕਾਰੀ ਕੋਲ ਨਾਗਰਿਕ ਵਜੋਂ ਦਰਜ ਹੋਣ ਦਾ ਰਾਹ ਦਿੰਦਾ ਹੈ।";
    }
    return locale === "hi"
      ? `सही उत्तर है: ${ans}। अनुच्छेद 7 पाकिस्तान गए कुछ प्रवासियों से और अनुच्छेद 8 विदेश में रहने वाले भारतीय मूल के कुछ व्यक्तियों से संबंधित है।`
      : `ਸਹੀ ਜਵਾਬ: ${ans}। ਅਨੁਛੇਦ 7 ਪਾਕਿਸਤਾਨ ਗਏ ਕੁਝ ਪਰਵਾਸੀਆਂ ਬਾਰੇ ਹੈ, ਜਦਕਿ ਅਨੁਛੇਦ 8 ਵਿਦੇਸ਼ ਵਿੱਚ ਰਹਿੰਦੇ ਕੁਝ ਭਾਰਤੀ ਮੂਲ ਦੇ ਵਿਅਕਤੀਆਂ ਬਾਰੇ ਹੈ।`;
  }
