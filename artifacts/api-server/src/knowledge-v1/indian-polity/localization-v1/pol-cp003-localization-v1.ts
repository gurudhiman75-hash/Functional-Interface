...
function stem(q: (typeof ENGLISH)[number], locale: NativeLocale): string {
  ...
  if (ql === 18) {
    ...
    if (q.canonicalAnswer === "Article 7") return locale === "hi" ? "1 मार्च 1947 के बाद भारत से पाकिस्तान गए और बाद में स्थायी वापसी के परमिट पर लौटे व्यक्ति वाला अपवाद किस अनुच्छेद में है?" : "1 ਮਾਰਚ 1947 ਤੋਂ ਬਾਅਦ ਭਾਰਤ ਤੋਂ ਪਾਕਿਸਤਾਨ ਗਏ ਅਤੇ ਫਿਰ ਪੱਕੀ ਵਾਪਸੀ ਦੇ ਪਰਮਿਟ ਨਾਲ ਮੁੜੇ ਵਿਅਕਤੀ ਵਾਲਾ ਅਪਵਾਦ ਕਿਹੜੇ ਅਨੁਛੇਦ ਵਿੱਚ ਹੈ?";
