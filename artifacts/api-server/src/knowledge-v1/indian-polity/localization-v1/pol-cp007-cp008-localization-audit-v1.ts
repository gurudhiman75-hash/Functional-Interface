...
const PA_STEM_BANNED=["ਇਨ੍ਹਾਂ ਵਿੱਚੋਂ ਇਨ੍ਹਾਂ ਵਿੱਚੋਂ","ਕਿਹੜੇ ਕਿਸਮ","ਕਿਹੜੇ ਸਾਬਕਾ","ਕਿਹੜਾ ਅਨੁਛੇਦ 51A","ਕਿਸ ਅਨੁਛੇਦ ਦਾ ਵਿਸ਼ਾ","ਕਿਹੜੇ ਅਨੁਛੇਦ ਹੇਠ","ਹੇਠ ਹੇਠ","ਇਸ ਅਧਿਆਇ ਵਿੱਚ ਮੁੱਖ ਤੌਰ 'ਤੇ","ਸ਼ਕਤੀ ਕਿਹੜੇ ਅਨੁਛੇਦ ਵਿੱਚ ਦਿੱਤਾ ਗਿਆ","ਸਹੁੰ ਜਾਂ ਪ੍ਰਤਿਗਿਆ ਕਿਹੜੇ ਅਨੁਛੇਦ ਵਿੱਚ ਦਿੱਤਾ ਗਿਆ","ਚੋਣ ਕਿਹੜੇ ਅਨੁਛੇਦ ਵਿੱਚ ਦਿੱਤਾ ਗਿਆ","ਘਟਾਉਣਾ ਦਾ ਕੀ ਅਰਥ"] as const;
const HI_STEM_BANNED=["कौन-सा अनुच्छेद 51A","किस पूर्व देश","इस अध्याय में मुख्यतः","शक्ति किस अनुच्छेद में दिया गया","शपथ या प्रतिज्ञान किस अनुच्छेद में दिया गया","निर्वाचन किस अनुच्छेद में दिया गया"] as const;
