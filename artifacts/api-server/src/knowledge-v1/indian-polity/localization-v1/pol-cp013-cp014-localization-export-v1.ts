...
for(const locale of ["en","hi","pa"] as const){
 const qs=[...generatePolCp013LocalizedReviewV1(locale),...generatePolCp014LocalizedReviewV1(locale)];
 const lines=[`# POL-001 CP013–CP014 — ${names[locale]} Localization Review V1`,"",`Questions: ${qs.length}`,""];
 ...
 fs.writeFileSync(path.join(dir,`POL-CP013-CP014-${locale.toUpperCase()}-REVIEW-V1.md`),lines.join("\n"));
}
console.log("POL-001 CP013–CP014 multilingual review Markdown generated.");
