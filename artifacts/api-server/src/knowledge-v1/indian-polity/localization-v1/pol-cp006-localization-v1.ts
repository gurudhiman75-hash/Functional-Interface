...
"Affirmed Parliament's constituent power to amend the Constitution and made presidential assent to a duly passed amendment Bill mandatory":lp("संविधान संशोधन की संसद की संविधायी शक्ति की पुष्टि की और विधिवत पारित संशोधन विधेयक पर राष्ट्रपति की स्वीकृति अनिवार्य की","ਸੰਸਦ ਕੋਲ ਸੰਵਿਧਾਨ ਸੋਧਣ ਦੀ ਸੰਵਿਧਾਨ-ਦਿੱਤੀ ਸ਼ਕਤੀ ਹੋਣ ਦੀ ਪੁਸ਼ਟੀ ਕੀਤੀ ਅਤੇ ਢੰਗ ਨਾਲ ਪਾਸ ਸੋਧ ਬਿੱਲ 'ਤੇ ਰਾਸ਼ਟਰਪਤੀ ਦੀ ਮਨਜ਼ੂਰੀ ਲਾਜ਼ਮੀ ਕੀਤੀ"),
...
"Fifth Schedule":lp("अनुसूचित क्षेत्रों और अनुसूचित जनजातियों का प्रशासन व नियंत्रण","ਅਨੁਸੂਚਿਤ ਖੇਤਰਾਂ ਅਤੇ ਅਨੁਸੂਚਿਤ ਜਨਜਾਤੀਆਂ ਦਾ ਪ੍ਰਸ਼ਾਸਨ ਅਤੇ ਨਿਯੰਤਰਣ"),
...
"Union and State legislative lists":lp("संघ और राज्य की विधायी सूचियाँ","ਸੰਘ ਅਤੇ ਰਾਜ ਦੀਆਂ ਕਾਨੂੰਨੀ ਸੂਚੀਆਂ"),
...
function stem(q:(typeof ENGLISH)[number],l:NativeLocale):string{
 ...
 if(ql===4)return l==="hi"?"अनुच्छेद 368 के तहत निम्न में से किस बदलाव के लिए कम-से-कम आधे राज्य विधानमंडलों की पुष्टि चाहिए?":"ਅਨੁਛੇਦ 368 ਹੇਠ ਹੇਠ ਲਿਖਿਆਂ ਵਿੱਚੋਂ ਕਿਹੜੇ ਬਦਲਾਅ ਲਈ ਘੱਟੋ-ਘੱਟ ਅੱਧੇ ਰਾਜ ਵਿਧਾਨ ਮੰਡਲਾਂ ਦੀ ਪੁਸ਼ਟੀ ਲੋੜੀਂਦੀ ਹੈ?";
 if(ql===5){
 ...
 if(ql===7){
   ...
   return l==="hi"?`${native(CASE_NAME[c]!,l)} (${row.year}) इस अध्याय में मुख्यतः किस सिद्धांत के लिए जाना जाता है?`:`${native(CASE_NAME[c]!,l)} (${row.year}) ਇਸ ਅਧਿਆਇ ਵਿੱਚ ਮੁੱਖ ਤੌਰ 'ਤੇ ਕਿਹੜੇ ਸਿਧਾਂਤ ਲਈ ਜਾਣਿਆ ਜਾਂਦਾ ਹੈ?`;
 }
 if(ql===8){
   if(q.canonicalAnswer==="Kesavananda Bharati v. State of Kerala")return l==="hi"?"मूल संरचना सिद्धांत किस प्रमुख मामले में स्थापित हुआ?":"ਮੂਲ ਸੰਰਚਨਾ ਸਿਧਾਂਤ ਕਿਹੜੇ ਮੁੱਖ ਮਾਮਲੇ ਵਿੱਚ ਸਥਾਪਤ ਹੋਇਆ?";
 ...
 if(ql===11){
   ...
   return l==="hi"?"निम्न में से कौन-सी मान्य मूल विशेषता है?":"ਹੇਠ ਲਿਖਿਆਂ ਵਿੱਚੋਂ ਕਿਹੜੀ ਮੰਨੀ ਹੋਈ ਮੂਲ ਵਿਸ਼ੇਸ਼ਤਾ ਹੈ?";
 }
 if(ql===12){
 ...
 if(ql===14){const s=q.canonicalAnswer;return l==="hi"?`${native(SCHEDULE_SUBJECT[s]!,l)} किस अनुसूची में है?`:`${native(SCHEDULE_SUBJECT[s]!,l)} ਕਿਹੜੀ ਅਨੁਸੂਚੀ ਵਿੱਚ ਹੈ?`;}
 if(ql===15){
 ...
 if(ql===21){const am=amendByChange(q.canonicalAnswer)!;const row=POL_CP006_HIGH_YIELD_AMENDMENTS_V1.find(x=>x.amendment===am)!;return l==="hi"?`${native(AMEND[am]!,l)} (${row.year}) किस बदलाव से जुड़ा है?`:`${native(AMEND[am]!,l)} (${row.year}) ਕਿਹੜੇ ਬਦਲਾਅ ਨਾਲ ਜੁੜੀ ਹੈ?`;}
 ...
 if(ql===24){
   ...
   if(q.canonicalAnswer.startsWith("Forty-second —"))return l==="hi"?"42वें और 44वें संविधान संशोधनों का कौन-सा जोड़ा सही सुमेलित है?":"42ਵੀਂ ਅਤੇ 44ਵੀਂ ਸੰਵਿਧਾਨ ਸੋਧ ਦਾ ਕਿਹੜਾ ਜੋੜ ਸਹੀ ਮਿਲਾਇਆ ਗਿਆ ਹੈ?";
 ...
 if(ql===25){const am=amendByChange(q.canonicalAnswer)!;return l==="hi"?`${native(AMEND[am]!,l)} किस बदलाव से जुड़ा है?`:`${native(AMEND[am]!,l)} ਕਿਹੜੇ ਬਦਲਾਅ ਨਾਲ ਜੁੜੀ ਹੈ?`;}
 if(ql===26){
...
function explanation(q:(typeof ENGLISH)[number],l:NativeLocale):string{
 ...
 if([13,14,15,16].includes(ql))return l==="hi"?`सही उत्तर है: ${ans}। इसे अनुसूची के वास्तविक संवैधानिक विषय से मिलाकर पहचानें।`:`ਸਹੀ ਜਵਾਬ: ${ans}। ਇਸਨੂੰ ਅਨੁਸੂਚੀ ਦੇ ਅਸਲ ਸੰਵਿਧਾਨਕ ਵਿਸ਼ੇ ਨਾਲ ਮਿਲਾ ਕੇ ਪਛਾਣੋ।`;
 ...
 if(ql===18)return l==="hi"?"दसवीं अनुसूची में दल-बदल विरोधी प्रावधान हैं। इसे 52वें संविधान संशोधन, 1985 से जोड़ा गया।":"10ਵੀਂ ਅਨੁਸੂਚੀ ਵਿੱਚ ਦਲ-ਬਦਲ ਵਿਰੋਧੀ ਪ੍ਰਬੰਧ ਹਨ। ਇਹ 52ਵੀਂ ਸੰਵਿਧਾਨ ਸੋਧ, 1985 ਨਾਲ ਜੋੜੀ ਗਈ।";
 if(ql===19)return l==="hi"?"ग्यारहवीं अनुसूची पंचायतों से संबंधित है। इसे 73वें संविधान संशोधन से जोड़ा गया और इसमें 29 विषय हैं।":"11ਵੀਂ ਅਨੁਸੂਚੀ ਪੰਚਾਇਤਾਂ ਬਾਰੇ ਹੈ। ਇਹ 73ਵੀਂ ਸੰਵਿਧਾਨ ਸੋਧ ਨਾਲ ਜੋੜੀ ਗਈ ਅਤੇ ਇਸ ਵਿੱਚ 29 ਵਿਸ਼ੇ ਹਨ।";
 if(ql===20)return l==="hi"?"बारहवीं अनुसूची नगरपालिकाओं से संबंधित है। इसे 74वें संविधान संशोधन से जोड़ा गया और इसमें 18 विषय हैं।":"12ਵੀਂ ਅਨੁਸੂਚੀ ਨਗਰ ਪਾਲਿਕਾਵਾਂ ਬਾਰੇ ਹੈ। ਇਹ 74ਵੀਂ ਸੰਵਿਧਾਨ ਸੋਧ ਨਾਲ ਜੋੜੀ ਗਈ ਅਤੇ ਇਸ ਵਿੱਚ 18 ਵਿਸ਼ੇ ਹਨ।";
