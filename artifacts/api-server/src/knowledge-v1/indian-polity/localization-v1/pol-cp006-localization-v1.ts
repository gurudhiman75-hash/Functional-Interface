...
function stem(q:(typeof ENGLISH)[number],l:NativeLocale):string{
 ...
 if(ql===5){
   ...
   return l==="hi"?"अनुच्छेद 368 के तहत संविधान संशोधन विधेयक के बारे में कौन-सा कथन सही है?":"ਅਨੁਛੇਦ 368 ਹੇਠ ਸੰਵਿਧਾਨ ਸੋਧ ਬਿੱਲ ਬਾਰੇ ਕਿਹੜਾ ਬਿਆਨ ਸਹੀ ਹੈ?";
 }
 if(ql===6){
 ...
 if(ql===7){
   ...
   return l==="hi"?`${native(CASE_NAME[c]!,l)} (${row.year}) का मामला मुख्यतः किस सिद्धांत से जुड़ा है?`:`${native(CASE_NAME[c]!,l)} (${row.year}) ਦਾ ਮਾਮਲਾ ਮੁੱਖ ਤੌਰ 'ਤੇ ਕਿਸ ਸਿਧਾਂਤ ਨਾਲ ਜੁੜਿਆ ਹੈ?`;
 }
 if(ql===8){
 ...
 if(ql===10){
   if(q.canonicalAnswer==="Fundamental Rights and Directive Principles")return l==="hi"?"मिनर्वा मिल्स के निर्णय ने किन दो संवैधानिक भागों के बीच संतुलन पर जोर दिया?":"ਮਿਨਰਵਾ ਮਿਲਜ਼ ਦੇ ਫ਼ੈਸਲੇ ਨੇ ਕਿਹੜੇ ਦੋ ਸੰਵਿਧਾਨਕ ਹਿੱਸਿਆਂ ਵਿਚਕਾਰ ਸੰਤੁਲਨ 'ਤੇ ਜ਼ੋਰ ਦਿੱਤਾ?";
   if(q.canonicalAnswer==="Limited amending power of Parliament")return l==="hi"?"मिनर्वा मिल्स का निर्णय किस मूल-संरचना सिद्धांत से विशेष रूप से जुड़ा है?":"ਮਿਨਰਵਾ ਮਿਲਜ਼ ਦਾ ਫ਼ੈਸਲਾ ਕਿਹੜੇ ਮੂਲ-ਸੰਰਚਨਾ ਸਿਧਾਂਤ ਨਾਲ ਖ਼ਾਸ ਤੌਰ 'ਤੇ ਜੁੜਿਆ ਹੈ?";
   return l==="hi"?"मिनर्वा मिल्स के निर्णय को कौन-सा कथन सही दर्शाता है?":"ਮਿਨਰਵਾ ਮਿਲਜ਼ ਦੇ ਫ਼ੈਸਲੇ ਨੂੰ ਕਿਹੜਾ ਬਿਆਨ ਸਹੀ ਦਰਸਾਉਂਦਾ ਹੈ?";
 }
 if(ql===11){
   if(q.canonicalAnswer==="Secularism")return l==="hi"?"एस. आर. बोम्मई का निर्णय किस मूल विशेषता से विशेष रूप से जुड़ा है?":"ਐਸ. ਆਰ. ਬੋਮਮਈ ਦਾ ਫ਼ੈਸਲਾ ਕਿਹੜੀ ਮੂਲ ਵਿਸ਼ੇਸ਼ਤਾ ਨਾਲ ਖ਼ਾਸ ਤੌਰ 'ਤੇ ਜੁੜਿਆ ਹੈ?";
 ...
 if(ql===22){
   ...
   if(q.canonicalAnswer==="One Hundred and First Amendment")return l==="hi"?"वस्तु एवं सेवा कर के लिए संवैधानिक ढाँचा किस संशोधन से आया?":"ਵਸਤੂ ਅਤੇ ਸੇਵਾ ਕਰ ਲਈ ਸੰਵਿਧਾਨਕ ਢਾਂਚਾ ਕਿਹੜੀ ਸੋਧ ਨਾਲ ਆਇਆ?";
 ...
 if(ql===24){
   if(q.stem.includes("Mini-Constitution"))return l==="hi"?"‘मिनी-कॉन्स्टिट्यूशन’ के नाम से प्रसिद्ध व्यापक संविधान संशोधन कौन-सा है?":"‘ਮਿਨੀ-ਕਾਂਸਟਿਟਿਊਸ਼ਨ’ ਦੇ ਨਾਂ ਨਾਲ ਪ੍ਰਸਿੱਧ ਵਿਆਪਕ ਸੰਵਿਧਾਨ ਸੋਧ ਕਿਹੜੀ ਹੈ?";
   ...
   throw new Error(`${q.questionId}: unsupported QL24 variant`);
 }
