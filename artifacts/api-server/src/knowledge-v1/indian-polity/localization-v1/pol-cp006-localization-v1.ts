...
function explanation(q:(typeof ENGLISH)[number],l:NativeLocale):string{
 const ql=Number(q.qlId.slice(-3));const ans=option(q.canonicalAnswer,l);
 ...
 if([13,14,15,16,17,18,19,20].includes(ql))return l==="hi"?`सही उत्तर है: ${ans}। अनुसूची को उसके संवैधानिक विषय से जोड़कर याद रखें।`:`ਸਹੀ ਜਵਾਬ: ${ans}। ਅਨੁਸੂਚੀ ਨੂੰ ਇਸਦੇ ਸੰਵਿਧਾਨਕ ਵਿਸ਼ੇ ਨਾਲ ਜੋੜ ਕੇ ਯਾਦ ਰੱਖੋ।`;
 ...
 if(ql===26)return l==="hi"?`सही उत्तर है: ${ans}। हर कथन को अनुच्छेद, मूल-संरचना सिद्धांत या संबंधित अनुसूची से मिलाकर देखें।`:`ਸਹੀ ਜਵਾਬ: ${ans}। ਹਰ ਬਿਆਨ ਨੂੰ ਅਨੁਛੇਦ, ਮੂਲ-ਸੰਰਚਨਾ ਸਿਧਾਂਤ ਜਾਂ ਸੰਬੰਧਿਤ ਅਨੁਸੂਚੀ ਨਾਲ ਮਿਲਾ ਕੇ ਵੇਖੋ।`;
