...
function stem(q:(typeof ENGLISH)[number],l:NativeLocale):string{
  ...
  if(ql===9){const am=Object.keys(AMEND).find(x=>q.stem.startsWith(x))!;const label=native(AMEND[am]!,l);const hiLabel=label.replace("वाँ संविधान संशोधन","वें संविधान संशोधन");return l==="hi"?`${hiLabel} का सही संबंध किससे है?`:`${label} ਦਾ ਸਹੀ ਸੰਬੰਧ ਕਿਸ ਨਾਲ ਹੈ?`;}
  if(ql===10){
  ...
  if(ql===11){const c=clauseForDuty(q.canonicalAnswer)!;return l==="hi"?`${ARTICLE(c,l)} के तहत नागरिक का कर्तव्य क्या है?`:`${ARTICLE(c,l)} ਹੇਠ ਨਾਗਰਿਕ ਦਾ ਕਿਹੜਾ ਫ਼ਰਜ਼ ਹੈ?`;}
  if(ql===12){const c=q.canonicalAnswer;const dutyText=native(DUTY[c]!,l);return l==="hi"?`${dutyText} अनुच्छेद 51A के किस खंड में है?`:`${dutyText} ਅਨੁਛੇਦ 51A ਦੇ ਕਿਹੜੇ ਖੰਡ ਵਿੱਚ ਦਿੱਤਾ ਗਿਆ ਹੈ?`;}
  if(ql===13)return l==="hi"?"निम्न में से कौन-सा मौलिक कर्तव्य है?":"ਹੇਠ ਲਿਖਿਆਂ ਵਿੱਚੋਂ ਕਿਹੜਾ ਮੂਲ ਫ਼ਰਜ਼ ਹੈ?";
  if(ql===14)return l==="hi"?"निम्न में से कौन-सा कार्य अनुच्छेद 51A में मौलिक कर्तव्य के रूप में स्पष्ट रूप से सूचीबद्ध नहीं है?":"ਹੇਠ ਲਿਖਿਆਂ ਵਿੱਚੋਂ ਕਿਹੜਾ ਕੰਮ ਅਨੁਛੇਦ 51A ਵਿੱਚ ਮੂਲ ਫ਼ਰਜ਼ ਵਜੋਂ ਸਪਸ਼ਟ ਤੌਰ 'ਤੇ ਦਰਜ ਨਹੀਂ ਹੈ?";
  if(ql===15){
  ...
  if(ql===17){
    if(q.stem.startsWith("Protect"))return l==="hi"?"प्राकृतिक पर्यावरण की रक्षा और सुधार का दायित्व संविधान में किस रूप में दिया गया है?":"ਕੁਦਰਤੀ ਵਾਤਾਵਰਣ ਦੀ ਰੱਖਿਆ ਅਤੇ ਸੁਧਾਰ ਦੀ ਜ਼ਿੰਮੇਵਾਰੀ ਸੰਵਿਧਾਨ ਵਿੱਚ ਕਿਸ ਰੂਪ ਵਿੱਚ ਦਿੱਤੀ ਗਈ ਹੈ?";
    if(q.stem.startsWith("Organise"))return l==="hi"?"ग्राम पंचायतों के संगठन का प्रावधान संविधान में किस रूप में दिया गया है?":"ਪਿੰਡ ਪੰਚਾਇਤਾਂ ਬਣਾਉਣ ਦਾ ਪ੍ਰਬੰਧ ਸੰਵਿਧਾਨ ਵਿੱਚ ਕਿਸ ਰੂਪ ਵਿੱਚ ਦਿੱਤਾ ਗਿਆ ਹੈ?";
    return l==="hi"?"वैज्ञानिक दृष्टिकोण विकसित करने का दायित्व संविधान में किस रूप में दिया गया है?":"ਵਿਗਿਆਨਕ ਸੋਚ ਵਿਕਸਿਤ ਕਰਨ ਦੀ ਜ਼ਿੰਮੇਵਾਰੀ ਸੰਵਿਧਾਨ ਵਿੱਚ ਕਿਸ ਰੂਪ ਵਿੱਚ ਦਿੱਤੀ ਗਈ ਹੈ?";
  }
  ...
  if(ql===21){
    ...
    return l==="hi"?"अनुच्छेद 51 मुख्यतः किस प्रकार के सिद्धांतों से संबंधित है?":"ਅਨੁਛੇਦ 51 ਮੁੱਖ ਤੌਰ 'ਤੇ ਕਿਸ ਕਿਸਮ ਦੇ ਸਿਧਾਂਤਾਂ ਬਾਰੇ ਹੈ?";
  }
  if(ql===22){
    if(q.canonicalAnswer==="Ireland")return l==="hi"?"भारतीय संविधान के नीति-निदेशक तत्वों का विचार किस देश के संविधान से प्रभावित था?":"ਭਾਰਤੀ ਸੰਵਿਧਾਨ ਦੇ ਨੀਤੀ-ਨਿਰਦੇਸ਼ਕ ਤੱਤਾਂ ਦਾ ਵਿਚਾਰ ਕਿਸ ਦੇਸ਼ ਦੇ ਸੰਵਿਧਾਨ ਤੋਂ ਪ੍ਰਭਾਵਿਤ ਸੀ?";
    if(q.canonicalAnswer==="USSR")return l==="hi"?"भारतीय संविधान के मौलिक कर्तव्य किस देश के संविधान से प्रभावित थे?":"ਭਾਰਤੀ ਸੰਵਿਧਾਨ ਦੇ ਮੂਲ ਫ਼ਰਜ਼ ਕਿਸ ਦੇਸ਼ ਦੇ ਸੰਵਿਧਾਨ ਤੋਂ ਪ੍ਰਭਾਵਿਤ ਸਨ?";
