...
export const POL_CP012_SEEDS_A: readonly PolCp012Seed[] = Object.freeze([
  ...
  q(3, "The Constitution fixes a separate minimum age for appointment as a Supreme Court Judge:", "No", ["Yes, 35 years", "Yes, 40 years", "Yes, 45 years"], "Article 124 sets professional qualifications and citizenship but does not prescribe a separate numerical minimum age for Supreme Court appointment.", "pol-cp012-art124"),
  ...
  q(4, "A person appointed as a Supreme Court Judge must be a:", "Citizen of India", ["Member of Parliament", "State Governor", "Senior Advocate only"], "Indian citizenship is compulsory under Article 124, along with one of the listed judicial, advocacy or distinguished-jurist qualifications.", "pol-cp012-art124"),
  q(4, "One judicial qualification for Supreme Court appointment is at least:", "Five years as a High Court Judge", ["Three years as a District Judge", "Five years as a Supreme Court advocate only", "Ten years as a Governor"], "Article 124 accepts at least five years as a High Court Judge, including service in two or more High Courts in succession.", "pol-cp012-art124"),
  q(4, "One advocacy qualification for Supreme Court appointment is at least:", "Ten years as a High Court advocate", ["Five years as a High Court advocate", "Ten years as a District Judge", "Fifteen years as a law professor"], "Article 124 allows appointment after at least ten years as an advocate of a High Court or two or more High Courts in succession.", "pol-cp012-art124"),
  q(4, "Who may be appointed under the 'distinguished jurist' qualification?", "A person considered a distinguished jurist by the President", ["Only a sitting High Court Chief Justice", "Only the Attorney-General", "Only a former Governor"], "Article 124 expressly includes a distinguished jurist in the President's opinion, so prior service as a Judge or advocate is not the only route.", "pol-cp012-art124"),
