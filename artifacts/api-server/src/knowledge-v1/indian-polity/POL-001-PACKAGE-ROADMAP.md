...
The approved CP001–CP012 localization layers cover 855 English authority questions and 2,565 review surfaces across English, Hindi and Punjabi. CP013–CP014 add 480 review-candidate surfaces (160 per locale). Native-script leakage, native-Punjabi editorial quality, numeric/legal-form preservation, question-count parity, QL parity, source parity, option-order parity and correct-index parity are executable CI gates.
