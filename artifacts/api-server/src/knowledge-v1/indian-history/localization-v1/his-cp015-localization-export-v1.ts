...
const lines: string[] = [
  "# History Multilingual V1 — HIS-CP-015 Review",
  "",
...
for (const locale of locales) {
  ...
  generateHisCp015LocalizedReviewV1(locale).forEach((q, index) => lines.push(...renderQuestion(q, index)));
}
const target = path.join(outDir, "HIS-MULTILINGUAL-V1-CP015-REVIEW.md");
