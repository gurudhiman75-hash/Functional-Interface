...
const lines: string[] = [
  "# History Multilingual V1 — HIS-CP-001 Review",
  "",
...
for (const locale of locales) {
  ...
  generateHisCp001LocalizedReviewV1(locale).forEach((q, index) => lines.push(...renderQuestion(q, index)));
}

const target = path.join(outDir, "HIS-MULTILINGUAL-V1-CP001-REVIEW.md");
