...
- `HIS-CP-008` Delhi Sultanate — approved and merged
  - 60 questions per locale
  - 180 English/Hindi/Punjabi learner surfaces
- `HIS-CP-010` Mughal Empire — independent multilingual review candidate
  - 60 questions per locale
  - 180 English/Hindi/Punjabi learner surfaces
- CP009 is under separate multilingual review and is not included in this branch.
- cumulative implemented/review candidate surfaces represented here: 534 questions per locale / 1602 EN-HI-PA surfaces
