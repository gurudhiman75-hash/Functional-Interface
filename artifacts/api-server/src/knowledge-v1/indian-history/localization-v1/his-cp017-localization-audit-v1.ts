...
fail(HIS_CP017_REVIEW_BATCH_V1.length===60,`CP017 English expected 60, found ${HIS_CP017_REVIEW_BATCH_V1.length}`);
fail(Object.keys(HIS_CP017_HI_V1).length===60,`CP017 Hindi overlays expected 60, found ${Object.keys(HIS_CP017_HI_V1).length}`);
fail(Object.keys(HIS_CP017_PA_V1).length===60,`CP017 Punjabi overlays expected 60, found ${Object.keys(HIS_CP017_PA_V1).length}`);

for(const locale of locales)assertParity(HIS_CP017_REVIEW_BATCH_V1,generateHisCp017LocalizedReviewV1(locale),locale);
