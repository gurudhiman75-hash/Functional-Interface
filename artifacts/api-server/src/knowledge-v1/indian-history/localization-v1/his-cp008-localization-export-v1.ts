...
const lines: string[] = [
  "# History Multilingual V1 — HIS-CP-008 Review",
  "",
...
for (const locale of locales) {
  ...
  generateHisCp008LocalizedReviewV1(locale).forEach((q, index) => lines.push(...renderQuestion(q, index)));
}
const target = path.join(outDir, "HIS-MULTILINGUAL-V1-CP008-REVIEW.md");
