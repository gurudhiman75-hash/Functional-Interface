...
type EnglishQuestion = (typeof HIS_CP023_REVIEW_BATCH_V1)[number];
...
export function generateHisCp023LocalizedReviewV1(locale:HisLocaleV1):HisLocalizedQuestionV1[]{
  return HIS_CP023_REVIEW_BATCH_V1.map((q,index)=>{
...
export const HIS_CP023_LOCALIZATION_V1_SUPPORTED_LOCALES=["en","hi","pa"] as const;
export const HIS_CP023_LOCALIZATION_V1_SUPPORTED_CPS=["HIS-CP-023"] as const;
