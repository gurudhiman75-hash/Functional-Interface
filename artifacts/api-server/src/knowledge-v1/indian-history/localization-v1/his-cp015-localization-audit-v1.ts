...
import { generateHisCp011LocalizedReviewV1 } from "./his-cp015-localization-v1";
...
for (const locale of locales) assertParity(HIS_CP015_REVIEW_BATCH_V1, generateHisCp011LocalizedReviewV1(locale), locale);
