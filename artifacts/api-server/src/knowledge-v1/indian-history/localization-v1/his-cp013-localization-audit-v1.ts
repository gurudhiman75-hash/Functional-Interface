...
import { generateHisCp011LocalizedReviewV1 } from "./his-cp013-localization-v1";
...
for (const locale of locales) assertParity(HIS_CP013_REVIEW_BATCH_V1, generateHisCp011LocalizedReviewV1(locale), locale);
