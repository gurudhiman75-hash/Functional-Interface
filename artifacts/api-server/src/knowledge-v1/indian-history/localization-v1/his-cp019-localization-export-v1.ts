...
const lines:string[]=[
  "# History Multilingual V1 — HIS-CP-019 Review",
  "",
...
for(const locale of locales){
  ...
  generateHisCp018LocalizedReviewV1(locale).forEach((q,index)=>lines.push(...renderQuestion(q,index)));
}
const target=path.join(outDir,"HIS-MULTILINGUAL-V1-CP019-REVIEW.md");
