...
const lines: string[] = [
  "# History Multilingual V1 — HIS-CP-003 Review",
  "",
...
for (const locale of locales) {
  ...
  generateHisCp003LocalizedReviewV1(locale).forEach((q, index) => lines.push(...renderQuestion(q, index)));
}

const target = path.join(outDir, "HIS-MULTILINGUAL-V1-CP003-REVIEW.md");
