...
import { HIS_CP020_REQUIRED_FACTS_V1,HIS_CP020_REVIEW_BATCH_V1,auditHisCp020ReviewBatchV1 } from "./his-cp020-review-v1";
...
assert.equal(HIS_CP020_REQUIRED_FACTS_V1.length,60);
...
assert.equal(HIS_CP020_REVIEW_BATCH_V1.some(q=>(q.explanation.match(/[.!?](?:\s|$)/g)??[]).length<2),false);
