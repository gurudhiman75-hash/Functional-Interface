...
export const PART_3: readonly SciCp040ReviewSpec[] = [
  [
    6,
    "Easy",
  ...
  [
    ...
    [
      "perform photosynthesis with chlorophyll",
      "have no cells",
      "are prokaryotic"
    ],
  ...
  [
    ...
    [
      "Photosynthesis becomes independent of water",
  ...
  [
    ...
    "Blood glucose may remain abnormally high",
    [
      "Blood glucose must fall to zero",
  ...
  [
    ...
    "Overuse can select for resistant bacteria",
    [
      "They make viruses stronger directly",
