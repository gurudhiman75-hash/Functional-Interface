...
A. Gravity reverses
B. Mass becomes zero
C. Air pushes it only from behind
D. Action and reaction forces act in opposite directions
...
C. Both always have zero momentum
D. Momentum does not depend on mass
...
A. They must have the same speed
B. The lighter car may be moving faster than the truck
C. They must have the same mass
D. The truck must always be faster
...
A. height above the liquid
B. decreasing density only
C. depth
D. surface colour
...
A. The increased pressure raises water's boiling point
B. Pressure removes heat
C. The boiling point falls
D. Steam stops forming
...
A. spread light over a wider area
B. concentrate sunlight at a focus
C. form only diminished images
D. stop radiation
...
A. Wool creates heat continuously
B. Wool reflects gravity
C. They trap air that slows heat loss
D. Air conducts heat very well
...
A. The jar shrinks to zero
B. Warm water removes gravity
C. Pressure always becomes zero
D. The metal lid expands slightly when heated
...
A. The coil loses mass
B. The magnetic flux through the coil changes
C. The magnet produces chemical energy
D. Resistance becomes exactly zero
...
A. Their outer electron shells are stable
B. They have no electrons
C. They contain no protons
...
A. Atoms stop moving
B. Activation energy becomes impossible
C. Particles collide more often and with greater energy
D. All bonds disappear instantly
...
A. It contains no iron
B. It cannot react with oxygen
C. Chromium forms a protective oxide layer
D. It is always coated with plastic
...
A. It can release carbon dioxide gas
B. It produces nitrogen only
C. It removes all water
D. It prevents heating
...
A. It must be a noble metal
B. It is more reactive than hydrogen in the activity series
C. It is less reactive than hydrogen
D. It cannot lose electrons
...
Which plant tissue transports sugars from leaves to other parts?
...
Fungi differ from green plants because fungi generally:

A. perform photosynthesis with chlorophyll
B. lack chlorophyll and obtain food heterotrophically
C. have no cells
D. are prokaryotic
...
Which plant hormone is strongly linked with cell elongation and tropic responses?
...
A plant wilts even though soil water is available because its roots are badly damaged. Why?

A. Photosynthesis becomes independent of water
B. Stomata permanently create water
C. Xylem turns into phloem
D. Water uptake by roots is reduced
...
Which part of the brain is important for balance and coordination?
...
Which hormone prepares the body for an emergency 'fight or flight' response?
...
A reflex action can occur before conscious awareness because the immediate response may be coordinated by the:
...
If the pancreas produces too little insulin, which change is expected?

A. Blood glucose must fall to zero
B. Blood glucose may remain abnormally high
C. Oxygen transport stops
D. Urine formation stops completely
...
Night blindness is commonly linked to deficiency of:
...
A. Overuse can select for resistant bacteria
B. They make viruses stronger directly
C. They remove all immunity
D. They always cause deficiency disease
...
A. makes all individuals identical
B. prevents inheritance
C. provides differences on which selection can act
D. stops reproduction
...
A. Every bacterium chooses to become resistant
B. Antibiotics create identical mutations on demand
C. Resistance is unrelated to selection
D. Resistant variants survive and reproduce more successfully
...
B. Available energy decreases at higher trophic levels
C. Top predators create energy
D. Producers contain no energy
...
B. grow whole plants directly
C. separate sound frequencies
D. make many copies of a selected DNA sequence
...
A. Decomposition of dead algae lowers dissolved oxygen
B. Algae turn water into acid instantly
C. Fish stop using oxygen
D. Fertilizer removes all water
...
A. Bacteria naturally contain every human gene
B. The genetic code is nearly universal and the inserted gene can be expressed
C. Human proteins contain no genetic information
D. DNA cannot function across species
...
B. Ammeter measures voltage in parallel
C. Barometer measures current
D. Hygrometer measures pressure
...
A. Water gains extra heat
B. Lower atmospheric pressure lowers the boiling temperature
C. Gravity becomes zero
D. The boiling point rises sharply
...
A. Rutherford—electron; Thomson—neutron; Chadwick—nucleus
B. Becquerel—X-rays; Röntgen—electron; Chadwick—radioactivity
C. Thomson—electron; Rutherford—nucleus; Chadwick—neutron
D. Bohr—penicillin; Fleming—atomic model; Jenner—neutron
...
A. Photosynthesis → antibiotics → ammeter
B. Denitrification → red blood cells → hygrometer
C. Respiration → platelets → barometer
D. Trophic energy transfer → immune memory → voltmeter
