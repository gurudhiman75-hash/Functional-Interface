...
export const PART_3: readonly SciCp031ReviewSpec[] = [
  [
    6,
    "Easy",
    "Which microorganism is widely used in bread making?",
    "Yeast",
    [
      "Amoeba",
      "Rhizobium",
  ...
  [
    6,
    "Easy",
    "The conversion of sugar into alcohol by yeast is called:",
    "Fermentation",
    [
      "Photosynthesis",
      "Transpiration",
  ...
  [
    6,
    "Medium",
    "Why does bread dough rise after yeast is added?",
    "Carbon dioxide produced during fermentation forms bubbles",
    [
      "Yeast produces oxygen by photosynthesis",
  ...
  [
    6,
    "Medium",
    "Curd formation from milk involves production of:",
    "Lactic acid",
    [
      "Hydrochloric acid",
      "Uric acid",
  ...
  [
    6,
    "Hard",
    "A baker adds yeast but keeps dough at a temperature that kills the yeast cells. What is the likely result?",
    "The dough will rise poorly because little fermentation occurs",
    [
      "The dough will rise faster",
  ...
  [
    7,
    "Easy",
    "Which bacterium lives in root nodules of many leguminous plants?",
    "Rhizobium",
    [
      "Lactobacillus",
      "Salmonella",
  ...
  [
    7,
    "Medium",
    "Why can growing legumes improve soil nitrogen?",
    "Rhizobium in their root nodules fixes nitrogen",
    [
      "Legumes release nitrogen gas from leaves",
  ...
  [
    7,
    "Medium",
    "Some cyanobacteria are useful in paddy fields because they:",
    "Fix atmospheric nitrogen",
    [
      "Produce antibiotics in every case",
  ...
  [
    7,
    "Medium",
    "A biofertilizer improves crop nutrition chiefly by using:",
    "Living microorganisms that increase nutrient availability",
    [
  ...
  [
    7,
    "Hard",
    "A farmer repeatedly includes a pulse crop in rotation and later observes less need for nitrogen fertilizer. Which process best explains this?",
    "Biological nitrogen fixation by associated microbes",
    [
  ...
  [
    8,
    "Easy",
    "Penicillin was originally obtained from a:",
    "Penicillium fungus",
    [
      "Virus",
      "Protozoan",
  ...
  [
    8,
    "Easy",
    "Microorganisms are used industrially to produce products such as:",
  ...
  [
    8,
    "Medium",
    "Why are microorganisms useful in industrial fermentation?",
    "They can convert raw materials into useful products under controlled conditions",
    [
      "They eliminate the need for nutrients",
