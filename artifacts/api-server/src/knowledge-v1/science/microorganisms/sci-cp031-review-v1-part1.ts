...
export const PART_1: readonly SciCp031ReviewSpec[] = [
  [
    1,
    "Easy",
  ...
  [
    1,
    "Easy",
    "Which group includes yeast and moulds?",
    "Fungi",
    [
      "Protozoa",
      "Algae only",
  ...
  [
    1,
    "Medium",
    "Microorganisms are commonly found:",
    "In soil, water, air and living organisms",
    [
      "Only in hospitals",
      "Only in oceans",
      "Only inside plants"
  ...
  [
    1,
    "Medium",
    "Which group consists of single-celled organisms such as Amoeba and Paramecium?",
    "Protozoa",
    [
      "Fungi",
      "Viruses",
  ...
  [
    1,
    "Medium",
    "Why are microorganisms important even though many are invisible to the naked eye?",
    "They participate in food production, decomposition and nutrient cycles",
    [
  ...
  [
    1,
    "Hard",
    "A microscopic organism is unicellular, lacks a true nucleus and divides by binary fission. Which group fits best?",
    "Bacteria",
    [
      "Fungi",
      "Protozoa",
  ...
  [
    2,
    "Easy",
    "A common method of bacterial reproduction is:",
    "Binary fission",
    [
      "Budding only",
      "Seed formation",
  ...
  [
    2,
    "Medium",
    "Bacteria are called prokaryotes because they:",
  ...
  [
    2,
    "Medium",
    "Which bacterium is widely used to convert milk into curd?",
    "Lactobacillus",
    [
      "Rhizobium",
      "Vibrio cholerae",
  ...
  [
    2,
    "Medium",
    "Some bacteria form resistant structures called spores when conditions are unfavourable. This helps them to:",
  ...
  [
    2,
    "Hard",
    "A bacterial culture doubles in number repeatedly under favourable conditions. Which process accounts for this rapid increase?",
    "Successive binary fission",
    [
      "Meiosis only",
      "Pollination",
  ...
  [
    3,
    "Easy",
    "Bread mould belongs to the group:",
    "Fungi",
    [
      "Bacteria",
      "Protozoa",
  ...
  [
    3,
    "Medium",
    "Fungi generally obtain nutrition by:",
    "Absorbing dissolved organic matter",
    [
      "Photosynthesizing with chlorophyll in all species",
