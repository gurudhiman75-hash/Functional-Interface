...
export const PART_2: readonly SciCp030ReviewSpec[] = [
  [
    3,
    "Medium",
  ...
  [
    ...
    "The recessive allele remains present in heterozygous F1 individuals",
    [
      "The allele is recreated by the environment",
  ...
  [
    ...
    "Both tall parents carry the recessive dwarf allele",
    [
      "Both parents are pure dominant",
  ...
  [
    ...
    "Each fertilization is an independent chance involving an X- or Y-bearing sperm",
    [
      "The next child must be a boy",
