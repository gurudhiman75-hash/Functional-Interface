...
const S6: readonly S[] = [
  ...
  [2,"Easy","Which property shows that sound is a mechanical wave?","it needs a material medium to travel",["it travels through vacuum","it has no frequency","it always moves at light speed"],"Mechanical waves require a material medium. This dependence on matter distinguishes sound from electromagnetic waves such as light. That is why ordinary sound cannot cross empty space between planets."],
  [3,"Easy","The number of vibrations made in one second is called:","frequency",["amplitude","wavelength","loudness"],"Frequency is the number of oscillations per second. One hertz means one complete vibration or cycle occurs each second. Frequency is therefore a rate describing repeated vibration."],
  [3,"Easy","The SI unit of frequency is:","hertz (Hz)",["decibel (dB)","metre (m)","second (s)"],"Frequency is measured in hertz. A source vibrating 200 times each second therefore has a frequency of 200 Hz. The symbol Hz is the standard SI abbreviation for this unit."],
  [3,"Easy","A sound with a higher frequency is generally heard as:","higher pitch",["greater loudness only","lower pitch","slower sound"],"Pitch depends on frequency. Pitch is the hearing sensation that lets us distinguish higher-frequency sounds from lower-frequency sounds. This remains true even when the loudness of the sound is unchanged."],
  ...
  [3,"Easy","A soft sound has, compared with a loud sound, generally:","smaller amplitude",["higher speed","greater frequency in every case","larger wavelength in every case"],"Soft sounds are linked to smaller amplitudes. Reducing amplitude lowers sound intensity without necessarily changing its pitch. Amplitude controls sound intensity rather than the rate of vibration."],
  [3,"Easy","If the frequency of a sound doubles while other factors are unchanged, its perceived pitch generally:","increases",["decreases","becomes zero","depends only on amplitude"],"Higher frequency corresponds to higher pitch. If amplitude stays unchanged, increasing frequency changes pitch rather than loudness. The ear interprets the faster vibration as a higher note."],
  ...
  [4,"Medium","Frequency and time period are related by:","f = 1/T",["f = T","f = T²","f = 2T"],"Frequency is the reciprocal of time period. This means a high-frequency vibration has a shorter time period. The product of frequency and time period is therefore equal to one."],
  ...
  [4,"Medium","A sound wave of frequency 50 Hz has a time period of:","0.02 s",["2 s","50 s","0.5 s"],"T = 1/f = 1/50 = 0.02 s. A 50 Hz source completes one cycle every 0.02 second. The calculation is simply the reciprocal of the given frequency."],
  ...
  [7,"Medium","The part of the human ear that vibrates when sound waves enter is the:","eardrum",["retina","cornea","optic nerve"],"Sound waves make the eardrum vibrate. The eardrum converts pressure variations in the incoming sound into mechanical vibrations. These vibrations are then transmitted onward through the middle-ear bones."],
  ...
  [9,"Hard","Consider the statements:\nI. Ultrasound has frequency above 20 kHz.\nII. Infrasound has frequency below 20 Hz.\nWhich is correct?","Both I and II",["I only","II only","Neither I nor II"],"Both frequency ranges are correctly stated. These limits divide sound into infrasonic, audible and ultrasonic frequency regions. Normal human hearing lies approximately between these lower and upper frequency limits."],
