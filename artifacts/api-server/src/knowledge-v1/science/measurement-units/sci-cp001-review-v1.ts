...
const REVIEW_SPECS: readonly ReviewSpec[] = Object.freeze([
  ...
  [2,"Easy","Which SI unit is used for work and energy?","joule (J)",["watt (W)","newton (N)","hertz (Hz)"],"Work and energy are measured in joules (J). Work transfers energy, so both quantities use the same SI unit.",["sci001-energy-joule"]],
  [2,"Easy","Power is measured in which SI unit?","watt (W)",["joule (J)","pascal (Pa)","volt (V)"],"Power is measured in watts (W). One watt means one joule of energy transferred or used each second.",["sci001-power-watt"]],
  ...
  [3,"Easy","Which instrument is used to measure atmospheric pressure?","barometer",["manometer","hydrometer","calorimeter"],"A barometer measures atmospheric pressure. Barometers are also useful in weather observation because atmospheric pressure changes with weather conditions.",["sci001-barometer-pressure"]],
  ...
  [3,"Easy","Which instrument is used to measure temperature?","thermometer",["barometer","ammeter","spring balance"],"A thermometer measures temperature. Different thermometers may use different sensors, but all are calibrated to indicate temperature.",["sci001-thermometer-temperature"]],
  ...
  [5,"Medium","2.5 litres is equal to:","2500 mL",["250 mL","25 mL","25,000 mL"],"1 litre = 1000 millilitres, so 2.5 litres = 2500 mL. Multiplying litres by 1000 converts volume into millilitres.",["sci001-volume-conversion"]],
  ...
  [6,"Medium","A frequency of 1 hertz means:","1 cycle per second",["1 cycle per minute","1 metre per second","1 joule per second"],"One hertz means one cycle or oscillation per second. Thus frequency counts repeated events or oscillations per unit time.",["sci001-frequency-hertz-relation"]],
  ...
  [10,"Hard","Which set is correctly matched?\n1. Ammeter — current\n2. Barometer — atmospheric pressure\n3. Lactometer — relative density of milk","All three",["1 and 2 only","2 and 3 only","1 and 3 only"],"All three instrument–measurement pairs are correct. These are standard instrument–quantity matches frequently used in basic measurement questions.",["sci001-ammeter-current","sci001-barometer-pressure","sci001-lactometer-milk"]],
