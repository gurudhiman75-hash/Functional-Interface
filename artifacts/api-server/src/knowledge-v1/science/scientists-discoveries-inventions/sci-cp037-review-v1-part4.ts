...
export const PART_4: readonly SciCp037ReviewSpec[] = [
  [
    8,
    "Medium",
  ...
  [
    ...
    "Meghnad Saha — ionization theory of stellar atmospheres",
    [
      "C. V. Raman — ABO blood groups",
      "S. N. Bose — penicillin",
  ...
  [
    ...
    "Jenner — vaccination; Fleming — penicillin",
    [
      "Fleming — vaccination; Jenner — penicillin",
  ...
  [
    ...
    "Hooke → Leeuwenhoek → Pasteur → Koch",
    [
      "Leeuwenhoek → Hooke → Koch → Pasteur",
  ...
  [
    ...
    "Faraday — induction; Mendeleev — periodic table; Mendel — inheritance",
    [
      "Faraday — vaccination; Mendeleev — radioactivity; Mendel — X-rays",
