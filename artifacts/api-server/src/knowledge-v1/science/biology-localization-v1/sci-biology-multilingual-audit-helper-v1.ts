...
const allowedLatin=/\b(DNA|RNA|ATP|ER|pH|HIV|AIDS|CD4|F1|F2|TT|Tt|tt|XX|XY|YY|XO|XXX|Amoeba|Paramecium|Lactobacillus|Rhizobium|Vibrio|cholerae|Salmonella|Typhi|Mycobacterium|tuberculosis|Plasmodium|vivax|falciparum|Aedes|aegypti|Anopheles|Culex|Penicillium|Rhizopus|Homo|sapiens|CFC|CFCs|PCR|GMO|Bt|Golden|Rice|Bacillus|thuringiensis|Escherichia|coli|Polymerase|Chain|Reaction)\b/g;
