...
const cpId="SCI-CP-019" as const;
const locales=["en","hi","pa"] as const;
const devanagari=/[ऀ-ॿ]/;
const gurmukhi=/[਀-੿]/;
const forbiddenEnglish=/\b(which|what|why|how|because|cell|cells|nucleus|membrane|wall|protein|plant|animal|organism|tissue|organ|mitosis|meiosis|ribosome|golgi|chloroplast|mitochondria|lysosome|vacuole)\b/i;
...
assert.equal(surfaces.en[48].stem,"Which organelle is present in both typical plant and animal cells?","Q49 corrected English stem regressed");
assert.equal(surfaces.en[48].canonicalAnswer,"Mitochondrion","Q49 corrected answer pairing regressed");

console.log(JSON.stringify({
  status:"PASS",
  scope:"SCI-CP-019 multilingual V1",
  locales:[...locales],
  ...
  correctedEnglishDefect:"SCI-CP-019 Q49 stem/answer pairing fixed before localization",
},null,2));
