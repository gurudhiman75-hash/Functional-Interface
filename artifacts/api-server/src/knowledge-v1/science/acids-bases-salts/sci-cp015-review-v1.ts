...
export const SCI_CP015_QL_NAMES_V1: Record<number,string> = {
  1: "Acid/base ions and basic concepts",
  2: "Indicators and colour changes",
  3: "pH scale basics",
  4: "Characteristic acid/base reactions",
  5: "Strength, concentration, neutralization and pH applications",
  6: "Nature of salts and common formulae",
  7: "Baking/washing soda, bleaching powder and chlor-alkali",
  8: "Water of crystallization, gypsum and plaster of Paris",
  9: "Integrated acid-base-salt reasoning",
...
export const SCI_CP015_REVIEW_V1: readonly SciCp015ReviewQuestion[] = Object.freeze(
  REVIEW_SPECS.map((spec,index)=>{
    ...
    return Object.freeze({
      questionId:`SCI-CP-015-REV-${pad3(index+1)}`,
      chapterId:"SCI-001" as const,
      cpId:"SCI-CP-015" as const,
      qlId:`SCI-015-QL-${pad3(ql)}`,
      qlName:SCI_CP015_QL_NAMES_V1[ql],
