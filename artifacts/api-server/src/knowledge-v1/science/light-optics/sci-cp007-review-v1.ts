...
const S7: readonly S[] = [
  ...
  [1, "Easy", "A smooth polished surface gives mainly:", "regular reflection", ["only refraction", "no reflection", "random absorption only"], "A smooth surface reflects parallel incident rays in an orderly way."],
  ...
  [4, "Medium", "A concave mirror is used in a solar cooker mainly because it can:", "concentrate sunlight at its focus", ["spread sunlight widely", "block all infrared radiation", "form only virtual images"], "Parallel sunlight can be converged near the focus of a concave mirror."],
  ...
  [5, "Medium", "A pencil partly immersed in water appears bent mainly due to:", "refraction", ["reflection only", "diffusion", "magnetism"], "Light changes direction as it passes from water to air."],
  ...
  [7, "Medium", "Presbyopia is mainly related to:", "age-related reduction in the eye's power of accommodation", ["infection of the retina only", "complete absence of iris", "excessive tear production"], "With age, the lens becomes less flexible and accommodation decreases."],
  ...
  [8, "Medium", "A rainbow is formed mainly due to refraction, dispersion and:", "internal reflection inside water droplets", ["magnetic induction", "sound interference", "electric conduction"], "Sunlight is refracted and dispersed, reflected inside droplets, and refracted again."],
  [8, "Medium", "The blue colour of the clear daytime sky is mainly due to:", "scattering of shorter wavelengths of sunlight", ["reflection from oceans", "absorption of all blue light", "dispersion by large mirrors"], "Shorter wavelengths such as blue are scattered more strongly by the atmosphere."],
  [8, "Medium", "The Sun appears reddish near sunrise and sunset mainly because:", "shorter wavelengths are scattered out of the direct path", ["red light travels faster in vacuum", "the Sun becomes cooler", "the atmosphere produces red light"], "The long atmospheric path scatters much of the shorter-wavelength light, leaving more red light to reach the eye directly."],
