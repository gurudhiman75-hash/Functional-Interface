...
const S7: readonly S[] = [
  ...
  [2,"Easy","A plane mirror forms an image that is:","the same size as the object",["always enlarged","always diminished","twice the object size"],"Plane-mirror magnification is 1. Magnification is +1, so image height equals object height. The image height therefore matches the object height."],
  ...
  [2,"Easy","The left-right reversal seen in a plane mirror is called:","lateral inversion",["dispersion","refraction","total internal reflection"],"Plane mirrors produce lateral inversion. The reversal is apparent left-to-right because front-back direction is reversed by reflection. The image remains upright even though its sides appear reversed."],
  ...
  [4,"Medium","For a spherical mirror, the focal length is approximately:","half the radius of curvature",["equal to twice the radius","equal to the diameter","independent of radius"],"For a spherical mirror, f = R/2. The relation is valid for spherical mirrors when paraxial rays are considered. For example, a 20 cm radius corresponds to a focal length of about 10 cm."],
  ...
  [6,"Medium","The SI unit commonly used for the power of a lens is:","dioptre",["metre","pascal","candela"],"Lens power is measured in dioptres. One dioptre corresponds to a lens with focal length one metre. Lens power is the reciprocal of focal length measured in metres."],
