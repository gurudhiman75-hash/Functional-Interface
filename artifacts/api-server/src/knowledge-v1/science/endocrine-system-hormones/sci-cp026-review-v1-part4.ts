...
export const PART_4: readonly SciCp026ReviewSpec[] = [
  [
    8,
    "Medium",
    "When blood glucose falls, which hormone is expected to increase?",
    "Glucagon",
    [
      "Insulin",
      "Oxytocin",
  ...
  [
    8,
    "Medium",
    "Why can a small amount of hormone produce a large effect?",
    "Target-cell signalling can amplify the response",
    [
      "Hormones always become enzymes",
  ...
  [
    8,
    "Hard",
    "A gland's hormone rises, and the increased hormone level then reduces further stimulation of that gland. This is an example of:",
    "Negative feedback",
    [
  ...
  [
    ...
    "Diabetes mellitus involves inadequate insulin action, either because too little insulin is produced or because tissues respond poorly to it.",
    [
      "DIABETES-INSULIN"
    ]
  ],
  [
    9,
    "Medium",
    "A child with severe growth-hormone deficiency may develop:",
    "Pituitary dwarfism",
    [
      "Gigantism",
      "Goitre",
  ...
  [
    9,
    "Medium",
    "Excess growth hormone in a child is linked with:",
    "Gigantism",
    [
      "Pituitary dwarfism",
  ...
  [
    9,
    "Medium",
    "Iodine-deficiency goitre affects which gland?",
    "Thyroid gland",
    [
      "Pituitary gland",
      "Adrenal gland",
  ...
  [
    9,
    "Hard",
    "A patient has persistently high blood glucose because pancreatic beta cells produce too little hormone. Which hormone is deficient?",
    "Insulin",
    [
      "Glucagon",
      "Adrenaline",
  ...
  [
    9,
    "Hard",
    "A person has excessive thirst and passes a large volume of very dilute urine, but blood glucose is normal. Which hormonal problem fits best?",
    "Too little ADH action",
    [
      "Too much insulin",
  ...
  [
    10,
    "Easy",
    "Which gland secretes both insulin and glucagon?",
    "Pancreas",
    [
      "Thyroid",
      "Pituitary",
  ...
  [
    10,
    "Medium",
    "After a meal, insulin rises while glucagon falls. What is the net effect?",
    "Blood glucose is brought down toward normal",
    [
      "Blood glucose rises further without limit",
      "Urine stops forming",
  ...
  [
    10,
    "Medium",
    "During fasting, glucagon rises. Why is this useful?",
    "It helps maintain blood glucose by mobilizing stored fuel",
    [
      "It lowers blood glucose by increasing uptake",
  ...
  [
    10,
    "Medium",
    "A person is frightened and immediately develops a faster heartbeat. Which type of coordination best explains the rapid change?",
    "Nervous signals plus adrenaline release",
    [
      "Slow thyroid-hormone action only",
      "Growth hormone only",
      "Melatonin only"
    ],
  ...
  [
    10,
    "Hard",
    "Blood glucose remains high after a meal despite normal glucagon levels. Which change would most directly explain this?",
    "Insulin secretion or insulin action is inadequate",
    [
      "ADH is too high",
  ...
  [
    10,
    "Hard",
    "A hormone changes slowly over hours and affects many tissues, while a reflex movement occurs within a fraction of a second. What best explains the difference?",
    "Hormones travel through blood, whereas nerve impulses move rapidly along neurons",
    [
      "Hormones are always electrical signals",
