...
export const PART_2: readonly SciCp026ReviewSpec[] = [
  ...
  [
    ...
    "Beta cells in the pancreatic islets secrete insulin. These cells are located in clusters called the islets of Langerhans. Damage to these cells can reduce insulin supply and disturb blood-glucose control.",
    [
      "BETA-CELLS-INSULIN"
    ]
  ],
