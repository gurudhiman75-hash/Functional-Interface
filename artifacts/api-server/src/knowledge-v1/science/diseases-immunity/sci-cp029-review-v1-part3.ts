...
export const PART_3: readonly SciCp029ReviewSpec[] = [
  [
    ...
    "Intact skin forms a physical barrier that prevents many pathogens from entering body tissues.",
    [
      "SKIN-BARRIER"
    ]
  ],
  [
    ...
    "Mucus can trap inhaled particles and microorganisms before they reach deeper tissues.",
    [
      "MUCUS-BARRIER"
    ]
  ],
  [
    ...
    "The acidic environment of the stomach destroys many microorganisms entering with food.",
    [
  ...
  [
    ...
    "Phagocytes surround and digest foreign particles and microbes.",
    [
      "PHAGOCYTES"
    ]
  ],
  [
    ...
    "Inflammation is a rapid, non-specific response that helps contain damage and recruit immune defences.",
    [
      "INFLAMMATION-INNATE"
    ]
  ],
  [
    ...
    "Innate defences act rapidly and do not require prior exposure to the specific pathogen.",
    [
  ...
  [
    ...
    "Antibodies are immune proteins that bind specifically to particular antigens.",
    [
      "ANTIBODY-DEFINITION"
    ]
  ],
  [
    ...
    "Antigens are recognized as foreign by the immune system and can stimulate specific immune responses.",
    [
      "ANTIGEN-DEFINITION"
    ]
  ],
  [
    ...
    "Memory lymphocytes remain after the first exposure and generate a quicker, stronger response on re-exposure.",
    [
      "IMMUNE-MEMORY"
    ]
  ],
  [
    ...
    "Adaptive immune responses are directed toward specific antigens on pathogens or other foreign material.",
    [
      "ACQUIRED-SPECIFIC"
    ]
  ],
  [
    ...
    "Infection can stimulate the person's own immune system to make antibodies and memory cells.",
    [
  ...
  [
    ...
    "Passive immunity provides immediate antibodies, but they decline with time and usually do not create lasting memory.",
    [
  ...
  [
    ...
    "Vaccines expose the immune system to safe antigenic material so it can build protection.",
    [
  ...
  [
    ...
    "Vaccines are designed to stimulate protective immunity without producing the full disease in healthy recipients.",
    [
      "VACCINE-ANTIGEN"
    ]
  ],
  [
    ...
    "Vaccination promotes memory cells that can respond rapidly during later exposure.",
    [
      "VACCINE-MEMORY"
    ]
  ]
