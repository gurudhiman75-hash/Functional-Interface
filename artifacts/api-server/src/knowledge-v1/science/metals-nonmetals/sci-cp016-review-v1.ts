...
const REVIEW_SPECS: readonly ReviewSpec[] = Object.freeze([
  ...
  [1,"Easy","Which metal is liquid at ordinary room temperature?","mercury",["iron","aluminium","zinc"],"Mercury is a familiar exception to the general rule that metals are solid at room temperature. Its liquid state makes it a clear physical-property exception among familiar metals.",["sci016-mercury-liquid"]],
  [1,"Easy","Metals generally conduct heat and electricity well because they contain:","mobile electrons",["only fixed neutrons","no charged particles","free protons outside nuclei"],"Metallic structures contain electrons that can move through the lattice, allowing heat and electric charge to be transferred efficiently. The same mobile electrons explain why metals are commonly used for electrical wiring and heat transfer.",["sci016-metal-conductivity"]],
  [1,"Easy","Which statement is generally true of solid non-metals?","They are usually brittle rather than malleable",["They are usually ductile","They are always sonorous","They are all good electrical conductors"],"Most solid non-metals break when hammered instead of forming sheets. This contrasts with the malleability of many metals. They cannot usually be drawn into wires or beaten into sheets like ductile and malleable metals.",["sci016-nonmetal-brittle"]],

  [2,"Easy","Magnesium burns in oxygen to form:","magnesium oxide",["magnesium chloride","magnesium sulphide","magnesium carbonate"],"Magnesium combines with oxygen to form magnesium oxide, MgO. The reaction is seen as a bright white flame. Magnesium oxide is a basic metal oxide and can react with acids to form salts.",["sci016-magnesium-oxide"]],
  ...
  [2,"Easy","Which oxide reacts with both acids and bases?","aluminium oxide",["sodium oxide only","carbon dioxide only","sulphur dioxide only"],"Aluminium oxide is amphoteric. It can react with acids as well as strong bases. This means it can show both acidic and basic behaviour depending on the reacting substance.",["sci016-alumina-amphoteric"]],
  [2,"Easy","Which other metal oxide is commonly described as amphoteric?","zinc oxide",["magnesium oxide","calcium oxide","potassium oxide"],"Zinc oxide reacts with both acids and bases, so it is classified as amphoteric. Its reactions with both types of reagent distinguish it from a purely basic metal oxide.",["sci016-zinc-oxide-amphoteric"]],
  [2,"Easy","Which metal reacts vigorously with cold water?","sodium",["copper","silver","gold"],"Sodium is high in the reactivity series and reacts vigorously with cold water, producing sodium hydroxide and hydrogen. The reaction is strongly exothermic, so the released hydrogen may even ignite.",["sci016-sodium-water"]],
  [2,"Easy","Copper normally does not release hydrogen from dilute hydrochloric acid because copper is:","below hydrogen in the reactivity series",["above sodium in the series","a non-metal","unable to form ions"],"A metal must be above hydrogen to displace hydrogen from a dilute non-oxidizing acid. Copper lies below hydrogen. Therefore copper does not normally produce hydrogen gas with dilute HCl.",["sci016-copper-acid"]],

  [3,"Easy","A metal can displace another metal from its salt solution when it is:","more reactive than the metal in the salt",["less reactive than the metal in the salt","identical in reactivity in every case","a non-metal"],"Displacement occurs when the free metal is higher in the reactivity series than the metal present in the salt. Comparing positions in the reactivity series predicts whether the replacement reaction can occur.",["sci016-displacement-rule"]],
  [3,"Easy","Which metal can displace copper from copper sulphate solution?","zinc",["silver","gold","copper"],"Zinc lies above copper in the reactivity series, so zinc can displace copper from copper sulphate solution. Copper metal is deposited while zinc enters solution as zinc ions.",["sci016-zinc-displace-copper"]],
  [3,"Easy","In Fe + CuSO₄ → FeSO₄ + Cu, the reaction occurs because:","iron is more reactive than copper",["copper is more reactive than iron","iron is below copper in the series","sulphate ions are metals"],"Iron is higher than copper in the reactivity series, so it replaces copper from copper sulphate. The reaction forms iron sulphate in solution and deposits copper metal.",["sci016-fe-cuso4"]],
  [3,"Easy","Which metal cannot displace zinc from zinc sulphate solution?","copper",["magnesium","calcium","aluminium"],"Copper is less reactive than zinc and therefore cannot displace zinc from zinc sulphate solution. Because copper is below zinc, no displacement reaction is expected.",["sci016-copper-zinc-displacement"]],
  [3,"Easy","Which order shows decreasing reactivity correctly?","Mg > Zn > Fe > Cu",["Cu > Fe > Zn > Mg","Fe > Mg > Cu > Zn","Zn > Mg > Cu > Fe"],"Magnesium is more reactive than zinc, zinc more reactive than iron, and iron more reactive than copper. This order can be used to predict reactions with acids and salt solutions.",["sci016-reactivity-order"]],
  [3,"Easy","A metal that releases hydrogen from dilute hydrochloric acid must generally lie:","above hydrogen in the reactivity series",["below hydrogen in the series","below gold only","outside the reactivity series"],"Metals above hydrogen can displace hydrogen ions from dilute non-oxidizing acids and release hydrogen gas. Metals below hydrogen generally cannot release hydrogen from dilute non-oxidizing acids.",["sci016-hydrogen-position"]],
  ...
  [4,"Medium","Why does solid sodium chloride conduct electricity poorly?","its ions are fixed in the crystal lattice",["it contains no ions","chloride becomes neutral","sodium becomes a non-metal"],"Solid NaCl has charged ions, but they cannot move freely. Without mobile charge carriers, electric current cannot pass easily. Heating until molten releases the ions from fixed positions and restores electrical conduction.",["sci016-solid-nacl"]],
  [4,"Medium","Molten sodium chloride conducts electricity because:","its ions are free to move",["its protons leave the nuclei","all ions become neutral","it changes into metallic sodium completely"],"Melting frees the ions from fixed lattice positions. Mobile ions can then carry electric charge. Positive and negative ions move in opposite directions toward the electrodes.",["sci016-molten-nacl"]],
  ...
  [5,"Medium","Haematite is an important ore of:","iron",["aluminium","lead","mercury"],"Haematite is iron(III) oxide-rich ore and is one of the major ores of iron. Its iron oxide content is reduced during extraction to obtain metallic iron.",["sci016-haematite-iron"]],
  [5,"Medium","Galena is an important ore of:","lead",["zinc","aluminium","mercury"],"Galena is lead sulphide, PbS, and is a major ore of lead. The sulphide ore must be processed chemically before metallic lead is obtained.",["sci016-galena-lead"]],
  [5,"Medium","Cinnabar is an important ore of:","mercury",["iron","zinc","aluminium"],"Cinnabar is mercury sulphide, HgS, and is a well-known ore of mercury. Heating and oxidation steps can be used to recover mercury from this sulphide ore.",["sci016-cinnabar-mercury"]],
  [5,"Medium","Zinc blende is:","zinc sulphide",["zinc carbonate","lead sulphide","iron oxide"],"Zinc blende, also called sphalerite, is zinc sulphide, ZnS. It is a sulphide ore, so roasting is a common first conversion step before reduction.",["sci016-zinc-blende"]],
  [5,"Medium","Calamine is commonly represented at school-exam level as an ore containing:","zinc carbonate",["lead sulphide","mercury sulphide","aluminium oxide"],"Calamine is commonly treated in school-level chemistry as zinc carbonate, ZnCO₃, an ore of zinc. As a carbonate ore, it is commonly converted to zinc oxide by calcination.",["sci016-calamine-zinc"]],
  ...
  [6,"Medium","Heating a sulphide ore strongly in excess air is called:","roasting",["calcination","galvanization","electrolytic refining"],"Roasting heats a sulphide ore in air, commonly converting the sulphide into an oxide and releasing sulphur-containing gases. The oxide formed is often easier to reduce to the metal than the original sulphide.",["sci016-roasting"]],
  ...
  [6,"Medium","A substance added during smelting to react with gangue is called:","flux",["slag","ore","alloy"],"Flux is added to combine chemically with gangue. The product formed can then be removed more easily. Its purpose is not to become the metal but to help remove unwanted mineral impurities.",["sci016-flux"]],
  [6,"Medium","The fusible product formed when flux combines with gangue is called:","slag",["ore","alloy","electrolyte"],"Flux reacts with gangue to form slag. Slag separates from the molten metal and helps remove impurities. Because slag separates from the metal phase, it can be removed during smelting.",["sci016-slag"]],
  ...
  [7,"Medium","In electrolytic refining, pure metal is deposited on the:","cathode",["anode","gangue","slag"],"Metal ions from the electrolyte gain electrons and deposit as pure metal on the cathode. The cathode therefore becomes thicker and purer as refining continues.",["sci016-refining-cathode"]],
  [7,"Medium","The thermite reaction commonly uses aluminium powder to reduce:","iron(III) oxide",["sodium chloride","calcium oxide","potassium chloride"],"In the thermite reaction aluminium reduces iron(III) oxide to molten iron and releases a large amount of heat. The intense heat produced can melt iron and has been used for welding heavy steel sections.",["sci016-thermite"]],
  ...
  [8,"Medium","Rusting of iron requires oxygen and:","water or moisture",["nitrogen only","sunlight only","hydrogen only"],"Iron rusts when both oxygen and moisture are present. Removing either condition greatly slows rust formation. Rust is a hydrated iron oxide formed through corrosion rather than simple dry oxidation alone.",["sci016-rusting"]],
  ...
  [8,"Medium","The green coating that develops on old copper surfaces is a:","basic copper carbonate patina",["zinc oxide layer","iron rust layer","silver sulphide layer"],"Copper exposed for a long time to moist air and carbon dioxide develops a green patina commonly described as basic copper carbonate.",["sci016-copper-patina"]],
  [8,"Medium","Brass is an alloy of:","copper and zinc",["copper and tin","iron and carbon","lead and tin"],"Brass is principally copper mixed with zinc. Changing the zinc proportion can alter hardness, strength and colour of the alloy.",["sci016-brass"]],
  [8,"Medium","Bronze is an alloy of:","copper and tin",["copper and zinc","iron and chromium","aluminium and sodium"],"Bronze is principally copper mixed with tin. The tin content makes bronze harder than pure copper and useful for many cast objects.",["sci016-bronze"]],
  [8,"Medium","Stainless steel resists corrosion largely because it contains:","chromium",["sodium","mercury","calcium"],"Chromium forms a thin protective oxide film on stainless steel, greatly improving its resistance to corrosion. This passive chromium-rich surface film slows further attack by air and moisture.",["sci016-stainless-chromium"]],
  ...
  [9,"Hard","A metallurgical step adds a substance that reacts with gangue and produces a removable molten material. The added substance and product are respectively:","flux and slag",["slag and flux","ore and alloy","anode and cathode"],"Flux is added to react with gangue. Their reaction forms slag, which can be separated from the metal. The pair describes the reagent used to remove gangue and the removable product formed from it.",["sci016-integrated-flux-slag"]],
