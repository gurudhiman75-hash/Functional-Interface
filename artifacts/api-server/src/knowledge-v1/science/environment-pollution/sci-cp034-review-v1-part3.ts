...
export const PART_3: readonly SciCp034ReviewSpec[] = [
  [
    6,
    "Easy",
  ...
  [
    ...
    [
      "Destroys all atmospheric oxygen",
  ...
  [
    ...
    "It reduces carbon uptake by trees and can release stored carbon",
    [
      "Trees are the only source of carbon dioxide",
  ...
  [
    ...
    "A long-term rise in Earth's average surface temperature",
    [
  ...
  [
    ...
    "Lower carbon dioxide emissions from power generation",
    [
      "Immediate repair of the ozone layer only",
  ...
  [
    ...
    "More ultraviolet radiation can reach Earth's surface",
    [
      "Less oxygen enters red blood cells directly",
      "Rain becomes louder",
  ...
  [
    ...
    "Stratospheric ozone is protective, while ground-level ozone can be a pollutant",
    [
      "All ozone is equally beneficial",
  ...
  [
    ...
    "Lakes, soils, plants and buildings",
    [
  ...
  [
    ...
    "It can be oxidized and converted into sulfuric acid in the atmosphere",
    [
      "It turns directly into nitrogen gas",
