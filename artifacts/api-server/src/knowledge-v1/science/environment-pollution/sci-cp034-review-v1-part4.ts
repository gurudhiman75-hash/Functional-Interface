...
export const PART_4: readonly SciCp034ReviewSpec[] = [
  [
    8,
    "Medium",
  ...
  [
    ...
    "It can lower the pH of lakes and streams",
    [
      "It always raises oxygen to toxic levels",
  ...
  [
    ...
    "Processes waste materials into new materials or products",
    [
      "Always uses an item unchanged",
  ...
  [
    ...
    "Vegetable peels and garden leaves",
    [
      "Used batteries",
      "Broken glass only",
      "Plastic wrappers"
  ...
  [
    ...
    "Avoiding waste prevents resource use and processing impacts in the first place",
    [
      "Recycling always creates more waste than disposal",
  ...
  [
    ...
    "Each stream can receive the most suitable treatment with less contamination",
    [
      "All waste can be dumped together later",
  ...
  [
    ...
    "They reduce habitat loss and disturbance for many species",
    [
      "They eliminate all natural competition",
  ...
  [
    ...
    "Greater use of public transport and cleaner transport options",
    [
      "Longer idling of engines",
  ...
  [
    ...
    "It can reduce ecosystem resilience and eliminate species and genetic resources",
    [
  ...
  [
    ...
    "Reduce nutrient runoff from farms and sewage sources",
    [
      "Increase noise barriers",
  ...
  [
    ...
    "Prioritize reduction and reuse before recycling and disposal",
    [
      "Expand single-use products",
