...
const REVIEW_SPECS: readonly ReviewSpec[] = Object.freeze([
  ...
  [8,"Medium","A machine lifts a 200 N load with an effort of 50 N. Its mechanical advantage is:","4",["2","50","250"],"Mechanical advantage = load/effort = 200/50 = 4. The load force is four times the effort in this example.",["sci003-mechanical-advantage"]],
