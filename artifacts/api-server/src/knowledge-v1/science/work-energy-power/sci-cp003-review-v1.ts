...
const REVIEW_SPECS: readonly ReviewSpec[] = Object.freeze([
  ...
  [3,"Easy","The energy stored in an object because of its position or configuration is called:","potential energy",["kinetic energy","sound energy","electrical current"],"Potential energy is stored energy associated with position or configuration.",["sci003-potential-definition"]],
  [3,"Easy","A stretched bow mainly stores:","potential energy",["kinetic energy","sound energy","light energy"],"A stretched bow stores elastic potential energy because of its deformation.",["sci003-elastic-potential"]],
  [3,"Easy","As a stone falls freely from a height, its gravitational potential energy is mainly converted into:","kinetic energy",["chemical energy","nuclear energy","magnetic energy"],"During free fall, gravitational potential energy decreases while kinetic energy increases.",["sci003-pe-to-ke"]],
  [3,"Easy","In an electric fan, electrical energy is mainly converted into:","mechanical energy",["chemical energy","nuclear energy","gravitational potential energy"],"The motor in a fan converts electrical energy mainly into mechanical rotational energy.",["sci003-fan-energy-conversion"]],
  ...
  [6,"Medium","A pendulum bob moves from an extreme position toward its lowest point. Its energy changes mainly from:","potential energy to kinetic energy",["kinetic energy to chemical energy","heat to potential energy","electrical energy to nuclear energy"],"As the bob descends, gravitational potential energy is converted into kinetic energy.",["sci003-pendulum-energy"]],
  ...
  [6,"Medium","When a moving bicycle is stopped by brakes, much of its mechanical energy is converted into:","heat",["mass","electric charge","gravitational potential energy"],"Friction in the brakes converts mechanical energy mainly into thermal energy.",["sci003-friction-energy-heat"]],
  ...
  [8,"Medium","A fixed pulley is commonly useful because it can:","change the direction of the applied force",["create mechanical energy","reduce the load's mass","make output work exceed input work"],"An ideal fixed pulley mainly changes the direction of the effort, making lifting more convenient.",["sci003-fixed-pulley"]],
