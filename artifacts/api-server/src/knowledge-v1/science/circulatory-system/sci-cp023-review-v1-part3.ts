...
export const PART_3: readonly SciCp023ReviewSpec[] = [
  [
    6,
    "Easy",
  ...
  [
    ...
    "Veins return blood toward the heart. Most veins carry deoxygenated blood, while pulmonary veins are an important exception.",
    [
      "VEINS-TOWARD"
    ]
  ],
  [
    ...
    "Substances can exchange easily between blood and tissues",
    [
      "They can withstand the highest pressure",
  ...
  [
    ...
    "Flows at lower pressure and may need help preventing backflow",
    [
      "Always moves at higher pressure than arteries",
      "Contains no plasma",
  ...
  [
    ...
    [
      "Flows through two arteries only",
  ...
  [
    ...
    "Pulmonary artery → Lung capillaries → Pulmonary vein",
    [
      "Aorta → Body capillaries → Vena cava",
      "Pulmonary vein → Lung capillaries → Pulmonary artery",
      "Vena cava → Lung capillaries → Aorta"
    ],
    "Blood from the right ventricle travels through the pulmonary artery to lung capillaries and returns through pulmonary veins to the left atrium.",
    [
      "PULMONARY-SEQUENCE"
    ]
  ],
  [
    ...
    "Pressure waves in arteries produced by each heartbeat",
    [
      "Contraction of veins only",
      "Movement of lymph",
