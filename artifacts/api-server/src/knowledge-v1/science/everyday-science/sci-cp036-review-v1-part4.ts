...
export const PART_4: readonly SciCp036ReviewSpec[] = [
  [
    8,
    "Medium",
    "Why is aluminium commonly used for cooking utensils?",
    "It conducts heat well and is relatively light",
    [
  ...
  [
    ...
    "They reduce adhesion between food and the pan surface",
    [
      "They increase rusting",
  ...
  [
    ...
    "Hard-water ions form insoluble salts with soap more readily than with detergent",
    [
      "Hard water contains no water molecules",
  ...
  [
    ...
    "They restrain the body and increase the time over which momentum changes",
    [
      "They increase vehicle speed",
      "They remove inertia",
  ...
  [
    ...
    "They reduce sliding friction by replacing it largely with rolling friction",
    [
      "They increase friction intentionally",
      "They stop rotation",
  ...
  [
    ...
    "Water can reduce effective friction between tyre and road",
    [
      "Water increases tyre mass enough to cause skidding",
  ...
  [
    ...
    "The vehicle has much more kinetic energy to dissipate",
    [
      "The vehicle loses inertia at high speed",
  ...
  [
    ...
    "Black surfaces absorb radiant energy efficiently",
    [
      "Black surfaces reflect all sunlight",
  ...
  [
    ...
    "Some electrical energy is being dissipated as heat because conversion is not perfectly efficient",
    [
      "The charger creates energy",
  ...
  [
    ...
    "More of the input energy is directed toward the desired output with lower unwanted losses",
    [
      "Both devices eliminate electrical resistance completely",
