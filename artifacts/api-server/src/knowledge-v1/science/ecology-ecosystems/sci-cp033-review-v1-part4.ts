...
export const PART_4: readonly SciCp033ReviewSpec[] = [
  [
    8,
    "Medium",
  ...
  [
    ...
    "Nitrogen fixed during the legume phase can increase soil nitrogen availability",
    [
      "Legumes remove all nitrogen from soil",
  ...
  [
    ...
    "Lacks established soil and a biological community",
    [
      "Already has mature forest soil",
  ...
  [
    ...
    "Are among the first organisms to colonize a disturbed or bare area",
    [
      "Always occupy the final stage of succession",
  ...
  [
    ...
    "Alternative feeding links can reduce dependence on any one species",
    [
      "Every species has only one food source",
  ...
  [
    ...
    "Insect numbers may increase",
    [
      "Producer energy becomes unlimited",
  ...
  [
    ...
    "Matter moves through biogeochemical cycles, whereas energy is lost as heat",
    [
      "Energy is converted entirely into minerals",
  ...
  [
    ...
    "Bird numbers may decline because their food supply has fallen",
    [
      "Bird numbers must increase",
  ...
  [
    ...
    "Decomposers consume oxygen while breaking down the large amount of dead organic matter",
    [
      "Producers permanently stop all respiration",
