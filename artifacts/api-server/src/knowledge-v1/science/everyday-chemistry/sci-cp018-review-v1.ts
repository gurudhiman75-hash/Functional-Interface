...
import { PART_1 } from "./sci-cp018-review-v2-part1";
import { PART_2 } from "./sci-cp018-review-v2-part2";
import { PART_3 } from "./sci-cp018-review-v2-part3";
import { PART_4 } from "./sci-cp018-review-v2-part4";
...
export const SCI_CP018_QL_NAMES_V1: Record<number,string> = {
  ...
  4:"Polymers, plastics and synthetic fibres",
  5:"Common hydrated salts and chemical names",
  6:"Food chemistry and preservation",
  7:"Water hardness and treatment",
  8:"Rubber, glass, cement and ceramics",
  9:"Integrated everyday-material reasoning",
