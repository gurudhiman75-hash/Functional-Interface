...
export const PART_3: readonly SciCp039ReviewSpec[] = [
  [
    6,
    "Easy",
  ...
  [
    6,
    "Medium",
    "Which tissue carries water upward in plants?",
    "xylem",
    [
      "phloem",
      "epidermis",
  ...
  [
    6,
    "Medium",
    "Rhizobium benefits leguminous plants by:",
  ...
  [
    6,
    "Medium",
    "Which kingdom in the five-kingdom system contains prokaryotic organisms?",
    "Monera",
    [
      "Protista",
      "Fungi",
  ...
  [
    6,
    "Hard",
    "A unicellular organism has a true nucleus and is not a bacterium. In the five-kingdom framework, the best first placement is:",
    "Protista",
    [
      "Monera",
      "Plantae only",
  ...
  [
    7,
    "Medium",
    "Where does most nutrient absorption from digested food occur?",
    "small intestine",
    [
      "stomach",
      "large intestine",
  ...
  [
    7,
    "Hard",
    "A person's breathing rate rises during exercise. What is the most direct reason?",
  ...
  [
    8,
    "Easy",
    "Vaccination helps protect the body by producing:",
    "immune memory",
    [
      "instant antibiotics",
  ...
  [
    8,
    "Medium",
    "Antibiotics are generally effective against:",
