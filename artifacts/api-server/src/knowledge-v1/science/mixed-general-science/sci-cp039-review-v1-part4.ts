...
export const PART_4: readonly SciCp039ReviewSpec[] = [
  [
    8,
    "Medium",
    "In Mendelian inheritance, a dominant allele is expressed in:",
    "a heterozygous individual",
    [
      "only homozygous recessive individuals",
      "only gametes",
      "no offspring"
    ],
  ...
  [
    8,
    "Medium",
    "Which blood cells are central to adaptive immune responses?",
    "lymphocytes",
    [
      "red blood cells",
      "platelets only",
  ...
  [
    8,
    "Hard",
    "Two healthy parents carry the same recessive disease allele. Why can an affected child still be born?",
    "The child may inherit the recessive allele from both parents",
    [
  ...
  [
    9,
    "Easy",
    "Organisms that make their own food form the first trophic level and are called:",
    "producers",
    [
      "decomposers",
      "secondary consumers",
  ...
  [
    9,
    "Medium",
    "The ten percent law refers to the approximate transfer of:",
  ...
  [
    9,
    "Medium",
    "Why can excessive fertilizer runoff cause fish deaths in lakes?",
    "It can cause algal blooms followed by oxygen depletion",
    [
  ...
  [
    9,
    "Hard",
    "If decomposers disappeared from an ecosystem, what long-term change would be expected?",
    "Dead matter would accumulate and nutrient recycling would slow",
    [
      "Energy would increase at each trophic level",
  ...
  [
    9,
    "Hard",
    "A forest is cleared and burned. Why can this increase atmospheric carbon dioxide in two ways?",
    "Burning releases stored carbon and fewer trees remain to absorb carbon dioxide",
    [
      "Both burning and cutting remove carbon dioxide",
  ...
  [
    ...
    [
      "Higher pressure lowers water temperature",
  ...
  [
    10,
    "Medium",
    "Which instrument records electrical activity of the heart?",
    "electrocardiograph",
    [
  ...
  [
    10,
    "Hard",
    "Which set is completely correct?",
    "Mendeleev—periodic table; Faraday—electromagnetic induction; Mendel—inheritance",
    [
      "Mendeleev—penicillin; Faraday—vaccination; Mendel—X-rays",
  ...
  [
    10,
    "Hard",
    "A clinic must measure blood pressure, lung volume and hearing threshold. Which sequence is correct?",
    "sphygmomanometer → spirometer → audiometer",
    [
      "spirometer → audiometer → barometer",
