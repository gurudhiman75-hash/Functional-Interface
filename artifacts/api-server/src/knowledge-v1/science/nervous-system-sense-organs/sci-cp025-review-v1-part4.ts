...
export const PART_4: readonly SciCp025ReviewSpec[] = [
  ...
  [
    ...
    "Skin contains mechanoreceptors that respond to touch, pressure and vibration. Other skin receptors detect temperature, pain and tissue damage. This lens shifts the image back onto the retina so distant objects can be seen clearly.",
    [
