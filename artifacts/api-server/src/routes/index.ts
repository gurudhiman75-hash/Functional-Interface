...
import adminQuestionStudioSimplificationRouter from "./admin-question-studio-simplification";
...
router.use("/admin/question-studio", adminQuestionStudioSimplificationRouter);
