...
import adminQuestionStudioRnkPersistenceRouter from "./admin-question-studio-rnk-persistence";
...
router.use("/admin/question-studio", adminQuestionStudioRnkPersistenceRouter);
