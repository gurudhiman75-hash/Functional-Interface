...
import adminQuestionStudioDashboardLifecycleRouter from "./admin-question-studio-dashboard-lifecycle";
...
router.use("/admin/question-studio", adminQuestionStudioDashboardLifecycleRouter);
