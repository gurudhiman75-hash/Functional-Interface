...
import adminQuestionStudioReasoningReviewRouter from "./admin-question-studio-reasoning-review";
...
router.use("/admin/question-studio", adminQuestionStudioReasoningReviewRouter);
