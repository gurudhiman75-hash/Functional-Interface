...
import adminQuestionStudioReasoningGateRouter from "./admin-question-studio-reasoning-gate";
...
router.use("/admin/question-studio", adminQuestionStudioReasoningGateRouter);
