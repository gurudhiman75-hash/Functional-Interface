...
async function seedDatabase() {
  try {
    ...
    const categoryData = [
      ...
      { id: "3", name: "Punjab", description: "Punjab state government exams and competitive tests", icon: "https://www.kindpng.com/picc/m/120-1201989_govt-of-punjab-india-logo-hd-png-download.png", color: "blue", testsCount: 0 },
    ];
