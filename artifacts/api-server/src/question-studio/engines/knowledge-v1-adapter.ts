...
import {
  isCom003QuestionStudioRequestV1,
...
export const knowledgeV1QuestionStudioAdapter: QuestionStudioEngineAdapter = {
  ...
  listPackages() {
    const packages = [
      ...
      ...knowledgeV1Com003QuestionStudioAdapterV1.listPackages(),
    ];
  ...
  async generate(request: QuestionStudioGenerationRequest): Promise<QuestionStudioGenerationResult> {
    if (isCom003QuestionStudioRequestV1(request)) {
      return knowledgeV1Com003QuestionStudioAdapterV1.generate(request);
    }
