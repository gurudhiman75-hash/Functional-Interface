...
assert.deepEqual(registered?.cpIds, ["ENG-001-CP001", "ENG-001-CP002", "ENG-001-CP003", "ENG-001-CP004", "ENG-001-CP005", "ENG-001-CP006", "ENG-001-CP007"]);
...
console.log("ENG-001 CP001–CP003 legacy Question Studio regressions passed with CP004–CP007 package registration.");
