...
const registeredCps = [...cp007Cps, "ENG-001-CP008", "ENG-001-CP009", "ENG-001-CP010", "ENG-001-CP011"];
...
console.log("ENG-001 CP007 Question Studio review-only integration tests passed with CP011 registered globally.");
