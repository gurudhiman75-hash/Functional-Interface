...
const registeredCps = [...expectedCps, "ENG-001-CP009", "ENG-001-CP010"];
...
console.log("ENG-001 CP008 Question Studio review-only integration tests passed with CP009-CP010 registered globally.");
