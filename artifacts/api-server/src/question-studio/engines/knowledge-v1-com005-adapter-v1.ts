...
const qlIds=COM005_ENGLISH_FREEZE_AUTHORITY_V1.permanentQlIds as readonly string[];
const cpIds=["COM-005-CP-001"] as const;
...
function corpusFor(language:QuestionStudioLanguage):readonly Com005FrozenQuestion[] {
  if(language==="en") return COM005_ENGLISH_FROZEN;
  if(language==="hi") return COM005_HINDI_FROZEN;
  return COM005_PUNJABI_FROZEN;
}
...
function toRecord(question:Com005FrozenQuestion):Com005CorpusRecord {return {...question,cpId:cpIds[0]};}
function recordForOutput(record:Com005CorpusRecord) {
  return {
    ...
    registrationStatus:"REGISTERED_BANK_ONLY_INTERNAL", registrationAuthorityId:COM005_LOCALIZATION_FREEZE_AUTHORITY_V1.authorityId,
    ...
    questionStudioReview:{...lifecycle,registrationStatus:"REGISTERED_BANK_ONLY_INTERNAL",registrationAuthorityId:COM005_LOCALIZATION_FREEZE_AUTHORITY_V1.authorityId,
      runtimeMode:COM005_QUESTION_STUDIO_RUNTIME_MODE_V1,contentAuthorityVersion:COM005_CONTENT_AUTHORITY_VERSION_V1,humanReviewApproved:true,
      frozenCorpusOnly:true,immutableCorpus:true,deterministicSelection:true,selectionWithoutReplacement:true,
      sourceEnglishAuthorityId:COM005_ENGLISH_FREEZE_AUTHORITY_V1.authorityId,localizationFreezeAuthorityId:COM005_LOCALIZATION_FREEZE_AUTHORITY_V1.authorityId,
...
export const COM005_STANDARD_BANK_ONLY_PACKAGE_V1:QuestionStudioPackageDefinition={
  ...
  label:"Computer Awareness · Computer Networking · English Freeze V1 / Hi-Pa Localization Freeze V1",
  ...
  metadata:{...lifecycle,reviewOnly:false,humanReviewApproved:true,frozenCorpusOnly:true,immutableCorpus:true,deterministicSelection:true,
    ...
    englishQuestionCount:COM005_ENGLISH_FROZEN.length,hindiQuestionCount:COM005_HINDI_FROZEN.length,punjabiQuestionCount:COM005_PUNJABI_FROZEN.length,
    ...
    localizationCombinedFingerprint:COM005_LOCALIZATION_FREEZE_AUTHORITY_V1.combinedFingerprint,revisionPolicy:COM005_REVISION_POLICY_V1,
...
export const knowledgeV1Com005QuestionStudioAdapterV1:QuestionStudioEngineAdapter={
  ...
  async generate(request:QuestionStudioGenerationRequest):Promise<QuestionStudioGenerationResult>{
    ...
    return {questions:selected.map(recordForOutput),generationContext:{...lifecycle,engineId:"knowledge-v1",packageId:COM005_QUESTION_STUDIO_PACKAGE_ID_V1,
      runtimeMode:COM005_QUESTION_STUDIO_RUNTIME_MODE_V1,registrationStatus:"REGISTERED_BANK_ONLY_INTERNAL",registrationAuthorityId:COM005_LOCALIZATION_FREEZE_AUTHORITY_V1.authorityId,
      ...
      contentAuthorityVersion:COM005_CONTENT_AUTHORITY_VERSION_V1,revisionPolicy:COM005_REVISION_POLICY_V1,language,locale:`${language}-IN`,
