...
assert.deepEqual(registered?.cpIds, [
  "ENG-001-CP001", "ENG-001-CP002", "ENG-001-CP003",
  "ENG-001-CP004", "ENG-001-CP005", "ENG-001-CP006", "ENG-001-CP007", "ENG-001-CP008", "ENG-001-CP009", "ENG-001-CP010",
]);
...
console.log("ENG-001 CP006 Question Studio review-only integration tests passed with CP010 registered globally.");
