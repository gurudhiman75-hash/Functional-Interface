...
const expectedCurrentCps = [...expectedCp009Cps, "ENG-001-CP010", "ENG-001-CP011", "ENG-001-CP012"];
...
console.log("ENG-001 CP009 Question Studio review-only integration tests passed with CP012 registered globally.");
