...
describe("ECO-001 Question Studio review-only registration", () => {
  it("registers one enabled 23-CP Economy package", () => {
  ...
  it("rejects unsupported language and unknown selectors", async () => {
    await expect(
      knowledgeV1Eco001QuestionStudioAdapterV1.generate({ packageId: "ECO-001", language: "hi" }),
