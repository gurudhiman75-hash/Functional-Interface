...
import {
  isEng001Cp009QuestionStudioRequestV1,
  languageV1Eng001Cp009QuestionStudioAdapterV1,
} from "./language-v1-eng001-cp009-adapter-v1";
import {
  isEng001Cp010QuestionStudioRequestV1,
  languageV1Eng001Cp010QuestionStudioAdapterV1,
} from "./language-v1-eng001-cp010-adapter-v1";
import {
  isEng001Cp011QuestionStudioRequestV1,
  languageV1Eng001Cp011QuestionStudioAdapterV1,
} from "./language-v1-eng001-cp011-adapter-v1";
import {
  isEng001Cp012QuestionStudioRequestV1,
  languageV1Eng001Cp012QuestionStudioAdapterV1,
} from "./language-v1-eng001-cp012-adapter-v1";
...
export const languageV1QuestionStudioAdapter: QuestionStudioEngineAdapter = {
  ...
  listPackages() {
    return [...languageV1Eng001Cp012QuestionStudioAdapterV1.listPackages()];
  },
