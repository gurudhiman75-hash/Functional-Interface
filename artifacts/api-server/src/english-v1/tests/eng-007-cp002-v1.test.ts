...
const canonicalSet=new Set(ENG007_CP002_ENTRIES_V1.map(x=>x.correct.toLowerCase()));
const misspellingSet=new Set(ENG007_CP002_ENTRIES_V1.map(x=>x.misspelling.toLowerCase()));
