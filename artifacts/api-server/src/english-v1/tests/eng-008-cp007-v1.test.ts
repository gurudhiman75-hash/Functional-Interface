...
assert.equal(ENG008_CP007_AUTHORITIES_V1.length,30);assert.equal(new Set(ENG008_CP007_AUTHORITIES_V1.map(x=>x.passageId)).size,30);
...
console.log("ENG-008 CP007 Banking Prelims word-fit audit passed.",{authorities:30,soak:1600});