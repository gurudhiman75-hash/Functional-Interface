...
assert.equal(ENG008_CP007_AUTHORITIES_V1.length,10);assert.equal(new Set(ENG008_CP007_AUTHORITIES_V1.map(x=>x.passageId)).size,10);
...
console.log("ENG-008 CP007 Banking Prelims word-fit audit passed.",{authorities:10,soak:1600});