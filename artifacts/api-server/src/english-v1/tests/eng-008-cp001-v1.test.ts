...
assert.deepEqual(Object.fromEntries(genres),{narrative:23,report:23});
for(const familyId of ENG008_CP001_FAMILY_IDS_V1)assert.equal(families.get(familyId),46,`${familyId} should have 30 authorities`);
