...
assert.deepEqual(Object.fromEntries(genres),{narrative:4,report:4,editorial:4});
...
console.log("ENG-008 CP001 foundation RC audit passed.",{passages:12,authorities:72,soak:6000});
