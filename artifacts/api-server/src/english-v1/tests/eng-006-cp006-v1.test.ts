...
const families=[["aphelion","perihelion"],["apogee","perigee"],["solute","solvent"],["isotope","isobar","isotone"],["oxidation","reduction"],["port","starboard"],["bow","stern"],["benevolent","malevolent"],["credulous","gullible"],["reticent","reserved"],["meticulous","fastidious"],["entourage","retinue"],["frugal","prodigal"]]as const;
