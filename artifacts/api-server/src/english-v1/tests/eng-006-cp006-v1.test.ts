...
const families=[["aphelion","perihelion"],["apogee","perigee"],["solute","solvent"],["isotope","isobar","isotone"],["oxidation","reduction"],["countryman","compatriot"],["alumnus","alumna"],["lease","tenancy"],["assault","battery"]]as const;
