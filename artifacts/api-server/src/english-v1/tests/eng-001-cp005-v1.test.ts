...
import { remediateCp005SceneForClosureV1 } from "../chapters/error-spotting/ENG-001/CP005/cp005-closure-remediation-v1";
...
const effectiveScenes = CP005_ALL_SCENES_V1.map(remediateCp005SceneForClosureV1);
