...
const replacements: Readonly<Record<string, VoiceNarrationSceneV1>> = {
  "VNR-H-001": voiceNarrationScene({
    id: "VNR-H-001", difficulty: "hard", ruleId: "GR-VNR-001", domain: "selection-panel", errorIndex: 1,
    correctSegments: ["After the panel had chosen the shortlist from twenty applicants,", "the three finalists were chosen", "only after their written scores had been compared", "with the interview records."],
    errorSegments: ["After the panel had chosen the shortlist from twenty applicants,", "the three finalists were chose", "only after their written scores had been compared", "with the interview records."],
  ...
  "VNR-H-002": voiceNarrationScene({
    id: "VNR-H-002", difficulty: "hard", ruleId: "GR-VNR-001", domain: "withdrawn-notices", errorIndex: 2,
    correctSegments: ["After the department withdrew the first draft,", "officials reviewed the notices again", "and they were withdrawn", "before the revised order was issued."],
    errorSegments: ["After the department withdrew the first draft,", "officials reviewed the notices again", "and they were withdrew", "before the revised order was issued."],
  ...
  "VNR-H-024": voiceNarrationScene({
    id: "VNR-H-024", difficulty: "hard", ruleId: "GR-VNR-012", domain: "inform-us", errorIndex: 2,
    correctSegments: ["After the coordinator explained to us that the timetable had changed,", "she contacted the volunteers", "and informed us that the session would start later", "than originally planned."],
    errorSegments: ["After the coordinator explained to us that the timetable had changed,", "she contacted the volunteers", "and informed to us that the session would start later", "than originally planned."],
