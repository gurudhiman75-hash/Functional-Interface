...
const lines:string[]=["# ENG-006 — One-word Substitution — Expanded Full Chapter Review V2","","Status: `HUMAN_EDITORIAL_REVIEW_PENDING__REVIEW_ONLY`","","Total bank: **1,400 unique substitutions**.","","Review sample: **180 questions — 30 from each checkpoint, balanced across Easy / Medium / Hard**.","","---",""];
const specs=[
...
lines.push("## Chapter review checklist","","- Definitions are precise and exam-standard.","- Exactly one option is defensible.","- Distractors are plausible and remain within the same semantic family.","- CP005/CP006 add genuine breadth rather than duplicates or trivial derivatives.","- Advanced and long-tail terms remain useful competitive vocabulary.","- Easy/Medium/Hard calibration is meaningful.","- Explanations are simple and direct.","");
