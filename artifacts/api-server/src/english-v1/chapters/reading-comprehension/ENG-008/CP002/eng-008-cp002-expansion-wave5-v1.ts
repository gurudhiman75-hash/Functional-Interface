...
A transparent dashboard should not pretend away these limits. It should help readers distinguish real change from changes in measurement so that a clean-looking chart does not create false certainty. Version dates are useful for the same reason. If a dashboard clearly states when a definition changed, later readers can understand why two apparently continuous points may not represent exactly the same concept.`,
 ...
 q("E15-Q7","RC2-F07","medium","Which statement is supported?","Some historical records may not contain enough detail for recalculation",["All old data can be converted","Method changes should be hidden","Only crime data has this problem"],"The fifth paragraph states this directly. This detail directly supports the stated answer in the passage.","do not contain enough detail"),
...
Officials concluded that evening sweeping improved access on several market roads but needed local adjustment where late-night activity or residential noise was important. The next phase will compare labour time, complaints and cleanliness ratings before deciding whether to expand the schedule. The municipality also recorded fuel use because a later schedule could change travel patterns between roads. That measure did not show a large difference, but officials decided to keep it in the next trial so operational cost would not be judged only through labour time.`,
 ...
 q("R10-Q7","RC2-F07","medium","Which statement is supported?","The trial tested cleaning access rather than whether people created less litter",["All six roads collected more litter","Residents preferred more noise","Deliveries stopped during the trial"],"The fifth paragraph states this explicitly. This detail directly supports the stated answer in the passage.","did not measure whether total litter generation changed"),
 q("R10-Q8","RC2-F08","easy","In context, “kerb” most nearly refers to:","the edge of the road beside the pavement",["a market stall","a cleaning vehicle","a restaurant entrance"],"Sweepers needed access to the road edge. This detail directly supports the stated answer in the passage.","reach the kerb")
 ]
},
{
...
Officials concluded that the token system improved clarity and comfort without increasing service capacity. They plan to test whether appointment booking by time slot can reduce actual waiting, while keeping the token system for walk-in visitors. The district will also measure how often visitors leave before being served. A clearer queue may reduce uncertainty without reducing the wait, but abandonment rates could show whether comfort and predictability still affect whether people remain in the system. The district will also compare complaint rates before and after the change so that perceived fairness is measured separately from waiting time.`,
 ...
 q("R11-Q2","RC2-F02","medium","Why did average waiting time change little?","Service capacity stayed the same",["Visitors refused tokens","The displays failed","Counters closed earlier"],"The same number of counters remained open. This detail directly supports the stated answer in the passage.","same number of counters"),
 ...
 q("R11-Q6","RC2-F06","hard","Which conclusion is justified?","A queue system can improve perceived order without increasing throughput",["Visible displays always reduce service time","Tokens eliminate the need for staff","Every visitor understands visual alerts equally"],"The pilot improved clarity but not capacity. This detail directly supports the stated answer in the passage.","without increasing service capacity"),
 q("R11-Q7","RC2-F07","medium","Which statement is supported?","Spoken announcements were added to help some elderly visitors",["All visitors disliked the displays","The centres stopped serving walk-ins","Queue disputes increased"],"The fifth paragraph states this directly. This detail directly supports the stated answer in the passage.","spoken announcement was added"),
