...
export const ENG008_CP003_EXPANSION_WAVE10_V1:readonly Eng008Cp003PassageV1[]=[
{
...
When the scholarship portal later sent a confirmation message, it listed the documents actually received and separately showed electronic bank verification. That final record matched what Mehak had submitted.`,
 ...
 q("N13-Q3","BP-F03","medium","What is the central idea of the passage?","Applicants should verify revised requirements using current identifiers and system status",["Longer checklists are always safer","Extra documents should never be submitted","Scholarship rules never change"],"The story shows how dates, scheme codes and verification status help distinguish an updated requirement from a possibly unrelated notice.","matching identifier is stronger evidence"),
 q("N13-Q4","BP-F04","medium","Which statement is supported?","Applicants could still attach the extra passbook copy even though it was no longer required",["Bank verification had been cancelled","The income certificate was removed from the checklist","Mehak submitted after the deadline"],"Staff said the extra document remained allowed but unnecessary for verified accounts.","still allowed to attach the extra document"),
 q("N13-Q5","BP-F05","easy","In context, “revision” is closest in meaning to:","an updated version or change",["a payment receipt","a rejected application","an exam result"],"The portal used the term for a newly changed checklist issued that morning.","revision notice"),
 q("N13-Q6","BP-F06","easy","Which word is opposite in meaning to “required”?","optional",["necessary","compulsory","essential"],"Required means mandatory; optional means not compulsory.","no longer required"),
 q("N13-Q7","BP-F07","medium","What does “bank verification complete” indicate?","The account details had already been confirmed electronically",["The scholarship had been paid","The bank account was closed","The passbook had been printed"],"The status explained why a paper copy was no longer necessary.","already been verified electronically"),
 q("N13-Q8","BP-F08","medium","Why did the college shorten the checklist?","Electronic verification made one paper document unnecessary",["Applicants requested fewer marksheets","The scholarship budget was reduced","The portal could not accept documents"],"The revised process avoided duplicate evidence for information already confirmed digitally.","reduce unnecessary paperwork"),
 q("N13-Q9","BP-F09","medium","Which title best suits the passage?","The Updated Scholarship Checklist",["The Missing Bank Account","A New College Notice Board","The Late Scholarship Payment"],"The passage centres on verifying a revised document requirement for a scholarship application.","revised checklist")
 ]
},
{
...
The airport later refreshed the original screen, but by then Arjun understood that a delayed display is not necessarily false in general; it may simply be behind the newest operational change.`,
 ...
 q("N14-Q3","BP-F03","medium","What is the central idea of the passage?","When travel information conflicts, the latest official update should be matched to the exact journey and cross-checked",["Printed boarding passes are unreliable","Airport screens should be ignored","Gate changes always indicate delay"],"Arjun resolves the conflict by checking flight identity, recency and another official source.","prefer the most recent official update"),
 q("N14-Q4","BP-F04","medium","Which statement is supported?","The printed boarding pass still had correct seat and flight details",["Arjun changed flights","The app showed Gate 18 throughout","Every airport screen updated simultaneously"],"The passage says only the gate assignment had changed.","name, flight number and seat remained correct"),
 q("N14-Q5","BP-F05","easy","In context, “concourse” is closest in meaning to:","a large public area connecting airport gates",["the aircraft cockpit","the luggage belt","the runway"],"Arjun checked a screen in the central passenger area before walking to the new gate.","central concourse"),
 q("N14-Q6","BP-F06","easy","Which word is opposite in meaning to “recent”?","old",["new","current","latest"],"Recent means new or not long ago; old is the opposite.","marked the update as recent"),
 q("N14-Q7","BP-F07","medium","What does the timestamp help show?","When the gate information was last updated",["When Arjun bought the ticket","How long security took","When the aircraft was built"],"The timestamp gives evidence of how current the displayed information is.","timestamp for the update"),
 q("N14-Q8","BP-F08","medium","Why might the screen near Gate 18 have remained wrong for a short time?","Different airport systems can update at different speeds",["Gate 18 was removed permanently","The airline had cancelled the flight","Arjun read the wrong date"],"The agent explained that display systems do not always refresh simultaneously.","update at slightly different times"),
 q("N14-Q9","BP-F09","medium","Which title best suits the passage?","The Changed Airport Gate",["The Missing Boarding Pass","A Delayed Security Check","The Empty Aircraft"],"The story centres on verifying a last-minute gate change.","flight would now leave from Gate 24")
 ]
},
{
...
The project therefore became less about counting bicycles and more about communicating readiness accurately at the moment someone wanted to borrow one.`,
 ...
 q("S12-Q3","BP-F03","medium","What is the central idea of the passage?","Shared-resource status should reflect actual readiness, not just physical presence",["Every bicycle needs a technician beside it","Battery level is the only important condition","Apps should show all engineering data"],"The project expands availability from location to charge, faults and confirmed dock connection.","communicating readiness accurately"),
 q("S12-Q4","BP-F04","medium","Which statement is supported?","A shade cover improved charging performance at one dock",["Every bike charged at the same speed","The app removed the amber status","Residents had to diagnose brake faults"],"The slower hot-afternoon dock improved after shading reduced heat exposure.","shade cover was added"),
 q("S12-Q5","BP-F05","easy","In context, “diagnose” is closest in meaning to:","identify the technical cause of a problem",["unlock a bicycle","report a symptom","reserve a dock"],"Residents only described visible problems; they were not expected to determine the underlying mechanical cause.","diagnose the technical cause"),
 q("S12-Q6","BP-F06","easy","Which word is opposite in meaning to “ready”?","unavailable",["prepared","usable","available"],"A bicycle not ready for use is effectively unavailable to the next rider.","actually ready"),
 q("S12-Q7","BP-F07","medium","What does the confirmation light indicate?","The dock has successfully registered the returned bicycle",["The battery is fully charged","The bicycle has no mechanical fault","The user has paid a fee"],"The light verifies that the return connection has been recognised by the system.","wait for the light before walking away"),
 q("S12-Q8","BP-F08","medium","Why did detailed diagnostic information remain hidden from ordinary riders?","Riders mainly needed a simple readiness status, while maintenance staff needed technical detail",["The app could not store data","Faults were kept secret","Residents were not allowed to report problems"],"The system separated user-facing information from maintenance information according to purpose.","Riders mainly needed to know whether"),
 q("S12-Q9","BP-F09","medium","Which title best suits the passage?","Shared E-Bike Dock Status",["Building a New Metro Station","Why Bicycles Need No Charging","The Closed Market Road"],"The passage centres on improving how a shared e-bike system communicates readiness.","status system")
 ]
},
{
...
By separating content rules from current status, the system became easier to understand at the moment residents were making a disposal decision.`,
 ...
 q("S13-Q3","BP-F03","medium","What is the central idea of the passage?","Effective shared waste systems need simple sorting guidance, current bin status and suitable collection timing",["Cameras are necessary for waste control","Colour tags can replace all instructions","Every bin should be collected at the same frequency"],"The project improves behaviour by addressing information and operational factors together.","simple instructions, accurate status and collection schedules"),
 q("S13-Q4","BP-F04","medium","Which statement is supported?","The collection team became responsible for resetting tags after cleaning",["Residents were fined for every mistake","All bins filled at the same rate","Cameras were installed"],"The change prevented old red warnings from remaining after a bin was ready again.","responsible for resetting the tag"),
 q("S13-Q5","BP-F05","easy","In context, “contamination” is closest in meaning to:","unwanted material mixed with the compost waste",["a full bin","bad weather","slow collection"],"Plastic and other non-compostable items were the contamination problem.","plastic bags and other non-compostable items"),
 q("S13-Q6","BP-F06","easy","Which word is opposite in meaning to “accepted”?","rejected",["allowed","approved","permitted"],"Accepted items are allowed; rejected items are not.","accepted items"),
 q("S13-Q7","BP-F07","medium","What does the yellow tag indicate?","The bin is nearly due for collection and another bin may be preferable",["The bin contains hazardous waste","The bin has just been cleaned","The bin is permanently closed"],"Yellow communicated an approaching capacity or collection limit, not a contamination fault.","collection was due soon"),
 q("S13-Q8","BP-F08","medium","Why did the committee reject cameras?","It judged the privacy cost too high for the benefit",["Cameras cannot work outdoors","Workers refused to view video","Residents wanted longer instructions"],"The association preferred anonymous education over individual surveillance.","privacy cost too high"),
 q("S13-Q9","BP-F09","medium","Which title best suits the passage?","Community Compost Bin Tags",["The Apartment Recycling Ban","A New Waste Truck","Why Food Scraps Are Valuable"],"The passage centres on tags and clearer guidance for shared compost bins.","coloured tag beside the lid")
 ]
},
{
...
The main lesson was to keep the conclusion matched to what had actually been measured. Temperature data supported a temperature claim; it did not automatically support every claim people make about battery health.`,
 ...
 q("SC11-Q3","BP-F03","medium","What is the central idea of the passage?","The experiment found temperature differences but kept conclusions limited to what was actually measured",["The coolest phone will always last longest","Charging near a fan is unsafe","External temperature proves battery damage"],"The passage repeatedly separates observed heat patterns from unmeasured long-term outcomes.","keep the conclusion matched to what had actually been measured"),
 q("SC11-Q4","BP-F04","medium","Which statement is supported?","Video use increased temperature compared with resting on the desk",["The fan phone charged fastest","Internal cell temperature was measured directly","Battery health improved during the trial"],"The active phone warmed more than the resting phone under otherwise similar charging.","phone playing video also warmed more"),
 q("SC11-Q5","BP-F05","easy","In context, “capacity” is closest in meaning to:","the amount of charge a battery can hold",["the number of phones in a room","the speed of a fan","the charger cable length"],"Long-term battery capacity refers to how much energy the battery can store.","battery capacity over months"),
 q("SC11-Q6","BP-F06","easy","Which word is opposite in meaning to “external”?","internal",["outside","surface","visible"],"External refers to the outside; internal refers to the inside.","external sensor"),
 q("SC11-Q7","BP-F07","medium","What does “general pattern remained similar” mean?","The relative temperature ordering was broadly repeated even when exact values changed",["Every reading was identical","All devices charged at the same speed","Room temperature never changed"],"The experiment reproduced the same broad relationships across days and device swaps.","general pattern remained similar"),
 q("SC11-Q8","BP-F08","medium","Why was the video condition harder to interpret than the resting condition?","Video use added processor and screen heat as well as charging heat",["The phone had a different charger","The battery started empty","No temperature was recorded"],"More than one factor differed, making the source of additional heat less isolated.","additional heat from the processor and display"),
 q("SC11-Q9","BP-F09","medium","Which title best suits the passage?","Testing Phone Battery Charging Habits",["Repairing a Broken Smartphone","Why Batteries Never Heat","Building a Cooling Fan"],"The passage describes a controlled comparison of phone temperatures under different charging-use conditions.","compared how quickly four identical smartphones warmed")
 ]
},
{
...
The final report therefore separated two questions: “Which of these cups kept water warm longest?” and “Which material is the best insulator?” Their data answered the first much better than the second.`,
 ...
 q("SC12-Q3","BP-F03","medium","What is the central idea of the passage?","A finished-product comparison can be useful without proving which material alone is best",["Material never affects insulation","Lids do not matter","The ceramic cup should be redesigned"],"The class distinguishes a practical product result from a controlled material claim.","data answered the first much better than the second"),
 q("SC12-Q4","BP-F04","medium","Which statement is supported?","Leaving lids partly open made all cups cool faster",["The temperature gap became larger","The ceramic cup had the smallest surface area","Students handled cups continuously"],"The follow-up directly showed faster cooling with partly open lids.","All three cups cooled faster"),
 q("SC12-Q5","BP-F05","easy","In context, “retain” is closest in meaning to:","keep rather than lose",["measure","produce","increase"],"Heat retention describes how well the cup keeps thermal energy from escaping.","retained the most heat"),
 q("SC12-Q6","BP-F06","easy","Which word is opposite in meaning to “briefly”?","continuously",["quickly","shortly","momentarily"],"Briefly means for a short time; continuously means without stopping.","handled each cup only briefly"),
 q("SC12-Q7","BP-F07","medium","What does the smaller gap with open lids suggest?","Lid condition strongly affected overall heat loss",["Material no longer mattered at all","Water volume changed","The thermometer became less accurate"],"Opening the lids increased a common heat-loss path and reduced differences among the cups.","lid condition could be a large part"),
 q("SC12-Q8","BP-F08","medium","Why did students add cup dimensions to the report?","Size and surface area could be competing explanations for cooling differences",["The cups had no labels","Dimensions determine water colour","The class needed a price comparison"],"Recording dimensions acknowledged design factors beyond material.","largest outer surface area"),
 q("SC12-Q9","BP-F09","medium","Which title best suits the passage?","Comparing Insulated Cups",["Making Stainless Steel","Why Ceramic Cannot Hold Water","A Lesson on Thermometer Repair"],"The passage describes a comparative cooling experiment using three insulated cups.","compared three insulated cups")
 ]
},
{
...
By separating those states, the retailer reduced false availability promises without pretending that inventory management could be fully automated.`,
 ...
 q("B14-Q3","BP-F03","medium","What is the central idea of the passage?","Inventory systems should distinguish stock states according to the decision being made",["Total stock is the only useful measure","Reserve stock should never be sold","Automated alerts should control inventory completely"],"The store separates immediate, reserve and incoming quantities because they answer different operational questions.","stock can mean different things depending on the decision"),
 q("B14-Q4","BP-F04","medium","Which statement is supported?","Incoming stock was shown with an expected arrival date",["Supplier shipments were always on time","Customers saw all reserve quantities","Low-stock alerts automatically opened reserve boxes"],"The store avoided treating expected deliveries as if they were already physically available.","labelled incoming quantities with an expected date"),
 q("B14-Q5","BP-F05","easy","In context, “buffer” is closest in meaning to:","extra stock kept to absorb demand or delay",["a sales receipt","a supplier discount","a product category"],"The higher buffer for fast-moving cables protected against running out between replenishments.","higher buffer"),
 q("B14-Q6","BP-F06","easy","Which word is opposite in meaning to “incoming”?","outgoing",["arriving","expected","delivered"],"Incoming stock is coming in; outgoing is moving out.","incoming stock"),
 q("B14-Q7","BP-F07","medium","What does “selling stock” refer to?","Units available for immediate customer purchase",["All products owned by the company","Only goods still with suppliers","Items reserved for weekends"],"The display separated units that staff could sell now from reserve and expected quantities.","immediate selling stock"),
 q("B14-Q8","BP-F08","medium","Why did managers review alert thresholds after several weeks?","Too many unnecessary alerts could cause staff to ignore them",["Alerts changed the product price","Supplier dates became exact","Reserve stock disappeared"],"The retailer wanted signals that were frequent enough to help but not so frequent that they lost attention.","stop paying attention"),
 q("B14-Q9","BP-F09","medium","Which title best suits the passage?","A Store Introduces Reserve Stock Alerts",["The Electronics Store Closes","A Supplier Cancels All Orders","Why Cables Should Cost More"],"The passage centres on separating sellable, reserve and incoming inventory with category-based alerts.","Reserve Stock Alerts")
 ]
},
{
...
The company concluded that a good substitution system should reduce delay without pretending that convenience is more important than dietary needs, price limits or personal preference.`,
 ...
 q("B15-Q3","BP-F03","medium","What is the central idea of the passage?","Substitution systems work better when customers define acceptable trade-offs and clear fallback rules",["Every unavailable item should be refunded","Brand is the only factor in substitution","Automatic replacement is always best"],"The service improves outcomes by letting customers specify limits on brand, price and contact.","asking customers what types of trade-offs"),
 q("B15-Q4","BP-F04","medium","Which statement is supported?","Sensitive product categories sometimes defaulted to refund unless the customer chose otherwise",["All categories used the same substitution rule","Infant food had the highest brand flexibility","Automatic substitutes could exceed any price"],"The company used more conservative defaults where product differences mattered more.","refund only unless the customer actively chose otherwise"),
 q("B15-Q5","BP-F05","easy","In context, “fallback” is closest in meaning to:","the backup action used if the preferred process cannot be completed",["the original item price","a customer complaint","a delivery address"],"The fallback choice determines what happens if the customer does not answer in time.","fallback choice selected at checkout"),
 q("B15-Q6","BP-F06","easy","Which word is opposite in meaning to “sensitive” in this context?","ordinary",["delicate","restricted","special"],"Sensitive categories require extra care; ordinary categories are less constrained.","sensitive categories"),
 q("B15-Q7","BP-F07","medium","What does the substitution price cap do?","Prevents automatic replacements from exceeding the amount the customer approved",["Guarantees the substitute is cheaper","Removes all price differences","Changes the delivery fee"],"The cap protects the customer's stated price limit.","capped automatic substitutions"),
 q("B15-Q8","BP-F08","medium","Why did the company track whether substituted items were later kept?","A substitution count alone would not show whether customers actually accepted the replacements",["Returns never occur","Picker speed was the only goal","Kept items have no price"],"Longer-term acceptance is a stronger measure of useful substitution than raw replacement frequency.","meaningless if customers regularly rejected"),
 q("B15-Q9","BP-F09","medium","Which title best suits the passage?","Online Grocery Substitution Choices",["The Grocery Service Stops Delivering","Why Infant Food Is Unavailable","A New Delivery Vehicle"],"The passage evaluates how an online grocer gives customers more control over replacement decisions.","substitution choices")
 ]
}
] as const;
