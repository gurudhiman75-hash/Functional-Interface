...
Arvind's main lesson was simple: speed is useful only after the information is clear. Running quickly toward the wrong platform would not have saved time. On his return journey a week later, Arvind noticed that the station had begun displaying a short “platform changed” banner whenever an announcement was corrected. The added message did not prevent operational changes, but it made the relationship between old and new information easier to understand. He also saw staff directing confused passengers toward the latest display instead of simply repeating the most recent announcement. The station had not eliminated uncertainty; it had improved how quickly conflicting information was resolved. Arvind also noticed that the corrected display remained visible for several minutes after the announcement ended, which helped passengers who arrived late.`,
 ...
 q("N04-Q6","BP-F06","easy","Which word is opposite in meaning to “clear”?","confusing",["obvious","plain","certain"],"Confusing is the opposite of clear. The passage context confirms this meaning.","information is clear"),
 q("N04-Q7","BP-F07","medium","What does “choosing whichever one was heard first” imply?","Acting on the earliest message without checking later evidence",["Ignoring all official information","Following only staff instructions","Waiting until the train leaves"],"The phrase contrasts quick acceptance with verification.","heard first passage detail"),
...
The incident was ordinary, but it showed how verification becomes more useful when people already expect something to be true. The receptionist later reviewed the previous month's entries and found two other cases where shortened names could have caused confusion. Those packages had reached the correct residents, but the review showed that the weakness was not limited to Tara's incident. The building therefore kept the extra identification fields permanently and asked temporary reception staff to follow the same check. Tara later realised that the extra verification took only a few seconds, much less time than correcting a mistaken delivery after the package had been handed over.`,
 questions:[
...
By the end of the term, the kitchen still required occasional reminders, but fewer disputes came from uncertainty about ownership. The experience suggested that shared spaces work better when basic information is recorded where decisions are actually made. The committee later compared complaint types and found that disputes about ownership fell more than complaints about cleanliness. That distinction helped them avoid claiming that the labels had solved every kitchen problem. They began treating labelling, cleaning and refrigerator maintenance as separate issues, each requiring its own simple rule rather than one broad policy. The residence also tested a small reminder card on each refrigerator door explaining when old food would be removed. Because everyone could see the clean-up rule before storing food, fewer residents said they were surprised when abandoned items were discarded. The committee also added a separate shelf for food being intentionally shared.`,
 ...
 q("S05-Q6","BP-F06","easy","Which word is opposite in meaning to “strict”?","flexible",["rigid","firm","severe"],"Flexible is the opposite of strict. The passage context confirms this meaning.","strict penalties"),
...
The experiment showed that price communication is not only about accuracy. A useful estimate should also make uncertainty visible and give customers a clear point at which to accept or reject a larger expense. The shop later added photographs of major damaged parts to some approval messages when the fault was difficult to explain in words. Customers did not need the image for every repair, but it helped when the additional cost was substantial. The owner found that transparency worked best when the amount of explanation matched the size and complexity of the change. The shop also recorded how often customers rejected a repair after seeing the confirmed estimate. Those cancellations were not treated as failures; they showed that the approval step gave customers a genuine choice before more money was spent. The shop also tracked whether approved repairs later returned with the same fault.`,
 ...
 q("B05-Q2","BP-F02","medium","Why were some customers less upset by a higher final price?","They had been warned that the first estimate was provisional",["They received discounts","They did not see the bill","The shop removed labour charges"],"Advance warning reduced surprise. The passage context confirms this meaning.","told in advance"),
 ...
 q("B05-Q6","BP-F06","easy","Which word is opposite in meaning to “confirmed”?","uncertain",["verified","finalised","approved"],"Uncertain is the opposite of confirmed. The passage context confirms this meaning.","confirmed repair cost"),
