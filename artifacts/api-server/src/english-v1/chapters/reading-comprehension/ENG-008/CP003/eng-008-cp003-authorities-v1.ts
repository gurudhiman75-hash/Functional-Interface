import { ENG008_CP003_EXPANSION_WAVE8_V1 } from "./eng-008-cp003-expansion-wave8-v1";
import { ENG008_CP003_EXPANSION_WAVE7_V1 } from "./eng-008-cp003-expansion-wave7-v1";
import { ENG008_CP003_EXPANSION_WAVE6_V1 } from "./eng-008-cp003-expansion-wave6-v1";
import { ENG008_CP003_EXPANSION_WAVE5_V1 } from "./eng-008-cp003-expansion-wave5-v1";
...
...ENG008_CP003_EXPANSION_WAVE8_V1,
...ENG008_CP003_EXPANSION_WAVE7_V1,
...ENG008_CP003_EXPANSION_WAVE6_V1,
...ENG008_CP003_EXPANSION_WAVE5_V1,
...
By the end of the third month, the group also began keeping a short list of the most frequently borrowed items. That list helped them decide which tools were genuinely useful to share and which had been added simply because someone happened to own a spare. The organisers wanted the shelf to remain practical rather than gradually becoming a storage place for unwanted objects. They also planned to remove items that had not been borrowed for several months, keeping the collection focused on tools that residents actually found useful. The organisers later added a small borrowing card beside each tool so residents could note when an item had been taken and when it was expected back. The simple record reduced uncertainty without turning the shelf into a formal rental system.`,
 questions:[
