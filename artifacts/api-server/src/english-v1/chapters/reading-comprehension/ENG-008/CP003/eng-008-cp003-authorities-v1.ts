...
The trial also changed how officials thought about efficiency. Lower electricity use was important, but it was only one measure of success. Engineers were asked to track complaints, response time and maintenance needs alongside energy savings. The town wanted to know whether the new system remained dependable for residents, not simply whether it consumed less power on paper.`,
 questions:[
