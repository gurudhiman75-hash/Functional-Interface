...
The problem was small, but Nisha noticed how quickly people had begun making assumptions from one photograph. She realised that a clue can narrow a search without proving the answer. Checking the official list took only a minute and prevented the wrong student from receiving credit.`,
 questions:[
...
The school did not conclude that every student now read the board carefully. Some still relied on messages from classmates. However, the new layout made important notices easier to locate and reduced the chance that a colourful poster would hide a deadline. Staff decided to keep the sections and review them each term.`,
 questions:[
