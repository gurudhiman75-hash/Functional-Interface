...
The problem was small, but Nisha noticed how quickly people had begun making assumptions from one photograph. She realised that a clue can narrow a search without proving the answer. Checking the official list took only a minute and prevented the wrong student from receiving credit. After the exhibition, the teacher asked the class to attach duplicate labels to the storage boxes used for future events. Nisha suggested keeping the registration list beside the display area as well, because a backup record was useful when a physical tag was lost. The change was simple, but it reduced dependence on any one label.`,
 ...
 q("N10-Q6","RC-F06","medium","Which statement is supported by the passage?","The original name card may have fallen when the table was moved",["The model belonged to Harjit","The teacher removed the card","The project list was missing"],"Aman gives this explanation directly. This detail directly supports the stated answer in the passage.","probably fallen when the table was moved")
 ]
},
{
...
The school did not conclude that every student now read the board carefully. Some still relied on messages from classmates. However, the new layout made important notices easier to locate and reduced the chance that a colourful poster would hide a deadline. Staff decided to keep the sections and review them each term. The school also asked whether students could tell which section contained a notice before reading the full text. Most could do so after a few days, which suggested that the fixed categories themselves were becoming familiar. Staff decided that future posters would keep the same headings rather than redesigning the board every month.`,
 questions:[
 q("R10-Q1","RC-F01","easy","How was the noticeboard reorganised?","Into fixed sections by type of information",["By student age","By poster colour","By classroom number"],"The second paragraph lists separate sections by purpose.","fixed sections passage detail"),
 q("R10-Q2","RC-F02","medium","Why did repeated questions fall?","Students could find key information more easily",["Teachers stopped answering questions","Notices were removed","Exam dates changed less often"],"The new structure made notices easier to locate.","easier to locate passage detail"),
 q("R10-Q3","RC-F03","medium","What is the main idea of the report?","A clearer information layout reduced confusion without changing the information itself",["The school removed its noticeboard","Students stopped using classmates for information","Posters were banned"],"The change was organisational rather than informational.","new layout passage detail"),
 ...
 q("R10-Q5","RC-F05","easy","In context, “deadline” most nearly means:","the final date for completing something",["a noticeboard section","a classroom rule","an exam result"],"The passage discusses scholarship and exam dates that should not be missed.","hide a deadline passage detail"),
 q("R10-Q6","RC-F06","medium","Which statement is supported?","Some students still depended on classmates for information",["All students read the board daily","Exam notices were removed","The board had no date labels"],"The final paragraph states this directly. This detail directly supports the stated answer in the passage.","still relied on messages from classmates")
 ]
},
{
...
Staff also noticed that first-time visitors asked fewer questions about distance at the information booth. The park decided to keep the markers and add one simple map showing how the numbered points connected around the route. Officials said the improvement was small but useful because it helped visitors understand the space without needing extra staff assistance. The park also compared weekend and weekday use. Weekend visitors were more likely to use the markers for exercise goals, while weekday walkers more often used them to judge how much time remained before work or school. Staff said this showed that the same information could support different needs.`,
 questions:[
 q("R11-Q1","RC-F01","easy","How often were distance markers placed?","Every 250 metres",["Every 50 metres","Every kilometre","Only at the entrance"],"The opening paragraph directly gives the spacing.","every 250 metres passage detail"),
 q("R11-Q2","RC-F02","medium","Why did some walkers use the markers to decide when to turn back?","They had limited time and could judge how far they had gone",["The track was unsafe","The markers showed weather","The park was closing permanently"],"The passage links the markers to distance awareness and time limits.","limited time passage detail"),
 ...
 q("R11-Q5","RC-F05","easy","In context, “progress” most nearly means:","distance already completed",["ticket price","walking speed only","park opening time"],"The markers show how far a walker has gone. This detail directly supports the stated answer in the passage.","making progress visible"),
 q("R11-Q6","RC-F06","medium","Which statement is supported?","First-time visitors asked fewer distance questions after the markers were added",["The track surface changed","The park removed its information booth","Only athletes used the markers"],"The final paragraph directly reports this. This detail directly supports the stated answer in the passage.","asked fewer questions")
 ]
}
] as const;