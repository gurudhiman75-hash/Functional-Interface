...
export const ENG008_CP004_EXPANSION_WAVE10_V1:readonly Eng008Cp004PassageV1[]=[
{
 id:"ENG008-BM-E09",title:"Why Productivity Growth and Wage Growth Can Diverge",genre:"economy",
 text:`Productivity is often described as the amount of output produced for each unit of labour. When productivity rises, an economy can produce more without increasing working hours by the same proportion. It is tempting to assume that workers' wages must then rise at the same pace. In practice, the relationship is more complicated.
...
The broader lesson is that productivity growth creates capacity for higher living standards, but it does not mechanically determine who receives the benefit or when. Understanding the connection requires attention to measurement, prices, investment and the institutions that shape bargaining and distribution.`,
 ...
 q("E09-Q3","BM-F03","hard","Which option best states the central argument?","Productivity creates scope for higher living standards, but wage outcomes depend on timing, distribution, prices and institutions",["Productivity and wages should move identically each year","Profits explain every wage gap","Productivity is irrelevant to living standards"],"The passage repeatedly separates output creation from how and when its gains are shared.","creates capacity ... but does not mechanically determine"),
 q("E09-Q4","BM-F04","hard","What is the author's tone?","Analytical and qualified",["Dismissive of productivity","Promotional","Alarmist"],"The author accepts productivity's importance while explaining several reasons the wage link is not mechanical.","relationship is more complicated"),
 q("E09-Q5","BM-F05","medium","Why does the author discuss service-sector measurement?","Measured productivity may miss changes in quality or output that are hard to count",["Services produce no output","Manufacturing has no quality changes","Software cannot raise productivity"],"The passage cautions that some productivity gaps may partly reflect imperfect measurement.","harder to capture"),
 q("E09-Q6","BM-F06","hard","Which statement cannot be inferred?","Every worker in a country benefits equally when average productivity rises",["Sector shifts can raise the average","Bargaining institutions affect wage outcomes","Capital investment can raise output per worker"],"The passage explicitly warns that aggregate productivity can rise without equal workplace-level gains.","does not imply that every workplace became more productive"),
 q("E09-Q7","BM-F07","hard","What role does the paragraph on capital intensity play?","It explains why part of productivity-related income may compensate owners of productive capital",["It argues machinery reduces output","It defines real wages","It shows investment has no cost"],"Higher output per worker can partly reflect expensive equipment that also requires financing and replacement.","finance, maintain and replace that capital"),
 q("E09-Q8","BM-F08","hard","Which conclusion follows most logically?","Evaluating living-standard gains requires examining distribution and real wages alongside productivity",["Productivity data should be ignored","Nominal wages alone measure welfare","Labour share never changes"],"The policy paragraph explicitly recommends combining productivity with other distribution and purchasing-power measures.","also examine real wages"),
 q("E09-Q9","BM-F09","medium","In context, “bargaining power” most nearly means:","the ability of workers or employers to influence pay and conditions",["the legal definition of output","the price of machinery","the inflation rate"],"The term appears among institutions that affect how productivity gains are shared.","shape bargaining and distribution"),
 q("E09-Q10","BM-F10","hard","Which assumption does the passage challenge?","That more output per worker automatically produces the same proportional wage increase",["Technology can raise output","Prices can rise","Workers can change jobs"],"The article is built around rejecting a mechanical one-to-one link between productivity and wages.","does not mechanically determine")
 ]
},
{
...
The broader lesson is that subscription metrics are shaped by customer age, acquisition source and pricing history. Churn is useful, but its meaning becomes clearer when customers are followed through comparable stages of the relationship rather than blended into one moving average.`,
 ...
 q("B08-Q3","BM-F03","hard","Which option best states the central argument?","Subscription churn should be interpreted by cohort, customer value and lifecycle stage rather than as one headline rate",["Churn should be replaced by sign-up counts","Discount campaigns always reduce loyalty","Only revenue churn matters"],"The article repeatedly shows how one average hides timing, source and value differences.","rather than blended into one moving average"),
 q("B08-Q4","BM-F04","hard","What is the author's tone?","Analytical and commercially focused",["Hostile to subscription models","Promotional","Humorous"],"The author evaluates measurement choices and their implications for business decisions.","useful question is not merely"),
 q("B08-Q5","BM-F05","medium","Why does the author discuss a March app redesign?","It is a competing explanation for differences between customer cohorts",["It defines churn","It proves design never affects retention","It shows discounts have no effect"],"Cohorts separated by joining date may also experience different products.","reasons unrelated to the acquisition campaign"),
 q("B08-Q6","BM-F06","hard","Which statement cannot be inferred?","The cohort with the highest initial sign-ups is necessarily the most valuable",["Revenue churn can differ from customer churn","Temporary pauses can distort cancellation metrics","Acquisition source can affect retention"],"The passage says smaller but durable cohorts can be more valuable than large campaigns with weak retention.","smaller campaign whose customers remain for years"),
 q("B08-Q7","BM-F07","hard","What role does the paragraph on revenue retention play?","It shows that customer counts and financial impact are not always proportional",["It proves enterprise customers never leave","It defines cohort age","It argues prices should be identical"],"Different customers contribute different amounts of revenue, so equal cancellation counts can have unequal business effects.","different financial effect"),
 q("B08-Q8","BM-F08","hard","Which conclusion follows most logically?","Businesses should compare customers at similar relationship stages before judging retention performance",["Monthly churn alone is sufficient","Pauses should always count as permanent loss","Promotional cohorts should be ignored"],"The conclusion argues for lifecycle-aligned comparisons rather than blending customers of very different ages.","comparable stages of the relationship"),
 q("B08-Q9","BM-F09","medium","In context, “cohort” most nearly means:","a group of customers sharing a common joining time or characteristic",["a single cancellation","a pricing formula","a support ticket"],"The passage defines cohorts by when or how customers joined.","grouping customers"),
 q("B08-Q10","BM-F10","hard","Which assumption does the passage challenge?","That one overall churn percentage fully describes customer loyalty",["Customers can cancel subscriptions","Discounts affect price","Apps can be redesigned"],"The article shows that timing, source and account value can all change what a headline churn rate means.","one overall percentage can hide")
 ]
},
{
...
The broader lesson is that a reliable digital service is one that performs its important functions within acceptable limits. Measurement should therefore reflect what users can actually accomplish, not merely whether a server answers a health check.`,
 ...
 q("T07-Q3","BM-F03","hard","Which option best states the central argument?","Reliability should be measured using function, performance and user impact as well as binary uptime",["Uptime should never be reported","Every service needs the same reliability target","Latency is more important than all other measures"],"The article expands reliability beyond simple reachability.","combines availability with performance and user impact"),
 q("T07-Q4","BM-F04","hard","What is the author's tone?","Technical and balanced",["Dismissive of reliability metrics","Promotional","Alarmist"],"The author values uptime as a baseline while explaining its limitations.","does not make uptime meaningless"),
 q("T07-Q5","BM-F05","medium","Why does the author discuss partial regional outages?","An overall service average can hide severe local failures",["Regions always use different software","Global services cannot be monitored","Regional users do not affect uptime"],"A system may appear healthy globally while one region is unusable.","overall average may hide severe local disruption"),
 q("T07-Q6","BM-F06","hard","Which statement cannot be inferred?","A 99.9 per cent uptime figure proves that users can complete every important task reliably",["Monitoring from one location can miss problems","Maintenance rules should be explicit","Different services justify different reliability targets"],"The central argument is that uptime alone cannot prove functional quality.","availability as identical to service quality"),
 q("T07-Q7","BM-F07","hard","What role does the paragraph on expensive redundancy play?","It shows that reliability targets involve cost-benefit trade-offs",["It argues redundancy is unnecessary","It defines latency","It proves banking systems never fail"],"The appropriate target depends partly on the consequence of failure and the cost of prevention.","same target may waste resources"),
 q("T07-Q8","BM-F08","hard","Which conclusion follows most logically?","Service metrics should be tied to the tasks users need to complete",["Server health checks are sufficient","All planned downtime should be excluded","Every error should count as total outage"],"The conclusion defines reliability through successful important functions, not just server response.","what users can actually accomplish"),
 q("T07-Q9","BM-F09","medium","In context, “latency” most nearly means:","delay in receiving a response",["total storage capacity","number of users","length of an outage contract"],"Latency measures how quickly a service responds even while available.","taking twenty seconds to load"),
 q("T07-Q10","BM-F10","hard","Which assumption does the passage challenge?","That an online/offline measure is enough to describe digital service quality",["Servers can fail","Customers use APIs","Monitoring has costs"],"The passage repeatedly shows degraded states between fully working and fully down.","more than binary availability")
 ]
},
{
...
The broader lesson is that an adherence percentage is not a complete description of patient behaviour. Clear definitions prevent a programme from looking successful simply because difficult cases disappeared from measurement.`,
 ...
 q("H07-Q3","BM-F03","hard","Which option best states the central argument?","Adherence measures require explicit denominators, methods and reasons for treatment changes",["Refill data is useless","All treatment discontinuation is non-adherence","The highest adherence rate always indicates the best programme"],"The passage shows how different definitions can produce very different meanings.","describes the denominator, measurement method"),
 q("H07-Q4","BM-F04","hard","What is the author's tone?","Clinical and analytical",["Dismissive of patients","Promotional","Alarmist"],"The author carefully separates measurement steps and legitimate reasons for stopping treatment.","appropriate clinical decision"),
 q("H07-Q5","BM-F05","medium","Why does the author distinguish persistence from adherence?","Remaining on treatment and following the daily schedule are different behaviours",["Persistence measures medicine price","Adherence measures only clinic visits","The two terms are identical"],"A patient can do well on one dimension and poorly on the other.","Both outcomes can matter"),
 q("H07-Q6","BM-F06","hard","Which statement cannot be inferred?","A very high adherence percentage necessarily means patients have better health outcomes",["Access barriers can reduce adherence","Electronic containers measure openings rather than swallowing","Doctor-directed discontinuation should be interpreted separately"],"The passage explicitly says treatment use must be linked to appropriateness and outcome.","Perfect adherence ... would not be a meaningful health goal"),
 q("H07-Q7","BM-F07","hard","What role does the paragraph on reminders, cost and stock play?","It shows why interventions should target the actual reason for missed treatment",["It proves reminders never work","It defines the denominator","It argues medicines should be free"],"Different barriers require different responses.","match the barrier"),
 q("H07-Q8","BM-F08","hard","Which conclusion follows most logically?","Adherence dashboards should retain patients who disengage as part of the measurement story rather than silently dropping them",["Only active patients should ever be counted","Self-report is always superior","Every missed refill has the same cause"],"The central denominator warning is that difficult cases can vanish and falsely improve results.","difficult cases disappeared from measurement"),
 q("H07-Q9","BM-F09","medium","In context, “persistence” most nearly means:","continuing treatment over time",["taking every dose at the exact minute","collecting one prescription","reporting a side effect"],"Persistence is defined as how long a patient remains on treatment.","how long a patient remains on treatment"),
 q("H07-Q10","BM-F10","hard","Which assumption does the passage challenge?","That one adherence percentage directly reveals how well a treatment programme is functioning",["Patients can forget doses","Pharmacies keep records","Doctors change prescriptions"],"The passage identifies denominator, measurement and access issues hidden inside a single rate.","not a complete description")
 ]
},
{
...
The broader lesson is that recycling is a chain, not a bin. Collection is necessary, but environmental benefit depends on what happens after the truck leaves the street.`,
 ...
 q("EN06-Q3","BM-F03","hard","Which option best states the central argument?","Recycling performance should follow material beyond collection through sorting, sale and reprocessing",["Household collection weight is sufficient","Recycling symbols guarantee local recyclability","All cities should accept the same items"],"The passage treats recycling as a chain of stages rather than one curbside action.","follows material through stages"),
 q("EN06-Q4","BM-F04","hard","What is the author's tone?","Analytical and systems-focused",["Hostile to recycling","Promotional","Humorous"],"The author supports recycling while explaining operational and market limits.","Collection is necessary, but"),
 q("EN06-Q5","BM-F05","medium","Why does the author discuss local infrastructure?","An item may be recyclable in theory but not processable by a particular facility",["Facilities determine household income","Every city has identical equipment","Infrastructure makes contamination irrelevant"],"Accepted-item guidance must match what local sorting systems can actually handle.","reflect local infrastructure"),
 q("EN06-Q6","BM-F06","hard","Which statement cannot be inferred?","Increasing collected tonnes always increases recovered usable material by the same proportion",["Markets affect recycling outcomes","Product design can affect recoverability","Cities use different measurement rules"],"The entire passage shows why losses between collection and recovery vary.","difference ... loss or residue"),
 q("EN06-Q7","BM-F07","hard","What role does the paragraph on “wish-cycling” play?","It explains how well-intentioned behaviour can worsen contamination and inflate collection totals",["It argues residents should stop recycling","It defines virgin material","It proves symbols are illegal"],"Putting doubtful items into bins can raise measured collection while reducing stream quality.","increase collection weight while making sorting harder"),
 q("EN06-Q8","BM-F08","hard","Which conclusion follows most logically?","Policy should target the stage where material is being lost rather than assuming public education solves every problem",["Education always fixes market demand","Collection vehicles should be removed","Only manufacturers matter"],"Different failure stages require different interventions.","identify where improvement is needed"),
 q("EN06-Q9","BM-F09","medium","In context, “residue” most nearly means:","material left over or rejected after sorting",["new recycled products","household collection bins","transport fuel"],"The passage uses residue for material that does not become usable recovered output.","difference is sometimes called loss or residue"),
 q("EN06-Q10","BM-F10","hard","Which assumption does the passage challenge?","That material placed in a recycling bin has already achieved the environmental benefit of recycling",["Cities collect waste","Plastic has different polymers","Factories buy materials"],"The final line emphasises that collection is only the start of the chain.","what happens after the truck leaves")
 ]
},
{
...
The broader lesson is that a fare subsidy changes price, not geography or timetable. It can be an important tool, but its effect depends on the transport network around it. Access improves only when the service is both affordable and practically usable.`,
 ...
 q("SP06-Q3","BM-F03","hard","Which option best states the central argument?","Transport access depends on price, route availability, frequency and usability, so subsidy coverage alone is incomplete",["Fare reductions are ineffective","Every area needs identical bus frequency","Digital applications always increase access"],"The article broadens access beyond affordability.","affordability is only one component"),
 q("SP06-Q4","BM-F04","hard","What is the author's tone?","Policy-focused and balanced",["Opposed to transport subsidies","Promotional","Humorous"],"The author recognises subsidies as useful while explaining limits and complementary needs.","can clearly help. Yet"),
 q("SP06-Q5","BM-F05","medium","Why does the author discuss different programme goals?","The appropriate success metric depends on what the policy is intended to change",["Every subsidy has one universal goal","Household cost is never relevant","Only vehicle mode share matters"],"Job access, expense relief and school attendance are distinct outcomes.","Different goals require different measures"),
 q("SP06-Q6","BM-F06","hard","Which statement cannot be inferred?","A free bus pass guarantees practical access to employment",["Application systems can exclude eligible users","Low frequency imposes a time cost","Route geography affects access"],"The passage repeatedly shows that zero fare cannot solve missing or unreliable service.","price, not geography or timetable"),
 q("SP06-Q7","BM-F07","hard","What role does the paragraph on demand-responsive vans play?","It gives an example of a complementary service that can address geographic gaps at added cost",["It proves fixed routes should be removed","It defines subsidy eligibility","It argues vans are cheaper in all areas"],"The example shows one way to improve access beyond fare policy while preserving trade-offs.","fill gaps but require booking"),
 q("SP06-Q8","BM-F08","hard","Which conclusion follows most logically?","Transport subsidy evaluation should examine whether eligible people can actually reach needed destinations at useful times",["Claim numbers alone are sufficient","Fare levels should be ignored","Only urban users should be surveyed"],"The proposed evaluation focuses on practical trip capability rather than possession of a discount.","reach common destinations at the times they need"),
 q("SP06-Q9","BM-F09","medium","In context, “take-up” most nearly means:","the share of eligible people who claim or use the subsidy",["bus occupancy","ticket price","route length"],"The term describes whether people actually use the programme for which they qualify.","low take-up"),
 q("SP06-Q10","BM-F10","hard","Which assumption does the passage challenge?","That making transport cheaper is enough to make it accessible",["Buses have timetables","Workers commute","Routes cost money"],"The core argument separates affordability from practical usability.","both affordable and practically usable")
 ]
},
{
...
The broader lesson is that fairness is not one measurable property. Process and outcome are connected but distinct, and a serious evaluation should ask both how a decision was made and what consequences it produced.`,
 ...
 q("PH06-Q3","BM-F03","hard","Which option best states the central argument?","Fairness claims should distinguish the quality of the decision process from the justice of the resulting outcome",["Only outcomes matter","Only rules matter","Fairness can be reduced to equal treatment"],"The passage repeatedly separates procedural and outcome fairness while showing their interaction.","connected but distinct"),
 q("PH06-Q4","BM-F04","hard","What is the author's tone?","Reflective and analytical",["Moralising","Dismissive of fairness","Humorous"],"The author clarifies competing meanings rather than imposing one universal formula.","different contexts place different weight"),
 q("PH06-Q5","BM-F05","medium","Why does the author discuss appeal mechanisms?","They can improve procedural legitimacy by allowing errors to be reviewed and corrected",["Appeals guarantee perfect outcomes","They make rules unnecessary","They eliminate disagreement"],"The ability to challenge decisions changes the fairness of the process even if mistakes still occur.","present evidence and obtain correction"),
 q("PH06-Q6","BM-F06","hard","Which statement cannot be inferred?","A perfectly consistent rule is necessarily fair in every context",["Relevant differences can justify different treatment","Outcome and process can be evaluated separately","Information limits can produce mistakes"],"The stair example directly rejects consistency as a sufficient condition.","Consistency is important but not always sufficient"),
 q("PH06-Q7","BM-F07","hard","What role does the medical-triage example play?","It shows that a reasonable process can still produce occasional bad outcomes under uncertainty",["It proves medical systems are unfair","It defines equality","It argues appeals are unnecessary"],"Good procedure does not guarantee perfect results when information is incomplete.","cannot guarantee the best outcome"),
 q("PH06-Q8","BM-F08","hard","Which conclusion follows most logically?","Disputes about fairness become clearer when people identify whether they object to rules, application or outcomes",["Every fairness dispute has one correct answer","Equal outcomes should always be preferred","Reasons do not matter"],"The author recommends specifying the type of fairness claim before evaluating it.","specify which fairness claim"),
 q("PH06-Q9","BM-F09","medium","In context, “arbitrary” most nearly means:","based on unexplained or inconsistent choice rather than a clear rule",["legally binding","perfectly equal","randomly selected by lottery"],"Unexplained decisions can feel arbitrary because the basis is unclear.","feel arbitrary"),
 q("PH06-Q10","BM-F10","hard","Which assumption does the passage challenge?","That a decision can be labelled fair or unfair without specifying what kind of fairness is being judged",["Rules affect outcomes","People disagree","Some decisions use lotteries"],"The entire article argues that fairness contains several distinct dimensions.","fairness is not one measurable property")
 ]
},
{
...
The broader lesson is that accuracy in live reporting includes showing the level of confidence appropriate to each stage. Updating is not a weakness. The risk comes when revisions erase the path from tentative information to firmer knowledge and leave readers unable to distinguish correction from normal development.`,
 ...
 q("M06-Q3","BM-F03","hard","Which option best states the central argument?","Breaking-news accuracy requires visible handling of uncertainty, updates and genuine corrections across versions",["Newsrooms should wait for complete certainty","Headlines should never change","Social media should not carry news"],"The article frames live reporting as a sequence of evidence states.","sequence of evidence states"),
 q("M06-Q4","BM-F04","hard","What is the author's tone?","Practical and media-literate",["Hostile to breaking news","Promotional","Sensational"],"The passage recognises the need for speed while proposing transparent update practices.","goal is not zero uncertainty"),
 q("M06-Q5","BM-F05","medium","Why does the author emphasise source attribution?","It signals the strength and origin of early evidence",["Attribution removes all uncertainty","Sources should replace verification","Readers ignore headlines"],"Attribution helps distinguish official statements, interpretation and unverified visual evidence.","different kinds of evidence"),
 q("M06-Q6","BM-F06","hard","Which statement cannot be inferred?","Every changed sentence in a developing story should be labelled a correction",["Timestamps can help readers understand sequence","Screenshots can preserve outdated claims","Major clarifications may need redistribution"],"The passage explicitly distinguishes normal updates from corrections for factual mistakes.","Not every update requires a correction"),
 q("M06-Q7","BM-F07","hard","What role does the social-media paragraph play?","It shows why correcting only the live article may not reach audiences exposed to earlier versions",["It proves screenshots are unreliable","It argues newsrooms should leave social media","It defines source attribution"],"Early claims can continue circulating outside the updated page.","screenshots ... continue circulating"),
 q("M06-Q8","BM-F08","hard","Which conclusion follows most logically?","Major corrections should be communicated through channels comparable to those that spread the original claim",["Corrections should remain inside the article only","Early uncertainty should be hidden","All breaking news should be delayed"],"The passage recommends using the same social accounts for important correction or clarification.","same social accounts"),
 q("M06-Q9","BM-F09","medium","In context, “tentative” most nearly means:","provisional and not yet fully certain",["deliberately false","permanently fixed","legally protected"],"Early information may be credible but still subject to revision as evidence develops.","tentative information"),
 q("M06-Q10","BM-F10","hard","Which assumption does the passage challenge?","That an updated news article can be understood fully without knowing how its claims changed over time",["News websites use timestamps","Sources can be quoted","Breaking news develops"],"The central issue is version awareness and preserving the path from uncertainty to firmer evidence.","revisions erase the path")
 ]
}
] as const;
