import { ENG008_CP005_EXPANSION_WAVE10_V1 } from "./eng-008-cp005-expansion-wave10-v1";
import { ENG008_CP005_EXPANSION_WAVE9_V1 } from "./eng-008-cp005-expansion-wave9-v1";
import { ENG008_CP005_EXPANSION_WAVE8_V1 } from "./eng-008-cp005-expansion-wave8-v1";
import { ENG008_CP005_EXPANSION_WAVE7_V1 } from "./eng-008-cp005-expansion-wave7-v1";
import { ENG008_CP005_EXPANSION_WAVE6_V1 } from "./eng-008-cp005-expansion-wave6-v1";
import { ENG008_CP005_EXPANSION_WAVE5_V1 } from "./eng-008-cp005-expansion-wave5-v1";
import { ENG008_CP005_EXPANSION_WAVE4_V1 } from "./eng-008-cp005-expansion-wave4-v1";
import { ENG008_CP005_EXPANSION_WAVE3_V1 } from "./eng-008-cp005-expansion-wave3-v1";
import { ENG008_CP005_EXPANSION_WAVE2_V1 } from "./eng-008-cp005-expansion-wave2-v1";
...
...ENG008_CP005_EXPANSION_WAVE10_V1,
...
...ENG008_CP005_EXPANSION_WAVE4_V1,
...ENG008_CP005_EXPANSION_WAVE3_V1,
...ENG008_CP005_EXPANSION_WAVE2_V1,
...
For the next survey, the agency plans to sample non-users as well as current riders and to link survey responses with actual arrival records. That design would help distinguish whether people perceive a route as unreliable because the service is objectively irregular, because their tolerance for delay is lower, or because both factors operate together. The agency also wants to compare peak and off-peak responses because reliability may matter differently when riders face strict arrival times.`,
 questions:[
...
A follow-up project will therefore track students across an entire academic year instead of one examination period. Researchers hope that repeated observations will show whether changes within the same student over time are related to changes in sleep and study routines, reducing—but not eliminating—the problem of comparing students who differ in many other ways. The researchers will also collect information about course load, employment hours and prior achievement so that changes in sleep are interpreted alongside other pressures that may affect performance. That information may help separate whether students sleep less because they are already under greater academic or work pressure, rather than assuming sleep duration is the only meaningful difference between groups.`,
 questions:[
...
Future research will separate these dimensions and compare them with actual purchase histories where customers consent to data use. This would not automatically prove causation, but it could show whether particular service experiences predict later visits after accounting for distance and price. The association also wants to survey former customers, since people who stopped visiting may reveal barriers that satisfied current shoppers never mention. Researchers also plan to compare responses across store categories because the importance of helpful staff may differ between routine grocery purchases and less frequent purchases that require advice or product explanation. The association also wants to distinguish repeat visits driven by routine convenience from those driven by deliberate preference, because the same customer may return frequently for very different reasons.`,
 questions:[
...
In the next phase, researchers will record not only whether a feature is available but how students interact with it. They are particularly interested in whether attempting a problem before requesting help leads to better transfer to new problems. The aim is to distinguish simple exposure to the tutor from patterns of use that might plausibly support learning. The team will also compare outcomes by prior mathematics achievement to see whether the same feature helps beginners and stronger students in similar ways.`,
 questions:[
