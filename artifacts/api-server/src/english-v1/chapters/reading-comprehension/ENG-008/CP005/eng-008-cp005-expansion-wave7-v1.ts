...
The company will also compare project stages. Early planning may require more live discussion because goals are still uncertain, while mature execution may benefit more from short written progress notes. If the effect differs by stage, a flexible meeting design may work better than one permanent rule. This would allow teams to keep synchronous time for ambiguity and negotiation while moving predictable status reporting into asynchronous channels.`,
 ...
 q("W05-Q6","RS-F06","hard","Which is a directly reported finding?","Follow-up message volume rose slightly",["All follow-up messages disappeared","Written updates reduced every discussion","Other teams had the same result"],"The fifth paragraph reports this directly. The cited result directly supports this interpretation.","Message volume rose slightly"),
 ...
 q("W05-Q8","RS-F08","medium","Which next step is best supported?","Rotate the practice across teams and compare which agenda types work well asynchronously",["Remove all live meetings","Measure only message count","Ignore team differences"],"The final paragraph proposes this design. The cited result directly supports this interpretation.","rotate the practice across teams")
 ]
},
{
...
Weather exposure may change the effect as well. During very hot or rainy periods, shade and shelter can matter more than seat shape. The next trial will therefore compare comfort under different weather conditions and record whether passengers choose to stand because the seat is wet, hot or occupied. This should help separate the value of seating from the wider quality of the shelter environment. Researchers will also record whether seats are occupied by bags or other objects, since nominal seating capacity may overstate the number of places actually available to passengers during especially busy travel periods in practice.`,
 ...
 q("T05-Q4","RS-F04","hard","Which limitation most directly affects the comfort comparison?","Some upgraded stops also had better shade",["The study lasted six weeks","Passengers could stand","Bus shelters existed"],"Shade could independently improve comfort. The cited result directly supports this interpretation.","slightly better shade"),
 ...
 q("T05-Q6","RS-F06","hard","Which is a directly reported finding?","Wider seats required slightly more cleaning at some shelters",["Bus frequency increased","All passengers sat down","Shade decreased"],"The sixth paragraph states this. The cited result directly supports this interpretation.","spent slightly longer cleaning"),
 q("T05-Q7","RS-F07","hard","Which competing explanation is explicitly identified?","Better shade at some upgraded shelters may have raised comfort ratings",["Bus fares fell","Stops were moved closer","Passengers received free tickets"],"The passage identifies shade as a confound. The cited result directly supports this interpretation.","slightly better shade"),
 q("T05-Q8","RS-F08","medium","Which next step is best supported?","Randomly upgrade matched shelters and measure accessibility features",["Replace every shelter immediately","Ignore maintenance","Measure only bus speed"],"The final paragraph proposes this design. The cited result directly supports this interpretation.","randomly upgrade matched shelters")
 ]
},
{
...
Cost and durability will be included as well. A coating that lowers cooling energy modestly may still be worthwhile if it lasts many years and requires little maintenance, but less attractive if frequent recoating is needed. The district plans to compare installation cost, maintenance, energy savings and indoor comfort together. This broader measure will help determine whether the treatment is practical at scale rather than merely effective during a short summer test. Researchers will also compare rooms with different ceiling insulation because roof coatings may interact with existing building design. That analysis could show whether the same coating produces larger benefits in some types of classroom blocks than in other buildings.`,
 questions:[
 q("E05-Q1","RS-F01","medium","What happened to roof-surface temperature on coated buildings?","It was substantially lower on clear days",["It rose sharply","It was not measured","It matched dark roofs exactly"],"The second paragraph reports this directly. The cited result directly supports this interpretation.","substantially cooler at the surface"),
 ...
 q("E05-Q3","RS-F03","medium","Which summary is most accurate?","Reflective coatings were linked to cooler roofs and modest indoor benefits, but building differences limit causal certainty",["Coatings eliminated classroom heat","Every building was randomly assigned","Durability was proven"],"The conclusion states the qualified result. The cited result directly supports this interpretation.","associated with lower roof temperatures"),
 ...
 q("E05-Q6","RS-F06","hard","Which is a directly reported finding?","Some coated blocks used slightly less afternoon cooling energy",["All air-conditioning use ended","The coating lasted many years","Ventilation was identical"],"The sixth paragraph reports this directly. The cited result directly supports this interpretation.","used slightly less afternoon cooling energy"),
...
The platform will also distinguish reminder effectiveness from notification dependence. If learners revise only when prompted, regularity may disappear once reminders stop. A post-intervention period will therefore measure whether users continue spaced practice after notifications are withdrawn. This will help determine whether the system is building a durable study habit or simply creating temporary compliance while the external cue remains active. Researchers will also track whether learners begin scheduling revision themselves after repeated exposure to spaced reminders. That would provide stronger evidence that the feature supports a transferable study habit rather than only short-term notification response.`,
 questions:[
 ...
 q("D06-Q3","RS-F03","medium","Which summary is most accurate?","Targeted spaced reminders improved revision regularity and showed a small delayed benefit when learners actually revisited topics",["Reminders doubled all exam scores","Generic messages worked best","Question volume rose sharply"],"The conclusion states this directly. The cited result directly supports this interpretation.","small delayed-performance benefit"),
 ...
 q("D06-Q6","RS-F06","hard","Which is a directly reported finding?","Users preferred reminders that named the exact topic",["Promotional notifications improved revision","All users kept notifications on","Generic messages produced the best scores"],"The survey reports this preference. The cited result directly supports this interpretation.","liked reminders more when they named the exact topic"),
 q("D06-Q7","RS-F07","hard","Which competing mechanism is explicitly identified?","Notification fatigue from promotional messages may reduce exposure to study reminders",["Users received easier questions","Topics became shorter","The delayed quiz was optional"],"The seventh paragraph explains this pathway. The cited result directly supports this interpretation.","disable all notifications"),
 q("D06-Q8","RS-F08","medium","Which next step is best supported?","Test different reminder frequencies while separating study notifications from promotions",["Send as many reminders as possible","Remove topic names","Measure only question volume"],"The final paragraph proposes this design. The cited result directly supports this interpretation.","vary reminder frequency")
 ]
}
] as const;