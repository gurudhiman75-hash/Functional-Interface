...
The company concluded that streaks increased day-to-day practice frequency, but frequency alone did not prove better learning. A follow-up study will include delayed test performance and compare fixed streaks with more flexible weekly goals. The company also plans to examine what happens after a streak breaks. Some learners may resume normally, while others may disengage because the visible count has returned to zero. A weekly-goal design could reduce this all-or-nothing response by allowing recovery after one missed day. Researchers will compare return rates after a lapse and measure whether users with flexible goals continue practising more consistently over several weeks. This will help distinguish a motivating progress signal from a feature that works only while an unbroken sequence is maintained.`,
 questions:[
