...
The company concluded that protected morning time was associated with more uninterrupted work, but project mix and volunteer selection limited causal certainty. A future test will rotate the policy across teams and hold project load more constant.`,
 questions:[
 ...
 q("W04-Q6","RS-F06","hard","Which is a directly reported finding?","Evening login time did not rise substantially",["Employees worked fewer total hours","All decisions moved to the morning","Every team handled incidents the same way"],"The seventh paragraph directly reports this.","did not rise substantially"),
 ...
 q("W04-Q8","RS-F08","medium","Which next step is best supported?","Rotate the policy across teams while keeping project load more comparable",["Make it permanent immediately","Ban all meetings","Measure only employee satisfaction"],"The conclusion proposes this design.","rotate the policy across teams")
 ]
},
{
...
The rail operator concluded that larger directional signs were associated with fewer questions and somewhat fewer missed transfers, but timetable changes and station design affected the result. A follow-up study will compare matched stations without schedule changes.`,
 questions:[
 ...
 q("T04-Q6","RS-F06","hard","Which is a directly reported finding?","Estimated walking time was useful to travellers deciding whether to hurry",["Mobility-limited passengers benefited most","Advertisements improved navigation","All old signs were removed"],"The survey directly reports this.","estimated walking time was especially useful"),
...
The café concluded that the default refill prompt was associated with lower disposable-cup use, but concurrent campaigns and limited customer tracking made the size of the independent effect uncertain. A future trial will rotate the prompt across outlets while keeping campaign exposure more consistent.`,
 questions:[
 ...
 q("C03-Q8","RS-F08","medium","Which next step is best supported?","Rotate the prompt across outlets while keeping other campaign exposure more comparable",["Ban disposable cups immediately","Measure sales only","Ignore regular customers"],"The final paragraph proposes this design.","rotate the prompt across outlets")
 ]
},
{
...
The company concluded that streaks increased day-to-day practice frequency, but frequency alone did not prove better learning. A follow-up study will include delayed test performance and compare fixed streaks with more flexible weekly goals.`,
 questions:[
 q("D04-Q1","RS-F01","medium","What happened to practice frequency among users who saw the streak counter?","They practised on more days on average",["They practised on fewer days","They stopped using reminders","They completed fewer active days"],"The second paragraph directly reports this.","practised on more days"),
 ...
 q("D04-Q5","RS-F05","hard","Which statement makes an unjustified causal claim?","The streak feature improved exam performance",["The streak group practised more days","Some users felt pressure","Hard-question differences were smaller"],"Exam performance was not measured.","did not prove better learning"),
 q("D04-Q6","RS-F06","hard","Which is a directly reported finding?","Some users felt pressure after missing a day",["Pressure caused lower exam scores","Flexible goals are better","All long-streak users disliked the feature"],"The survey directly reports this reaction.","described it as pressure"),
 ...
 q("D04-Q8","RS-F08","medium","Which next step is best supported?","Measure delayed performance and compare streaks with flexible weekly goals",["Remove the counter immediately","Study only easy questions","Ignore study quality"],"The final paragraph proposes exactly this.","compare fixed streaks with more flexible weekly goals")
 ]
}
] as const;