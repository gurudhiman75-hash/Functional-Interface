...
export function generateEng007CP006QuestionV1(input:GenerateEng007CP006V1Input){
  return buildEng007SpellingQuestionV1("ENG-007-CP006",ENG007_CP006_ENTRIES_V1,input);
}
