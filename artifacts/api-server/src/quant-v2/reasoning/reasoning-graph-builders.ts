  ...
  return graph(problem, {
    ...
    steps: [
      step({
        ...
        descriptionKey: "calculate_only_first_set",
        inputVariables: ["subjectA", "bothPct"],
        outputVariable: "onlyA",
        equation: "onlyA = {subjectA} - {bothPct}",
      }),
      step({
        id: "calculate_only_b",
        type: "derive_remaining_component",
        descriptionKey: "calculate_only_second_set",
        inputVariables: ["subjectB", "bothPct"],
        outputVariable: "onlyB",
        equation: "onlyB = {subjectB} - {bothPct}",
      }),
      step({
        id: "calculate_union",
        type: "aggregate_components",
        descriptionKey: "calculate_total_percentage_with_overlap",
        inputVariables: ["onlyA", "onlyB", "bothPct"],
        outputVariable: "unionPct",
        equation: "unionPct = {onlyA} + {onlyB} + {bothPct}",
      }),
      step({
        id: "calculate_none",
        type: "derive_remaining_component",
        descriptionKey: "calculate_neither_region",
