...
export const NAV_GROUPS: NavGroup[] = [
  ...
  { id: 'analytics', label: 'Analytics', items: [
    ...
    { label: 'Question Analytics', path: '/analytics/questions', icon: BarChart3, status: 'live', permission: 'users.students.read', summary: 'Canonical question exposure, answer, skip, correctness, option-selection and flag aggregates.', milestone: 'Per-question timing and discrimination remain deferred until the runner persists their canonical inputs.' },
