...
export const NAV_GROUPS: NavGroup[] = [
  ...
  { id: 'content', label: 'Content', items: [
    ...
    { label: 'Content Review', path: '/content/review', icon: ClipboardCheck, status: 'live', permission: 'content.questions.read', summary: 'Unified canonical queue with reviewer ownership, threaded comments, saved views, SLA ageing and immutable version comparison.' },
  ...
  { id: 'tests', label: 'Tests', items: [
    ...
    { label: 'Test Series', path: '/tests/series', icon: Box, status: 'in_progress', summary: 'Organise tests into exam-oriented series with ordering and availability rules.', milestone: 'Canonical series tables, versioning, membership and student availability rules.' },
