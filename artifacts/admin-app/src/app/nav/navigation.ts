...
export const NAV_GROUPS: NavGroup[] = [
  ...
  { id: 'content', label: 'Content', items: [
    ...
    { label: 'CA Production Readiness', path: '/content/current-affairs/production-readiness', icon: ShieldCheck, status: 'live', permission: 'content.questions.read', summary: 'Red/amber/green daily operating gate for source coverage, pipeline freshness, pack completeness, release deadlines and bounded recovery.' },
    { label: 'CA Question Review', path: '/content/current-affairs/questions', icon: FileQuestion, status: 'live', permission: 'content.questions.read', summary: 'Inspect, revise and approve BANK_ONLY Current Affairs questions with Hindi/Punjabi answer-parity controls before editorial release.' },
