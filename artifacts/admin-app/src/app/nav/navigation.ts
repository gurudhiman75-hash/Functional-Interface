...
export const NAV_GROUPS: NavGroup[] = [
  ...
  { id: 'content', label: 'Content', items: [
    ...
    { label: 'Notes Studio v2', path: '/content/notes-studio-v2', icon: FileText, status: 'live', permission: 'content.questions.read', summary: 'Generate, reconcile, quality-check and publish independent English, Hindi and Punjabi study notes from the source-agnostic notes-gen-v1 fact graph.' },
