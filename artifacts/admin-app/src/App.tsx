...
export default function App() {
  return <MathRenderingProvider><ThemeProvider><Suspense fallback={<RouteFallback />}><RouterProvider router={router} /></Suspense><Toaster /></ThemeProvider></MathRenderingProvider>;
}
