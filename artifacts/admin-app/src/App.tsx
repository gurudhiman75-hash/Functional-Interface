...
{index:true,element:<Navigate to="/dashboard" replace/>},{path:'/dashboard',element:<LiveDashboardPage/>},{path:'/content/questions/generate',element:<QuestionStudioPage/>},{path:'/content/studio',element:<Navigate to="/content/questions/generate" replace/>},{path:'/content/questions/:id',element:<QuestionDetailPage/>},{path:'/content/questions',element:<QuestionBankWorkspacePage/>},{path:'/content/review',element:<ContentReviewPage/>},{path:'/content/learning-resources',element:<LearningResourcesPage/>},{path:'/content/current-affairs/questions/:generationItemId',element:<CurrentAffairsQuestionEditorialWorkbenchPage/>},{path:'/content/current-affairs/questions',element:<CurrentAffairsQuestionEditorialQueuePage/>},{path:'/content/current-affairs/editorial/:eventId',element:<CurrentAffairsEditorialWorkbenchPage/>},{path:'/content/current-affairs',element:<CurrentAffairsStudioPage/>},{path:'/content/coverage',element:<CoveragePage/>},{path:'/content/taxonomy',element:<TaxonomyPage/>},{path:'/content/sets',element:<PendingWorkspacePage/>},{path:'/content/media',element:<PendingWorkspacePage/>},
